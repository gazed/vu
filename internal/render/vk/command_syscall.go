...
// Code generated by go-vk from vk.xml at 2026-04-10 07:32:28.7515138 -0400 EDT m=+2.240017601. DO NOT EDIT.
...
func AcquireNextImage2KHR(device Device, acquireInfo *AcquireNextImageInfoKHR) (imageIndex uint32, r error) {
	...
	ptr_ptr_pImageIndex := &imageIndex
	...
	rsys, _, _ = syscall.SyscallN(vkAcquireNextImage2KHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pAcquireInfo)), uintptr(unsafe.Pointer(ptr_ptr_pImageIndex)))
	r = Result(rsys)
...
func AcquireNextImageKHR(device Device, swapchain SwapchainKHR, timeout uint64, semaphore Semaphore, fence Fence) (imageIndex uint32, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkAcquireNextImageKHR.fnHandle.Addr(), uintptr(device), uintptr(swapchain), uintptr(timeout), uintptr(semaphore), uintptr(fence), uintptr(unsafe.Pointer(ptr_ptr_pImageIndex)))
	r = Result(rsys)
...
func AcquirePerformanceConfigurationINTEL(device Device, acquireInfo *PerformanceConfigurationAcquireInfoINTEL) (configuration PerformanceConfigurationINTEL, r error) {
	...
	ptr_ptr_pConfiguration := &configuration
	...
	rsys, _, _ = syscall.SyscallN(vkAcquirePerformanceConfigurationINTEL.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pAcquireInfo)), uintptr(unsafe.Pointer(ptr_ptr_pConfiguration)))
	r = Result(rsys)
...
func AllocateMemory(device Device, allocateInfo *MemoryAllocateInfo, allocator *AllocationCallbacks) (memory DeviceMemory, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkAllocateMemory.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pAllocateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pMemory)))
	r = Result(rsys)
...
func BindOpticalFlowSessionImageNV(device Device, session OpticalFlowSessionNV, bindingPoint OpticalFlowSessionBindingPointNV, view ImageView, layout ImageLayout) (r error) {
	...
	if vkBindOpticalFlowSessionImageNV.fnHandle == nil {
		vkBindOpticalFlowSessionImageNV.fnHandle = dlHandle.NewProc("vkBindOpticalFlowSessionImageNV")
	}
	rsys, _, _ = syscall.SyscallN(vkBindOpticalFlowSessionImageNV.fnHandle.Addr(), uintptr(device), uintptr(session), uintptr(bindingPoint), uintptr(view), uintptr(layout))
	r = Result(rsys)
...
func BindVideoSessionMemoryKHR(device Device, videoSession VideoSessionKHR, bindSessionMemoryInfos []BindVideoSessionMemoryInfoKHR) (r error) {
	...
	if vkBindVideoSessionMemoryKHR.fnHandle == nil {
		vkBindVideoSessionMemoryKHR.fnHandle = dlHandle.NewProc("vkBindVideoSessionMemoryKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkBindVideoSessionMemoryKHR.fnHandle.Addr(), uintptr(device), uintptr(videoSession), uintptr(bindSessionMemoryInfoCount), uintptr(unsafe.Pointer(pBindSessionMemoryInfos)))
	r = Result(rsys)
...
func BuildMicromapsEXT(device Device, deferredOperation DeferredOperationKHR, infos []MicromapBuildInfoEXT) (r error) {
	...
	if vkBuildMicromapsEXT.fnHandle == nil {
		vkBuildMicromapsEXT.fnHandle = dlHandle.NewProc("vkBuildMicromapsEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkBuildMicromapsEXT.fnHandle.Addr(), uintptr(device), uintptr(deferredOperation), uintptr(infoCount), uintptr(unsafe.Pointer(pInfos)))
	r = Result(rsys)
...
func CmdBeginRendering(commandBuffer CommandBuffer, renderingInfo *RenderingInfo) {
	...
	if vkCmdBeginRendering.fnHandle == nil {
		vkCmdBeginRendering.fnHandle = dlHandle.NewProc("vkCmdBeginRendering")
	}
	syscall.SyscallN(vkCmdBeginRendering.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pRenderingInfo)))
...
func CmdBeginVideoCodingKHR(commandBuffer CommandBuffer, beginInfo *VideoBeginCodingInfoKHR) {
	...
	if vkCmdBeginVideoCodingKHR.fnHandle == nil {
		vkCmdBeginVideoCodingKHR.fnHandle = dlHandle.NewProc("vkCmdBeginVideoCodingKHR")
	}
	syscall.SyscallN(vkCmdBeginVideoCodingKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pBeginInfo)))
...
func CmdBindDescriptorBufferEmbeddedSamplers2EXT(commandBuffer CommandBuffer, bindDescriptorBufferEmbeddedSamplersInfo *BindDescriptorBufferEmbeddedSamplersInfoEXT) {
	...
	if vkCmdBindDescriptorBufferEmbeddedSamplers2EXT.fnHandle == nil {
		vkCmdBindDescriptorBufferEmbeddedSamplers2EXT.fnHandle = dlHandle.NewProc("vkCmdBindDescriptorBufferEmbeddedSamplers2EXT")
	}
	syscall.SyscallN(vkCmdBindDescriptorBufferEmbeddedSamplers2EXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pBindDescriptorBufferEmbeddedSamplersInfo)))
...
func CmdBindDescriptorBufferEmbeddedSamplersEXT(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, layout PipelineLayout, set uint32) {
	...
	if vkCmdBindDescriptorBufferEmbeddedSamplersEXT.fnHandle == nil {
		vkCmdBindDescriptorBufferEmbeddedSamplersEXT.fnHandle = dlHandle.NewProc("vkCmdBindDescriptorBufferEmbeddedSamplersEXT")
	}
	syscall.SyscallN(vkCmdBindDescriptorBufferEmbeddedSamplersEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(pipelineBindPoint), uintptr(layout), uintptr(set))
...
func CmdBindDescriptorBuffersEXT(commandBuffer CommandBuffer, bindingInfos []DescriptorBufferBindingInfoEXT) {
	...
	if vkCmdBindDescriptorBuffersEXT.fnHandle == nil {
		vkCmdBindDescriptorBuffersEXT.fnHandle = dlHandle.NewProc("vkCmdBindDescriptorBuffersEXT")
	}
	syscall.SyscallN(vkCmdBindDescriptorBuffersEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(bufferCount), uintptr(unsafe.Pointer(pBindingInfos)))
...
func CmdBindDescriptorSets2KHR(commandBuffer CommandBuffer, bindDescriptorSetsInfo *BindDescriptorSetsInfoKHR) {
	...
	if vkCmdBindDescriptorSets2KHR.fnHandle == nil {
		vkCmdBindDescriptorSets2KHR.fnHandle = dlHandle.NewProc("vkCmdBindDescriptorSets2KHR")
	}
	syscall.SyscallN(vkCmdBindDescriptorSets2KHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pBindDescriptorSetsInfo)))
...
func CmdBindIndexBuffer2KHR(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, size DeviceSize, indexType IndexType) {
	...
	if vkCmdBindIndexBuffer2KHR.fnHandle == nil {
		vkCmdBindIndexBuffer2KHR.fnHandle = dlHandle.NewProc("vkCmdBindIndexBuffer2KHR")
	}
	syscall.SyscallN(vkCmdBindIndexBuffer2KHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(buffer), uintptr(offset), uintptr(size), uintptr(indexType))
...
func CmdBindShadersEXT(commandBuffer CommandBuffer, stages []ShaderStageFlagBits, shaders []ShaderEXT) {
	...
	if vkCmdBindShadersEXT.fnHandle == nil {
		vkCmdBindShadersEXT.fnHandle = dlHandle.NewProc("vkCmdBindShadersEXT")
	}
	syscall.SyscallN(vkCmdBindShadersEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(stageCount), uintptr(unsafe.Pointer(pStages)), uintptr(unsafe.Pointer(pShaders)))
...
func CmdBindVertexBuffers2(commandBuffer CommandBuffer, firstBinding uint32, buffers []Buffer, offsets []DeviceSize, sizes []DeviceSize, strides []DeviceSize) {
	...
	if vkCmdBindVertexBuffers2.fnHandle == nil {
		vkCmdBindVertexBuffers2.fnHandle = dlHandle.NewProc("vkCmdBindVertexBuffers2")
	}
	syscall.SyscallN(vkCmdBindVertexBuffers2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(firstBinding), uintptr(bindingCount), uintptr(unsafe.Pointer(pBuffers)), uintptr(unsafe.Pointer(pOffsets)), uintptr(unsafe.Pointer(pSizes)), uintptr(unsafe.Pointer(pStrides)))
...
func CmdBlitImage2(commandBuffer CommandBuffer, blitImageInfo *BlitImageInfo2) {
	...
	if vkCmdBlitImage2.fnHandle == nil {
		vkCmdBlitImage2.fnHandle = dlHandle.NewProc("vkCmdBlitImage2")
	}
	syscall.SyscallN(vkCmdBlitImage2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pBlitImageInfo)))
...
func CmdBuildAccelerationStructureNV(commandBuffer CommandBuffer, info *AccelerationStructureInfoNV, instanceData Buffer, instanceOffset DeviceSize, update bool, dst AccelerationStructureNV, src AccelerationStructureNV, scratch Buffer, scratchOffset DeviceSize) {
	...
	update_Bool32_Bool32 := translateInternal_Bool32(update)
	...
	syscall.SyscallN(vkCmdBuildAccelerationStructureNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pInfo)), uintptr(instanceData), uintptr(instanceOffset), uintptr(update_Bool32_Bool32), uintptr(dst), uintptr(src), uintptr(scratch), uintptr(scratchOffset))
...
func CmdBuildMicromapsEXT(commandBuffer CommandBuffer, infos []MicromapBuildInfoEXT) {
	...
	if vkCmdBuildMicromapsEXT.fnHandle == nil {
		vkCmdBuildMicromapsEXT.fnHandle = dlHandle.NewProc("vkCmdBuildMicromapsEXT")
	}
	syscall.SyscallN(vkCmdBuildMicromapsEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(infoCount), uintptr(unsafe.Pointer(pInfos)))
...
func CmdControlVideoCodingKHR(commandBuffer CommandBuffer, codingControlInfo *VideoCodingControlInfoKHR) {
	...
	if vkCmdControlVideoCodingKHR.fnHandle == nil {
		vkCmdControlVideoCodingKHR.fnHandle = dlHandle.NewProc("vkCmdControlVideoCodingKHR")
	}
	syscall.SyscallN(vkCmdControlVideoCodingKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pCodingControlInfo)))
...
func CmdCopyBuffer2(commandBuffer CommandBuffer, copyBufferInfo *CopyBufferInfo2) {
	...
	if vkCmdCopyBuffer2.fnHandle == nil {
		vkCmdCopyBuffer2.fnHandle = dlHandle.NewProc("vkCmdCopyBuffer2")
	}
	syscall.SyscallN(vkCmdCopyBuffer2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pCopyBufferInfo)))
...
func CmdCopyBufferToImage2(commandBuffer CommandBuffer, copyBufferToImageInfo *CopyBufferToImageInfo2) {
	...
	if vkCmdCopyBufferToImage2.fnHandle == nil {
		vkCmdCopyBufferToImage2.fnHandle = dlHandle.NewProc("vkCmdCopyBufferToImage2")
	}
	syscall.SyscallN(vkCmdCopyBufferToImage2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pCopyBufferToImageInfo)))
...
func CmdCopyImage2(commandBuffer CommandBuffer, copyImageInfo *CopyImageInfo2) {
	...
	if vkCmdCopyImage2.fnHandle == nil {
		vkCmdCopyImage2.fnHandle = dlHandle.NewProc("vkCmdCopyImage2")
	}
	syscall.SyscallN(vkCmdCopyImage2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pCopyImageInfo)))
...
func CmdCopyImageToBuffer2(commandBuffer CommandBuffer, copyImageToBufferInfo *CopyImageToBufferInfo2) {
	...
	if vkCmdCopyImageToBuffer2.fnHandle == nil {
		vkCmdCopyImageToBuffer2.fnHandle = dlHandle.NewProc("vkCmdCopyImageToBuffer2")
	}
	syscall.SyscallN(vkCmdCopyImageToBuffer2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pCopyImageToBufferInfo)))
...
func CmdCopyMemoryIndirectNV(commandBuffer CommandBuffer, copyBufferAddress DeviceAddress, copyCount uint32, stride uint32) {
	...
	if vkCmdCopyMemoryIndirectNV.fnHandle == nil {
		vkCmdCopyMemoryIndirectNV.fnHandle = dlHandle.NewProc("vkCmdCopyMemoryIndirectNV")
	}
	syscall.SyscallN(vkCmdCopyMemoryIndirectNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(copyBufferAddress), uintptr(copyCount), uintptr(stride))
...
func CmdCopyMemoryToImageIndirectNV(commandBuffer CommandBuffer, copyBufferAddress DeviceAddress, stride uint32, dstImage Image, dstImageLayout ImageLayout, imageSubresources []ImageSubresourceLayers) {
	...
	if vkCmdCopyMemoryToImageIndirectNV.fnHandle == nil {
		vkCmdCopyMemoryToImageIndirectNV.fnHandle = dlHandle.NewProc("vkCmdCopyMemoryToImageIndirectNV")
	}
	syscall.SyscallN(vkCmdCopyMemoryToImageIndirectNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(copyBufferAddress), uintptr(copyCount), uintptr(stride), uintptr(dstImage), uintptr(dstImageLayout), uintptr(unsafe.Pointer(pImageSubresources)))
...
func CmdCopyMemoryToMicromapEXT(commandBuffer CommandBuffer, info *CopyMemoryToMicromapInfoEXT) {
	...
	if vkCmdCopyMemoryToMicromapEXT.fnHandle == nil {
		vkCmdCopyMemoryToMicromapEXT.fnHandle = dlHandle.NewProc("vkCmdCopyMemoryToMicromapEXT")
	}
	syscall.SyscallN(vkCmdCopyMemoryToMicromapEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pInfo)))
...
func CmdCopyMicromapEXT(commandBuffer CommandBuffer, info *CopyMicromapInfoEXT) {
	...
	if vkCmdCopyMicromapEXT.fnHandle == nil {
		vkCmdCopyMicromapEXT.fnHandle = dlHandle.NewProc("vkCmdCopyMicromapEXT")
	}
	syscall.SyscallN(vkCmdCopyMicromapEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pInfo)))
...
func CmdCopyMicromapToMemoryEXT(commandBuffer CommandBuffer, info *CopyMicromapToMemoryInfoEXT) {
	...
	if vkCmdCopyMicromapToMemoryEXT.fnHandle == nil {
		vkCmdCopyMicromapToMemoryEXT.fnHandle = dlHandle.NewProc("vkCmdCopyMicromapToMemoryEXT")
	}
	syscall.SyscallN(vkCmdCopyMicromapToMemoryEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pInfo)))
...
func CmdCudaLaunchKernelNV(commandBuffer CommandBuffer, launchInfo *CudaLaunchInfoNV) {
	...
	if vkCmdCudaLaunchKernelNV.fnHandle == nil {
		vkCmdCudaLaunchKernelNV.fnHandle = dlHandle.NewProc("vkCmdCudaLaunchKernelNV")
	}
	syscall.SyscallN(vkCmdCudaLaunchKernelNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pLaunchInfo)))
...
func CmdDecodeVideoKHR(commandBuffer CommandBuffer, decodeInfo *VideoDecodeInfoKHR) {
	...
	if vkCmdDecodeVideoKHR.fnHandle == nil {
		vkCmdDecodeVideoKHR.fnHandle = dlHandle.NewProc("vkCmdDecodeVideoKHR")
	}
	syscall.SyscallN(vkCmdDecodeVideoKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pDecodeInfo)))
...
func CmdDecompressMemoryIndirectCountNV(commandBuffer CommandBuffer, indirectCommandsAddress DeviceAddress, indirectCommandsCountAddress DeviceAddress, stride uint32) {
	...
	if vkCmdDecompressMemoryIndirectCountNV.fnHandle == nil {
		vkCmdDecompressMemoryIndirectCountNV.fnHandle = dlHandle.NewProc("vkCmdDecompressMemoryIndirectCountNV")
	}
	syscall.SyscallN(vkCmdDecompressMemoryIndirectCountNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(indirectCommandsAddress), uintptr(indirectCommandsCountAddress), uintptr(stride))
...
func CmdDecompressMemoryNV(commandBuffer CommandBuffer, decompressMemoryRegions []DecompressMemoryRegionNV) {
	...
	if vkCmdDecompressMemoryNV.fnHandle == nil {
		vkCmdDecompressMemoryNV.fnHandle = dlHandle.NewProc("vkCmdDecompressMemoryNV")
	}
	syscall.SyscallN(vkCmdDecompressMemoryNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(decompressRegionCount), uintptr(unsafe.Pointer(pDecompressMemoryRegions)))
...
func CmdDrawClusterHUAWEI(commandBuffer CommandBuffer, groupCountX uint32, groupCountY uint32, groupCountZ uint32) {
	...
	if vkCmdDrawClusterHUAWEI.fnHandle == nil {
		vkCmdDrawClusterHUAWEI.fnHandle = dlHandle.NewProc("vkCmdDrawClusterHUAWEI")
	}
	syscall.SyscallN(vkCmdDrawClusterHUAWEI.fnHandle.Addr(), uintptr(commandBuffer), uintptr(groupCountX), uintptr(groupCountY), uintptr(groupCountZ))
...
func CmdDrawClusterIndirectHUAWEI(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize) {
	...
	if vkCmdDrawClusterIndirectHUAWEI.fnHandle == nil {
		vkCmdDrawClusterIndirectHUAWEI.fnHandle = dlHandle.NewProc("vkCmdDrawClusterIndirectHUAWEI")
	}
	syscall.SyscallN(vkCmdDrawClusterIndirectHUAWEI.fnHandle.Addr(), uintptr(commandBuffer), uintptr(buffer), uintptr(offset))
...
func CmdDrawMeshTasksEXT(commandBuffer CommandBuffer, groupCountX uint32, groupCountY uint32, groupCountZ uint32) {
	...
	if vkCmdDrawMeshTasksEXT.fnHandle == nil {
		vkCmdDrawMeshTasksEXT.fnHandle = dlHandle.NewProc("vkCmdDrawMeshTasksEXT")
	}
	syscall.SyscallN(vkCmdDrawMeshTasksEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(groupCountX), uintptr(groupCountY), uintptr(groupCountZ))
...
func CmdDrawMeshTasksIndirectCountEXT(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, countBuffer Buffer, countBufferOffset DeviceSize, maxDrawCount uint32, stride uint32) {
	...
	if vkCmdDrawMeshTasksIndirectCountEXT.fnHandle == nil {
		vkCmdDrawMeshTasksIndirectCountEXT.fnHandle = dlHandle.NewProc("vkCmdDrawMeshTasksIndirectCountEXT")
	}
	syscall.SyscallN(vkCmdDrawMeshTasksIndirectCountEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(buffer), uintptr(offset), uintptr(countBuffer), uintptr(countBufferOffset), uintptr(maxDrawCount), uintptr(stride))
...
func CmdDrawMeshTasksIndirectEXT(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, drawCount uint32, stride uint32) {
	...
	if vkCmdDrawMeshTasksIndirectEXT.fnHandle == nil {
		vkCmdDrawMeshTasksIndirectEXT.fnHandle = dlHandle.NewProc("vkCmdDrawMeshTasksIndirectEXT")
	}
	syscall.SyscallN(vkCmdDrawMeshTasksIndirectEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(buffer), uintptr(offset), uintptr(drawCount), uintptr(stride))
...
func CmdEncodeVideoKHR(commandBuffer CommandBuffer, encodeInfo *VideoEncodeInfoKHR) {
	...
	if vkCmdEncodeVideoKHR.fnHandle == nil {
		vkCmdEncodeVideoKHR.fnHandle = dlHandle.NewProc("vkCmdEncodeVideoKHR")
	}
	syscall.SyscallN(vkCmdEncodeVideoKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pEncodeInfo)))
...
func CmdEndRendering(commandBuffer CommandBuffer) {
	...
	if vkCmdEndRendering.fnHandle == nil {
		vkCmdEndRendering.fnHandle = dlHandle.NewProc("vkCmdEndRendering")
	}
	syscall.SyscallN(vkCmdEndRendering.fnHandle.Addr(), uintptr(commandBuffer))
...
func CmdEndVideoCodingKHR(commandBuffer CommandBuffer, endCodingInfo *VideoEndCodingInfoKHR) {
	...
	if vkCmdEndVideoCodingKHR.fnHandle == nil {
		vkCmdEndVideoCodingKHR.fnHandle = dlHandle.NewProc("vkCmdEndVideoCodingKHR")
	}
	syscall.SyscallN(vkCmdEndVideoCodingKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pEndCodingInfo)))
...
func CmdExecuteGeneratedCommandsNV(commandBuffer CommandBuffer, isPreprocessed bool, generatedCommandsInfo *GeneratedCommandsInfoNV) {
	isPreprocessed_Bool32_Bool32 := translateInternal_Bool32(isPreprocessed)
	...
	syscall.SyscallN(vkCmdExecuteGeneratedCommandsNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(isPreprocessed_Bool32_Bool32), uintptr(unsafe.Pointer(pGeneratedCommandsInfo)))
...
func CmdOpticalFlowExecuteNV(commandBuffer CommandBuffer, session OpticalFlowSessionNV, executeInfo *OpticalFlowExecuteInfoNV) {
	...
	if vkCmdOpticalFlowExecuteNV.fnHandle == nil {
		vkCmdOpticalFlowExecuteNV.fnHandle = dlHandle.NewProc("vkCmdOpticalFlowExecuteNV")
	}
	syscall.SyscallN(vkCmdOpticalFlowExecuteNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(session), uintptr(unsafe.Pointer(pExecuteInfo)))
...
func CmdPipelineBarrier2(commandBuffer CommandBuffer, dependencyInfo *DependencyInfo) {
	...
	if vkCmdPipelineBarrier2.fnHandle == nil {
		vkCmdPipelineBarrier2.fnHandle = dlHandle.NewProc("vkCmdPipelineBarrier2")
	}
	syscall.SyscallN(vkCmdPipelineBarrier2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pDependencyInfo)))
...
func CmdPushConstants2KHR(commandBuffer CommandBuffer, pushConstantsInfo *PushConstantsInfoKHR) {
	...
	if vkCmdPushConstants2KHR.fnHandle == nil {
		vkCmdPushConstants2KHR.fnHandle = dlHandle.NewProc("vkCmdPushConstants2KHR")
	}
	syscall.SyscallN(vkCmdPushConstants2KHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pPushConstantsInfo)))
...
func CmdPushDescriptorSet2KHR(commandBuffer CommandBuffer, pushDescriptorSetInfo *PushDescriptorSetInfoKHR) {
	...
	if vkCmdPushDescriptorSet2KHR.fnHandle == nil {
		vkCmdPushDescriptorSet2KHR.fnHandle = dlHandle.NewProc("vkCmdPushDescriptorSet2KHR")
	}
	syscall.SyscallN(vkCmdPushDescriptorSet2KHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pPushDescriptorSetInfo)))
...
func CmdPushDescriptorSetWithTemplate2KHR(commandBuffer CommandBuffer, pushDescriptorSetWithTemplateInfo *PushDescriptorSetWithTemplateInfoKHR) {
	...
	if vkCmdPushDescriptorSetWithTemplate2KHR.fnHandle == nil {
		vkCmdPushDescriptorSetWithTemplate2KHR.fnHandle = dlHandle.NewProc("vkCmdPushDescriptorSetWithTemplate2KHR")
	}
	syscall.SyscallN(vkCmdPushDescriptorSetWithTemplate2KHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pPushDescriptorSetWithTemplateInfo)))
...
func CmdRefreshObjectsKHR(commandBuffer CommandBuffer, refreshObjects *RefreshObjectListKHR) {
	...
	if vkCmdRefreshObjectsKHR.fnHandle == nil {
		vkCmdRefreshObjectsKHR.fnHandle = dlHandle.NewProc("vkCmdRefreshObjectsKHR")
	}
	syscall.SyscallN(vkCmdRefreshObjectsKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pRefreshObjects)))
...
func CmdResetEvent2(commandBuffer CommandBuffer, event Event, stageMask PipelineStageFlags2) {
	...
	if vkCmdResetEvent2.fnHandle == nil {
		vkCmdResetEvent2.fnHandle = dlHandle.NewProc("vkCmdResetEvent2")
	}
	syscall.SyscallN(vkCmdResetEvent2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(event), uintptr(stageMask))
...
func CmdResolveImage2(commandBuffer CommandBuffer, resolveImageInfo *ResolveImageInfo2) {
	...
	if vkCmdResolveImage2.fnHandle == nil {
		vkCmdResolveImage2.fnHandle = dlHandle.NewProc("vkCmdResolveImage2")
	}
	syscall.SyscallN(vkCmdResolveImage2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pResolveImageInfo)))
...
func CmdSetAlphaToCoverageEnableEXT(commandBuffer CommandBuffer, alphaToCoverageEnable bool) {
	alphaToCoverageEnable_Bool32_Bool32 := translateInternal_Bool32(alphaToCoverageEnable)

	if vkCmdSetAlphaToCoverageEnableEXT.fnHandle == nil {
		vkCmdSetAlphaToCoverageEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetAlphaToCoverageEnableEXT")
	}
	syscall.SyscallN(vkCmdSetAlphaToCoverageEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(alphaToCoverageEnable_Bool32_Bool32))
...
func CmdSetAlphaToOneEnableEXT(commandBuffer CommandBuffer, alphaToOneEnable bool) {
	alphaToOneEnable_Bool32_Bool32 := translateInternal_Bool32(alphaToOneEnable)

	if vkCmdSetAlphaToOneEnableEXT.fnHandle == nil {
		vkCmdSetAlphaToOneEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetAlphaToOneEnableEXT")
	}
	syscall.SyscallN(vkCmdSetAlphaToOneEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(alphaToOneEnable_Bool32_Bool32))
...
func CmdSetAttachmentFeedbackLoopEnableEXT(commandBuffer CommandBuffer, aspectMask ImageAspectFlags) {
	...
	if vkCmdSetAttachmentFeedbackLoopEnableEXT.fnHandle == nil {
		vkCmdSetAttachmentFeedbackLoopEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetAttachmentFeedbackLoopEnableEXT")
	}
	syscall.SyscallN(vkCmdSetAttachmentFeedbackLoopEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(aspectMask))
...
func CmdSetColorBlendAdvancedEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorBlendAdvanced []ColorBlendAdvancedEXT) {
	...
	if vkCmdSetColorBlendAdvancedEXT.fnHandle == nil {
		vkCmdSetColorBlendAdvancedEXT.fnHandle = dlHandle.NewProc("vkCmdSetColorBlendAdvancedEXT")
	}
	syscall.SyscallN(vkCmdSetColorBlendAdvancedEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(firstAttachment), uintptr(attachmentCount), uintptr(unsafe.Pointer(pColorBlendAdvanced)))
...
func CmdSetColorBlendEnableEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorBlendEnables []bool) {
	...
	if vkCmdSetColorBlendEnableEXT.fnHandle == nil {
		vkCmdSetColorBlendEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetColorBlendEnableEXT")
	}
	syscall.SyscallN(vkCmdSetColorBlendEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(firstAttachment), uintptr(attachmentCount), uintptr(unsafe.Pointer(pColorBlendEnables)))
...
func CmdSetColorBlendEquationEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorBlendEquations []ColorBlendEquationEXT) {
	...
	if vkCmdSetColorBlendEquationEXT.fnHandle == nil {
		vkCmdSetColorBlendEquationEXT.fnHandle = dlHandle.NewProc("vkCmdSetColorBlendEquationEXT")
	}
	syscall.SyscallN(vkCmdSetColorBlendEquationEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(firstAttachment), uintptr(attachmentCount), uintptr(unsafe.Pointer(pColorBlendEquations)))
...
func CmdSetColorWriteMaskEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorWriteMasks []ColorComponentFlags) {
	...
	if vkCmdSetColorWriteMaskEXT.fnHandle == nil {
		vkCmdSetColorWriteMaskEXT.fnHandle = dlHandle.NewProc("vkCmdSetColorWriteMaskEXT")
	}
	syscall.SyscallN(vkCmdSetColorWriteMaskEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(firstAttachment), uintptr(attachmentCount), uintptr(unsafe.Pointer(pColorWriteMasks)))
...
func CmdSetConservativeRasterizationModeEXT(commandBuffer CommandBuffer, conservativeRasterizationMode ConservativeRasterizationModeEXT) {
	...
	if vkCmdSetConservativeRasterizationModeEXT.fnHandle == nil {
		vkCmdSetConservativeRasterizationModeEXT.fnHandle = dlHandle.NewProc("vkCmdSetConservativeRasterizationModeEXT")
	}
	syscall.SyscallN(vkCmdSetConservativeRasterizationModeEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(conservativeRasterizationMode))
...
func CmdSetCoverageModulationModeNV(commandBuffer CommandBuffer, coverageModulationMode CoverageModulationModeNV) {
	...
	if vkCmdSetCoverageModulationModeNV.fnHandle == nil {
		vkCmdSetCoverageModulationModeNV.fnHandle = dlHandle.NewProc("vkCmdSetCoverageModulationModeNV")
	}
	syscall.SyscallN(vkCmdSetCoverageModulationModeNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(coverageModulationMode))
...
func CmdSetCoverageModulationTableEnableNV(commandBuffer CommandBuffer, coverageModulationTableEnable bool) {
	coverageModulationTableEnable_Bool32_Bool32 := translateInternal_Bool32(coverageModulationTableEnable)

	if vkCmdSetCoverageModulationTableEnableNV.fnHandle == nil {
		vkCmdSetCoverageModulationTableEnableNV.fnHandle = dlHandle.NewProc("vkCmdSetCoverageModulationTableEnableNV")
	}
	syscall.SyscallN(vkCmdSetCoverageModulationTableEnableNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(coverageModulationTableEnable_Bool32_Bool32))
...
func CmdSetCoverageModulationTableNV(commandBuffer CommandBuffer, coverageModulationTable []float32) {
	...
	if vkCmdSetCoverageModulationTableNV.fnHandle == nil {
		vkCmdSetCoverageModulationTableNV.fnHandle = dlHandle.NewProc("vkCmdSetCoverageModulationTableNV")
	}
	syscall.SyscallN(vkCmdSetCoverageModulationTableNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(coverageModulationTableCount), uintptr(unsafe.Pointer(pCoverageModulationTable)))
...
func CmdSetCoverageReductionModeNV(commandBuffer CommandBuffer, coverageReductionMode CoverageReductionModeNV) {
	...
	if vkCmdSetCoverageReductionModeNV.fnHandle == nil {
		vkCmdSetCoverageReductionModeNV.fnHandle = dlHandle.NewProc("vkCmdSetCoverageReductionModeNV")
	}
	syscall.SyscallN(vkCmdSetCoverageReductionModeNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(coverageReductionMode))
...
func CmdSetCoverageToColorEnableNV(commandBuffer CommandBuffer, coverageToColorEnable bool) {
	coverageToColorEnable_Bool32_Bool32 := translateInternal_Bool32(coverageToColorEnable)

	if vkCmdSetCoverageToColorEnableNV.fnHandle == nil {
		vkCmdSetCoverageToColorEnableNV.fnHandle = dlHandle.NewProc("vkCmdSetCoverageToColorEnableNV")
	}
	syscall.SyscallN(vkCmdSetCoverageToColorEnableNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(coverageToColorEnable_Bool32_Bool32))
...
func CmdSetCoverageToColorLocationNV(commandBuffer CommandBuffer, coverageToColorLocation uint32) {
	...
	if vkCmdSetCoverageToColorLocationNV.fnHandle == nil {
		vkCmdSetCoverageToColorLocationNV.fnHandle = dlHandle.NewProc("vkCmdSetCoverageToColorLocationNV")
	}
	syscall.SyscallN(vkCmdSetCoverageToColorLocationNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(coverageToColorLocation))
...
func CmdSetCullMode(commandBuffer CommandBuffer, cullMode CullModeFlags) {
	...
	if vkCmdSetCullMode.fnHandle == nil {
		vkCmdSetCullMode.fnHandle = dlHandle.NewProc("vkCmdSetCullMode")
	}
	syscall.SyscallN(vkCmdSetCullMode.fnHandle.Addr(), uintptr(commandBuffer), uintptr(cullMode))
...
func CmdSetDepthBias2EXT(commandBuffer CommandBuffer, depthBiasInfo *DepthBiasInfoEXT) {
	...
	if vkCmdSetDepthBias2EXT.fnHandle == nil {
		vkCmdSetDepthBias2EXT.fnHandle = dlHandle.NewProc("vkCmdSetDepthBias2EXT")
	}
	syscall.SyscallN(vkCmdSetDepthBias2EXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pDepthBiasInfo)))
...
func CmdSetDepthBiasEnable(commandBuffer CommandBuffer, depthBiasEnable bool) {
	depthBiasEnable_Bool32_Bool32 := translateInternal_Bool32(depthBiasEnable)

	if vkCmdSetDepthBiasEnable.fnHandle == nil {
		vkCmdSetDepthBiasEnable.fnHandle = dlHandle.NewProc("vkCmdSetDepthBiasEnable")
	}
	syscall.SyscallN(vkCmdSetDepthBiasEnable.fnHandle.Addr(), uintptr(commandBuffer), uintptr(depthBiasEnable_Bool32_Bool32))
...
func CmdSetDepthBoundsTestEnable(commandBuffer CommandBuffer, depthBoundsTestEnable bool) {
	depthBoundsTestEnable_Bool32_Bool32 := translateInternal_Bool32(depthBoundsTestEnable)

	if vkCmdSetDepthBoundsTestEnable.fnHandle == nil {
		vkCmdSetDepthBoundsTestEnable.fnHandle = dlHandle.NewProc("vkCmdSetDepthBoundsTestEnable")
	}
	syscall.SyscallN(vkCmdSetDepthBoundsTestEnable.fnHandle.Addr(), uintptr(commandBuffer), uintptr(depthBoundsTestEnable_Bool32_Bool32))
...
func CmdSetDepthClampEnableEXT(commandBuffer CommandBuffer, depthClampEnable bool) {
	depthClampEnable_Bool32_Bool32 := translateInternal_Bool32(depthClampEnable)

	if vkCmdSetDepthClampEnableEXT.fnHandle == nil {
		vkCmdSetDepthClampEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetDepthClampEnableEXT")
	}
	syscall.SyscallN(vkCmdSetDepthClampEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(depthClampEnable_Bool32_Bool32))
...
func CmdSetDepthClipEnableEXT(commandBuffer CommandBuffer, depthClipEnable bool) {
	depthClipEnable_Bool32_Bool32 := translateInternal_Bool32(depthClipEnable)

	if vkCmdSetDepthClipEnableEXT.fnHandle == nil {
		vkCmdSetDepthClipEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetDepthClipEnableEXT")
	}
	syscall.SyscallN(vkCmdSetDepthClipEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(depthClipEnable_Bool32_Bool32))
...
func CmdSetDepthClipNegativeOneToOneEXT(commandBuffer CommandBuffer, negativeOneToOne bool) {
	negativeOneToOne_Bool32_Bool32 := translateInternal_Bool32(negativeOneToOne)

	if vkCmdSetDepthClipNegativeOneToOneEXT.fnHandle == nil {
		vkCmdSetDepthClipNegativeOneToOneEXT.fnHandle = dlHandle.NewProc("vkCmdSetDepthClipNegativeOneToOneEXT")
	}
	syscall.SyscallN(vkCmdSetDepthClipNegativeOneToOneEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(negativeOneToOne_Bool32_Bool32))
...
func CmdSetDepthCompareOp(commandBuffer CommandBuffer, depthCompareOp CompareOp) {
	...
	if vkCmdSetDepthCompareOp.fnHandle == nil {
		vkCmdSetDepthCompareOp.fnHandle = dlHandle.NewProc("vkCmdSetDepthCompareOp")
	}
	syscall.SyscallN(vkCmdSetDepthCompareOp.fnHandle.Addr(), uintptr(commandBuffer), uintptr(depthCompareOp))
...
func CmdSetDepthTestEnable(commandBuffer CommandBuffer, depthTestEnable bool) {
	depthTestEnable_Bool32_Bool32 := translateInternal_Bool32(depthTestEnable)

	if vkCmdSetDepthTestEnable.fnHandle == nil {
		vkCmdSetDepthTestEnable.fnHandle = dlHandle.NewProc("vkCmdSetDepthTestEnable")
	}
	syscall.SyscallN(vkCmdSetDepthTestEnable.fnHandle.Addr(), uintptr(commandBuffer), uintptr(depthTestEnable_Bool32_Bool32))
...
func CmdSetDepthWriteEnable(commandBuffer CommandBuffer, depthWriteEnable bool) {
	depthWriteEnable_Bool32_Bool32 := translateInternal_Bool32(depthWriteEnable)

	if vkCmdSetDepthWriteEnable.fnHandle == nil {
		vkCmdSetDepthWriteEnable.fnHandle = dlHandle.NewProc("vkCmdSetDepthWriteEnable")
	}
	syscall.SyscallN(vkCmdSetDepthWriteEnable.fnHandle.Addr(), uintptr(commandBuffer), uintptr(depthWriteEnable_Bool32_Bool32))
...
func CmdSetDescriptorBufferOffsets2EXT(commandBuffer CommandBuffer, setDescriptorBufferOffsetsInfo *SetDescriptorBufferOffsetsInfoEXT) {
	...
	if vkCmdSetDescriptorBufferOffsets2EXT.fnHandle == nil {
		vkCmdSetDescriptorBufferOffsets2EXT.fnHandle = dlHandle.NewProc("vkCmdSetDescriptorBufferOffsets2EXT")
	}
	syscall.SyscallN(vkCmdSetDescriptorBufferOffsets2EXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pSetDescriptorBufferOffsetsInfo)))
...
func CmdSetDescriptorBufferOffsetsEXT(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, layout PipelineLayout, firstSet uint32, bufferIndices []uint32, offsets []DeviceSize) {
	...
	if vkCmdSetDescriptorBufferOffsetsEXT.fnHandle == nil {
		vkCmdSetDescriptorBufferOffsetsEXT.fnHandle = dlHandle.NewProc("vkCmdSetDescriptorBufferOffsetsEXT")
	}
	syscall.SyscallN(vkCmdSetDescriptorBufferOffsetsEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(pipelineBindPoint), uintptr(layout), uintptr(firstSet), uintptr(setCount), uintptr(unsafe.Pointer(pBufferIndices)), uintptr(unsafe.Pointer(pOffsets)))
...
func CmdSetDiscardRectangleEnableEXT(commandBuffer CommandBuffer, discardRectangleEnable bool) {
	discardRectangleEnable_Bool32_Bool32 := translateInternal_Bool32(discardRectangleEnable)

	if vkCmdSetDiscardRectangleEnableEXT.fnHandle == nil {
		vkCmdSetDiscardRectangleEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetDiscardRectangleEnableEXT")
	}
	syscall.SyscallN(vkCmdSetDiscardRectangleEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(discardRectangleEnable_Bool32_Bool32))
...
func CmdSetDiscardRectangleModeEXT(commandBuffer CommandBuffer, discardRectangleMode DiscardRectangleModeEXT) {
	...
	if vkCmdSetDiscardRectangleModeEXT.fnHandle == nil {
		vkCmdSetDiscardRectangleModeEXT.fnHandle = dlHandle.NewProc("vkCmdSetDiscardRectangleModeEXT")
	}
	syscall.SyscallN(vkCmdSetDiscardRectangleModeEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(discardRectangleMode))
...
func CmdSetEvent2(commandBuffer CommandBuffer, event Event, dependencyInfo *DependencyInfo) {
	...
	if vkCmdSetEvent2.fnHandle == nil {
		vkCmdSetEvent2.fnHandle = dlHandle.NewProc("vkCmdSetEvent2")
	}
	syscall.SyscallN(vkCmdSetEvent2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(event), uintptr(unsafe.Pointer(pDependencyInfo)))
...
func CmdSetExclusiveScissorEnableNV(commandBuffer CommandBuffer, firstExclusiveScissor uint32, exclusiveScissorEnables []bool) {
	...
	if vkCmdSetExclusiveScissorEnableNV.fnHandle == nil {
		vkCmdSetExclusiveScissorEnableNV.fnHandle = dlHandle.NewProc("vkCmdSetExclusiveScissorEnableNV")
	}
	syscall.SyscallN(vkCmdSetExclusiveScissorEnableNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(firstExclusiveScissor), uintptr(exclusiveScissorCount), uintptr(unsafe.Pointer(pExclusiveScissorEnables)))
...
func CmdSetExtraPrimitiveOverestimationSizeEXT(commandBuffer CommandBuffer, extraPrimitiveOverestimationSize float32) {
	...
	if vkCmdSetExtraPrimitiveOverestimationSizeEXT.fnHandle == nil {
		vkCmdSetExtraPrimitiveOverestimationSizeEXT.fnHandle = dlHandle.NewProc("vkCmdSetExtraPrimitiveOverestimationSizeEXT")
	}
	syscall.SyscallN(vkCmdSetExtraPrimitiveOverestimationSizeEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(extraPrimitiveOverestimationSize))
...
func CmdSetFrontFace(commandBuffer CommandBuffer, frontFace FrontFace) {
	...
	if vkCmdSetFrontFace.fnHandle == nil {
		vkCmdSetFrontFace.fnHandle = dlHandle.NewProc("vkCmdSetFrontFace")
	}
	syscall.SyscallN(vkCmdSetFrontFace.fnHandle.Addr(), uintptr(commandBuffer), uintptr(frontFace))
...
func CmdSetLineRasterizationModeEXT(commandBuffer CommandBuffer, lineRasterizationMode LineRasterizationModeEXT) {
	...
	if vkCmdSetLineRasterizationModeEXT.fnHandle == nil {
		vkCmdSetLineRasterizationModeEXT.fnHandle = dlHandle.NewProc("vkCmdSetLineRasterizationModeEXT")
	}
	syscall.SyscallN(vkCmdSetLineRasterizationModeEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(lineRasterizationMode))
...
func CmdSetLineStippleEnableEXT(commandBuffer CommandBuffer, stippledLineEnable bool) {
	stippledLineEnable_Bool32_Bool32 := translateInternal_Bool32(stippledLineEnable)

	if vkCmdSetLineStippleEnableEXT.fnHandle == nil {
		vkCmdSetLineStippleEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetLineStippleEnableEXT")
	}
	syscall.SyscallN(vkCmdSetLineStippleEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(stippledLineEnable_Bool32_Bool32))
...
func CmdSetLineStippleKHR(commandBuffer CommandBuffer, lineStippleFactor uint32, lineStipplePattern uint16) {
	...
	if vkCmdSetLineStippleKHR.fnHandle == nil {
		vkCmdSetLineStippleKHR.fnHandle = dlHandle.NewProc("vkCmdSetLineStippleKHR")
	}
	syscall.SyscallN(vkCmdSetLineStippleKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(lineStippleFactor), uintptr(lineStipplePattern))
...
func CmdSetLogicOpEnableEXT(commandBuffer CommandBuffer, logicOpEnable bool) {
	logicOpEnable_Bool32_Bool32 := translateInternal_Bool32(logicOpEnable)

	if vkCmdSetLogicOpEnableEXT.fnHandle == nil {
		vkCmdSetLogicOpEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetLogicOpEnableEXT")
	}
	syscall.SyscallN(vkCmdSetLogicOpEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(logicOpEnable_Bool32_Bool32))
...
func CmdSetPolygonModeEXT(commandBuffer CommandBuffer, polygonMode PolygonMode) {
	...
	if vkCmdSetPolygonModeEXT.fnHandle == nil {
		vkCmdSetPolygonModeEXT.fnHandle = dlHandle.NewProc("vkCmdSetPolygonModeEXT")
	}
	syscall.SyscallN(vkCmdSetPolygonModeEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(polygonMode))
...
func CmdSetPrimitiveRestartEnable(commandBuffer CommandBuffer, primitiveRestartEnable bool) {
	primitiveRestartEnable_Bool32_Bool32 := translateInternal_Bool32(primitiveRestartEnable)

	if vkCmdSetPrimitiveRestartEnable.fnHandle == nil {
		vkCmdSetPrimitiveRestartEnable.fnHandle = dlHandle.NewProc("vkCmdSetPrimitiveRestartEnable")
	}
	syscall.SyscallN(vkCmdSetPrimitiveRestartEnable.fnHandle.Addr(), uintptr(commandBuffer), uintptr(primitiveRestartEnable_Bool32_Bool32))
...
func CmdSetPrimitiveTopology(commandBuffer CommandBuffer, primitiveTopology PrimitiveTopology) {
	...
	if vkCmdSetPrimitiveTopology.fnHandle == nil {
		vkCmdSetPrimitiveTopology.fnHandle = dlHandle.NewProc("vkCmdSetPrimitiveTopology")
	}
	syscall.SyscallN(vkCmdSetPrimitiveTopology.fnHandle.Addr(), uintptr(commandBuffer), uintptr(primitiveTopology))
...
func CmdSetProvokingVertexModeEXT(commandBuffer CommandBuffer, provokingVertexMode ProvokingVertexModeEXT) {
	...
	if vkCmdSetProvokingVertexModeEXT.fnHandle == nil {
		vkCmdSetProvokingVertexModeEXT.fnHandle = dlHandle.NewProc("vkCmdSetProvokingVertexModeEXT")
	}
	syscall.SyscallN(vkCmdSetProvokingVertexModeEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(provokingVertexMode))
...
func CmdSetRasterizationSamplesEXT(commandBuffer CommandBuffer, rasterizationSamples SampleCountFlagBits) {
	...
	if vkCmdSetRasterizationSamplesEXT.fnHandle == nil {
		vkCmdSetRasterizationSamplesEXT.fnHandle = dlHandle.NewProc("vkCmdSetRasterizationSamplesEXT")
	}
	syscall.SyscallN(vkCmdSetRasterizationSamplesEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(rasterizationSamples))
...
func CmdSetRasterizationStreamEXT(commandBuffer CommandBuffer, rasterizationStream uint32) {
	...
	if vkCmdSetRasterizationStreamEXT.fnHandle == nil {
		vkCmdSetRasterizationStreamEXT.fnHandle = dlHandle.NewProc("vkCmdSetRasterizationStreamEXT")
	}
	syscall.SyscallN(vkCmdSetRasterizationStreamEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(rasterizationStream))
...
func CmdSetRasterizerDiscardEnable(commandBuffer CommandBuffer, rasterizerDiscardEnable bool) {
	rasterizerDiscardEnable_Bool32_Bool32 := translateInternal_Bool32(rasterizerDiscardEnable)

	if vkCmdSetRasterizerDiscardEnable.fnHandle == nil {
		vkCmdSetRasterizerDiscardEnable.fnHandle = dlHandle.NewProc("vkCmdSetRasterizerDiscardEnable")
	}
	syscall.SyscallN(vkCmdSetRasterizerDiscardEnable.fnHandle.Addr(), uintptr(commandBuffer), uintptr(rasterizerDiscardEnable_Bool32_Bool32))
...
func CmdSetRenderingAttachmentLocationsKHR(commandBuffer CommandBuffer, locationInfo *RenderingAttachmentLocationInfoKHR) {
	...
	if vkCmdSetRenderingAttachmentLocationsKHR.fnHandle == nil {
		vkCmdSetRenderingAttachmentLocationsKHR.fnHandle = dlHandle.NewProc("vkCmdSetRenderingAttachmentLocationsKHR")
	}
	syscall.SyscallN(vkCmdSetRenderingAttachmentLocationsKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pLocationInfo)))
...
func CmdSetRenderingInputAttachmentIndicesKHR(commandBuffer CommandBuffer, inputAttachmentIndexInfo *RenderingInputAttachmentIndexInfoKHR) {
	...
	if vkCmdSetRenderingInputAttachmentIndicesKHR.fnHandle == nil {
		vkCmdSetRenderingInputAttachmentIndicesKHR.fnHandle = dlHandle.NewProc("vkCmdSetRenderingInputAttachmentIndicesKHR")
	}
	syscall.SyscallN(vkCmdSetRenderingInputAttachmentIndicesKHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(unsafe.Pointer(pInputAttachmentIndexInfo)))
...
func CmdSetRepresentativeFragmentTestEnableNV(commandBuffer CommandBuffer, representativeFragmentTestEnable bool) {
	representativeFragmentTestEnable_Bool32_Bool32 := translateInternal_Bool32(representativeFragmentTestEnable)

	if vkCmdSetRepresentativeFragmentTestEnableNV.fnHandle == nil {
		vkCmdSetRepresentativeFragmentTestEnableNV.fnHandle = dlHandle.NewProc("vkCmdSetRepresentativeFragmentTestEnableNV")
	}
	syscall.SyscallN(vkCmdSetRepresentativeFragmentTestEnableNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(representativeFragmentTestEnable_Bool32_Bool32))
...
func CmdSetSampleLocationsEnableEXT(commandBuffer CommandBuffer, sampleLocationsEnable bool) {
	sampleLocationsEnable_Bool32_Bool32 := translateInternal_Bool32(sampleLocationsEnable)

	if vkCmdSetSampleLocationsEnableEXT.fnHandle == nil {
		vkCmdSetSampleLocationsEnableEXT.fnHandle = dlHandle.NewProc("vkCmdSetSampleLocationsEnableEXT")
	}
	syscall.SyscallN(vkCmdSetSampleLocationsEnableEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(sampleLocationsEnable_Bool32_Bool32))
...
func CmdSetSampleMaskEXT(commandBuffer CommandBuffer, samples SampleCountFlagBits, sampleMask []SampleMask) {
	...
	if vkCmdSetSampleMaskEXT.fnHandle == nil {
		vkCmdSetSampleMaskEXT.fnHandle = dlHandle.NewProc("vkCmdSetSampleMaskEXT")
	}
	syscall.SyscallN(vkCmdSetSampleMaskEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(samples), uintptr(unsafe.Pointer(pSampleMask)))
...
func CmdSetScissorWithCount(commandBuffer CommandBuffer, scissors []Rect2D) {
	...
	if vkCmdSetScissorWithCount.fnHandle == nil {
		vkCmdSetScissorWithCount.fnHandle = dlHandle.NewProc("vkCmdSetScissorWithCount")
	}
	syscall.SyscallN(vkCmdSetScissorWithCount.fnHandle.Addr(), uintptr(commandBuffer), uintptr(scissorCount), uintptr(unsafe.Pointer(pScissors)))
...
func CmdSetShadingRateImageEnableNV(commandBuffer CommandBuffer, shadingRateImageEnable bool) {
	shadingRateImageEnable_Bool32_Bool32 := translateInternal_Bool32(shadingRateImageEnable)

	if vkCmdSetShadingRateImageEnableNV.fnHandle == nil {
		vkCmdSetShadingRateImageEnableNV.fnHandle = dlHandle.NewProc("vkCmdSetShadingRateImageEnableNV")
	}
	syscall.SyscallN(vkCmdSetShadingRateImageEnableNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(shadingRateImageEnable_Bool32_Bool32))
...
func CmdSetStencilOp(commandBuffer CommandBuffer, faceMask StencilFaceFlags, failOp StencilOp, passOp StencilOp, depthFailOp StencilOp, compareOp CompareOp) {
	...
	if vkCmdSetStencilOp.fnHandle == nil {
		vkCmdSetStencilOp.fnHandle = dlHandle.NewProc("vkCmdSetStencilOp")
	}
	syscall.SyscallN(vkCmdSetStencilOp.fnHandle.Addr(), uintptr(commandBuffer), uintptr(faceMask), uintptr(failOp), uintptr(passOp), uintptr(depthFailOp), uintptr(compareOp))
...
func CmdSetStencilTestEnable(commandBuffer CommandBuffer, stencilTestEnable bool) {
	stencilTestEnable_Bool32_Bool32 := translateInternal_Bool32(stencilTestEnable)

	if vkCmdSetStencilTestEnable.fnHandle == nil {
		vkCmdSetStencilTestEnable.fnHandle = dlHandle.NewProc("vkCmdSetStencilTestEnable")
	}
	syscall.SyscallN(vkCmdSetStencilTestEnable.fnHandle.Addr(), uintptr(commandBuffer), uintptr(stencilTestEnable_Bool32_Bool32))
...
func CmdSetTessellationDomainOriginEXT(commandBuffer CommandBuffer, domainOrigin TessellationDomainOrigin) {
	...
	if vkCmdSetTessellationDomainOriginEXT.fnHandle == nil {
		vkCmdSetTessellationDomainOriginEXT.fnHandle = dlHandle.NewProc("vkCmdSetTessellationDomainOriginEXT")
	}
	syscall.SyscallN(vkCmdSetTessellationDomainOriginEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(domainOrigin))
...
func CmdSetViewportSwizzleNV(commandBuffer CommandBuffer, firstViewport uint32, viewportSwizzles []ViewportSwizzleNV) {
	...
	if vkCmdSetViewportSwizzleNV.fnHandle == nil {
		vkCmdSetViewportSwizzleNV.fnHandle = dlHandle.NewProc("vkCmdSetViewportSwizzleNV")
	}
	syscall.SyscallN(vkCmdSetViewportSwizzleNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(firstViewport), uintptr(viewportCount), uintptr(unsafe.Pointer(pViewportSwizzles)))
...
func CmdSetViewportWScalingEnableNV(commandBuffer CommandBuffer, viewportWScalingEnable bool) {
	viewportWScalingEnable_Bool32_Bool32 := translateInternal_Bool32(viewportWScalingEnable)

	if vkCmdSetViewportWScalingEnableNV.fnHandle == nil {
		vkCmdSetViewportWScalingEnableNV.fnHandle = dlHandle.NewProc("vkCmdSetViewportWScalingEnableNV")
	}
	syscall.SyscallN(vkCmdSetViewportWScalingEnableNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(viewportWScalingEnable_Bool32_Bool32))
...
func CmdSetViewportWithCount(commandBuffer CommandBuffer, viewports []Viewport) {
	...
	if vkCmdSetViewportWithCount.fnHandle == nil {
		vkCmdSetViewportWithCount.fnHandle = dlHandle.NewProc("vkCmdSetViewportWithCount")
	}
	syscall.SyscallN(vkCmdSetViewportWithCount.fnHandle.Addr(), uintptr(commandBuffer), uintptr(viewportCount), uintptr(unsafe.Pointer(pViewports)))
...
func CmdTraceRaysIndirect2KHR(commandBuffer CommandBuffer, indirectDeviceAddress DeviceAddress) {
	...
	if vkCmdTraceRaysIndirect2KHR.fnHandle == nil {
		vkCmdTraceRaysIndirect2KHR.fnHandle = dlHandle.NewProc("vkCmdTraceRaysIndirect2KHR")
	}
	syscall.SyscallN(vkCmdTraceRaysIndirect2KHR.fnHandle.Addr(), uintptr(commandBuffer), uintptr(indirectDeviceAddress))
...
func CmdUpdatePipelineIndirectBufferNV(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, pipeline Pipeline) {
	...
	if vkCmdUpdatePipelineIndirectBufferNV.fnHandle == nil {
		vkCmdUpdatePipelineIndirectBufferNV.fnHandle = dlHandle.NewProc("vkCmdUpdatePipelineIndirectBufferNV")
	}
	syscall.SyscallN(vkCmdUpdatePipelineIndirectBufferNV.fnHandle.Addr(), uintptr(commandBuffer), uintptr(pipelineBindPoint), uintptr(pipeline))
...
func CmdWaitEvents2(commandBuffer CommandBuffer, events []Event, dependencyInfos []DependencyInfo) {
	...
	if vkCmdWaitEvents2.fnHandle == nil {
		vkCmdWaitEvents2.fnHandle = dlHandle.NewProc("vkCmdWaitEvents2")
	}
	syscall.SyscallN(vkCmdWaitEvents2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(eventCount), uintptr(unsafe.Pointer(pEvents)), uintptr(unsafe.Pointer(pDependencyInfos)))
...
func CmdWriteMicromapsPropertiesEXT(commandBuffer CommandBuffer, micromaps []MicromapEXT, queryType QueryType, queryPool QueryPool, firstQuery uint32) {
	...
	if vkCmdWriteMicromapsPropertiesEXT.fnHandle == nil {
		vkCmdWriteMicromapsPropertiesEXT.fnHandle = dlHandle.NewProc("vkCmdWriteMicromapsPropertiesEXT")
	}
	syscall.SyscallN(vkCmdWriteMicromapsPropertiesEXT.fnHandle.Addr(), uintptr(commandBuffer), uintptr(micromapCount), uintptr(unsafe.Pointer(pMicromaps)), uintptr(queryType), uintptr(queryPool), uintptr(firstQuery))
...
func CmdWriteTimestamp2(commandBuffer CommandBuffer, stage PipelineStageFlags2, queryPool QueryPool, query uint32) {
	...
	if vkCmdWriteTimestamp2.fnHandle == nil {
		vkCmdWriteTimestamp2.fnHandle = dlHandle.NewProc("vkCmdWriteTimestamp2")
	}
	syscall.SyscallN(vkCmdWriteTimestamp2.fnHandle.Addr(), uintptr(commandBuffer), uintptr(stage), uintptr(queryPool), uintptr(query))
...
func CopyImageToImageEXT(device Device, copyImageToImageInfo *CopyImageToImageInfoEXT) (r error) {
	...
	if vkCopyImageToImageEXT.fnHandle == nil {
		vkCopyImageToImageEXT.fnHandle = dlHandle.NewProc("vkCopyImageToImageEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCopyImageToImageEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCopyImageToImageInfo)))
	r = Result(rsys)
...
func CopyImageToMemoryEXT(device Device, copyImageToMemoryInfo *CopyImageToMemoryInfoEXT) (r error) {
	...
	if vkCopyImageToMemoryEXT.fnHandle == nil {
		vkCopyImageToMemoryEXT.fnHandle = dlHandle.NewProc("vkCopyImageToMemoryEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCopyImageToMemoryEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCopyImageToMemoryInfo)))
	r = Result(rsys)
...
func CopyMemoryToImageEXT(device Device, copyMemoryToImageInfo *CopyMemoryToImageInfoEXT) (r error) {
	...
	if vkCopyMemoryToImageEXT.fnHandle == nil {
		vkCopyMemoryToImageEXT.fnHandle = dlHandle.NewProc("vkCopyMemoryToImageEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCopyMemoryToImageEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCopyMemoryToImageInfo)))
	r = Result(rsys)
...
func CopyMemoryToMicromapEXT(device Device, deferredOperation DeferredOperationKHR, info *CopyMemoryToMicromapInfoEXT) (r error) {
	...
	if vkCopyMemoryToMicromapEXT.fnHandle == nil {
		vkCopyMemoryToMicromapEXT.fnHandle = dlHandle.NewProc("vkCopyMemoryToMicromapEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCopyMemoryToMicromapEXT.fnHandle.Addr(), uintptr(device), uintptr(deferredOperation), uintptr(unsafe.Pointer(pInfo)))
	r = Result(rsys)
...
func CopyMicromapEXT(device Device, deferredOperation DeferredOperationKHR, info *CopyMicromapInfoEXT) (r error) {
	...
	if vkCopyMicromapEXT.fnHandle == nil {
		vkCopyMicromapEXT.fnHandle = dlHandle.NewProc("vkCopyMicromapEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCopyMicromapEXT.fnHandle.Addr(), uintptr(device), uintptr(deferredOperation), uintptr(unsafe.Pointer(pInfo)))
	r = Result(rsys)
...
func CopyMicromapToMemoryEXT(device Device, deferredOperation DeferredOperationKHR, info *CopyMicromapToMemoryInfoEXT) (r error) {
	...
	if vkCopyMicromapToMemoryEXT.fnHandle == nil {
		vkCopyMicromapToMemoryEXT.fnHandle = dlHandle.NewProc("vkCopyMicromapToMemoryEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCopyMicromapToMemoryEXT.fnHandle.Addr(), uintptr(device), uintptr(deferredOperation), uintptr(unsafe.Pointer(pInfo)))
	r = Result(rsys)
...
func CreateAccelerationStructureKHR(device Device, createInfo *AccelerationStructureCreateInfoKHR, allocator *AllocationCallbacks) (accelerationStructure AccelerationStructureKHR, r error) {
	...
	ptr_ptr_pAccelerationStructure := &accelerationStructure
	...
	rsys, _, _ = syscall.SyscallN(vkCreateAccelerationStructureKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pAccelerationStructure)))
	r = Result(rsys)
...
func CreateAccelerationStructureNV(device Device, createInfo *AccelerationStructureCreateInfoNV, allocator *AllocationCallbacks) (accelerationStructure AccelerationStructureNV, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateAccelerationStructureNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pAccelerationStructure)))
	r = Result(rsys)
...
func CreateBuffer(device Device, createInfo *BufferCreateInfo, allocator *AllocationCallbacks) (buffer Buffer, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateBuffer.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pBuffer)))
	r = Result(rsys)
...
func CreateBufferView(device Device, createInfo *BufferViewCreateInfo, allocator *AllocationCallbacks) (view BufferView, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateBufferView.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pView)))
	r = Result(rsys)
...
func CreateCommandPool(device Device, createInfo *CommandPoolCreateInfo, allocator *AllocationCallbacks) (commandPool CommandPool, r error) {
	...
	ptr_ptr_pCommandPool := &commandPool
	...
	rsys, _, _ = syscall.SyscallN(vkCreateCommandPool.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pCommandPool)))
	r = Result(rsys)
...
func CreateCuFunctionNVX(device Device, createInfo *CuFunctionCreateInfoNVX, allocator *AllocationCallbacks) (function CuFunctionNVX, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateCuFunctionNVX.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pFunction)))
	r = Result(rsys)
...
func CreateCuModuleNVX(device Device, createInfo *CuModuleCreateInfoNVX, allocator *AllocationCallbacks) (module CuModuleNVX, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateCuModuleNVX.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pModule)))
	r = Result(rsys)
...
func CreateCudaFunctionNV(device Device, createInfo *CudaFunctionCreateInfoNV, allocator *AllocationCallbacks) (function CudaFunctionNV, r error) {
	...
	if vkCreateCudaFunctionNV.fnHandle == nil {
		vkCreateCudaFunctionNV.fnHandle = dlHandle.NewProc("vkCreateCudaFunctionNV")
	}
	rsys, _, _ = syscall.SyscallN(vkCreateCudaFunctionNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pFunction)))
	r = Result(rsys)
...
func CreateCudaModuleNV(device Device, createInfo *CudaModuleCreateInfoNV, allocator *AllocationCallbacks) (module CudaModuleNV, r error) {
	...
	if vkCreateCudaModuleNV.fnHandle == nil {
		vkCreateCudaModuleNV.fnHandle = dlHandle.NewProc("vkCreateCudaModuleNV")
	}
	rsys, _, _ = syscall.SyscallN(vkCreateCudaModuleNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pModule)))
	r = Result(rsys)
...
func CreateDebugReportCallbackEXT(instance Instance, createInfo *DebugReportCallbackCreateInfoEXT, allocator *AllocationCallbacks) (callback DebugReportCallbackEXT, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDebugReportCallbackEXT.fnHandle.Addr(), uintptr(instance), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pCallback)))
	r = Result(rsys)
...
func CreateDebugUtilsMessengerEXT(instance Instance, createInfo *DebugUtilsMessengerCreateInfoEXT, allocator *AllocationCallbacks) (messenger DebugUtilsMessengerEXT, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDebugUtilsMessengerEXT.fnHandle.Addr(), uintptr(instance), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pMessenger)))
	r = Result(rsys)
...
func CreateDeferredOperationKHR(device Device, allocator *AllocationCallbacks) (deferredOperation DeferredOperationKHR, r error) {
	...
	ptr_ptr_pDeferredOperation := &deferredOperation
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDeferredOperationKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pDeferredOperation)))
	r = Result(rsys)
...
func CreateDescriptorPool(device Device, createInfo *DescriptorPoolCreateInfo, allocator *AllocationCallbacks) (descriptorPool DescriptorPool, r error) {
	...
	ptr_ptr_pDescriptorPool := &descriptorPool
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDescriptorPool.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pDescriptorPool)))
	r = Result(rsys)
...
func CreateDescriptorSetLayout(device Device, createInfo *DescriptorSetLayoutCreateInfo, allocator *AllocationCallbacks) (setLayout DescriptorSetLayout, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDescriptorSetLayout.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pSetLayout)))
	r = Result(rsys)
...
func CreateDescriptorUpdateTemplate(device Device, createInfo *DescriptorUpdateTemplateCreateInfo, allocator *AllocationCallbacks) (descriptorUpdateTemplate DescriptorUpdateTemplate, r error) {
	...
	ptr_ptr_pDescriptorUpdateTemplate := &descriptorUpdateTemplate
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDescriptorUpdateTemplate.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pDescriptorUpdateTemplate)))
	r = Result(rsys)
...
func CreateDevice(physicalDevice PhysicalDevice, createInfo *DeviceCreateInfo, allocator *AllocationCallbacks) (device Device, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDevice.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pDevice)))
	r = Result(rsys)
...
func CreateDisplayModeKHR(physicalDevice PhysicalDevice, display DisplayKHR, createInfo *DisplayModeCreateInfoKHR, allocator *AllocationCallbacks) (mode DisplayModeKHR, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDisplayModeKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(display), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pMode)))
	r = Result(rsys)
...
func CreateDisplayPlaneSurfaceKHR(instance Instance, createInfo *DisplaySurfaceCreateInfoKHR, allocator *AllocationCallbacks) (surface SurfaceKHR, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateDisplayPlaneSurfaceKHR.fnHandle.Addr(), uintptr(instance), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pSurface)))
	r = Result(rsys)
...
func CreateEvent(device Device, createInfo *EventCreateInfo, allocator *AllocationCallbacks) (event Event, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateEvent.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pEvent)))
	r = Result(rsys)
...
func CreateFence(device Device, createInfo *FenceCreateInfo, allocator *AllocationCallbacks) (fence Fence, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateFence.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pFence)))
	r = Result(rsys)
...
func CreateFramebuffer(device Device, createInfo *FramebufferCreateInfo, allocator *AllocationCallbacks) (framebuffer Framebuffer, r error) {
	...
	ptr_ptr_pFramebuffer := &framebuffer
	...
	rsys, _, _ = syscall.SyscallN(vkCreateFramebuffer.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pFramebuffer)))
	r = Result(rsys)
...
func CreateHeadlessSurfaceEXT(instance Instance, createInfo *HeadlessSurfaceCreateInfoEXT, allocator *AllocationCallbacks) (surface SurfaceKHR, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateHeadlessSurfaceEXT.fnHandle.Addr(), uintptr(instance), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pSurface)))
	r = Result(rsys)
...
func CreateImage(device Device, createInfo *ImageCreateInfo, allocator *AllocationCallbacks) (image Image, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateImage.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pImage)))
	r = Result(rsys)
...
func CreateImageView(device Device, createInfo *ImageViewCreateInfo, allocator *AllocationCallbacks) (view ImageView, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateImageView.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pView)))
	r = Result(rsys)
...
func CreateIndirectCommandsLayoutNV(device Device, createInfo *IndirectCommandsLayoutCreateInfoNV, allocator *AllocationCallbacks) (indirectCommandsLayout IndirectCommandsLayoutNV, r error) {
	...
	ptr_ptr_pIndirectCommandsLayout := &indirectCommandsLayout
	...
	rsys, _, _ = syscall.SyscallN(vkCreateIndirectCommandsLayoutNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pIndirectCommandsLayout)))
	r = Result(rsys)
...
func CreateInstance(createInfo *InstanceCreateInfo, allocator *AllocationCallbacks) (instance Instance, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateInstance.fnHandle.Addr(), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pInstance)))
	r = Result(rsys)
...
func CreateMicromapEXT(device Device, createInfo *MicromapCreateInfoEXT, allocator *AllocationCallbacks) (micromap MicromapEXT, r error) {
	...
	ptr_ptr_pMicromap := &micromap

	var rsys uintptr

	if vkCreateMicromapEXT.fnHandle == nil {
		vkCreateMicromapEXT.fnHandle = dlHandle.NewProc("vkCreateMicromapEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCreateMicromapEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pMicromap)))
	r = Result(rsys)
...
func CreateOpticalFlowSessionNV(device Device, createInfo *OpticalFlowSessionCreateInfoNV, allocator *AllocationCallbacks) (session OpticalFlowSessionNV, r error) {
	...
	ptr_ptr_pSession := &session

	var rsys uintptr

	if vkCreateOpticalFlowSessionNV.fnHandle == nil {
		vkCreateOpticalFlowSessionNV.fnHandle = dlHandle.NewProc("vkCreateOpticalFlowSessionNV")
	}
	rsys, _, _ = syscall.SyscallN(vkCreateOpticalFlowSessionNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pSession)))
	r = Result(rsys)
...
func CreatePipelineCache(device Device, createInfo *PipelineCacheCreateInfo, allocator *AllocationCallbacks) (pipelineCache PipelineCache, r error) {
	...
	ptr_ptr_pPipelineCache := &pipelineCache
	...
	rsys, _, _ = syscall.SyscallN(vkCreatePipelineCache.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pPipelineCache)))
	r = Result(rsys)
...
func CreatePipelineLayout(device Device, createInfo *PipelineLayoutCreateInfo, allocator *AllocationCallbacks) (pipelineLayout PipelineLayout, r error) {
	...
	ptr_ptr_pPipelineLayout := &pipelineLayout
	...
	rsys, _, _ = syscall.SyscallN(vkCreatePipelineLayout.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pPipelineLayout)))
	r = Result(rsys)
...
func CreatePrivateDataSlot(device Device, createInfo *PrivateDataSlotCreateInfo, allocator *AllocationCallbacks) (privateDataSlot PrivateDataSlot, r error) {
	...
	ptr_ptr_pPrivateDataSlot := &privateDataSlot

	var rsys uintptr

	if vkCreatePrivateDataSlot.fnHandle == nil {
		vkCreatePrivateDataSlot.fnHandle = dlHandle.NewProc("vkCreatePrivateDataSlot")
	}
	rsys, _, _ = syscall.SyscallN(vkCreatePrivateDataSlot.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pPrivateDataSlot)))
	r = Result(rsys)
...
func CreateQueryPool(device Device, createInfo *QueryPoolCreateInfo, allocator *AllocationCallbacks) (queryPool QueryPool, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateQueryPool.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pQueryPool)))
	r = Result(rsys)
...
func CreateRenderPass(device Device, createInfo *RenderPassCreateInfo, allocator *AllocationCallbacks) (renderPass RenderPass, r error) {
	...
	ptr_ptr_pRenderPass := &renderPass
	...
	rsys, _, _ = syscall.SyscallN(vkCreateRenderPass.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pRenderPass)))
	r = Result(rsys)
...
func CreateRenderPass2(device Device, createInfo *RenderPassCreateInfo2, allocator *AllocationCallbacks) (renderPass RenderPass, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateRenderPass2.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pRenderPass)))
	r = Result(rsys)
...
func CreateSampler(device Device, createInfo *SamplerCreateInfo, allocator *AllocationCallbacks) (sampler Sampler, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateSampler.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pSampler)))
	r = Result(rsys)
...
func CreateSamplerYcbcrConversion(device Device, createInfo *SamplerYcbcrConversionCreateInfo, allocator *AllocationCallbacks) (ycbcrConversion SamplerYcbcrConversion, r error) {
	...
	ptr_ptr_pYcbcrConversion := &ycbcrConversion
	...
	rsys, _, _ = syscall.SyscallN(vkCreateSamplerYcbcrConversion.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pYcbcrConversion)))
	r = Result(rsys)
...
func CreateSemaphore(device Device, createInfo *SemaphoreCreateInfo, allocator *AllocationCallbacks) (semaphore Semaphore, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateSemaphore.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pSemaphore)))
	r = Result(rsys)
...
func CreateShaderModule(device Device, createInfo *ShaderModuleCreateInfo, allocator *AllocationCallbacks) (shaderModule ShaderModule, r error) {
	...
	ptr_ptr_pShaderModule := &shaderModule
	...
	rsys, _, _ = syscall.SyscallN(vkCreateShaderModule.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pShaderModule)))
	r = Result(rsys)
...
func CreateShadersEXT(device Device, createInfos []ShaderCreateInfoEXT, allocator *AllocationCallbacks) (shaders []ShaderEXT, r error) {
	...
	if vkCreateShadersEXT.fnHandle == nil {
		vkCreateShadersEXT.fnHandle = dlHandle.NewProc("vkCreateShadersEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkCreateShadersEXT.fnHandle.Addr(), uintptr(device), uintptr(createInfoCount), uintptr(unsafe.Pointer(pCreateInfos)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(pShaders)))
	r = Result(rsys)
...
func CreateSwapchainKHR(device Device, createInfo *SwapchainCreateInfoKHR, allocator *AllocationCallbacks) (swapchain SwapchainKHR, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkCreateSwapchainKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pSwapchain)))
	r = Result(rsys)
...
func CreateValidationCacheEXT(device Device, createInfo *ValidationCacheCreateInfoEXT, allocator *AllocationCallbacks) (validationCache ValidationCacheEXT, r error) {
	...
	ptr_ptr_pValidationCache := &validationCache
	...
	rsys, _, _ = syscall.SyscallN(vkCreateValidationCacheEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pValidationCache)))
	r = Result(rsys)
...
func CreateVideoSessionKHR(device Device, createInfo *VideoSessionCreateInfoKHR, allocator *AllocationCallbacks) (videoSession VideoSessionKHR, r error) {
	...
	ptr_ptr_pVideoSession := &videoSession

	var rsys uintptr

	if vkCreateVideoSessionKHR.fnHandle == nil {
		vkCreateVideoSessionKHR.fnHandle = dlHandle.NewProc("vkCreateVideoSessionKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkCreateVideoSessionKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pVideoSession)))
	r = Result(rsys)
...
func CreateVideoSessionParametersKHR(device Device, createInfo *VideoSessionParametersCreateInfoKHR, allocator *AllocationCallbacks) (videoSessionParameters VideoSessionParametersKHR, r error) {
	...
	ptr_ptr_pVideoSessionParameters := &videoSessionParameters

	var rsys uintptr

	if vkCreateVideoSessionParametersKHR.fnHandle == nil {
		vkCreateVideoSessionParametersKHR.fnHandle = dlHandle.NewProc("vkCreateVideoSessionParametersKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkCreateVideoSessionParametersKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pVideoSessionParameters)))
	r = Result(rsys)
...
func DestroyCudaFunctionNV(device Device, function CudaFunctionNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyCudaFunctionNV.fnHandle == nil {
		vkDestroyCudaFunctionNV.fnHandle = dlHandle.NewProc("vkDestroyCudaFunctionNV")
	}
	syscall.SyscallN(vkDestroyCudaFunctionNV.fnHandle.Addr(), uintptr(device), uintptr(function), uintptr(unsafe.Pointer(pAllocator)))
...
func DestroyCudaModuleNV(device Device, module CudaModuleNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyCudaModuleNV.fnHandle == nil {
		vkDestroyCudaModuleNV.fnHandle = dlHandle.NewProc("vkDestroyCudaModuleNV")
	}
	syscall.SyscallN(vkDestroyCudaModuleNV.fnHandle.Addr(), uintptr(device), uintptr(module), uintptr(unsafe.Pointer(pAllocator)))
...
func DestroyMicromapEXT(device Device, micromap MicromapEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyMicromapEXT.fnHandle == nil {
		vkDestroyMicromapEXT.fnHandle = dlHandle.NewProc("vkDestroyMicromapEXT")
	}
	syscall.SyscallN(vkDestroyMicromapEXT.fnHandle.Addr(), uintptr(device), uintptr(micromap), uintptr(unsafe.Pointer(pAllocator)))
...
func DestroyOpticalFlowSessionNV(device Device, session OpticalFlowSessionNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyOpticalFlowSessionNV.fnHandle == nil {
		vkDestroyOpticalFlowSessionNV.fnHandle = dlHandle.NewProc("vkDestroyOpticalFlowSessionNV")
	}
	syscall.SyscallN(vkDestroyOpticalFlowSessionNV.fnHandle.Addr(), uintptr(device), uintptr(session), uintptr(unsafe.Pointer(pAllocator)))
...
func DestroyPrivateDataSlot(device Device, privateDataSlot PrivateDataSlot, allocator *AllocationCallbacks) {
	...
	if vkDestroyPrivateDataSlot.fnHandle == nil {
		vkDestroyPrivateDataSlot.fnHandle = dlHandle.NewProc("vkDestroyPrivateDataSlot")
	}
	syscall.SyscallN(vkDestroyPrivateDataSlot.fnHandle.Addr(), uintptr(device), uintptr(privateDataSlot), uintptr(unsafe.Pointer(pAllocator)))
...
func DestroyShaderEXT(device Device, shader ShaderEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyShaderEXT.fnHandle == nil {
		vkDestroyShaderEXT.fnHandle = dlHandle.NewProc("vkDestroyShaderEXT")
	}
	syscall.SyscallN(vkDestroyShaderEXT.fnHandle.Addr(), uintptr(device), uintptr(shader), uintptr(unsafe.Pointer(pAllocator)))
...
func DestroyVideoSessionKHR(device Device, videoSession VideoSessionKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroyVideoSessionKHR.fnHandle == nil {
		vkDestroyVideoSessionKHR.fnHandle = dlHandle.NewProc("vkDestroyVideoSessionKHR")
	}
	syscall.SyscallN(vkDestroyVideoSessionKHR.fnHandle.Addr(), uintptr(device), uintptr(videoSession), uintptr(unsafe.Pointer(pAllocator)))
...
func DestroyVideoSessionParametersKHR(device Device, videoSessionParameters VideoSessionParametersKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroyVideoSessionParametersKHR.fnHandle == nil {
		vkDestroyVideoSessionParametersKHR.fnHandle = dlHandle.NewProc("vkDestroyVideoSessionParametersKHR")
	}
	syscall.SyscallN(vkDestroyVideoSessionParametersKHR.fnHandle.Addr(), uintptr(device), uintptr(videoSessionParameters), uintptr(unsafe.Pointer(pAllocator)))
...
func EnumerateInstanceVersion() (apiVersion uint32, r error) {
	...
	ptr_ptr_pApiVersion := &apiVersion
	...
	rsys, _, _ = syscall.SyscallN(vkEnumerateInstanceVersion.fnHandle.Addr(), uintptr(unsafe.Pointer(ptr_ptr_pApiVersion)))
	r = Result(rsys)
...
func GetAccelerationStructureMemoryRequirementsNV(device Device, info *AccelerationStructureMemoryRequirementsInfoNV) (memoryRequirements MemoryRequirements2KHR) {
	...
	ptr_ptr_pMemoryRequirements := &memoryRequirements
	...
	syscall.SyscallN(vkGetAccelerationStructureMemoryRequirementsNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_ptr_pMemoryRequirements)))
...
func GetAccelerationStructureOpaqueCaptureDescriptorDataEXT(device Device, info *AccelerationStructureCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT.fnHandle = dlHandle.NewProc("vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_ptr_pData)))
	r = Result(rsys)
...
func GetBufferMemoryRequirements(device Device, buffer Buffer) (memoryRequirements MemoryRequirements) {
	...
	syscall.SyscallN(vkGetBufferMemoryRequirements.fnHandle.Addr(), uintptr(device), uintptr(buffer), uintptr(unsafe.Pointer(ptr_ptr_pMemoryRequirements)))
...
func GetBufferOpaqueCaptureDescriptorDataEXT(device Device, info *BufferCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetBufferOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetBufferOpaqueCaptureDescriptorDataEXT.fnHandle = dlHandle.NewProc("vkGetBufferOpaqueCaptureDescriptorDataEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetBufferOpaqueCaptureDescriptorDataEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_ptr_pData)))
	r = Result(rsys)
...
func GetCalibratedTimestampsKHR(device Device, timestampInfos []CalibratedTimestampInfoKHR) (timestamps []uint64, maxDeviation uint64, r error) {
	...
	ptr_ptr_pMaxDeviation := &maxDeviation

	var rsys uintptr

	if vkGetCalibratedTimestampsKHR.fnHandle == nil {
		vkGetCalibratedTimestampsKHR.fnHandle = dlHandle.NewProc("vkGetCalibratedTimestampsKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetCalibratedTimestampsKHR.fnHandle.Addr(), uintptr(device), uintptr(timestampCount), uintptr(unsafe.Pointer(pTimestampInfos)), uintptr(unsafe.Pointer(pTimestamps)), uintptr(unsafe.Pointer(ptr_ptr_pMaxDeviation)))
	r = Result(rsys)
...
func GetCudaModuleCacheNV(device Device, module CudaModuleNV) (cacheData []byte, r error) {
	...
	if vkGetCudaModuleCacheNV.fnHandle == nil {
		vkGetCudaModuleCacheNV.fnHandle = dlHandle.NewProc("vkGetCudaModuleCacheNV")
	}
	rsys, _, _ = syscall.SyscallN(vkGetCudaModuleCacheNV.fnHandle.Addr(), uintptr(device), uintptr(module), uintptr(unsafe.Pointer(pCacheSize)), uintptr(unsafe.Pointer(pCacheData)))
	r = Result(rsys)
...
func GetDescriptorEXT(device Device, descriptorInfo *DescriptorGetInfoEXT, descriptor []byte) {
	...
	if vkGetDescriptorEXT.fnHandle == nil {
		vkGetDescriptorEXT.fnHandle = dlHandle.NewProc("vkGetDescriptorEXT")
	}
	syscall.SyscallN(vkGetDescriptorEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pDescriptorInfo)), uintptr(dataSize), uintptr(unsafe.Pointer(pDescriptor)))
...
func GetDescriptorSetHostMappingVALVE(device Device, descriptorSet DescriptorSet) (pData *byte) {
	...
	ptr_ptr_ppData := &pData

	if vkGetDescriptorSetHostMappingVALVE.fnHandle == nil {
		vkGetDescriptorSetHostMappingVALVE.fnHandle = dlHandle.NewProc("vkGetDescriptorSetHostMappingVALVE")
	}
	syscall.SyscallN(vkGetDescriptorSetHostMappingVALVE.fnHandle.Addr(), uintptr(device), uintptr(descriptorSet), uintptr(unsafe.Pointer(ptr_ptr_ppData)))
...
func GetDescriptorSetLayoutBindingOffsetEXT(device Device, layout DescriptorSetLayout, binding uint32) (offset DeviceSize) {
	...
	ptr_ptr_pOffset := &offset

	if vkGetDescriptorSetLayoutBindingOffsetEXT.fnHandle == nil {
		vkGetDescriptorSetLayoutBindingOffsetEXT.fnHandle = dlHandle.NewProc("vkGetDescriptorSetLayoutBindingOffsetEXT")
	}
	syscall.SyscallN(vkGetDescriptorSetLayoutBindingOffsetEXT.fnHandle.Addr(), uintptr(device), uintptr(layout), uintptr(binding), uintptr(unsafe.Pointer(ptr_ptr_pOffset)))
...
func GetDescriptorSetLayoutHostMappingInfoVALVE(device Device, bindingReference *DescriptorSetBindingReferenceVALVE) (hostMapping DescriptorSetLayoutHostMappingInfoVALVE) {
	...
	if vkGetDescriptorSetLayoutHostMappingInfoVALVE.fnHandle == nil {
		vkGetDescriptorSetLayoutHostMappingInfoVALVE.fnHandle = dlHandle.NewProc("vkGetDescriptorSetLayoutHostMappingInfoVALVE")
	}
	syscall.SyscallN(vkGetDescriptorSetLayoutHostMappingInfoVALVE.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pBindingReference)), uintptr(unsafe.Pointer(pHostMapping)))
...
func GetDescriptorSetLayoutSizeEXT(device Device, layout DescriptorSetLayout) (layoutSizeInBytes DeviceSize) {
	...
	ptr_ptr_pLayoutSizeInBytes := &layoutSizeInBytes

	if vkGetDescriptorSetLayoutSizeEXT.fnHandle == nil {
		vkGetDescriptorSetLayoutSizeEXT.fnHandle = dlHandle.NewProc("vkGetDescriptorSetLayoutSizeEXT")
	}
	syscall.SyscallN(vkGetDescriptorSetLayoutSizeEXT.fnHandle.Addr(), uintptr(device), uintptr(layout), uintptr(unsafe.Pointer(ptr_ptr_pLayoutSizeInBytes)))
...
func GetDeviceAccelerationStructureCompatibilityKHR(device Device, versionInfo *AccelerationStructureVersionInfoKHR) (compatibility AccelerationStructureCompatibilityKHR) {
	...
	ptr_ptr_pCompatibility := &compatibility
	...
	syscall.SyscallN(vkGetDeviceAccelerationStructureCompatibilityKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pVersionInfo)), uintptr(unsafe.Pointer(ptr_ptr_pCompatibility)))
...
func GetDeviceBufferMemoryRequirements(device Device, info *DeviceBufferMemoryRequirements) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetDeviceBufferMemoryRequirements.fnHandle == nil {
		vkGetDeviceBufferMemoryRequirements.fnHandle = dlHandle.NewProc("vkGetDeviceBufferMemoryRequirements")
	}
	syscall.SyscallN(vkGetDeviceBufferMemoryRequirements.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))
...
func GetDeviceFaultInfoEXT(device Device) (faultCounts DeviceFaultCountsEXT, faultInfo DeviceFaultInfoEXT, r error) {
	...
	if vkGetDeviceFaultInfoEXT.fnHandle == nil {
		vkGetDeviceFaultInfoEXT.fnHandle = dlHandle.NewProc("vkGetDeviceFaultInfoEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetDeviceFaultInfoEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pFaultCounts)), uintptr(unsafe.Pointer(pFaultInfo)))
	r = Result(rsys)
...
func GetDeviceGroupPeerMemoryFeatures(device Device, heapIndex uint32, localDeviceIndex uint32, remoteDeviceIndex uint32) (peerMemoryFeatures PeerMemoryFeatureFlags) {
	...
	ptr_ptr_pPeerMemoryFeatures := &peerMemoryFeatures
	...
	syscall.SyscallN(vkGetDeviceGroupPeerMemoryFeatures.fnHandle.Addr(), uintptr(device), uintptr(heapIndex), uintptr(localDeviceIndex), uintptr(remoteDeviceIndex), uintptr(unsafe.Pointer(ptr_ptr_pPeerMemoryFeatures)))
...
func GetDeviceGroupSurfacePresentModesKHR(device Device, surface SurfaceKHR) (modes DeviceGroupPresentModeFlagsKHR, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkGetDeviceGroupSurfacePresentModesKHR.fnHandle.Addr(), uintptr(device), uintptr(surface), uintptr(unsafe.Pointer(ptr_ptr_pModes)))
	r = Result(rsys)
...
func GetDeviceImageMemoryRequirements(device Device, info *DeviceImageMemoryRequirements) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetDeviceImageMemoryRequirements.fnHandle == nil {
		vkGetDeviceImageMemoryRequirements.fnHandle = dlHandle.NewProc("vkGetDeviceImageMemoryRequirements")
	}
	syscall.SyscallN(vkGetDeviceImageMemoryRequirements.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))
...
func GetDeviceImageSparseMemoryRequirements(device Device, info *DeviceImageMemoryRequirements) (sparseMemoryRequirements []SparseImageMemoryRequirements2) {
	...
	if vkGetDeviceImageSparseMemoryRequirements.fnHandle == nil {
		vkGetDeviceImageSparseMemoryRequirements.fnHandle = dlHandle.NewProc("vkGetDeviceImageSparseMemoryRequirements")
	}
	syscall.SyscallN(vkGetDeviceImageSparseMemoryRequirements.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pSparseMemoryRequirementCount)), uintptr(unsafe.Pointer(pSparseMemoryRequirements)))
...
func GetDeviceImageSubresourceLayoutKHR(device Device, info *DeviceImageSubresourceInfoKHR) (layout SubresourceLayout2KHR) {
	...
	if vkGetDeviceImageSubresourceLayoutKHR.fnHandle == nil {
		vkGetDeviceImageSubresourceLayoutKHR.fnHandle = dlHandle.NewProc("vkGetDeviceImageSubresourceLayoutKHR")
	}
	syscall.SyscallN(vkGetDeviceImageSubresourceLayoutKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(pLayout)))
...
func GetDeviceMemoryCommitment(device Device, memory DeviceMemory) (committedMemoryInBytes DeviceSize) {
	...
	ptr_ptr_pCommittedMemoryInBytes := &committedMemoryInBytes
	...
	syscall.SyscallN(vkGetDeviceMemoryCommitment.fnHandle.Addr(), uintptr(device), uintptr(memory), uintptr(unsafe.Pointer(ptr_ptr_pCommittedMemoryInBytes)))
...
func GetDeviceMicromapCompatibilityEXT(device Device, versionInfo *MicromapVersionInfoEXT) (compatibility AccelerationStructureCompatibilityKHR) {
	...
	if vkGetDeviceMicromapCompatibilityEXT.fnHandle == nil {
		vkGetDeviceMicromapCompatibilityEXT.fnHandle = dlHandle.NewProc("vkGetDeviceMicromapCompatibilityEXT")
	}
	syscall.SyscallN(vkGetDeviceMicromapCompatibilityEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pVersionInfo)), uintptr(unsafe.Pointer(ptr_ptr_pCompatibility)))
...
func GetDeviceQueue(device Device, queueFamilyIndex uint32, queueIndex uint32) (queue Queue) {
	...
	ptr_ptr_pQueue := &queue

	if vkGetDeviceQueue.fnHandle == nil {
		vkGetDeviceQueue.fnHandle = dlHandle.NewProc("vkGetDeviceQueue")
	}
	syscall.SyscallN(vkGetDeviceQueue.fnHandle.Addr(), uintptr(device), uintptr(queueFamilyIndex), uintptr(queueIndex), uintptr(unsafe.Pointer(ptr_ptr_pQueue)))
...
func GetDeviceQueue2(device Device, queueInfo *DeviceQueueInfo2) (queue Queue) {
	...
	syscall.SyscallN(vkGetDeviceQueue2.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pQueueInfo)), uintptr(unsafe.Pointer(ptr_ptr_pQueue)))
...
func GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(device Device, renderpass RenderPass) (maxWorkgroupSize Extent2D, r error) {
	...
	ptr_ptr_pMaxWorkgroupSize := &maxWorkgroupSize
	...
	rsys, _, _ = syscall.SyscallN(vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI.fnHandle.Addr(), uintptr(device), uintptr(renderpass), uintptr(unsafe.Pointer(ptr_ptr_pMaxWorkgroupSize)))
	r = Result(rsys)
...
func GetDrmDisplayEXT(physicalDevice PhysicalDevice, drmFd int32, connectorId uint32) (display DisplayKHR, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkGetDrmDisplayEXT.fnHandle.Addr(), uintptr(physicalDevice), uintptr(drmFd), uintptr(connectorId), uintptr(unsafe.Pointer(ptr_ptr_display)))
	r = Result(rsys)
...
func GetDynamicRenderingTilePropertiesQCOM(device Device, renderingInfo *RenderingInfo) (properties TilePropertiesQCOM, r error) {
	...
	if vkGetDynamicRenderingTilePropertiesQCOM.fnHandle == nil {
		vkGetDynamicRenderingTilePropertiesQCOM.fnHandle = dlHandle.NewProc("vkGetDynamicRenderingTilePropertiesQCOM")
	}
	rsys, _, _ = syscall.SyscallN(vkGetDynamicRenderingTilePropertiesQCOM.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pRenderingInfo)), uintptr(unsafe.Pointer(pProperties)))
	r = Result(rsys)
...
func GetEncodedVideoSessionParametersKHR(device Device, videoSessionParametersInfo *VideoEncodeSessionParametersGetInfoKHR) (feedbackInfo VideoEncodeSessionParametersFeedbackInfoKHR, data []byte, r error) {
	...
	if vkGetEncodedVideoSessionParametersKHR.fnHandle == nil {
		vkGetEncodedVideoSessionParametersKHR.fnHandle = dlHandle.NewProc("vkGetEncodedVideoSessionParametersKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetEncodedVideoSessionParametersKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pVideoSessionParametersInfo)), uintptr(unsafe.Pointer(pFeedbackInfo)), uintptr(unsafe.Pointer(pDataSize)), uintptr(unsafe.Pointer(pData)))
	r = Result(rsys)
...
func GetFenceFdKHR(device Device, getFdInfo *FenceGetFdInfoKHR) (fd int32, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkGetFenceFdKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pGetFdInfo)), uintptr(unsafe.Pointer(ptr_ptr_pFd)))
	r = Result(rsys)
...
func GetFramebufferTilePropertiesQCOM(device Device, framebuffer Framebuffer) (properties []TilePropertiesQCOM, r error) {
	...
	if vkGetFramebufferTilePropertiesQCOM.fnHandle == nil {
		vkGetFramebufferTilePropertiesQCOM.fnHandle = dlHandle.NewProc("vkGetFramebufferTilePropertiesQCOM")
	}
	rsys, _, _ = syscall.SyscallN(vkGetFramebufferTilePropertiesQCOM.fnHandle.Addr(), uintptr(device), uintptr(framebuffer), uintptr(unsafe.Pointer(pPropertiesCount)), uintptr(unsafe.Pointer(pProperties)))
	r = Result(rsys)
...
func GetImageMemoryRequirements(device Device, image Image) (memoryRequirements MemoryRequirements) {
	...
	syscall.SyscallN(vkGetImageMemoryRequirements.fnHandle.Addr(), uintptr(device), uintptr(image), uintptr(unsafe.Pointer(ptr_ptr_pMemoryRequirements)))
...
func GetImageOpaqueCaptureDescriptorDataEXT(device Device, info *ImageCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetImageOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetImageOpaqueCaptureDescriptorDataEXT.fnHandle = dlHandle.NewProc("vkGetImageOpaqueCaptureDescriptorDataEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetImageOpaqueCaptureDescriptorDataEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_ptr_pData)))
	r = Result(rsys)
...
func GetImageSubresourceLayout(device Device, image Image, subresource *ImageSubresource) (layout SubresourceLayout) {
	...
	syscall.SyscallN(vkGetImageSubresourceLayout.fnHandle.Addr(), uintptr(device), uintptr(image), uintptr(unsafe.Pointer(pSubresource)), uintptr(unsafe.Pointer(ptr_ptr_pLayout)))
...
func GetImageSubresourceLayout2KHR(device Device, image Image, subresource *ImageSubresource2KHR) (layout SubresourceLayout2KHR) {
	...
	if vkGetImageSubresourceLayout2KHR.fnHandle == nil {
		vkGetImageSubresourceLayout2KHR.fnHandle = dlHandle.NewProc("vkGetImageSubresourceLayout2KHR")
	}
	syscall.SyscallN(vkGetImageSubresourceLayout2KHR.fnHandle.Addr(), uintptr(device), uintptr(image), uintptr(unsafe.Pointer(pSubresource)), uintptr(unsafe.Pointer(pLayout)))
...
func GetImageViewOpaqueCaptureDescriptorDataEXT(device Device, info *ImageViewCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetImageViewOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetImageViewOpaqueCaptureDescriptorDataEXT.fnHandle = dlHandle.NewProc("vkGetImageViewOpaqueCaptureDescriptorDataEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetImageViewOpaqueCaptureDescriptorDataEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_ptr_pData)))
	r = Result(rsys)
...
func GetLatencyTimingsNV(device Device, swapchain SwapchainKHR) (latencyMarkerInfo GetLatencyMarkerInfoNV) {
	...
	if vkGetLatencyTimingsNV.fnHandle == nil {
		vkGetLatencyTimingsNV.fnHandle = dlHandle.NewProc("vkGetLatencyTimingsNV")
	}
	syscall.SyscallN(vkGetLatencyTimingsNV.fnHandle.Addr(), uintptr(device), uintptr(swapchain), uintptr(unsafe.Pointer(pLatencyMarkerInfo)))
...
func GetMemoryFdKHR(device Device, getFdInfo *MemoryGetFdInfoKHR) (fd int32, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkGetMemoryFdKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pGetFdInfo)), uintptr(unsafe.Pointer(ptr_ptr_pFd)))
	r = Result(rsys)
...
func GetMemoryRemoteAddressNV(device Device, memoryGetRemoteAddressInfo *MemoryGetRemoteAddressInfoNV) (address RemoteAddressNV, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkGetMemoryRemoteAddressNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pMemoryGetRemoteAddressInfo)), uintptr(unsafe.Pointer(ptr_ptr_pAddress)))
	r = Result(rsys)
...
func GetMicromapBuildSizesEXT(device Device, buildType AccelerationStructureBuildTypeKHR, buildInfo *MicromapBuildInfoEXT) (sizeInfo MicromapBuildSizesInfoEXT) {
	...
	if vkGetMicromapBuildSizesEXT.fnHandle == nil {
		vkGetMicromapBuildSizesEXT.fnHandle = dlHandle.NewProc("vkGetMicromapBuildSizesEXT")
	}
	syscall.SyscallN(vkGetMicromapBuildSizesEXT.fnHandle.Addr(), uintptr(device), uintptr(buildType), uintptr(unsafe.Pointer(pBuildInfo)), uintptr(unsafe.Pointer(pSizeInfo)))
...
func GetPhysicalDeviceCalibrateableTimeDomainsKHR(physicalDevice PhysicalDevice) (timeDomains []TimeDomainKHR, r error) {
	...
	if vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.fnHandle == nil {
		vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceCalibrateableTimeDomainsKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pTimeDomainCount)), uintptr(unsafe.Pointer(pTimeDomains)))
	r = Result(rsys)
...
func GetPhysicalDeviceCooperativeMatrixPropertiesKHR(physicalDevice PhysicalDevice) (properties []CooperativeMatrixPropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pPropertyCount)), uintptr(unsafe.Pointer(pProperties)))
	r = Result(rsys)
...
func GetPhysicalDeviceFormatProperties(physicalDevice PhysicalDevice, format Format) (formatProperties FormatProperties) {
	...
	ptr_ptr_pFormatProperties := &formatProperties
	...
	syscall.SyscallN(vkGetPhysicalDeviceFormatProperties.fnHandle.Addr(), uintptr(physicalDevice), uintptr(format), uintptr(unsafe.Pointer(ptr_ptr_pFormatProperties)))
...
func GetPhysicalDeviceMemoryProperties(physicalDevice PhysicalDevice) (memoryProperties PhysicalDeviceMemoryProperties) {
	...
	ptr_ptr_pMemoryProperties := &memoryProperties
	...
	syscall.SyscallN(vkGetPhysicalDeviceMemoryProperties.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(ptr_ptr_pMemoryProperties)))
...
func GetPhysicalDeviceOpticalFlowImageFormatsNV(physicalDevice PhysicalDevice, opticalFlowImageFormatInfo *OpticalFlowImageFormatInfoNV) (imageFormatProperties []OpticalFlowImageFormatPropertiesNV, r error) {
	...
	if vkGetPhysicalDeviceOpticalFlowImageFormatsNV.fnHandle == nil {
		vkGetPhysicalDeviceOpticalFlowImageFormatsNV.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceOpticalFlowImageFormatsNV")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceOpticalFlowImageFormatsNV.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pOpticalFlowImageFormatInfo)), uintptr(unsafe.Pointer(pFormatCount)), uintptr(unsafe.Pointer(pImageFormatProperties)))
	r = Result(rsys)
...
func GetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(physicalDevice PhysicalDevice, performanceQueryCreateInfo *QueryPoolPerformanceCreateInfoKHR) (numPasses uint32) {
	...
	syscall.SyscallN(vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pPerformanceQueryCreateInfo)), uintptr(unsafe.Pointer(ptr_ptr_pNumPasses)))
...
func GetPhysicalDeviceRefreshableObjectTypesKHR(physicalDevice PhysicalDevice) (refreshableObjectTypes []ObjectType, r error) {
	...
	if vkGetPhysicalDeviceRefreshableObjectTypesKHR.fnHandle == nil {
		vkGetPhysicalDeviceRefreshableObjectTypesKHR.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceRefreshableObjectTypesKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceRefreshableObjectTypesKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pRefreshableObjectTypeCount)), uintptr(unsafe.Pointer(pRefreshableObjectTypes)))
	r = Result(rsys)
...
func GetPhysicalDeviceToolProperties(physicalDevice PhysicalDevice) (toolProperties []PhysicalDeviceToolProperties, r error) {
	...
	if vkGetPhysicalDeviceToolProperties.fnHandle == nil {
		vkGetPhysicalDeviceToolProperties.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceToolProperties")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceToolProperties.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pToolCount)), uintptr(unsafe.Pointer(pToolProperties)))
	r = Result(rsys)
...
func GetPhysicalDeviceVideoCapabilitiesKHR(physicalDevice PhysicalDevice, videoProfile *VideoProfileInfoKHR) (capabilities VideoCapabilitiesKHR, r error) {
	...
	if vkGetPhysicalDeviceVideoCapabilitiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceVideoCapabilitiesKHR.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceVideoCapabilitiesKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceVideoCapabilitiesKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pVideoProfile)), uintptr(unsafe.Pointer(pCapabilities)))
	r = Result(rsys)
...
func GetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR(physicalDevice PhysicalDevice, qualityLevelInfo *PhysicalDeviceVideoEncodeQualityLevelInfoKHR) (qualityLevelProperties VideoEncodeQualityLevelPropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pQualityLevelInfo)), uintptr(unsafe.Pointer(pQualityLevelProperties)))
	r = Result(rsys)
...
func GetPhysicalDeviceVideoFormatPropertiesKHR(physicalDevice PhysicalDevice, videoFormatInfo *PhysicalDeviceVideoFormatInfoKHR) (videoFormatProperties []VideoFormatPropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceVideoFormatPropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceVideoFormatPropertiesKHR.fnHandle = dlHandle.NewProc("vkGetPhysicalDeviceVideoFormatPropertiesKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPhysicalDeviceVideoFormatPropertiesKHR.fnHandle.Addr(), uintptr(physicalDevice), uintptr(unsafe.Pointer(pVideoFormatInfo)), uintptr(unsafe.Pointer(pVideoFormatPropertyCount)), uintptr(unsafe.Pointer(pVideoFormatProperties)))
	r = Result(rsys)
...
func GetPipelineIndirectDeviceAddressNV(device Device, info *PipelineIndirectDeviceAddressInfoNV) (deviceAddress DeviceAddress) {
	...
	if vkGetPipelineIndirectDeviceAddressNV.fnHandle == nil {
		vkGetPipelineIndirectDeviceAddressNV.fnHandle = dlHandle.NewProc("vkGetPipelineIndirectDeviceAddressNV")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPipelineIndirectDeviceAddressNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)))
	deviceAddress = DeviceAddress(rsys)
...
func GetPipelineIndirectMemoryRequirementsNV(device Device, createInfo *ComputePipelineCreateInfo) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetPipelineIndirectMemoryRequirementsNV.fnHandle == nil {
		vkGetPipelineIndirectMemoryRequirementsNV.fnHandle = dlHandle.NewProc("vkGetPipelineIndirectMemoryRequirementsNV")
	}
	syscall.SyscallN(vkGetPipelineIndirectMemoryRequirementsNV.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pMemoryRequirements)))
...
func GetPipelinePropertiesEXT(device Device, pipelineInfo *PipelineInfoEXT) (pipelineProperties BaseOutStructure, r error) {
	...
	ptr_ptr_pPipelineProperties := &pipelineProperties

	var rsys uintptr

	if vkGetPipelinePropertiesEXT.fnHandle == nil {
		vkGetPipelinePropertiesEXT.fnHandle = dlHandle.NewProc("vkGetPipelinePropertiesEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetPipelinePropertiesEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pPipelineInfo)), uintptr(unsafe.Pointer(ptr_ptr_pPipelineProperties)))
	r = Result(rsys)
...
func GetPrivateData(device Device, objectType ObjectType, objectHandle uint64, privateDataSlot PrivateDataSlot) (data uint64) {
	...
	if vkGetPrivateData.fnHandle == nil {
		vkGetPrivateData.fnHandle = dlHandle.NewProc("vkGetPrivateData")
	}
	syscall.SyscallN(vkGetPrivateData.fnHandle.Addr(), uintptr(device), uintptr(objectType), uintptr(objectHandle), uintptr(privateDataSlot), uintptr(unsafe.Pointer(ptr_ptr_pData)))
...
func GetRefreshCycleDurationGOOGLE(device Device, swapchain SwapchainKHR) (displayTimingProperties RefreshCycleDurationGOOGLE, r error) {
	...
	ptr_ptr_pDisplayTimingProperties := &displayTimingProperties
	...
	rsys, _, _ = syscall.SyscallN(vkGetRefreshCycleDurationGOOGLE.fnHandle.Addr(), uintptr(device), uintptr(swapchain), uintptr(unsafe.Pointer(ptr_ptr_pDisplayTimingProperties)))
	r = Result(rsys)
...
func GetRenderAreaGranularity(device Device, renderPass RenderPass) (granularity Extent2D) {
	...
	ptr_ptr_pGranularity := &granularity
	...
	syscall.SyscallN(vkGetRenderAreaGranularity.fnHandle.Addr(), uintptr(device), uintptr(renderPass), uintptr(unsafe.Pointer(ptr_ptr_pGranularity)))
...
func GetRenderingAreaGranularityKHR(device Device, renderingAreaInfo *RenderingAreaInfoKHR) (granularity Extent2D) {
	...
	if vkGetRenderingAreaGranularityKHR.fnHandle == nil {
		vkGetRenderingAreaGranularityKHR.fnHandle = dlHandle.NewProc("vkGetRenderingAreaGranularityKHR")
	}
	syscall.SyscallN(vkGetRenderingAreaGranularityKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pRenderingAreaInfo)), uintptr(unsafe.Pointer(ptr_ptr_pGranularity)))
...
func GetSamplerOpaqueCaptureDescriptorDataEXT(device Device, info *SamplerCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetSamplerOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetSamplerOpaqueCaptureDescriptorDataEXT.fnHandle = dlHandle.NewProc("vkGetSamplerOpaqueCaptureDescriptorDataEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetSamplerOpaqueCaptureDescriptorDataEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pInfo)), uintptr(unsafe.Pointer(ptr_ptr_pData)))
	r = Result(rsys)
...
func GetSemaphoreCounterValue(device Device, semaphore Semaphore) (value uint64, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkGetSemaphoreCounterValue.fnHandle.Addr(), uintptr(device), uintptr(semaphore), uintptr(unsafe.Pointer(ptr_ptr_pValue)))
	r = Result(rsys)
...
func GetSemaphoreFdKHR(device Device, getFdInfo *SemaphoreGetFdInfoKHR) (fd int32, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkGetSemaphoreFdKHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pGetFdInfo)), uintptr(unsafe.Pointer(ptr_ptr_pFd)))
	r = Result(rsys)
...
func GetShaderBinaryDataEXT(device Device, shader ShaderEXT) (data []byte, r error) {
	...
	if vkGetShaderBinaryDataEXT.fnHandle == nil {
		vkGetShaderBinaryDataEXT.fnHandle = dlHandle.NewProc("vkGetShaderBinaryDataEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkGetShaderBinaryDataEXT.fnHandle.Addr(), uintptr(device), uintptr(shader), uintptr(unsafe.Pointer(pDataSize)), uintptr(unsafe.Pointer(pData)))
	r = Result(rsys)
...
func GetShaderModuleCreateInfoIdentifierEXT(device Device, createInfo *ShaderModuleCreateInfo) (identifier ShaderModuleIdentifierEXT) {
	...
	if vkGetShaderModuleCreateInfoIdentifierEXT.fnHandle == nil {
		vkGetShaderModuleCreateInfoIdentifierEXT.fnHandle = dlHandle.NewProc("vkGetShaderModuleCreateInfoIdentifierEXT")
	}
	syscall.SyscallN(vkGetShaderModuleCreateInfoIdentifierEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pCreateInfo)), uintptr(unsafe.Pointer(pIdentifier)))
...
func GetShaderModuleIdentifierEXT(device Device, shaderModule ShaderModule) (identifier ShaderModuleIdentifierEXT) {
	...
	if vkGetShaderModuleIdentifierEXT.fnHandle == nil {
		vkGetShaderModuleIdentifierEXT.fnHandle = dlHandle.NewProc("vkGetShaderModuleIdentifierEXT")
	}
	syscall.SyscallN(vkGetShaderModuleIdentifierEXT.fnHandle.Addr(), uintptr(device), uintptr(shaderModule), uintptr(unsafe.Pointer(pIdentifier)))
...
func GetSwapchainCounterEXT(device Device, swapchain SwapchainKHR, counter SurfaceCounterFlagBitsEXT) (counterValue uint64, r error) {
	...
	ptr_ptr_pCounterValue := &counterValue
	...
	rsys, _, _ = syscall.SyscallN(vkGetSwapchainCounterEXT.fnHandle.Addr(), uintptr(device), uintptr(swapchain), uintptr(counter), uintptr(unsafe.Pointer(ptr_ptr_pCounterValue)))
	r = Result(rsys)
...
func GetVideoSessionMemoryRequirementsKHR(device Device, videoSession VideoSessionKHR) (memoryRequirements []VideoSessionMemoryRequirementsKHR, r error) {
	...
	if vkGetVideoSessionMemoryRequirementsKHR.fnHandle == nil {
		vkGetVideoSessionMemoryRequirementsKHR.fnHandle = dlHandle.NewProc("vkGetVideoSessionMemoryRequirementsKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkGetVideoSessionMemoryRequirementsKHR.fnHandle.Addr(), uintptr(device), uintptr(videoSession), uintptr(unsafe.Pointer(pMemoryRequirementsCount)), uintptr(unsafe.Pointer(pMemoryRequirements)))
	r = Result(rsys)
...
func LatencySleepNV(device Device, swapchain SwapchainKHR, sleepInfo *LatencySleepInfoNV) (r error) {
	...
	if vkLatencySleepNV.fnHandle == nil {
		vkLatencySleepNV.fnHandle = dlHandle.NewProc("vkLatencySleepNV")
	}
	rsys, _, _ = syscall.SyscallN(vkLatencySleepNV.fnHandle.Addr(), uintptr(device), uintptr(swapchain), uintptr(unsafe.Pointer(pSleepInfo)))
	r = Result(rsys)
...
func MapMemory(device Device, memory DeviceMemory, offset DeviceSize, size DeviceSize, flags MemoryMapFlags) (pData *byte, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkMapMemory.fnHandle.Addr(), uintptr(device), uintptr(memory), uintptr(offset), uintptr(size), uintptr(flags), uintptr(unsafe.Pointer(ptr_ptr_ppData)))
	r = Result(rsys)
...
func MapMemory2KHR(device Device, memoryMapInfo *MemoryMapInfoKHR) (pData *byte, r error) {
	...
	if vkMapMemory2KHR.fnHandle == nil {
		vkMapMemory2KHR.fnHandle = dlHandle.NewProc("vkMapMemory2KHR")
	}
	rsys, _, _ = syscall.SyscallN(vkMapMemory2KHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pMemoryMapInfo)), uintptr(unsafe.Pointer(ptr_ptr_ppData)))
	r = Result(rsys)
...
func QueueNotifyOutOfBandNV(queue Queue, queueTypeInfo *OutOfBandQueueTypeInfoNV) {
	...
	if vkQueueNotifyOutOfBandNV.fnHandle == nil {
		vkQueueNotifyOutOfBandNV.fnHandle = dlHandle.NewProc("vkQueueNotifyOutOfBandNV")
	}
	syscall.SyscallN(vkQueueNotifyOutOfBandNV.fnHandle.Addr(), uintptr(queue), uintptr(unsafe.Pointer(pQueueTypeInfo)))
...
func QueueSubmit2(queue Queue, submits []SubmitInfo2, fence Fence) (r error) {
	...
	if vkQueueSubmit2.fnHandle == nil {
		vkQueueSubmit2.fnHandle = dlHandle.NewProc("vkQueueSubmit2")
	}
	rsys, _, _ = syscall.SyscallN(vkQueueSubmit2.fnHandle.Addr(), uintptr(queue), uintptr(submitCount), uintptr(unsafe.Pointer(pSubmits)), uintptr(fence))
	r = Result(rsys)
...
func RegisterDeviceEventEXT(device Device, deviceEventInfo *DeviceEventInfoEXT, allocator *AllocationCallbacks) (fence Fence, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkRegisterDeviceEventEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pDeviceEventInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pFence)))
	r = Result(rsys)
...
func RegisterDisplayEventEXT(device Device, display DisplayKHR, displayEventInfo *DisplayEventInfoEXT, allocator *AllocationCallbacks) (fence Fence, r error) {
	...
	rsys, _, _ = syscall.SyscallN(vkRegisterDisplayEventEXT.fnHandle.Addr(), uintptr(device), uintptr(display), uintptr(unsafe.Pointer(pDisplayEventInfo)), uintptr(unsafe.Pointer(pAllocator)), uintptr(unsafe.Pointer(ptr_ptr_pFence)))
	r = Result(rsys)
...
func ReleaseSwapchainImagesEXT(device Device, releaseInfo *ReleaseSwapchainImagesInfoEXT) (r error) {
	...
	if vkReleaseSwapchainImagesEXT.fnHandle == nil {
		vkReleaseSwapchainImagesEXT.fnHandle = dlHandle.NewProc("vkReleaseSwapchainImagesEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkReleaseSwapchainImagesEXT.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pReleaseInfo)))
	r = Result(rsys)
...
func SetLatencyMarkerNV(device Device, swapchain SwapchainKHR, latencyMarkerInfo *SetLatencyMarkerInfoNV) {
	...
	if vkSetLatencyMarkerNV.fnHandle == nil {
		vkSetLatencyMarkerNV.fnHandle = dlHandle.NewProc("vkSetLatencyMarkerNV")
	}
	syscall.SyscallN(vkSetLatencyMarkerNV.fnHandle.Addr(), uintptr(device), uintptr(swapchain), uintptr(unsafe.Pointer(pLatencyMarkerInfo)))
...
func SetLatencySleepModeNV(device Device, swapchain SwapchainKHR, sleepModeInfo *LatencySleepModeInfoNV) (r error) {
	...
	if vkSetLatencySleepModeNV.fnHandle == nil {
		vkSetLatencySleepModeNV.fnHandle = dlHandle.NewProc("vkSetLatencySleepModeNV")
	}
	rsys, _, _ = syscall.SyscallN(vkSetLatencySleepModeNV.fnHandle.Addr(), uintptr(device), uintptr(swapchain), uintptr(unsafe.Pointer(pSleepModeInfo)))
	r = Result(rsys)
...
func SetLocalDimmingAMD(device Device, swapChain SwapchainKHR, localDimmingEnable bool) {
	localDimmingEnable_Bool32_Bool32 := translateInternal_Bool32(localDimmingEnable)

	if vkSetLocalDimmingAMD.fnHandle == nil {
		vkSetLocalDimmingAMD.fnHandle = dlHandle.NewProc("vkSetLocalDimmingAMD")
	}
	syscall.SyscallN(vkSetLocalDimmingAMD.fnHandle.Addr(), uintptr(device), uintptr(swapChain), uintptr(localDimmingEnable_Bool32_Bool32))
...
func SetPrivateData(device Device, objectType ObjectType, objectHandle uint64, privateDataSlot PrivateDataSlot, data uint64) (r error) {
	...
	if vkSetPrivateData.fnHandle == nil {
		vkSetPrivateData.fnHandle = dlHandle.NewProc("vkSetPrivateData")
	}
	rsys, _, _ = syscall.SyscallN(vkSetPrivateData.fnHandle.Addr(), uintptr(device), uintptr(objectType), uintptr(objectHandle), uintptr(privateDataSlot), uintptr(data))
	r = Result(rsys)
...
func TransitionImageLayoutEXT(device Device, transitions []HostImageLayoutTransitionInfoEXT) (r error) {
	...
	if vkTransitionImageLayoutEXT.fnHandle == nil {
		vkTransitionImageLayoutEXT.fnHandle = dlHandle.NewProc("vkTransitionImageLayoutEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkTransitionImageLayoutEXT.fnHandle.Addr(), uintptr(device), uintptr(transitionCount), uintptr(unsafe.Pointer(pTransitions)))
	r = Result(rsys)
...
func UnmapMemory2KHR(device Device, memoryUnmapInfo *MemoryUnmapInfoKHR) (r error) {
	...
	if vkUnmapMemory2KHR.fnHandle == nil {
		vkUnmapMemory2KHR.fnHandle = dlHandle.NewProc("vkUnmapMemory2KHR")
	}
	rsys, _, _ = syscall.SyscallN(vkUnmapMemory2KHR.fnHandle.Addr(), uintptr(device), uintptr(unsafe.Pointer(pMemoryUnmapInfo)))
	r = Result(rsys)
...
func UpdateVideoSessionParametersKHR(device Device, videoSessionParameters VideoSessionParametersKHR, updateInfo *VideoSessionParametersUpdateInfoKHR) (r error) {
	...
	if vkUpdateVideoSessionParametersKHR.fnHandle == nil {
		vkUpdateVideoSessionParametersKHR.fnHandle = dlHandle.NewProc("vkUpdateVideoSessionParametersKHR")
	}
	rsys, _, _ = syscall.SyscallN(vkUpdateVideoSessionParametersKHR.fnHandle.Addr(), uintptr(device), uintptr(videoSessionParameters), uintptr(unsafe.Pointer(pUpdateInfo)))
	r = Result(rsys)
...
func WaitForFences(device Device, fences []Fence, waitAll bool, timeout uint64) (r error) {
	...
	waitAll_Bool32_Bool32 := translateInternal_Bool32(waitAll)
	var rsys uintptr

	if vkWaitForFences.fnHandle == nil {
		vkWaitForFences.fnHandle = dlHandle.NewProc("vkWaitForFences")
	}
	rsys, _, _ = syscall.SyscallN(vkWaitForFences.fnHandle.Addr(), uintptr(device), uintptr(fenceCount), uintptr(unsafe.Pointer(pFences)), uintptr(waitAll_Bool32_Bool32), uintptr(timeout))
	r = Result(rsys)
...
func WriteMicromapsPropertiesEXT(device Device, micromaps []MicromapEXT, queryType QueryType, data []byte, stride uintptr) (r error) {
	...
	if vkWriteMicromapsPropertiesEXT.fnHandle == nil {
		vkWriteMicromapsPropertiesEXT.fnHandle = dlHandle.NewProc("vkWriteMicromapsPropertiesEXT")
	}
	rsys, _, _ = syscall.SyscallN(vkWriteMicromapsPropertiesEXT.fnHandle.Addr(), uintptr(device), uintptr(micromapCount), uintptr(unsafe.Pointer(pMicromaps)), uintptr(queryType), uintptr(dataSize), uintptr(unsafe.Pointer(pData)), uintptr(stride))
	r = Result(rsys)
