...
const _ImageUsageFlagBits_name = "IMAGE_USAGE_TRANSFER_SRC_BITIMAGE_USAGE_TRANSFER_DST_BITIMAGE_USAGE_SAMPLED_BITIMAGE_USAGE_STORAGE_BITIMAGE_USAGE_COLOR_ATTACHMENT_BITIMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BITIMAGE_USAGE_TRANSIENT_ATTACHMENT_BITIMAGE_USAGE_INPUT_ATTACHMENT_BITIMAGE_USAGE_VIDEO_DECODE_SRC_BIT_KHRIMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXTIMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRIMAGE_USAGE_HOST_TRANSFER_BIT_EXTIMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHRIMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTIMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEIIMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM"
