...
// Code generated by go-vk from vk.xml at 2025-11-20 11:05:55.7520034 -0500 EST m=+0.993415401. DO NOT EDIT.
...
func CmdBeginRenderingKHR(commandBuffer CommandBuffer, renderingInfo *RenderingInfoKHR) {
	...
	if vkCmdBeginRenderingKHR.fnHandle == nil {
		vkCmdBeginRenderingKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginRenderingKHR")))
	}
	C.Trampoline3(vkCmdBeginRenderingKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pRenderingInfo))), 0)
...
func CmdBindVertexBuffers2EXT(commandBuffer CommandBuffer, firstBinding uint32, buffers []Buffer, offsets []DeviceSize, sizes []DeviceSize, strides []DeviceSize) {
	...
	if vkCmdBindVertexBuffers2EXT.fnHandle == nil {
		vkCmdBindVertexBuffers2EXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindVertexBuffers2EXT")))
	}
	C.Trampoline9(vkCmdBindVertexBuffers2EXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstBinding)), C.uintptr_t(uintptr(bindingCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBuffers))), C.uintptr_t(uintptr(unsafe.Pointer(pOffsets))), C.uintptr_t(uintptr(unsafe.Pointer(pSizes))), C.uintptr_t(uintptr(unsafe.Pointer(pStrides))), 0, 0)
...
func CmdBlitImage2KHR(commandBuffer CommandBuffer, blitImageInfo *BlitImageInfo2KHR) {
	...
	if vkCmdBlitImage2KHR.fnHandle == nil {
		vkCmdBlitImage2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBlitImage2KHR")))
	}
	C.Trampoline3(vkCmdBlitImage2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pBlitImageInfo))), 0)
...
func CmdCopyBuffer2KHR(commandBuffer CommandBuffer, copyBufferInfo *CopyBufferInfo2KHR) {
	...
	if vkCmdCopyBuffer2KHR.fnHandle == nil {
		vkCmdCopyBuffer2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyBuffer2KHR")))
	}
	C.Trampoline3(vkCmdCopyBuffer2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyBufferInfo))), 0)
...
func CmdCopyBufferToImage2KHR(commandBuffer CommandBuffer, copyBufferToImageInfo *CopyBufferToImageInfo2KHR) {
	...
	if vkCmdCopyBufferToImage2KHR.fnHandle == nil {
		vkCmdCopyBufferToImage2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyBufferToImage2KHR")))
	}
	C.Trampoline3(vkCmdCopyBufferToImage2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyBufferToImageInfo))), 0)
...
func CmdCopyImage2KHR(commandBuffer CommandBuffer, copyImageInfo *CopyImageInfo2KHR) {
	...
	if vkCmdCopyImage2KHR.fnHandle == nil {
		vkCmdCopyImage2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyImage2KHR")))
	}
	C.Trampoline3(vkCmdCopyImage2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyImageInfo))), 0)
...
func CmdCopyImageToBuffer2KHR(commandBuffer CommandBuffer, copyImageToBufferInfo *CopyImageToBufferInfo2KHR) {
	...
	if vkCmdCopyImageToBuffer2KHR.fnHandle == nil {
		vkCmdCopyImageToBuffer2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyImageToBuffer2KHR")))
	}
	C.Trampoline3(vkCmdCopyImageToBuffer2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyImageToBufferInfo))), 0)
...
func CmdEndRenderingKHR(commandBuffer CommandBuffer) {
	...
	if vkCmdEndRenderingKHR.fnHandle == nil {
		vkCmdEndRenderingKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndRenderingKHR")))
	}
	C.Trampoline3(vkCmdEndRenderingKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
...
func CmdPipelineBarrier2KHR(commandBuffer CommandBuffer, dependencyInfo *DependencyInfoKHR) {
	...
	if vkCmdPipelineBarrier2KHR.fnHandle == nil {
		vkCmdPipelineBarrier2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPipelineBarrier2KHR")))
	}
	C.Trampoline3(vkCmdPipelineBarrier2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pDependencyInfo))), 0)
...
func CmdResetEvent2KHR(commandBuffer CommandBuffer, event Event, stageMask PipelineStageFlags2KHR) {
	...
	if vkCmdResetEvent2KHR.fnHandle == nil {
		vkCmdResetEvent2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdResetEvent2KHR")))
	}
	C.Trampoline3(vkCmdResetEvent2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(event)), C.uintptr_t(uintptr(stageMask)))
...
func CmdResolveImage2KHR(commandBuffer CommandBuffer, resolveImageInfo *ResolveImageInfo2KHR) {
	...
	if vkCmdResolveImage2KHR.fnHandle == nil {
		vkCmdResolveImage2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdResolveImage2KHR")))
	}
	C.Trampoline3(vkCmdResolveImage2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pResolveImageInfo))), 0)
...
func CmdSetCullModeEXT(commandBuffer CommandBuffer, cullMode CullModeFlags) {
	...
	if vkCmdSetCullModeEXT.fnHandle == nil {
		vkCmdSetCullModeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCullModeEXT")))
	}
	C.Trampoline3(vkCmdSetCullModeEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(cullMode)), 0)
...
func CmdSetDepthBiasEnableEXT(commandBuffer CommandBuffer, depthBiasEnable bool) {
	...
	if vkCmdSetDepthBiasEnableEXT.fnHandle == nil {
		vkCmdSetDepthBiasEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthBiasEnableEXT")))
	}
	C.Trampoline3(vkCmdSetDepthBiasEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthBiasEnable_Bool32)), 0)
...
func CmdSetDepthBoundsTestEnableEXT(commandBuffer CommandBuffer, depthBoundsTestEnable bool) {
	...
	if vkCmdSetDepthBoundsTestEnableEXT.fnHandle == nil {
		vkCmdSetDepthBoundsTestEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthBoundsTestEnableEXT")))
	}
	C.Trampoline3(vkCmdSetDepthBoundsTestEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthBoundsTestEnable_Bool32)), 0)
...
func CmdSetDepthCompareOpEXT(commandBuffer CommandBuffer, depthCompareOp CompareOp) {
	...
	if vkCmdSetDepthCompareOpEXT.fnHandle == nil {
		vkCmdSetDepthCompareOpEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthCompareOpEXT")))
	}
	C.Trampoline3(vkCmdSetDepthCompareOpEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthCompareOp)), 0)
...
func CmdSetDepthTestEnableEXT(commandBuffer CommandBuffer, depthTestEnable bool) {
	...
	if vkCmdSetDepthTestEnableEXT.fnHandle == nil {
		vkCmdSetDepthTestEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthTestEnableEXT")))
	}
	C.Trampoline3(vkCmdSetDepthTestEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthTestEnable_Bool32)), 0)
...
func CmdSetDepthWriteEnableEXT(commandBuffer CommandBuffer, depthWriteEnable bool) {
	...
	if vkCmdSetDepthWriteEnableEXT.fnHandle == nil {
		vkCmdSetDepthWriteEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthWriteEnableEXT")))
	}
	C.Trampoline3(vkCmdSetDepthWriteEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthWriteEnable_Bool32)), 0)
...
func CmdSetEvent2KHR(commandBuffer CommandBuffer, event Event, dependencyInfo *DependencyInfoKHR) {
	...
	if vkCmdSetEvent2KHR.fnHandle == nil {
		vkCmdSetEvent2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetEvent2KHR")))
	}
	C.Trampoline3(vkCmdSetEvent2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(event)), C.uintptr_t(uintptr(unsafe.Pointer(pDependencyInfo))))
...
func CmdSetFrontFaceEXT(commandBuffer CommandBuffer, frontFace FrontFace) {
	...
	if vkCmdSetFrontFaceEXT.fnHandle == nil {
		vkCmdSetFrontFaceEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetFrontFaceEXT")))
	}
	C.Trampoline3(vkCmdSetFrontFaceEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(frontFace)), 0)
...
func CmdSetLineStippleEXT(commandBuffer CommandBuffer, lineStippleFactor uint32, lineStipplePattern uint16) {
	...
	if vkCmdSetLineStippleEXT.fnHandle == nil {
		vkCmdSetLineStippleEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetLineStippleEXT")))
	}
	C.Trampoline3(vkCmdSetLineStippleEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(lineStippleFactor)), C.uintptr_t(uintptr(lineStipplePattern)))
...
func CmdSetPrimitiveRestartEnableEXT(commandBuffer CommandBuffer, primitiveRestartEnable bool) {
	...
	if vkCmdSetPrimitiveRestartEnableEXT.fnHandle == nil {
		vkCmdSetPrimitiveRestartEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPrimitiveRestartEnableEXT")))
	}
	C.Trampoline3(vkCmdSetPrimitiveRestartEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(primitiveRestartEnable_Bool32)), 0)
...
func CmdSetPrimitiveTopologyEXT(commandBuffer CommandBuffer, primitiveTopology PrimitiveTopology) {
	...
	if vkCmdSetPrimitiveTopologyEXT.fnHandle == nil {
		vkCmdSetPrimitiveTopologyEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPrimitiveTopologyEXT")))
	}
	C.Trampoline3(vkCmdSetPrimitiveTopologyEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(primitiveTopology)), 0)
...
func CmdSetRasterizerDiscardEnableEXT(commandBuffer CommandBuffer, rasterizerDiscardEnable bool) {
	...
	if vkCmdSetRasterizerDiscardEnableEXT.fnHandle == nil {
		vkCmdSetRasterizerDiscardEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRasterizerDiscardEnableEXT")))
	}
	C.Trampoline3(vkCmdSetRasterizerDiscardEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(rasterizerDiscardEnable_Bool32)), 0)
...
func CmdSetScissorWithCountEXT(commandBuffer CommandBuffer, scissors []Rect2D) {
	...
	if vkCmdSetScissorWithCountEXT.fnHandle == nil {
		vkCmdSetScissorWithCountEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetScissorWithCountEXT")))
	}
	C.Trampoline3(vkCmdSetScissorWithCountEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(scissorCount)), C.uintptr_t(uintptr(unsafe.Pointer(pScissors))))
...
func CmdSetStencilOpEXT(commandBuffer CommandBuffer, faceMask StencilFaceFlags, failOp StencilOp, passOp StencilOp, depthFailOp StencilOp, compareOp CompareOp) {
	...
	if vkCmdSetStencilOpEXT.fnHandle == nil {
		vkCmdSetStencilOpEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetStencilOpEXT")))
	}
	C.Trampoline6(vkCmdSetStencilOpEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(faceMask)), C.uintptr_t(uintptr(failOp)), C.uintptr_t(uintptr(passOp)), C.uintptr_t(uintptr(depthFailOp)), C.uintptr_t(uintptr(compareOp)))
...
func CmdSetStencilTestEnableEXT(commandBuffer CommandBuffer, stencilTestEnable bool) {
	...
	if vkCmdSetStencilTestEnableEXT.fnHandle == nil {
		vkCmdSetStencilTestEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetStencilTestEnableEXT")))
	}
	C.Trampoline3(vkCmdSetStencilTestEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(stencilTestEnable_Bool32)), 0)
...
func CmdSetViewportWithCountEXT(commandBuffer CommandBuffer, viewports []Viewport) {
	...
	if vkCmdSetViewportWithCountEXT.fnHandle == nil {
		vkCmdSetViewportWithCountEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetViewportWithCountEXT")))
	}
	C.Trampoline3(vkCmdSetViewportWithCountEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(viewportCount)), C.uintptr_t(uintptr(unsafe.Pointer(pViewports))))
...
func CmdWaitEvents2KHR(commandBuffer CommandBuffer, events []Event, dependencyInfos []DependencyInfoKHR) {
	...
	if vkCmdWaitEvents2KHR.fnHandle == nil {
		vkCmdWaitEvents2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWaitEvents2KHR")))
	}
	C.Trampoline6(vkCmdWaitEvents2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(eventCount)), C.uintptr_t(uintptr(unsafe.Pointer(pEvents))), C.uintptr_t(uintptr(unsafe.Pointer(pDependencyInfos))), 0, 0)
...
func CmdWriteTimestamp2KHR(commandBuffer CommandBuffer, stage PipelineStageFlags2KHR, queryPool QueryPool, query uint32) {
	...
	if vkCmdWriteTimestamp2KHR.fnHandle == nil {
		vkCmdWriteTimestamp2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteTimestamp2KHR")))
	}
	C.Trampoline6(vkCmdWriteTimestamp2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(stage)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(query)), 0, 0)
...
func CreatePrivateDataSlotEXT(device Device, createInfo *PrivateDataSlotCreateInfoEXT, allocator *AllocationCallbacks) (privateDataSlot PrivateDataSlotEXT, r error) {
	...
	if vkCreatePrivateDataSlotEXT.fnHandle == nil {
		vkCreatePrivateDataSlotEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreatePrivateDataSlotEXT")))
	}
	rsys = C.Trampoline6(vkCreatePrivateDataSlotEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pPrivateDataSlot))), 0, 0)
	r = Result(uintptr(rsys))
...
func DestroyPrivateDataSlotEXT(device Device, privateDataSlot PrivateDataSlotEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyPrivateDataSlotEXT.fnHandle == nil {
		vkDestroyPrivateDataSlotEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyPrivateDataSlotEXT")))
	}
	C.Trampoline3(vkDestroyPrivateDataSlotEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(privateDataSlot)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func GetCalibratedTimestampsEXT(device Device, timestampInfos []CalibratedTimestampInfoEXT) (timestamps []uint64, maxDeviation uint64, r error) {
	...
	if vkGetCalibratedTimestampsEXT.fnHandle == nil {
		vkGetCalibratedTimestampsEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetCalibratedTimestampsEXT")))
	}
	rsys = C.Trampoline6(vkGetCalibratedTimestampsEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(timestampCount)), C.uintptr_t(uintptr(unsafe.Pointer(pTimestampInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pTimestamps))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMaxDeviation))), 0)
	r = Result(uintptr(rsys))
...
func GetDeviceBufferMemoryRequirementsKHR(device Device, info *DeviceBufferMemoryRequirementsKHR) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetDeviceBufferMemoryRequirementsKHR.fnHandle == nil {
		vkGetDeviceBufferMemoryRequirementsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceBufferMemoryRequirementsKHR")))
	}
	C.Trampoline3(vkGetDeviceBufferMemoryRequirementsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetDeviceImageMemoryRequirementsKHR(device Device, info *DeviceImageMemoryRequirementsKHR) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetDeviceImageMemoryRequirementsKHR.fnHandle == nil {
		vkGetDeviceImageMemoryRequirementsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceImageMemoryRequirementsKHR")))
	}
	C.Trampoline3(vkGetDeviceImageMemoryRequirementsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetDeviceImageSparseMemoryRequirementsKHR(device Device, info *DeviceImageMemoryRequirementsKHR) (sparseMemoryRequirements []SparseImageMemoryRequirements2) {
	...
	if vkGetDeviceImageSparseMemoryRequirementsKHR.fnHandle == nil {
		vkGetDeviceImageSparseMemoryRequirementsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceImageSparseMemoryRequirementsKHR")))
	}
	C.Trampoline6(vkGetDeviceImageSparseMemoryRequirementsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirementCount))), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirements))), 0, 0)
...
func GetPhysicalDeviceCalibrateableTimeDomainsEXT(physicalDevice PhysicalDevice) (timeDomains []TimeDomainEXT, r error) {
	...
	if vkGetPhysicalDeviceCalibrateableTimeDomainsEXT.fnHandle == nil {
		vkGetPhysicalDeviceCalibrateableTimeDomainsEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceCalibrateableTimeDomainsEXT")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceCalibrateableTimeDomainsEXT.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pTimeDomainCount))), C.uintptr_t(uintptr(unsafe.Pointer(pTimeDomains))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceToolPropertiesEXT(physicalDevice PhysicalDevice) (toolProperties []PhysicalDeviceToolPropertiesEXT, r error) {
	...
	if vkGetPhysicalDeviceToolPropertiesEXT.fnHandle == nil {
		vkGetPhysicalDeviceToolPropertiesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceToolPropertiesEXT")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceToolPropertiesEXT.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pToolCount))), C.uintptr_t(uintptr(unsafe.Pointer(pToolProperties))))
	r = Result(uintptr(rsys))
...
func GetPrivateDataEXT(device Device, objectType ObjectType, objectHandle uint64, privateDataSlot PrivateDataSlotEXT) (data uint64) {
	...
	if vkGetPrivateDataEXT.fnHandle == nil {
		vkGetPrivateDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPrivateDataEXT")))
	}
	C.Trampoline6(vkGetPrivateDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(objectType)), C.uintptr_t(uintptr(objectHandle)), C.uintptr_t(uintptr(privateDataSlot)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pData))), 0)
...
func QueueSubmit2KHR(queue Queue, submits []SubmitInfo2KHR, fence Fence) (r error) {
	...
	if vkQueueSubmit2KHR.fnHandle == nil {
		vkQueueSubmit2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueSubmit2KHR")))
	}
	rsys = C.Trampoline6(vkQueueSubmit2KHR.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(submitCount)), C.uintptr_t(uintptr(unsafe.Pointer(pSubmits))), C.uintptr_t(uintptr(fence)), 0, 0)
	r = Result(uintptr(rsys))
...
func SetPrivateDataEXT(device Device, objectType ObjectType, objectHandle uint64, privateDataSlot PrivateDataSlotEXT, data uint64) (r error) {
	...
	if vkSetPrivateDataEXT.fnHandle == nil {
		vkSetPrivateDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetPrivateDataEXT")))
	}
	rsys = C.Trampoline6(vkSetPrivateDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(objectType)), C.uintptr_t(uintptr(objectHandle)), C.uintptr_t(uintptr(privateDataSlot)), C.uintptr_t(uintptr(data)), 0)
	r = Result(uintptr(rsys))
