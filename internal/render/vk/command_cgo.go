...
// Code generated by go-vk from vk.xml at 2026-04-10 07:32:28.1894519 -0400 EDT m=+1.677955701. DO NOT EDIT.
...
func AcquireDrmDisplayEXT(physicalDevice PhysicalDevice, drmFd int32, display DisplayKHR) (r error) {
	...
	if vkAcquireDrmDisplayEXT.fnHandle == nil {
		vkAcquireDrmDisplayEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAcquireDrmDisplayEXT")))
	}
	rsys = C.Trampoline3(vkAcquireDrmDisplayEXT.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(drmFd)), C.uintptr_t(uintptr(display)))
...
func AcquireNextImage2KHR(device Device, acquireInfo *AcquireNextImageInfoKHR) (imageIndex uint32, r error) {
	...
	if vkAcquireNextImage2KHR.fnHandle == nil {
		vkAcquireNextImage2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAcquireNextImage2KHR")))
	}
	rsys = C.Trampoline3(vkAcquireNextImage2KHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pAcquireInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pImageIndex))))
	r = Result(uintptr(rsys))
...
func AcquireNextImageKHR(device Device, swapchain SwapchainKHR, timeout uint64, semaphore Semaphore, fence Fence) (imageIndex uint32, r error) {
	...
	if vkAcquireNextImageKHR.fnHandle == nil {
		vkAcquireNextImageKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAcquireNextImageKHR")))
	}
	rsys = C.Trampoline6(vkAcquireNextImageKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(timeout)), C.uintptr_t(uintptr(semaphore)), C.uintptr_t(uintptr(fence)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pImageIndex))))
	r = Result(uintptr(rsys))
...
func AcquirePerformanceConfigurationINTEL(device Device, acquireInfo *PerformanceConfigurationAcquireInfoINTEL) (configuration PerformanceConfigurationINTEL, r error) {
	...
	if vkAcquirePerformanceConfigurationINTEL.fnHandle == nil {
		vkAcquirePerformanceConfigurationINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAcquirePerformanceConfigurationINTEL")))
	}
	rsys = C.Trampoline3(vkAcquirePerformanceConfigurationINTEL.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pAcquireInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pConfiguration))))
	r = Result(uintptr(rsys))
...
func AcquireProfilingLockKHR(device Device, info *AcquireProfilingLockInfoKHR) (r error) {
	...
	if vkAcquireProfilingLockKHR.fnHandle == nil {
		vkAcquireProfilingLockKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAcquireProfilingLockKHR")))
	}
	rsys = C.Trampoline3(vkAcquireProfilingLockKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
	r = Result(uintptr(rsys))
...
func AllocateCommandBuffers(device Device, allocateInfo *CommandBufferAllocateInfo) (commandBuffers []CommandBuffer, r error) {
	...
	if vkAllocateCommandBuffers.fnHandle == nil {
		vkAllocateCommandBuffers.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAllocateCommandBuffers")))
	}
	rsys = C.Trampoline3(vkAllocateCommandBuffers.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pCommandBuffers))))
	r = Result(uintptr(rsys))
...
func AllocateDescriptorSets(device Device, allocateInfo *DescriptorSetAllocateInfo) (descriptorSets []DescriptorSet, r error) {
	...
	if vkAllocateDescriptorSets.fnHandle == nil {
		vkAllocateDescriptorSets.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAllocateDescriptorSets")))
	}
	rsys = C.Trampoline3(vkAllocateDescriptorSets.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptorSets))))
	r = Result(uintptr(rsys))
...
func AllocateMemory(device Device, allocateInfo *MemoryAllocateInfo, allocator *AllocationCallbacks) (memory DeviceMemory, r error) {
	...
	if vkAllocateMemory.fnHandle == nil {
		vkAllocateMemory.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkAllocateMemory")))
	}
	rsys = C.Trampoline6(vkAllocateMemory.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMemory))), 0, 0)
	r = Result(uintptr(rsys))
...
func BeginCommandBuffer(commandBuffer CommandBuffer, beginInfo *CommandBufferBeginInfo) (r error) {
	...
	if vkBeginCommandBuffer.fnHandle == nil {
		vkBeginCommandBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBeginCommandBuffer")))
	}
	rsys = C.Trampoline3(vkBeginCommandBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pBeginInfo))), 0)
	r = Result(uintptr(rsys))
...
func BindAccelerationStructureMemoryNV(device Device, bindInfos []BindAccelerationStructureMemoryInfoNV) (r error) {
	...
	if vkBindAccelerationStructureMemoryNV.fnHandle == nil {
		vkBindAccelerationStructureMemoryNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBindAccelerationStructureMemoryNV")))
	}
	rsys = C.Trampoline3(vkBindAccelerationStructureMemoryNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(bindInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBindInfos))))
	r = Result(uintptr(rsys))
...
func BindBufferMemory(device Device, buffer Buffer, memory DeviceMemory, memoryOffset DeviceSize) (r error) {
	...
	if vkBindBufferMemory.fnHandle == nil {
		vkBindBufferMemory.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBindBufferMemory")))
	}
	rsys = C.Trampoline6(vkBindBufferMemory.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(memory)), C.uintptr_t(uintptr(memoryOffset)), 0, 0)
	r = Result(uintptr(rsys))
...
func BindBufferMemory2(device Device, bindInfos []BindBufferMemoryInfo) (r error) {
	...
	if vkBindBufferMemory2.fnHandle == nil {
		vkBindBufferMemory2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBindBufferMemory2")))
	}
	rsys = C.Trampoline3(vkBindBufferMemory2.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(bindInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBindInfos))))
	r = Result(uintptr(rsys))
...
func BindImageMemory(device Device, image Image, memory DeviceMemory, memoryOffset DeviceSize) (r error) {
	...
	if vkBindImageMemory.fnHandle == nil {
		vkBindImageMemory.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBindImageMemory")))
	}
	rsys = C.Trampoline6(vkBindImageMemory.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(memory)), C.uintptr_t(uintptr(memoryOffset)), 0, 0)
	r = Result(uintptr(rsys))
...
func BindImageMemory2(device Device, bindInfos []BindImageMemoryInfo) (r error) {
	...
	if vkBindImageMemory2.fnHandle == nil {
		vkBindImageMemory2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBindImageMemory2")))
	}
	rsys = C.Trampoline3(vkBindImageMemory2.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(bindInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBindInfos))))
	r = Result(uintptr(rsys))
...
func BindOpticalFlowSessionImageNV(device Device, session OpticalFlowSessionNV, bindingPoint OpticalFlowSessionBindingPointNV, view ImageView, layout ImageLayout) (r error) {
	...
	if vkBindOpticalFlowSessionImageNV.fnHandle == nil {
		vkBindOpticalFlowSessionImageNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBindOpticalFlowSessionImageNV")))
	}
	rsys = C.Trampoline6(vkBindOpticalFlowSessionImageNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(session)), C.uintptr_t(uintptr(bindingPoint)), C.uintptr_t(uintptr(view)), C.uintptr_t(uintptr(layout)), 0)
	r = Result(uintptr(rsys))
...
func BindVideoSessionMemoryKHR(device Device, videoSession VideoSessionKHR, bindSessionMemoryInfos []BindVideoSessionMemoryInfoKHR) (r error) {
	...
	if vkBindVideoSessionMemoryKHR.fnHandle == nil {
		vkBindVideoSessionMemoryKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBindVideoSessionMemoryKHR")))
	}
	rsys = C.Trampoline6(vkBindVideoSessionMemoryKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(videoSession)), C.uintptr_t(uintptr(bindSessionMemoryInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBindSessionMemoryInfos))), 0, 0)
	r = Result(uintptr(rsys))
...
func BuildAccelerationStructuresKHR(device Device, deferredOperation DeferredOperationKHR, infos []AccelerationStructureBuildGeometryInfoKHR, pBuildRangeInfos []*AccelerationStructureBuildRangeInfoKHR) (r error) {
	...
	if vkBuildAccelerationStructuresKHR.fnHandle == nil {
		vkBuildAccelerationStructuresKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBuildAccelerationStructuresKHR")))
	}
	rsys = C.Trampoline6(vkBuildAccelerationStructuresKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(infoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pInfos))), C.uintptr_t(uintptr(unsafe.Pointer(ppBuildRangeInfos))), 0)
	r = Result(uintptr(rsys))
...
func BuildMicromapsEXT(device Device, deferredOperation DeferredOperationKHR, infos []MicromapBuildInfoEXT) (r error) {
	...
	if vkBuildMicromapsEXT.fnHandle == nil {
		vkBuildMicromapsEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkBuildMicromapsEXT")))
	}
	rsys = C.Trampoline6(vkBuildMicromapsEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(infoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pInfos))), 0, 0)
	r = Result(uintptr(rsys))
...
func CmdBeginConditionalRenderingEXT(commandBuffer CommandBuffer, conditionalRenderingBegin *ConditionalRenderingBeginInfoEXT) {
	...
	if vkCmdBeginConditionalRenderingEXT.fnHandle == nil {
		vkCmdBeginConditionalRenderingEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginConditionalRenderingEXT")))
	}
	C.Trampoline3(vkCmdBeginConditionalRenderingEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pConditionalRenderingBegin))), 0)
...
func CmdBeginDebugUtilsLabelEXT(commandBuffer CommandBuffer, labelInfo *DebugUtilsLabelEXT) {
	...
	if vkCmdBeginDebugUtilsLabelEXT.fnHandle == nil {
		vkCmdBeginDebugUtilsLabelEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginDebugUtilsLabelEXT")))
	}
	C.Trampoline3(vkCmdBeginDebugUtilsLabelEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pLabelInfo))), 0)
...
func CmdBeginQuery(commandBuffer CommandBuffer, queryPool QueryPool, query uint32, flags QueryControlFlags) {
	...
	if vkCmdBeginQuery.fnHandle == nil {
		vkCmdBeginQuery.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginQuery")))
	}
	C.Trampoline6(vkCmdBeginQuery.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(query)), C.uintptr_t(uintptr(flags)), 0, 0)
...
func CmdBeginQueryIndexedEXT(commandBuffer CommandBuffer, queryPool QueryPool, query uint32, flags QueryControlFlags, index uint32) {
	...
	if vkCmdBeginQueryIndexedEXT.fnHandle == nil {
		vkCmdBeginQueryIndexedEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginQueryIndexedEXT")))
	}
	C.Trampoline6(vkCmdBeginQueryIndexedEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(query)), C.uintptr_t(uintptr(flags)), C.uintptr_t(uintptr(index)), 0)
...
func CmdBeginRenderPass(commandBuffer CommandBuffer, renderPassBegin *RenderPassBeginInfo, contents SubpassContents) {
	...
	if vkCmdBeginRenderPass.fnHandle == nil {
		vkCmdBeginRenderPass.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginRenderPass")))
	}
	C.Trampoline3(vkCmdBeginRenderPass.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pRenderPassBegin))), C.uintptr_t(uintptr(contents)))
...
func CmdBeginRenderPass2(commandBuffer CommandBuffer, renderPassBegin *RenderPassBeginInfo, subpassBeginInfo *SubpassBeginInfo) {
	...
	if vkCmdBeginRenderPass2.fnHandle == nil {
		vkCmdBeginRenderPass2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginRenderPass2")))
	}
	C.Trampoline3(vkCmdBeginRenderPass2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pRenderPassBegin))), C.uintptr_t(uintptr(unsafe.Pointer(pSubpassBeginInfo))))
...
func CmdBeginRendering(commandBuffer CommandBuffer, renderingInfo *RenderingInfo) {
	...
	if vkCmdBeginRendering.fnHandle == nil {
		vkCmdBeginRendering.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginRendering")))
	}
	C.Trampoline3(vkCmdBeginRendering.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pRenderingInfo))), 0)
...
func CmdBeginTransformFeedbackEXT(commandBuffer CommandBuffer, firstCounterBuffer uint32, counterBuffers []Buffer, counterBufferOffsets []DeviceSize) {
	...
	if vkCmdBeginTransformFeedbackEXT.fnHandle == nil {
		vkCmdBeginTransformFeedbackEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginTransformFeedbackEXT")))
	}
	C.Trampoline6(vkCmdBeginTransformFeedbackEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstCounterBuffer)), C.uintptr_t(uintptr(counterBufferCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCounterBuffers))), C.uintptr_t(uintptr(unsafe.Pointer(pCounterBufferOffsets))), 0)
...
func CmdBeginVideoCodingKHR(commandBuffer CommandBuffer, beginInfo *VideoBeginCodingInfoKHR) {
	...
	if vkCmdBeginVideoCodingKHR.fnHandle == nil {
		vkCmdBeginVideoCodingKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBeginVideoCodingKHR")))
	}
	C.Trampoline3(vkCmdBeginVideoCodingKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pBeginInfo))), 0)
...
func CmdBindDescriptorBufferEmbeddedSamplers2EXT(commandBuffer CommandBuffer, bindDescriptorBufferEmbeddedSamplersInfo *BindDescriptorBufferEmbeddedSamplersInfoEXT) {
	...
	if vkCmdBindDescriptorBufferEmbeddedSamplers2EXT.fnHandle == nil {
		vkCmdBindDescriptorBufferEmbeddedSamplers2EXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindDescriptorBufferEmbeddedSamplers2EXT")))
	}
	C.Trampoline3(vkCmdBindDescriptorBufferEmbeddedSamplers2EXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pBindDescriptorBufferEmbeddedSamplersInfo))), 0)
...
func CmdBindDescriptorBufferEmbeddedSamplersEXT(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, layout PipelineLayout, set uint32) {
	...
	if vkCmdBindDescriptorBufferEmbeddedSamplersEXT.fnHandle == nil {
		vkCmdBindDescriptorBufferEmbeddedSamplersEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindDescriptorBufferEmbeddedSamplersEXT")))
	}
	C.Trampoline6(vkCmdBindDescriptorBufferEmbeddedSamplersEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineBindPoint)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(set)), 0, 0)
...
func CmdBindDescriptorBuffersEXT(commandBuffer CommandBuffer, bindingInfos []DescriptorBufferBindingInfoEXT) {
	...
	if vkCmdBindDescriptorBuffersEXT.fnHandle == nil {
		vkCmdBindDescriptorBuffersEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindDescriptorBuffersEXT")))
	}
	C.Trampoline3(vkCmdBindDescriptorBuffersEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(bufferCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBindingInfos))))
...
func CmdBindDescriptorSets(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, layout PipelineLayout, firstSet uint32, descriptorSets []DescriptorSet, dynamicOffsets []uint32) {
	...
	if vkCmdBindDescriptorSets.fnHandle == nil {
		vkCmdBindDescriptorSets.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindDescriptorSets")))
	}
	C.Trampoline9(vkCmdBindDescriptorSets.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineBindPoint)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(firstSet)), C.uintptr_t(uintptr(descriptorSetCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptorSets))), C.uintptr_t(uintptr(dynamicOffsetCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDynamicOffsets))), 0)
...
func CmdBindDescriptorSets2KHR(commandBuffer CommandBuffer, bindDescriptorSetsInfo *BindDescriptorSetsInfoKHR) {
	...
	if vkCmdBindDescriptorSets2KHR.fnHandle == nil {
		vkCmdBindDescriptorSets2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindDescriptorSets2KHR")))
	}
	C.Trampoline3(vkCmdBindDescriptorSets2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pBindDescriptorSetsInfo))), 0)
...
func CmdBindIndexBuffer(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, indexType IndexType) {
	...
	if vkCmdBindIndexBuffer.fnHandle == nil {
		vkCmdBindIndexBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindIndexBuffer")))
	}
	C.Trampoline6(vkCmdBindIndexBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(indexType)), 0, 0)
...
func CmdBindIndexBuffer2KHR(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, size DeviceSize, indexType IndexType) {
	...
	if vkCmdBindIndexBuffer2KHR.fnHandle == nil {
		vkCmdBindIndexBuffer2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindIndexBuffer2KHR")))
	}
	C.Trampoline6(vkCmdBindIndexBuffer2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(size)), C.uintptr_t(uintptr(indexType)), 0)
...
func CmdBindInvocationMaskHUAWEI(commandBuffer CommandBuffer, imageView ImageView, imageLayout ImageLayout) {
	...
	if vkCmdBindInvocationMaskHUAWEI.fnHandle == nil {
		vkCmdBindInvocationMaskHUAWEI.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindInvocationMaskHUAWEI")))
	}
	C.Trampoline3(vkCmdBindInvocationMaskHUAWEI.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(imageView)), C.uintptr_t(uintptr(imageLayout)))
...
func CmdBindPipeline(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, pipeline Pipeline) {
	...
	if vkCmdBindPipeline.fnHandle == nil {
		vkCmdBindPipeline.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindPipeline")))
	}
	C.Trampoline3(vkCmdBindPipeline.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineBindPoint)), C.uintptr_t(uintptr(pipeline)))
...
func CmdBindPipelineShaderGroupNV(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, pipeline Pipeline, groupIndex uint32) {
	...
	if vkCmdBindPipelineShaderGroupNV.fnHandle == nil {
		vkCmdBindPipelineShaderGroupNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindPipelineShaderGroupNV")))
	}
	C.Trampoline6(vkCmdBindPipelineShaderGroupNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineBindPoint)), C.uintptr_t(uintptr(pipeline)), C.uintptr_t(uintptr(groupIndex)), 0, 0)
...
func CmdBindShadersEXT(commandBuffer CommandBuffer, stages []ShaderStageFlagBits, shaders []ShaderEXT) {
	...
	if vkCmdBindShadersEXT.fnHandle == nil {
		vkCmdBindShadersEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindShadersEXT")))
	}
	C.Trampoline6(vkCmdBindShadersEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(stageCount)), C.uintptr_t(uintptr(unsafe.Pointer(pStages))), C.uintptr_t(uintptr(unsafe.Pointer(pShaders))), 0, 0)
...
func CmdBindShadingRateImageNV(commandBuffer CommandBuffer, imageView ImageView, imageLayout ImageLayout) {
	...
	if vkCmdBindShadingRateImageNV.fnHandle == nil {
		vkCmdBindShadingRateImageNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindShadingRateImageNV")))
	}
	C.Trampoline3(vkCmdBindShadingRateImageNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(imageView)), C.uintptr_t(uintptr(imageLayout)))
...
func CmdBindTransformFeedbackBuffersEXT(commandBuffer CommandBuffer, firstBinding uint32, buffers []Buffer, offsets []DeviceSize, sizes []DeviceSize) {
	...
	if vkCmdBindTransformFeedbackBuffersEXT.fnHandle == nil {
		vkCmdBindTransformFeedbackBuffersEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindTransformFeedbackBuffersEXT")))
	}
	C.Trampoline6(vkCmdBindTransformFeedbackBuffersEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstBinding)), C.uintptr_t(uintptr(bindingCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBuffers))), C.uintptr_t(uintptr(unsafe.Pointer(pOffsets))), C.uintptr_t(uintptr(unsafe.Pointer(pSizes))))
...
func CmdBindVertexBuffers(commandBuffer CommandBuffer, firstBinding uint32, buffers []Buffer, offsets []DeviceSize) {
	...
	if vkCmdBindVertexBuffers.fnHandle == nil {
		vkCmdBindVertexBuffers.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindVertexBuffers")))
	}
	C.Trampoline6(vkCmdBindVertexBuffers.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstBinding)), C.uintptr_t(uintptr(bindingCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBuffers))), C.uintptr_t(uintptr(unsafe.Pointer(pOffsets))), 0)
...
func CmdBindVertexBuffers2(commandBuffer CommandBuffer, firstBinding uint32, buffers []Buffer, offsets []DeviceSize, sizes []DeviceSize, strides []DeviceSize) {
	...
	if vkCmdBindVertexBuffers2.fnHandle == nil {
		vkCmdBindVertexBuffers2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBindVertexBuffers2")))
	}
	C.Trampoline9(vkCmdBindVertexBuffers2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstBinding)), C.uintptr_t(uintptr(bindingCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBuffers))), C.uintptr_t(uintptr(unsafe.Pointer(pOffsets))), C.uintptr_t(uintptr(unsafe.Pointer(pSizes))), C.uintptr_t(uintptr(unsafe.Pointer(pStrides))), 0, 0)
...
func CmdBlitImage(commandBuffer CommandBuffer, srcImage Image, srcImageLayout ImageLayout, dstImage Image, dstImageLayout ImageLayout, regions []ImageBlit, filter Filter) {
	...
	if vkCmdBlitImage.fnHandle == nil {
		vkCmdBlitImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBlitImage")))
	}
	C.Trampoline9(vkCmdBlitImage.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(srcImage)), C.uintptr_t(uintptr(srcImageLayout)), C.uintptr_t(uintptr(dstImage)), C.uintptr_t(uintptr(dstImageLayout)), C.uintptr_t(uintptr(regionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRegions))), C.uintptr_t(uintptr(filter)), 0)
...
func CmdBlitImage2(commandBuffer CommandBuffer, blitImageInfo *BlitImageInfo2) {
	...
	if vkCmdBlitImage2.fnHandle == nil {
		vkCmdBlitImage2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBlitImage2")))
	}
	C.Trampoline3(vkCmdBlitImage2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pBlitImageInfo))), 0)
...
func CmdBuildAccelerationStructureNV(commandBuffer CommandBuffer, info *AccelerationStructureInfoNV, instanceData Buffer, instanceOffset DeviceSize, update bool, dst AccelerationStructureNV, src AccelerationStructureNV, scratch Buffer, scratchOffset DeviceSize) {
	...
	if vkCmdBuildAccelerationStructureNV.fnHandle == nil {
		vkCmdBuildAccelerationStructureNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBuildAccelerationStructureNV")))
	}
	C.Trampoline9(vkCmdBuildAccelerationStructureNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(instanceData)), C.uintptr_t(uintptr(instanceOffset)), C.uintptr_t(uintptr(update_Bool32)), C.uintptr_t(uintptr(dst)), C.uintptr_t(uintptr(src)), C.uintptr_t(uintptr(scratch)), C.uintptr_t(uintptr(scratchOffset)))
...
func CmdBuildAccelerationStructuresIndirectKHR(commandBuffer CommandBuffer, infos []AccelerationStructureBuildGeometryInfoKHR, indirectDeviceAddresses []DeviceAddress, indirectStrides []uint32, pMaxPrimitiveCounts []*uint32) {
	...
	if vkCmdBuildAccelerationStructuresIndirectKHR.fnHandle == nil {
		vkCmdBuildAccelerationStructuresIndirectKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBuildAccelerationStructuresIndirectKHR")))
	}
	C.Trampoline6(vkCmdBuildAccelerationStructuresIndirectKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(infoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pIndirectDeviceAddresses))), C.uintptr_t(uintptr(unsafe.Pointer(pIndirectStrides))), C.uintptr_t(uintptr(unsafe.Pointer(ppMaxPrimitiveCounts))))
...
func CmdBuildAccelerationStructuresKHR(commandBuffer CommandBuffer, infos []AccelerationStructureBuildGeometryInfoKHR, pBuildRangeInfos []*AccelerationStructureBuildRangeInfoKHR) {
	...
	if vkCmdBuildAccelerationStructuresKHR.fnHandle == nil {
		vkCmdBuildAccelerationStructuresKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBuildAccelerationStructuresKHR")))
	}
	C.Trampoline6(vkCmdBuildAccelerationStructuresKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(infoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pInfos))), C.uintptr_t(uintptr(unsafe.Pointer(ppBuildRangeInfos))), 0, 0)
...
func CmdBuildMicromapsEXT(commandBuffer CommandBuffer, infos []MicromapBuildInfoEXT) {
	...
	if vkCmdBuildMicromapsEXT.fnHandle == nil {
		vkCmdBuildMicromapsEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdBuildMicromapsEXT")))
	}
	C.Trampoline3(vkCmdBuildMicromapsEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(infoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pInfos))))
...
func CmdClearAttachments(commandBuffer CommandBuffer, attachments []ClearAttachment, rects []ClearRect) {
	...
	if vkCmdClearAttachments.fnHandle == nil {
		vkCmdClearAttachments.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdClearAttachments")))
	}
	C.Trampoline6(vkCmdClearAttachments.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(attachmentCount)), C.uintptr_t(uintptr(unsafe.Pointer(pAttachments))), C.uintptr_t(uintptr(rectCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRects))), 0)
...
func CmdClearColorImage(commandBuffer CommandBuffer, image Image, imageLayout ImageLayout, color *ClearColorValue, ranges []ImageSubresourceRange) {
	...
	if vkCmdClearColorImage.fnHandle == nil {
		vkCmdClearColorImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdClearColorImage")))
	}
	C.Trampoline6(vkCmdClearColorImage.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(imageLayout)), C.uintptr_t(uintptr(unsafe.Pointer(pColor))), C.uintptr_t(uintptr(rangeCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRanges))))
...
func CmdClearDepthStencilImage(commandBuffer CommandBuffer, image Image, imageLayout ImageLayout, depthStencil *ClearDepthStencilValue, ranges []ImageSubresourceRange) {
	...
	if vkCmdClearDepthStencilImage.fnHandle == nil {
		vkCmdClearDepthStencilImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdClearDepthStencilImage")))
	}
	C.Trampoline6(vkCmdClearDepthStencilImage.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(imageLayout)), C.uintptr_t(uintptr(unsafe.Pointer(pDepthStencil))), C.uintptr_t(uintptr(rangeCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRanges))))
...
func CmdControlVideoCodingKHR(commandBuffer CommandBuffer, codingControlInfo *VideoCodingControlInfoKHR) {
	...
	if vkCmdControlVideoCodingKHR.fnHandle == nil {
		vkCmdControlVideoCodingKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdControlVideoCodingKHR")))
	}
	C.Trampoline3(vkCmdControlVideoCodingKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCodingControlInfo))), 0)
...
func CmdCopyAccelerationStructureKHR(commandBuffer CommandBuffer, info *CopyAccelerationStructureInfoKHR) {
	...
	if vkCmdCopyAccelerationStructureKHR.fnHandle == nil {
		vkCmdCopyAccelerationStructureKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyAccelerationStructureKHR")))
	}
	C.Trampoline3(vkCmdCopyAccelerationStructureKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
...
func CmdCopyAccelerationStructureNV(commandBuffer CommandBuffer, dst AccelerationStructureNV, src AccelerationStructureNV, mode CopyAccelerationStructureModeKHR) {
	...
	if vkCmdCopyAccelerationStructureNV.fnHandle == nil {
		vkCmdCopyAccelerationStructureNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyAccelerationStructureNV")))
	}
	C.Trampoline6(vkCmdCopyAccelerationStructureNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(dst)), C.uintptr_t(uintptr(src)), C.uintptr_t(uintptr(mode)), 0, 0)
...
func CmdCopyAccelerationStructureToMemoryKHR(commandBuffer CommandBuffer, info *CopyAccelerationStructureToMemoryInfoKHR) {
	...
	if vkCmdCopyAccelerationStructureToMemoryKHR.fnHandle == nil {
		vkCmdCopyAccelerationStructureToMemoryKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyAccelerationStructureToMemoryKHR")))
	}
	C.Trampoline3(vkCmdCopyAccelerationStructureToMemoryKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
...
func CmdCopyBuffer(commandBuffer CommandBuffer, srcBuffer Buffer, dstBuffer Buffer, regions []BufferCopy) {
	...
	if vkCmdCopyBuffer.fnHandle == nil {
		vkCmdCopyBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyBuffer")))
	}
	C.Trampoline6(vkCmdCopyBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(srcBuffer)), C.uintptr_t(uintptr(dstBuffer)), C.uintptr_t(uintptr(regionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRegions))), 0)
...
func CmdCopyBuffer2(commandBuffer CommandBuffer, copyBufferInfo *CopyBufferInfo2) {
	...
	if vkCmdCopyBuffer2.fnHandle == nil {
		vkCmdCopyBuffer2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyBuffer2")))
	}
	C.Trampoline3(vkCmdCopyBuffer2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyBufferInfo))), 0)
...
func CmdCopyBufferToImage(commandBuffer CommandBuffer, srcBuffer Buffer, dstImage Image, dstImageLayout ImageLayout, regions []BufferImageCopy) {
	...
	if vkCmdCopyBufferToImage.fnHandle == nil {
		vkCmdCopyBufferToImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyBufferToImage")))
	}
	C.Trampoline6(vkCmdCopyBufferToImage.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(srcBuffer)), C.uintptr_t(uintptr(dstImage)), C.uintptr_t(uintptr(dstImageLayout)), C.uintptr_t(uintptr(regionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRegions))))
...
func CmdCopyBufferToImage2(commandBuffer CommandBuffer, copyBufferToImageInfo *CopyBufferToImageInfo2) {
	...
	if vkCmdCopyBufferToImage2.fnHandle == nil {
		vkCmdCopyBufferToImage2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyBufferToImage2")))
	}
	C.Trampoline3(vkCmdCopyBufferToImage2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyBufferToImageInfo))), 0)
...
func CmdCopyImage(commandBuffer CommandBuffer, srcImage Image, srcImageLayout ImageLayout, dstImage Image, dstImageLayout ImageLayout, regions []ImageCopy) {
	...
	if vkCmdCopyImage.fnHandle == nil {
		vkCmdCopyImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyImage")))
	}
	C.Trampoline9(vkCmdCopyImage.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(srcImage)), C.uintptr_t(uintptr(srcImageLayout)), C.uintptr_t(uintptr(dstImage)), C.uintptr_t(uintptr(dstImageLayout)), C.uintptr_t(uintptr(regionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRegions))), 0, 0)
...
func CmdCopyImage2(commandBuffer CommandBuffer, copyImageInfo *CopyImageInfo2) {
	...
	if vkCmdCopyImage2.fnHandle == nil {
		vkCmdCopyImage2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyImage2")))
	}
	C.Trampoline3(vkCmdCopyImage2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyImageInfo))), 0)
...
func CmdCopyImageToBuffer(commandBuffer CommandBuffer, srcImage Image, srcImageLayout ImageLayout, dstBuffer Buffer, regions []BufferImageCopy) {
	...
	if vkCmdCopyImageToBuffer.fnHandle == nil {
		vkCmdCopyImageToBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyImageToBuffer")))
	}
	C.Trampoline6(vkCmdCopyImageToBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(srcImage)), C.uintptr_t(uintptr(srcImageLayout)), C.uintptr_t(uintptr(dstBuffer)), C.uintptr_t(uintptr(regionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRegions))))
...
func CmdCopyImageToBuffer2(commandBuffer CommandBuffer, copyImageToBufferInfo *CopyImageToBufferInfo2) {
	...
	if vkCmdCopyImageToBuffer2.fnHandle == nil {
		vkCmdCopyImageToBuffer2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyImageToBuffer2")))
	}
	C.Trampoline3(vkCmdCopyImageToBuffer2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyImageToBufferInfo))), 0)
...
func CmdCopyMemoryIndirectNV(commandBuffer CommandBuffer, copyBufferAddress DeviceAddress, copyCount uint32, stride uint32) {
	...
	if vkCmdCopyMemoryIndirectNV.fnHandle == nil {
		vkCmdCopyMemoryIndirectNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyMemoryIndirectNV")))
	}
	C.Trampoline6(vkCmdCopyMemoryIndirectNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(copyBufferAddress)), C.uintptr_t(uintptr(copyCount)), C.uintptr_t(uintptr(stride)), 0, 0)
...
func CmdCopyMemoryToAccelerationStructureKHR(commandBuffer CommandBuffer, info *CopyMemoryToAccelerationStructureInfoKHR) {
	...
	if vkCmdCopyMemoryToAccelerationStructureKHR.fnHandle == nil {
		vkCmdCopyMemoryToAccelerationStructureKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyMemoryToAccelerationStructureKHR")))
	}
	C.Trampoline3(vkCmdCopyMemoryToAccelerationStructureKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
...
func CmdCopyMemoryToImageIndirectNV(commandBuffer CommandBuffer, copyBufferAddress DeviceAddress, stride uint32, dstImage Image, dstImageLayout ImageLayout, imageSubresources []ImageSubresourceLayers) {
	...
	if vkCmdCopyMemoryToImageIndirectNV.fnHandle == nil {
		vkCmdCopyMemoryToImageIndirectNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyMemoryToImageIndirectNV")))
	}
	C.Trampoline9(vkCmdCopyMemoryToImageIndirectNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(copyBufferAddress)), C.uintptr_t(uintptr(copyCount)), C.uintptr_t(uintptr(stride)), C.uintptr_t(uintptr(dstImage)), C.uintptr_t(uintptr(dstImageLayout)), C.uintptr_t(uintptr(unsafe.Pointer(pImageSubresources))), 0, 0)
...
func CmdCopyMemoryToMicromapEXT(commandBuffer CommandBuffer, info *CopyMemoryToMicromapInfoEXT) {
	...
	if vkCmdCopyMemoryToMicromapEXT.fnHandle == nil {
		vkCmdCopyMemoryToMicromapEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyMemoryToMicromapEXT")))
	}
	C.Trampoline3(vkCmdCopyMemoryToMicromapEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
...
func CmdCopyMicromapEXT(commandBuffer CommandBuffer, info *CopyMicromapInfoEXT) {
	...
	if vkCmdCopyMicromapEXT.fnHandle == nil {
		vkCmdCopyMicromapEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyMicromapEXT")))
	}
	C.Trampoline3(vkCmdCopyMicromapEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
...
func CmdCopyMicromapToMemoryEXT(commandBuffer CommandBuffer, info *CopyMicromapToMemoryInfoEXT) {
	...
	if vkCmdCopyMicromapToMemoryEXT.fnHandle == nil {
		vkCmdCopyMicromapToMemoryEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyMicromapToMemoryEXT")))
	}
	C.Trampoline3(vkCmdCopyMicromapToMemoryEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
...
func CmdCopyQueryPoolResults(commandBuffer CommandBuffer, queryPool QueryPool, firstQuery uint32, queryCount uint32, dstBuffer Buffer, dstOffset DeviceSize, stride DeviceSize, flags QueryResultFlags) {
	...
	if vkCmdCopyQueryPoolResults.fnHandle == nil {
		vkCmdCopyQueryPoolResults.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCopyQueryPoolResults")))
	}
	C.Trampoline9(vkCmdCopyQueryPoolResults.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(firstQuery)), C.uintptr_t(uintptr(queryCount)), C.uintptr_t(uintptr(dstBuffer)), C.uintptr_t(uintptr(dstOffset)), C.uintptr_t(uintptr(stride)), C.uintptr_t(uintptr(flags)), 0)
...
func CmdCuLaunchKernelNVX(commandBuffer CommandBuffer, launchInfo *CuLaunchInfoNVX) {
	...
	if vkCmdCuLaunchKernelNVX.fnHandle == nil {
		vkCmdCuLaunchKernelNVX.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCuLaunchKernelNVX")))
	}
	C.Trampoline3(vkCmdCuLaunchKernelNVX.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pLaunchInfo))), 0)
...
func CmdCudaLaunchKernelNV(commandBuffer CommandBuffer, launchInfo *CudaLaunchInfoNV) {
	...
	if vkCmdCudaLaunchKernelNV.fnHandle == nil {
		vkCmdCudaLaunchKernelNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdCudaLaunchKernelNV")))
	}
	C.Trampoline3(vkCmdCudaLaunchKernelNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pLaunchInfo))), 0)
...
func CmdDebugMarkerBeginEXT(commandBuffer CommandBuffer, markerInfo *DebugMarkerMarkerInfoEXT) {
	...
	if vkCmdDebugMarkerBeginEXT.fnHandle == nil {
		vkCmdDebugMarkerBeginEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDebugMarkerBeginEXT")))
	}
	C.Trampoline3(vkCmdDebugMarkerBeginEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pMarkerInfo))), 0)
...
func CmdDebugMarkerEndEXT(commandBuffer CommandBuffer) {
	...
	if vkCmdDebugMarkerEndEXT.fnHandle == nil {
		vkCmdDebugMarkerEndEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDebugMarkerEndEXT")))
	}
	C.Trampoline3(vkCmdDebugMarkerEndEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
...
func CmdDebugMarkerInsertEXT(commandBuffer CommandBuffer, markerInfo *DebugMarkerMarkerInfoEXT) {
	...
	if vkCmdDebugMarkerInsertEXT.fnHandle == nil {
		vkCmdDebugMarkerInsertEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDebugMarkerInsertEXT")))
	}
	C.Trampoline3(vkCmdDebugMarkerInsertEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pMarkerInfo))), 0)
...
func CmdDecodeVideoKHR(commandBuffer CommandBuffer, decodeInfo *VideoDecodeInfoKHR) {
	...
	if vkCmdDecodeVideoKHR.fnHandle == nil {
		vkCmdDecodeVideoKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDecodeVideoKHR")))
	}
	C.Trampoline3(vkCmdDecodeVideoKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pDecodeInfo))), 0)
...
func CmdDecompressMemoryIndirectCountNV(commandBuffer CommandBuffer, indirectCommandsAddress DeviceAddress, indirectCommandsCountAddress DeviceAddress, stride uint32) {
	...
	if vkCmdDecompressMemoryIndirectCountNV.fnHandle == nil {
		vkCmdDecompressMemoryIndirectCountNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDecompressMemoryIndirectCountNV")))
	}
	C.Trampoline6(vkCmdDecompressMemoryIndirectCountNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(indirectCommandsAddress)), C.uintptr_t(uintptr(indirectCommandsCountAddress)), C.uintptr_t(uintptr(stride)), 0, 0)
...
func CmdDecompressMemoryNV(commandBuffer CommandBuffer, decompressMemoryRegions []DecompressMemoryRegionNV) {
	...
	if vkCmdDecompressMemoryNV.fnHandle == nil {
		vkCmdDecompressMemoryNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDecompressMemoryNV")))
	}
	C.Trampoline3(vkCmdDecompressMemoryNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(decompressRegionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDecompressMemoryRegions))))
...
func CmdDispatch(commandBuffer CommandBuffer, groupCountX uint32, groupCountY uint32, groupCountZ uint32) {
	...
	if vkCmdDispatch.fnHandle == nil {
		vkCmdDispatch.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDispatch")))
	}
	C.Trampoline6(vkCmdDispatch.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(groupCountX)), C.uintptr_t(uintptr(groupCountY)), C.uintptr_t(uintptr(groupCountZ)), 0, 0)
...
func CmdDispatchBase(commandBuffer CommandBuffer, baseGroupX uint32, baseGroupY uint32, baseGroupZ uint32, groupCountX uint32, groupCountY uint32, groupCountZ uint32) {
	...
	if vkCmdDispatchBase.fnHandle == nil {
		vkCmdDispatchBase.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDispatchBase")))
	}
	C.Trampoline9(vkCmdDispatchBase.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(baseGroupX)), C.uintptr_t(uintptr(baseGroupY)), C.uintptr_t(uintptr(baseGroupZ)), C.uintptr_t(uintptr(groupCountX)), C.uintptr_t(uintptr(groupCountY)), C.uintptr_t(uintptr(groupCountZ)), 0, 0)
...
func CmdDispatchIndirect(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize) {
	...
	if vkCmdDispatchIndirect.fnHandle == nil {
		vkCmdDispatchIndirect.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDispatchIndirect")))
	}
	C.Trampoline3(vkCmdDispatchIndirect.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)))
...
func CmdDraw(commandBuffer CommandBuffer, vertexCount uint32, instanceCount uint32, firstVertex uint32, firstInstance uint32) {
	...
	if vkCmdDraw.fnHandle == nil {
		vkCmdDraw.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDraw")))
	}
	C.Trampoline6(vkCmdDraw.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(vertexCount)), C.uintptr_t(uintptr(instanceCount)), C.uintptr_t(uintptr(firstVertex)), C.uintptr_t(uintptr(firstInstance)), 0)
...
func CmdDrawClusterHUAWEI(commandBuffer CommandBuffer, groupCountX uint32, groupCountY uint32, groupCountZ uint32) {
	...
	if vkCmdDrawClusterHUAWEI.fnHandle == nil {
		vkCmdDrawClusterHUAWEI.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawClusterHUAWEI")))
	}
	C.Trampoline6(vkCmdDrawClusterHUAWEI.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(groupCountX)), C.uintptr_t(uintptr(groupCountY)), C.uintptr_t(uintptr(groupCountZ)), 0, 0)
...
func CmdDrawClusterIndirectHUAWEI(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize) {
	...
	if vkCmdDrawClusterIndirectHUAWEI.fnHandle == nil {
		vkCmdDrawClusterIndirectHUAWEI.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawClusterIndirectHUAWEI")))
	}
	C.Trampoline3(vkCmdDrawClusterIndirectHUAWEI.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)))
...
func CmdDrawIndexed(commandBuffer CommandBuffer, indexCount uint32, instanceCount uint32, firstIndex uint32, vertexOffset int32, firstInstance uint32) {
	...
	if vkCmdDrawIndexed.fnHandle == nil {
		vkCmdDrawIndexed.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawIndexed")))
	}
	C.Trampoline6(vkCmdDrawIndexed.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(indexCount)), C.uintptr_t(uintptr(instanceCount)), C.uintptr_t(uintptr(firstIndex)), C.uintptr_t(uintptr(vertexOffset)), C.uintptr_t(uintptr(firstInstance)))
...
func CmdDrawIndexedIndirect(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, drawCount uint32, stride uint32) {
	...
	if vkCmdDrawIndexedIndirect.fnHandle == nil {
		vkCmdDrawIndexedIndirect.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawIndexedIndirect")))
	}
	C.Trampoline6(vkCmdDrawIndexedIndirect.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(drawCount)), C.uintptr_t(uintptr(stride)), 0)
...
func CmdDrawIndexedIndirectCount(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, countBuffer Buffer, countBufferOffset DeviceSize, maxDrawCount uint32, stride uint32) {
	...
	if vkCmdDrawIndexedIndirectCount.fnHandle == nil {
		vkCmdDrawIndexedIndirectCount.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawIndexedIndirectCount")))
	}
	C.Trampoline9(vkCmdDrawIndexedIndirectCount.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(countBuffer)), C.uintptr_t(uintptr(countBufferOffset)), C.uintptr_t(uintptr(maxDrawCount)), C.uintptr_t(uintptr(stride)), 0, 0)
...
func CmdDrawIndirect(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, drawCount uint32, stride uint32) {
	...
	if vkCmdDrawIndirect.fnHandle == nil {
		vkCmdDrawIndirect.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawIndirect")))
	}
	C.Trampoline6(vkCmdDrawIndirect.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(drawCount)), C.uintptr_t(uintptr(stride)), 0)
...
func CmdDrawIndirectByteCountEXT(commandBuffer CommandBuffer, instanceCount uint32, firstInstance uint32, counterBuffer Buffer, counterBufferOffset DeviceSize, counterOffset uint32, vertexStride uint32) {
	...
	if vkCmdDrawIndirectByteCountEXT.fnHandle == nil {
		vkCmdDrawIndirectByteCountEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawIndirectByteCountEXT")))
	}
	C.Trampoline9(vkCmdDrawIndirectByteCountEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(instanceCount)), C.uintptr_t(uintptr(firstInstance)), C.uintptr_t(uintptr(counterBuffer)), C.uintptr_t(uintptr(counterBufferOffset)), C.uintptr_t(uintptr(counterOffset)), C.uintptr_t(uintptr(vertexStride)), 0, 0)
...
func CmdDrawIndirectCount(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, countBuffer Buffer, countBufferOffset DeviceSize, maxDrawCount uint32, stride uint32) {
	...
	if vkCmdDrawIndirectCount.fnHandle == nil {
		vkCmdDrawIndirectCount.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawIndirectCount")))
	}
	C.Trampoline9(vkCmdDrawIndirectCount.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(countBuffer)), C.uintptr_t(uintptr(countBufferOffset)), C.uintptr_t(uintptr(maxDrawCount)), C.uintptr_t(uintptr(stride)), 0, 0)
...
func CmdDrawMeshTasksEXT(commandBuffer CommandBuffer, groupCountX uint32, groupCountY uint32, groupCountZ uint32) {
	...
	if vkCmdDrawMeshTasksEXT.fnHandle == nil {
		vkCmdDrawMeshTasksEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMeshTasksEXT")))
	}
	C.Trampoline6(vkCmdDrawMeshTasksEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(groupCountX)), C.uintptr_t(uintptr(groupCountY)), C.uintptr_t(uintptr(groupCountZ)), 0, 0)
...
func CmdDrawMeshTasksIndirectCountEXT(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, countBuffer Buffer, countBufferOffset DeviceSize, maxDrawCount uint32, stride uint32) {
	...
	if vkCmdDrawMeshTasksIndirectCountEXT.fnHandle == nil {
		vkCmdDrawMeshTasksIndirectCountEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMeshTasksIndirectCountEXT")))
	}
	C.Trampoline9(vkCmdDrawMeshTasksIndirectCountEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(countBuffer)), C.uintptr_t(uintptr(countBufferOffset)), C.uintptr_t(uintptr(maxDrawCount)), C.uintptr_t(uintptr(stride)), 0, 0)
...
func CmdDrawMeshTasksIndirectCountNV(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, countBuffer Buffer, countBufferOffset DeviceSize, maxDrawCount uint32, stride uint32) {
	...
	if vkCmdDrawMeshTasksIndirectCountNV.fnHandle == nil {
		vkCmdDrawMeshTasksIndirectCountNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMeshTasksIndirectCountNV")))
	}
	C.Trampoline9(vkCmdDrawMeshTasksIndirectCountNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(countBuffer)), C.uintptr_t(uintptr(countBufferOffset)), C.uintptr_t(uintptr(maxDrawCount)), C.uintptr_t(uintptr(stride)), 0, 0)
...
func CmdDrawMeshTasksIndirectEXT(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, drawCount uint32, stride uint32) {
	...
	if vkCmdDrawMeshTasksIndirectEXT.fnHandle == nil {
		vkCmdDrawMeshTasksIndirectEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMeshTasksIndirectEXT")))
	}
	C.Trampoline6(vkCmdDrawMeshTasksIndirectEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(drawCount)), C.uintptr_t(uintptr(stride)), 0)
...
func CmdDrawMeshTasksIndirectNV(commandBuffer CommandBuffer, buffer Buffer, offset DeviceSize, drawCount uint32, stride uint32) {
	...
	if vkCmdDrawMeshTasksIndirectNV.fnHandle == nil {
		vkCmdDrawMeshTasksIndirectNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMeshTasksIndirectNV")))
	}
	C.Trampoline6(vkCmdDrawMeshTasksIndirectNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(drawCount)), C.uintptr_t(uintptr(stride)), 0)
...
func CmdDrawMeshTasksNV(commandBuffer CommandBuffer, taskCount uint32, firstTask uint32) {
	...
	if vkCmdDrawMeshTasksNV.fnHandle == nil {
		vkCmdDrawMeshTasksNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMeshTasksNV")))
	}
	C.Trampoline3(vkCmdDrawMeshTasksNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(taskCount)), C.uintptr_t(uintptr(firstTask)))
...
func CmdDrawMultiEXT(commandBuffer CommandBuffer, vertexInfo []MultiDrawInfoEXT, instanceCount uint32, firstInstance uint32, stride uint32) {
	...
	if vkCmdDrawMultiEXT.fnHandle == nil {
		vkCmdDrawMultiEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMultiEXT")))
	}
	C.Trampoline6(vkCmdDrawMultiEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(drawCount)), C.uintptr_t(uintptr(unsafe.Pointer(pVertexInfo))), C.uintptr_t(uintptr(instanceCount)), C.uintptr_t(uintptr(firstInstance)), C.uintptr_t(uintptr(stride)))
...
func CmdDrawMultiIndexedEXT(commandBuffer CommandBuffer, indexInfo []MultiDrawIndexedInfoEXT, instanceCount uint32, firstInstance uint32, stride uint32, vertexOffset *int32) {
	...
	if vkCmdDrawMultiIndexedEXT.fnHandle == nil {
		vkCmdDrawMultiIndexedEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdDrawMultiIndexedEXT")))
	}
	C.Trampoline9(vkCmdDrawMultiIndexedEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(drawCount)), C.uintptr_t(uintptr(unsafe.Pointer(pIndexInfo))), C.uintptr_t(uintptr(instanceCount)), C.uintptr_t(uintptr(firstInstance)), C.uintptr_t(uintptr(stride)), C.uintptr_t(uintptr(unsafe.Pointer(pVertexOffset))), 0, 0)
...
func CmdEncodeVideoKHR(commandBuffer CommandBuffer, encodeInfo *VideoEncodeInfoKHR) {
	...
	if vkCmdEncodeVideoKHR.fnHandle == nil {
		vkCmdEncodeVideoKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEncodeVideoKHR")))
	}
	C.Trampoline3(vkCmdEncodeVideoKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pEncodeInfo))), 0)
...
func CmdEndConditionalRenderingEXT(commandBuffer CommandBuffer) {
	...
	if vkCmdEndConditionalRenderingEXT.fnHandle == nil {
		vkCmdEndConditionalRenderingEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndConditionalRenderingEXT")))
	}
	C.Trampoline3(vkCmdEndConditionalRenderingEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
...
func CmdEndDebugUtilsLabelEXT(commandBuffer CommandBuffer) {
	...
	if vkCmdEndDebugUtilsLabelEXT.fnHandle == nil {
		vkCmdEndDebugUtilsLabelEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndDebugUtilsLabelEXT")))
	}
	C.Trampoline3(vkCmdEndDebugUtilsLabelEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
...
func CmdEndQuery(commandBuffer CommandBuffer, queryPool QueryPool, query uint32) {
	...
	if vkCmdEndQuery.fnHandle == nil {
		vkCmdEndQuery.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndQuery")))
	}
	C.Trampoline3(vkCmdEndQuery.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(query)))
...
func CmdEndQueryIndexedEXT(commandBuffer CommandBuffer, queryPool QueryPool, query uint32, index uint32) {
	...
	if vkCmdEndQueryIndexedEXT.fnHandle == nil {
		vkCmdEndQueryIndexedEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndQueryIndexedEXT")))
	}
	C.Trampoline6(vkCmdEndQueryIndexedEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(query)), C.uintptr_t(uintptr(index)), 0, 0)
...
func CmdEndRenderPass(commandBuffer CommandBuffer) {
	...
	if vkCmdEndRenderPass.fnHandle == nil {
		vkCmdEndRenderPass.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndRenderPass")))
	}
	C.Trampoline3(vkCmdEndRenderPass.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
...
func CmdEndRenderPass2(commandBuffer CommandBuffer, subpassEndInfo *SubpassEndInfo) {
	...
	if vkCmdEndRenderPass2.fnHandle == nil {
		vkCmdEndRenderPass2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndRenderPass2")))
	}
	C.Trampoline3(vkCmdEndRenderPass2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pSubpassEndInfo))), 0)
...
func CmdEndRendering(commandBuffer CommandBuffer) {
	...
	if vkCmdEndRendering.fnHandle == nil {
		vkCmdEndRendering.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndRendering")))
	}
	C.Trampoline3(vkCmdEndRendering.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
...
func CmdEndTransformFeedbackEXT(commandBuffer CommandBuffer, firstCounterBuffer uint32, counterBuffers []Buffer, counterBufferOffsets []DeviceSize) {
	...
	if vkCmdEndTransformFeedbackEXT.fnHandle == nil {
		vkCmdEndTransformFeedbackEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndTransformFeedbackEXT")))
	}
	C.Trampoline6(vkCmdEndTransformFeedbackEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstCounterBuffer)), C.uintptr_t(uintptr(counterBufferCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCounterBuffers))), C.uintptr_t(uintptr(unsafe.Pointer(pCounterBufferOffsets))), 0)
...
func CmdEndVideoCodingKHR(commandBuffer CommandBuffer, endCodingInfo *VideoEndCodingInfoKHR) {
	...
	if vkCmdEndVideoCodingKHR.fnHandle == nil {
		vkCmdEndVideoCodingKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdEndVideoCodingKHR")))
	}
	C.Trampoline3(vkCmdEndVideoCodingKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pEndCodingInfo))), 0)
...
func CmdExecuteCommands(commandBuffer CommandBuffer, commandBuffers []CommandBuffer) {
	...
	if vkCmdExecuteCommands.fnHandle == nil {
		vkCmdExecuteCommands.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdExecuteCommands")))
	}
	C.Trampoline3(vkCmdExecuteCommands.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(commandBufferCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCommandBuffers))))
...
func CmdExecuteGeneratedCommandsNV(commandBuffer CommandBuffer, isPreprocessed bool, generatedCommandsInfo *GeneratedCommandsInfoNV) {
	...
	if vkCmdExecuteGeneratedCommandsNV.fnHandle == nil {
		vkCmdExecuteGeneratedCommandsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdExecuteGeneratedCommandsNV")))
	}
	C.Trampoline3(vkCmdExecuteGeneratedCommandsNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(isPreprocessed_Bool32)), C.uintptr_t(uintptr(unsafe.Pointer(pGeneratedCommandsInfo))))
...
func CmdFillBuffer(commandBuffer CommandBuffer, dstBuffer Buffer, dstOffset DeviceSize, size DeviceSize, data uint32) {
	...
	if vkCmdFillBuffer.fnHandle == nil {
		vkCmdFillBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdFillBuffer")))
	}
	C.Trampoline6(vkCmdFillBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(dstBuffer)), C.uintptr_t(uintptr(dstOffset)), C.uintptr_t(uintptr(size)), C.uintptr_t(uintptr(data)), 0)
...
func CmdInsertDebugUtilsLabelEXT(commandBuffer CommandBuffer, labelInfo *DebugUtilsLabelEXT) {
	...
	if vkCmdInsertDebugUtilsLabelEXT.fnHandle == nil {
		vkCmdInsertDebugUtilsLabelEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdInsertDebugUtilsLabelEXT")))
	}
	C.Trampoline3(vkCmdInsertDebugUtilsLabelEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pLabelInfo))), 0)
...
func CmdNextSubpass(commandBuffer CommandBuffer, contents SubpassContents) {
	...
	if vkCmdNextSubpass.fnHandle == nil {
		vkCmdNextSubpass.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdNextSubpass")))
	}
	C.Trampoline3(vkCmdNextSubpass.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(contents)), 0)
...
func CmdNextSubpass2(commandBuffer CommandBuffer, subpassBeginInfo *SubpassBeginInfo, subpassEndInfo *SubpassEndInfo) {
	...
	if vkCmdNextSubpass2.fnHandle == nil {
		vkCmdNextSubpass2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdNextSubpass2")))
	}
	C.Trampoline3(vkCmdNextSubpass2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pSubpassBeginInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSubpassEndInfo))))
...
func CmdOpticalFlowExecuteNV(commandBuffer CommandBuffer, session OpticalFlowSessionNV, executeInfo *OpticalFlowExecuteInfoNV) {
	...
	if vkCmdOpticalFlowExecuteNV.fnHandle == nil {
		vkCmdOpticalFlowExecuteNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdOpticalFlowExecuteNV")))
	}
	C.Trampoline3(vkCmdOpticalFlowExecuteNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(session)), C.uintptr_t(uintptr(unsafe.Pointer(pExecuteInfo))))
...
func CmdPipelineBarrier(commandBuffer CommandBuffer, srcStageMask PipelineStageFlags, dstStageMask PipelineStageFlags, dependencyFlags DependencyFlags, memoryBarriers []MemoryBarrier, bufferMemoryBarriers []BufferMemoryBarrier, imageMemoryBarriers []ImageMemoryBarrier) {
	...
	if vkCmdPipelineBarrier.fnHandle == nil {
		vkCmdPipelineBarrier.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPipelineBarrier")))
	}
	C.Trampoline12(vkCmdPipelineBarrier.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(srcStageMask)), C.uintptr_t(uintptr(dstStageMask)), C.uintptr_t(uintptr(dependencyFlags)), C.uintptr_t(uintptr(memoryBarrierCount)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryBarriers))), C.uintptr_t(uintptr(bufferMemoryBarrierCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBufferMemoryBarriers))), C.uintptr_t(uintptr(imageMemoryBarrierCount)), C.uintptr_t(uintptr(unsafe.Pointer(pImageMemoryBarriers))), 0, 0)
...
func CmdPipelineBarrier2(commandBuffer CommandBuffer, dependencyInfo *DependencyInfo) {
	...
	if vkCmdPipelineBarrier2.fnHandle == nil {
		vkCmdPipelineBarrier2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPipelineBarrier2")))
	}
	C.Trampoline3(vkCmdPipelineBarrier2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pDependencyInfo))), 0)
...
func CmdPreprocessGeneratedCommandsNV(commandBuffer CommandBuffer, generatedCommandsInfo *GeneratedCommandsInfoNV) {
	...
	if vkCmdPreprocessGeneratedCommandsNV.fnHandle == nil {
		vkCmdPreprocessGeneratedCommandsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPreprocessGeneratedCommandsNV")))
	}
	C.Trampoline3(vkCmdPreprocessGeneratedCommandsNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pGeneratedCommandsInfo))), 0)
...
func CmdPushConstants(commandBuffer CommandBuffer, layout PipelineLayout, stageFlags ShaderStageFlags, offset uint32, values []byte) {
	...
	if vkCmdPushConstants.fnHandle == nil {
		vkCmdPushConstants.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPushConstants")))
	}
	C.Trampoline6(vkCmdPushConstants.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(stageFlags)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(size)), C.uintptr_t(uintptr(unsafe.Pointer(pValues))))
...
func CmdPushConstants2KHR(commandBuffer CommandBuffer, pushConstantsInfo *PushConstantsInfoKHR) {
	...
	if vkCmdPushConstants2KHR.fnHandle == nil {
		vkCmdPushConstants2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPushConstants2KHR")))
	}
	C.Trampoline3(vkCmdPushConstants2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pPushConstantsInfo))), 0)
...
func CmdPushDescriptorSet2KHR(commandBuffer CommandBuffer, pushDescriptorSetInfo *PushDescriptorSetInfoKHR) {
	...
	if vkCmdPushDescriptorSet2KHR.fnHandle == nil {
		vkCmdPushDescriptorSet2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPushDescriptorSet2KHR")))
	}
	C.Trampoline3(vkCmdPushDescriptorSet2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pPushDescriptorSetInfo))), 0)
...
func CmdPushDescriptorSetKHR(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, layout PipelineLayout, set uint32, descriptorWrites []WriteDescriptorSet) {
	...
	if vkCmdPushDescriptorSetKHR.fnHandle == nil {
		vkCmdPushDescriptorSetKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPushDescriptorSetKHR")))
	}
	C.Trampoline6(vkCmdPushDescriptorSetKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineBindPoint)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(set)), C.uintptr_t(uintptr(descriptorWriteCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptorWrites))))
...
func CmdPushDescriptorSetWithTemplate2KHR(commandBuffer CommandBuffer, pushDescriptorSetWithTemplateInfo *PushDescriptorSetWithTemplateInfoKHR) {
	...
	if vkCmdPushDescriptorSetWithTemplate2KHR.fnHandle == nil {
		vkCmdPushDescriptorSetWithTemplate2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPushDescriptorSetWithTemplate2KHR")))
	}
	C.Trampoline3(vkCmdPushDescriptorSetWithTemplate2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pPushDescriptorSetWithTemplateInfo))), 0)
...
func CmdPushDescriptorSetWithTemplateKHR(commandBuffer CommandBuffer, descriptorUpdateTemplate DescriptorUpdateTemplate, layout PipelineLayout, set uint32, data *byte) {
	...
	if vkCmdPushDescriptorSetWithTemplateKHR.fnHandle == nil {
		vkCmdPushDescriptorSetWithTemplateKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdPushDescriptorSetWithTemplateKHR")))
	}
	C.Trampoline6(vkCmdPushDescriptorSetWithTemplateKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(descriptorUpdateTemplate)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(set)), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0)
...
func CmdRefreshObjectsKHR(commandBuffer CommandBuffer, refreshObjects *RefreshObjectListKHR) {
	...
	if vkCmdRefreshObjectsKHR.fnHandle == nil {
		vkCmdRefreshObjectsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdRefreshObjectsKHR")))
	}
	C.Trampoline3(vkCmdRefreshObjectsKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pRefreshObjects))), 0)
...
func CmdResetEvent(commandBuffer CommandBuffer, event Event, stageMask PipelineStageFlags) {
	...
	if vkCmdResetEvent.fnHandle == nil {
		vkCmdResetEvent.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdResetEvent")))
	}
	C.Trampoline3(vkCmdResetEvent.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(event)), C.uintptr_t(uintptr(stageMask)))
...
func CmdResetEvent2(commandBuffer CommandBuffer, event Event, stageMask PipelineStageFlags2) {
	...
	if vkCmdResetEvent2.fnHandle == nil {
		vkCmdResetEvent2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdResetEvent2")))
	}
	C.Trampoline3(vkCmdResetEvent2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(event)), C.uintptr_t(uintptr(stageMask)))
...
func CmdResetQueryPool(commandBuffer CommandBuffer, queryPool QueryPool, firstQuery uint32, queryCount uint32) {
	...
	if vkCmdResetQueryPool.fnHandle == nil {
		vkCmdResetQueryPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdResetQueryPool")))
	}
	C.Trampoline6(vkCmdResetQueryPool.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(firstQuery)), C.uintptr_t(uintptr(queryCount)), 0, 0)
...
func CmdResolveImage(commandBuffer CommandBuffer, srcImage Image, srcImageLayout ImageLayout, dstImage Image, dstImageLayout ImageLayout, regions []ImageResolve) {
	...
	if vkCmdResolveImage.fnHandle == nil {
		vkCmdResolveImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdResolveImage")))
	}
	C.Trampoline9(vkCmdResolveImage.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(srcImage)), C.uintptr_t(uintptr(srcImageLayout)), C.uintptr_t(uintptr(dstImage)), C.uintptr_t(uintptr(dstImageLayout)), C.uintptr_t(uintptr(regionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pRegions))), 0, 0)
...
func CmdResolveImage2(commandBuffer CommandBuffer, resolveImageInfo *ResolveImageInfo2) {
	...
	if vkCmdResolveImage2.fnHandle == nil {
		vkCmdResolveImage2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdResolveImage2")))
	}
	C.Trampoline3(vkCmdResolveImage2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pResolveImageInfo))), 0)
...
func CmdSetAlphaToCoverageEnableEXT(commandBuffer CommandBuffer, alphaToCoverageEnable bool) {
	...
	if vkCmdSetAlphaToCoverageEnableEXT.fnHandle == nil {
		vkCmdSetAlphaToCoverageEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetAlphaToCoverageEnableEXT")))
	}
	C.Trampoline3(vkCmdSetAlphaToCoverageEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(alphaToCoverageEnable_Bool32)), 0)
...
func CmdSetAlphaToOneEnableEXT(commandBuffer CommandBuffer, alphaToOneEnable bool) {
	...
	if vkCmdSetAlphaToOneEnableEXT.fnHandle == nil {
		vkCmdSetAlphaToOneEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetAlphaToOneEnableEXT")))
	}
	C.Trampoline3(vkCmdSetAlphaToOneEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(alphaToOneEnable_Bool32)), 0)
...
func CmdSetAttachmentFeedbackLoopEnableEXT(commandBuffer CommandBuffer, aspectMask ImageAspectFlags) {
	...
	if vkCmdSetAttachmentFeedbackLoopEnableEXT.fnHandle == nil {
		vkCmdSetAttachmentFeedbackLoopEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetAttachmentFeedbackLoopEnableEXT")))
	}
	C.Trampoline3(vkCmdSetAttachmentFeedbackLoopEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(aspectMask)), 0)
...
func CmdSetBlendConstants(commandBuffer CommandBuffer, blendConstants float32) {
	...
	if vkCmdSetBlendConstants.fnHandle == nil {
		vkCmdSetBlendConstants.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetBlendConstants")))
	}
	C.Trampoline3(vkCmdSetBlendConstants.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(blendConstants)), 0)
...
func CmdSetCheckpointNV(commandBuffer CommandBuffer, checkpointMarker *byte) {
	...
	if vkCmdSetCheckpointNV.fnHandle == nil {
		vkCmdSetCheckpointNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCheckpointNV")))
	}
	C.Trampoline3(vkCmdSetCheckpointNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pCheckpointMarker))), 0)
...
func CmdSetCoarseSampleOrderNV(commandBuffer CommandBuffer, sampleOrderType CoarseSampleOrderTypeNV, customSampleOrders []CoarseSampleOrderCustomNV) {
	...
	if vkCmdSetCoarseSampleOrderNV.fnHandle == nil {
		vkCmdSetCoarseSampleOrderNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCoarseSampleOrderNV")))
	}
	C.Trampoline6(vkCmdSetCoarseSampleOrderNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(sampleOrderType)), C.uintptr_t(uintptr(customSampleOrderCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCustomSampleOrders))), 0, 0)
...
func CmdSetColorBlendAdvancedEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorBlendAdvanced []ColorBlendAdvancedEXT) {
	...
	if vkCmdSetColorBlendAdvancedEXT.fnHandle == nil {
		vkCmdSetColorBlendAdvancedEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetColorBlendAdvancedEXT")))
	}
	C.Trampoline6(vkCmdSetColorBlendAdvancedEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstAttachment)), C.uintptr_t(uintptr(attachmentCount)), C.uintptr_t(uintptr(unsafe.Pointer(pColorBlendAdvanced))), 0, 0)
...
func CmdSetColorBlendEnableEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorBlendEnables []bool) {
	...
	if vkCmdSetColorBlendEnableEXT.fnHandle == nil {
		vkCmdSetColorBlendEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetColorBlendEnableEXT")))
	}
	C.Trampoline6(vkCmdSetColorBlendEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstAttachment)), C.uintptr_t(uintptr(attachmentCount)), C.uintptr_t(uintptr(unsafe.Pointer(pColorBlendEnables))), 0, 0)
...
func CmdSetColorBlendEquationEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorBlendEquations []ColorBlendEquationEXT) {
	...
	if vkCmdSetColorBlendEquationEXT.fnHandle == nil {
		vkCmdSetColorBlendEquationEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetColorBlendEquationEXT")))
	}
	C.Trampoline6(vkCmdSetColorBlendEquationEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstAttachment)), C.uintptr_t(uintptr(attachmentCount)), C.uintptr_t(uintptr(unsafe.Pointer(pColorBlendEquations))), 0, 0)
...
func CmdSetColorWriteEnableEXT(commandBuffer CommandBuffer, colorWriteEnables []bool) {
	...
	if vkCmdSetColorWriteEnableEXT.fnHandle == nil {
		vkCmdSetColorWriteEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetColorWriteEnableEXT")))
	}
	C.Trampoline3(vkCmdSetColorWriteEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(attachmentCount)), C.uintptr_t(uintptr(unsafe.Pointer(pColorWriteEnables))))
...
func CmdSetColorWriteMaskEXT(commandBuffer CommandBuffer, firstAttachment uint32, colorWriteMasks []ColorComponentFlags) {
	...
	if vkCmdSetColorWriteMaskEXT.fnHandle == nil {
		vkCmdSetColorWriteMaskEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetColorWriteMaskEXT")))
	}
	C.Trampoline6(vkCmdSetColorWriteMaskEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstAttachment)), C.uintptr_t(uintptr(attachmentCount)), C.uintptr_t(uintptr(unsafe.Pointer(pColorWriteMasks))), 0, 0)
...
func CmdSetConservativeRasterizationModeEXT(commandBuffer CommandBuffer, conservativeRasterizationMode ConservativeRasterizationModeEXT) {
	...
	if vkCmdSetConservativeRasterizationModeEXT.fnHandle == nil {
		vkCmdSetConservativeRasterizationModeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetConservativeRasterizationModeEXT")))
	}
	C.Trampoline3(vkCmdSetConservativeRasterizationModeEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(conservativeRasterizationMode)), 0)
...
func CmdSetCoverageModulationModeNV(commandBuffer CommandBuffer, coverageModulationMode CoverageModulationModeNV) {
	...
	if vkCmdSetCoverageModulationModeNV.fnHandle == nil {
		vkCmdSetCoverageModulationModeNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCoverageModulationModeNV")))
	}
	C.Trampoline3(vkCmdSetCoverageModulationModeNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(coverageModulationMode)), 0)
...
func CmdSetCoverageModulationTableEnableNV(commandBuffer CommandBuffer, coverageModulationTableEnable bool) {
	...
	if vkCmdSetCoverageModulationTableEnableNV.fnHandle == nil {
		vkCmdSetCoverageModulationTableEnableNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCoverageModulationTableEnableNV")))
	}
	C.Trampoline3(vkCmdSetCoverageModulationTableEnableNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(coverageModulationTableEnable_Bool32)), 0)
...
func CmdSetCoverageModulationTableNV(commandBuffer CommandBuffer, coverageModulationTable []float32) {
	...
	if vkCmdSetCoverageModulationTableNV.fnHandle == nil {
		vkCmdSetCoverageModulationTableNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCoverageModulationTableNV")))
	}
	C.Trampoline3(vkCmdSetCoverageModulationTableNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(coverageModulationTableCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCoverageModulationTable))))
...
func CmdSetCoverageReductionModeNV(commandBuffer CommandBuffer, coverageReductionMode CoverageReductionModeNV) {
	...
	if vkCmdSetCoverageReductionModeNV.fnHandle == nil {
		vkCmdSetCoverageReductionModeNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCoverageReductionModeNV")))
	}
	C.Trampoline3(vkCmdSetCoverageReductionModeNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(coverageReductionMode)), 0)
...
func CmdSetCoverageToColorEnableNV(commandBuffer CommandBuffer, coverageToColorEnable bool) {
	...
	if vkCmdSetCoverageToColorEnableNV.fnHandle == nil {
		vkCmdSetCoverageToColorEnableNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCoverageToColorEnableNV")))
	}
	C.Trampoline3(vkCmdSetCoverageToColorEnableNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(coverageToColorEnable_Bool32)), 0)
...
func CmdSetCoverageToColorLocationNV(commandBuffer CommandBuffer, coverageToColorLocation uint32) {
	...
	if vkCmdSetCoverageToColorLocationNV.fnHandle == nil {
		vkCmdSetCoverageToColorLocationNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCoverageToColorLocationNV")))
	}
	C.Trampoline3(vkCmdSetCoverageToColorLocationNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(coverageToColorLocation)), 0)
...
func CmdSetCullMode(commandBuffer CommandBuffer, cullMode CullModeFlags) {
	...
	if vkCmdSetCullMode.fnHandle == nil {
		vkCmdSetCullMode.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetCullMode")))
	}
	C.Trampoline3(vkCmdSetCullMode.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(cullMode)), 0)
...
func CmdSetDepthBias(commandBuffer CommandBuffer, depthBiasConstantFactor float32, depthBiasClamp float32, depthBiasSlopeFactor float32) {
	...
	if vkCmdSetDepthBias.fnHandle == nil {
		vkCmdSetDepthBias.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthBias")))
	}
	C.Trampoline6(vkCmdSetDepthBias.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthBiasConstantFactor)), C.uintptr_t(uintptr(depthBiasClamp)), C.uintptr_t(uintptr(depthBiasSlopeFactor)), 0, 0)
...
func CmdSetDepthBias2EXT(commandBuffer CommandBuffer, depthBiasInfo *DepthBiasInfoEXT) {
	...
	if vkCmdSetDepthBias2EXT.fnHandle == nil {
		vkCmdSetDepthBias2EXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthBias2EXT")))
	}
	C.Trampoline3(vkCmdSetDepthBias2EXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pDepthBiasInfo))), 0)
...
func CmdSetDepthBiasEnable(commandBuffer CommandBuffer, depthBiasEnable bool) {
	...
	if vkCmdSetDepthBiasEnable.fnHandle == nil {
		vkCmdSetDepthBiasEnable.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthBiasEnable")))
	}
	C.Trampoline3(vkCmdSetDepthBiasEnable.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthBiasEnable_Bool32)), 0)
...
func CmdSetDepthBounds(commandBuffer CommandBuffer, minDepthBounds float32, maxDepthBounds float32) {
	...
	if vkCmdSetDepthBounds.fnHandle == nil {
		vkCmdSetDepthBounds.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthBounds")))
	}
	C.Trampoline3(vkCmdSetDepthBounds.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(minDepthBounds)), C.uintptr_t(uintptr(maxDepthBounds)))
...
func CmdSetDepthBoundsTestEnable(commandBuffer CommandBuffer, depthBoundsTestEnable bool) {
	...
	if vkCmdSetDepthBoundsTestEnable.fnHandle == nil {
		vkCmdSetDepthBoundsTestEnable.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthBoundsTestEnable")))
	}
	C.Trampoline3(vkCmdSetDepthBoundsTestEnable.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthBoundsTestEnable_Bool32)), 0)
...
func CmdSetDepthClampEnableEXT(commandBuffer CommandBuffer, depthClampEnable bool) {
	...
	if vkCmdSetDepthClampEnableEXT.fnHandle == nil {
		vkCmdSetDepthClampEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthClampEnableEXT")))
	}
	C.Trampoline3(vkCmdSetDepthClampEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthClampEnable_Bool32)), 0)
...
func CmdSetDepthClipEnableEXT(commandBuffer CommandBuffer, depthClipEnable bool) {
	...
	if vkCmdSetDepthClipEnableEXT.fnHandle == nil {
		vkCmdSetDepthClipEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthClipEnableEXT")))
	}
	C.Trampoline3(vkCmdSetDepthClipEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthClipEnable_Bool32)), 0)
...
func CmdSetDepthClipNegativeOneToOneEXT(commandBuffer CommandBuffer, negativeOneToOne bool) {
	...
	if vkCmdSetDepthClipNegativeOneToOneEXT.fnHandle == nil {
		vkCmdSetDepthClipNegativeOneToOneEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthClipNegativeOneToOneEXT")))
	}
	C.Trampoline3(vkCmdSetDepthClipNegativeOneToOneEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(negativeOneToOne_Bool32)), 0)
...
func CmdSetDepthCompareOp(commandBuffer CommandBuffer, depthCompareOp CompareOp) {
	...
	if vkCmdSetDepthCompareOp.fnHandle == nil {
		vkCmdSetDepthCompareOp.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthCompareOp")))
	}
	C.Trampoline3(vkCmdSetDepthCompareOp.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthCompareOp)), 0)
...
func CmdSetDepthTestEnable(commandBuffer CommandBuffer, depthTestEnable bool) {
	...
	if vkCmdSetDepthTestEnable.fnHandle == nil {
		vkCmdSetDepthTestEnable.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthTestEnable")))
	}
	C.Trampoline3(vkCmdSetDepthTestEnable.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthTestEnable_Bool32)), 0)
...
func CmdSetDepthWriteEnable(commandBuffer CommandBuffer, depthWriteEnable bool) {
	...
	if vkCmdSetDepthWriteEnable.fnHandle == nil {
		vkCmdSetDepthWriteEnable.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDepthWriteEnable")))
	}
	C.Trampoline3(vkCmdSetDepthWriteEnable.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(depthWriteEnable_Bool32)), 0)
...
func CmdSetDescriptorBufferOffsets2EXT(commandBuffer CommandBuffer, setDescriptorBufferOffsetsInfo *SetDescriptorBufferOffsetsInfoEXT) {
	...
	if vkCmdSetDescriptorBufferOffsets2EXT.fnHandle == nil {
		vkCmdSetDescriptorBufferOffsets2EXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDescriptorBufferOffsets2EXT")))
	}
	C.Trampoline3(vkCmdSetDescriptorBufferOffsets2EXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pSetDescriptorBufferOffsetsInfo))), 0)
...
func CmdSetDescriptorBufferOffsetsEXT(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, layout PipelineLayout, firstSet uint32, bufferIndices []uint32, offsets []DeviceSize) {
	...
	if vkCmdSetDescriptorBufferOffsetsEXT.fnHandle == nil {
		vkCmdSetDescriptorBufferOffsetsEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDescriptorBufferOffsetsEXT")))
	}
	C.Trampoline9(vkCmdSetDescriptorBufferOffsetsEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineBindPoint)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(firstSet)), C.uintptr_t(uintptr(setCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBufferIndices))), C.uintptr_t(uintptr(unsafe.Pointer(pOffsets))), 0, 0)
...
func CmdSetDeviceMask(commandBuffer CommandBuffer, deviceMask uint32) {
	...
	if vkCmdSetDeviceMask.fnHandle == nil {
		vkCmdSetDeviceMask.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDeviceMask")))
	}
	C.Trampoline3(vkCmdSetDeviceMask.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(deviceMask)), 0)
...
func CmdSetDiscardRectangleEXT(commandBuffer CommandBuffer, firstDiscardRectangle uint32, discardRectangles []Rect2D) {
	...
	if vkCmdSetDiscardRectangleEXT.fnHandle == nil {
		vkCmdSetDiscardRectangleEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDiscardRectangleEXT")))
	}
	C.Trampoline6(vkCmdSetDiscardRectangleEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstDiscardRectangle)), C.uintptr_t(uintptr(discardRectangleCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDiscardRectangles))), 0, 0)
...
func CmdSetDiscardRectangleEnableEXT(commandBuffer CommandBuffer, discardRectangleEnable bool) {
	...
	if vkCmdSetDiscardRectangleEnableEXT.fnHandle == nil {
		vkCmdSetDiscardRectangleEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDiscardRectangleEnableEXT")))
	}
	C.Trampoline3(vkCmdSetDiscardRectangleEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(discardRectangleEnable_Bool32)), 0)
...
func CmdSetDiscardRectangleModeEXT(commandBuffer CommandBuffer, discardRectangleMode DiscardRectangleModeEXT) {
	...
	if vkCmdSetDiscardRectangleModeEXT.fnHandle == nil {
		vkCmdSetDiscardRectangleModeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetDiscardRectangleModeEXT")))
	}
	C.Trampoline3(vkCmdSetDiscardRectangleModeEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(discardRectangleMode)), 0)
...
func CmdSetEvent(commandBuffer CommandBuffer, event Event, stageMask PipelineStageFlags) {
	...
	if vkCmdSetEvent.fnHandle == nil {
		vkCmdSetEvent.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetEvent")))
	}
	C.Trampoline3(vkCmdSetEvent.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(event)), C.uintptr_t(uintptr(stageMask)))
...
func CmdSetEvent2(commandBuffer CommandBuffer, event Event, dependencyInfo *DependencyInfo) {
	...
	if vkCmdSetEvent2.fnHandle == nil {
		vkCmdSetEvent2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetEvent2")))
	}
	C.Trampoline3(vkCmdSetEvent2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(event)), C.uintptr_t(uintptr(unsafe.Pointer(pDependencyInfo))))
...
func CmdSetExclusiveScissorEnableNV(commandBuffer CommandBuffer, firstExclusiveScissor uint32, exclusiveScissorEnables []bool) {
	...
	if vkCmdSetExclusiveScissorEnableNV.fnHandle == nil {
		vkCmdSetExclusiveScissorEnableNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetExclusiveScissorEnableNV")))
	}
	C.Trampoline6(vkCmdSetExclusiveScissorEnableNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstExclusiveScissor)), C.uintptr_t(uintptr(exclusiveScissorCount)), C.uintptr_t(uintptr(unsafe.Pointer(pExclusiveScissorEnables))), 0, 0)
...
func CmdSetExclusiveScissorNV(commandBuffer CommandBuffer, firstExclusiveScissor uint32, exclusiveScissors []Rect2D) {
	...
	if vkCmdSetExclusiveScissorNV.fnHandle == nil {
		vkCmdSetExclusiveScissorNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetExclusiveScissorNV")))
	}
	C.Trampoline6(vkCmdSetExclusiveScissorNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstExclusiveScissor)), C.uintptr_t(uintptr(exclusiveScissorCount)), C.uintptr_t(uintptr(unsafe.Pointer(pExclusiveScissors))), 0, 0)
...
func CmdSetExtraPrimitiveOverestimationSizeEXT(commandBuffer CommandBuffer, extraPrimitiveOverestimationSize float32) {
	...
	if vkCmdSetExtraPrimitiveOverestimationSizeEXT.fnHandle == nil {
		vkCmdSetExtraPrimitiveOverestimationSizeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetExtraPrimitiveOverestimationSizeEXT")))
	}
	C.Trampoline3(vkCmdSetExtraPrimitiveOverestimationSizeEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(extraPrimitiveOverestimationSize)), 0)
...
func CmdSetFragmentShadingRateEnumNV(commandBuffer CommandBuffer, shadingRate FragmentShadingRateNV, combinerOps FragmentShadingRateCombinerOpKHR) {
	...
	if vkCmdSetFragmentShadingRateEnumNV.fnHandle == nil {
		vkCmdSetFragmentShadingRateEnumNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetFragmentShadingRateEnumNV")))
	}
	C.Trampoline3(vkCmdSetFragmentShadingRateEnumNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(shadingRate)), C.uintptr_t(uintptr(combinerOps)))
...
func CmdSetFragmentShadingRateKHR(commandBuffer CommandBuffer, fragmentSize *Extent2D, combinerOps FragmentShadingRateCombinerOpKHR) {
	...
	if vkCmdSetFragmentShadingRateKHR.fnHandle == nil {
		vkCmdSetFragmentShadingRateKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetFragmentShadingRateKHR")))
	}
	C.Trampoline3(vkCmdSetFragmentShadingRateKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pFragmentSize))), C.uintptr_t(uintptr(combinerOps)))
...
func CmdSetFrontFace(commandBuffer CommandBuffer, frontFace FrontFace) {
	...
	if vkCmdSetFrontFace.fnHandle == nil {
		vkCmdSetFrontFace.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetFrontFace")))
	}
	C.Trampoline3(vkCmdSetFrontFace.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(frontFace)), 0)
...
func CmdSetLineRasterizationModeEXT(commandBuffer CommandBuffer, lineRasterizationMode LineRasterizationModeEXT) {
	...
	if vkCmdSetLineRasterizationModeEXT.fnHandle == nil {
		vkCmdSetLineRasterizationModeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetLineRasterizationModeEXT")))
	}
	C.Trampoline3(vkCmdSetLineRasterizationModeEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(lineRasterizationMode)), 0)
...
func CmdSetLineStippleEnableEXT(commandBuffer CommandBuffer, stippledLineEnable bool) {
	...
	if vkCmdSetLineStippleEnableEXT.fnHandle == nil {
		vkCmdSetLineStippleEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetLineStippleEnableEXT")))
	}
	C.Trampoline3(vkCmdSetLineStippleEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(stippledLineEnable_Bool32)), 0)
...
func CmdSetLineStippleKHR(commandBuffer CommandBuffer, lineStippleFactor uint32, lineStipplePattern uint16) {
	...
	if vkCmdSetLineStippleKHR.fnHandle == nil {
		vkCmdSetLineStippleKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetLineStippleKHR")))
	}
	C.Trampoline3(vkCmdSetLineStippleKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(lineStippleFactor)), C.uintptr_t(uintptr(lineStipplePattern)))
...
func CmdSetLineWidth(commandBuffer CommandBuffer, lineWidth float32) {
	...
	if vkCmdSetLineWidth.fnHandle == nil {
		vkCmdSetLineWidth.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetLineWidth")))
	}
	C.Trampoline3(vkCmdSetLineWidth.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(lineWidth)), 0)
...
func CmdSetLogicOpEXT(commandBuffer CommandBuffer, logicOp LogicOp) {
	...
	if vkCmdSetLogicOpEXT.fnHandle == nil {
		vkCmdSetLogicOpEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetLogicOpEXT")))
	}
	C.Trampoline3(vkCmdSetLogicOpEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(logicOp)), 0)
...
func CmdSetLogicOpEnableEXT(commandBuffer CommandBuffer, logicOpEnable bool) {
	...
	if vkCmdSetLogicOpEnableEXT.fnHandle == nil {
		vkCmdSetLogicOpEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetLogicOpEnableEXT")))
	}
	C.Trampoline3(vkCmdSetLogicOpEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(logicOpEnable_Bool32)), 0)
...
func CmdSetPatchControlPointsEXT(commandBuffer CommandBuffer, patchControlPoints uint32) {
	...
	if vkCmdSetPatchControlPointsEXT.fnHandle == nil {
		vkCmdSetPatchControlPointsEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPatchControlPointsEXT")))
	}
	C.Trampoline3(vkCmdSetPatchControlPointsEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(patchControlPoints)), 0)
...
func CmdSetPerformanceMarkerINTEL(commandBuffer CommandBuffer, markerInfo *PerformanceMarkerInfoINTEL) (r error) {
	...
	if vkCmdSetPerformanceMarkerINTEL.fnHandle == nil {
		vkCmdSetPerformanceMarkerINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPerformanceMarkerINTEL")))
	}
	rsys = C.Trampoline3(vkCmdSetPerformanceMarkerINTEL.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pMarkerInfo))), 0)
	r = Result(uintptr(rsys))
...
func CmdSetPerformanceOverrideINTEL(commandBuffer CommandBuffer, overrideInfo *PerformanceOverrideInfoINTEL) (r error) {
	...
	if vkCmdSetPerformanceOverrideINTEL.fnHandle == nil {
		vkCmdSetPerformanceOverrideINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPerformanceOverrideINTEL")))
	}
	rsys = C.Trampoline3(vkCmdSetPerformanceOverrideINTEL.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pOverrideInfo))), 0)
	r = Result(uintptr(rsys))
...
func CmdSetPerformanceStreamMarkerINTEL(commandBuffer CommandBuffer, markerInfo *PerformanceStreamMarkerInfoINTEL) (r error) {
	...
	if vkCmdSetPerformanceStreamMarkerINTEL.fnHandle == nil {
		vkCmdSetPerformanceStreamMarkerINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPerformanceStreamMarkerINTEL")))
	}
	rsys = C.Trampoline3(vkCmdSetPerformanceStreamMarkerINTEL.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pMarkerInfo))), 0)
	r = Result(uintptr(rsys))
...
func CmdSetPolygonModeEXT(commandBuffer CommandBuffer, polygonMode PolygonMode) {
	...
	if vkCmdSetPolygonModeEXT.fnHandle == nil {
		vkCmdSetPolygonModeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPolygonModeEXT")))
	}
	C.Trampoline3(vkCmdSetPolygonModeEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(polygonMode)), 0)
...
func CmdSetPrimitiveRestartEnable(commandBuffer CommandBuffer, primitiveRestartEnable bool) {
	...
	if vkCmdSetPrimitiveRestartEnable.fnHandle == nil {
		vkCmdSetPrimitiveRestartEnable.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPrimitiveRestartEnable")))
	}
	C.Trampoline3(vkCmdSetPrimitiveRestartEnable.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(primitiveRestartEnable_Bool32)), 0)
...
func CmdSetPrimitiveTopology(commandBuffer CommandBuffer, primitiveTopology PrimitiveTopology) {
	...
	if vkCmdSetPrimitiveTopology.fnHandle == nil {
		vkCmdSetPrimitiveTopology.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetPrimitiveTopology")))
	}
	C.Trampoline3(vkCmdSetPrimitiveTopology.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(primitiveTopology)), 0)
...
func CmdSetProvokingVertexModeEXT(commandBuffer CommandBuffer, provokingVertexMode ProvokingVertexModeEXT) {
	...
	if vkCmdSetProvokingVertexModeEXT.fnHandle == nil {
		vkCmdSetProvokingVertexModeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetProvokingVertexModeEXT")))
	}
	C.Trampoline3(vkCmdSetProvokingVertexModeEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(provokingVertexMode)), 0)
...
func CmdSetRasterizationSamplesEXT(commandBuffer CommandBuffer, rasterizationSamples SampleCountFlagBits) {
	...
	if vkCmdSetRasterizationSamplesEXT.fnHandle == nil {
		vkCmdSetRasterizationSamplesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRasterizationSamplesEXT")))
	}
	C.Trampoline3(vkCmdSetRasterizationSamplesEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(rasterizationSamples)), 0)
...
func CmdSetRasterizationStreamEXT(commandBuffer CommandBuffer, rasterizationStream uint32) {
	...
	if vkCmdSetRasterizationStreamEXT.fnHandle == nil {
		vkCmdSetRasterizationStreamEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRasterizationStreamEXT")))
	}
	C.Trampoline3(vkCmdSetRasterizationStreamEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(rasterizationStream)), 0)
...
func CmdSetRasterizerDiscardEnable(commandBuffer CommandBuffer, rasterizerDiscardEnable bool) {
	...
	if vkCmdSetRasterizerDiscardEnable.fnHandle == nil {
		vkCmdSetRasterizerDiscardEnable.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRasterizerDiscardEnable")))
	}
	C.Trampoline3(vkCmdSetRasterizerDiscardEnable.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(rasterizerDiscardEnable_Bool32)), 0)
...
func CmdSetRayTracingPipelineStackSizeKHR(commandBuffer CommandBuffer, pipelineStackSize uint32) {
	...
	if vkCmdSetRayTracingPipelineStackSizeKHR.fnHandle == nil {
		vkCmdSetRayTracingPipelineStackSizeKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRayTracingPipelineStackSizeKHR")))
	}
	C.Trampoline3(vkCmdSetRayTracingPipelineStackSizeKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineStackSize)), 0)
...
func CmdSetRenderingAttachmentLocationsKHR(commandBuffer CommandBuffer, locationInfo *RenderingAttachmentLocationInfoKHR) {
	...
	if vkCmdSetRenderingAttachmentLocationsKHR.fnHandle == nil {
		vkCmdSetRenderingAttachmentLocationsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRenderingAttachmentLocationsKHR")))
	}
	C.Trampoline3(vkCmdSetRenderingAttachmentLocationsKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pLocationInfo))), 0)
...
func CmdSetRenderingInputAttachmentIndicesKHR(commandBuffer CommandBuffer, inputAttachmentIndexInfo *RenderingInputAttachmentIndexInfoKHR) {
	...
	if vkCmdSetRenderingInputAttachmentIndicesKHR.fnHandle == nil {
		vkCmdSetRenderingInputAttachmentIndicesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRenderingInputAttachmentIndicesKHR")))
	}
	C.Trampoline3(vkCmdSetRenderingInputAttachmentIndicesKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pInputAttachmentIndexInfo))), 0)
...
func CmdSetRepresentativeFragmentTestEnableNV(commandBuffer CommandBuffer, representativeFragmentTestEnable bool) {
	...
	if vkCmdSetRepresentativeFragmentTestEnableNV.fnHandle == nil {
		vkCmdSetRepresentativeFragmentTestEnableNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetRepresentativeFragmentTestEnableNV")))
	}
	C.Trampoline3(vkCmdSetRepresentativeFragmentTestEnableNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(representativeFragmentTestEnable_Bool32)), 0)
...
func CmdSetSampleLocationsEXT(commandBuffer CommandBuffer, sampleLocationsInfo *SampleLocationsInfoEXT) {
	...
	if vkCmdSetSampleLocationsEXT.fnHandle == nil {
		vkCmdSetSampleLocationsEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetSampleLocationsEXT")))
	}
	C.Trampoline3(vkCmdSetSampleLocationsEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pSampleLocationsInfo))), 0)
...
func CmdSetSampleLocationsEnableEXT(commandBuffer CommandBuffer, sampleLocationsEnable bool) {
	...
	if vkCmdSetSampleLocationsEnableEXT.fnHandle == nil {
		vkCmdSetSampleLocationsEnableEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetSampleLocationsEnableEXT")))
	}
	C.Trampoline3(vkCmdSetSampleLocationsEnableEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(sampleLocationsEnable_Bool32)), 0)
...
func CmdSetSampleMaskEXT(commandBuffer CommandBuffer, samples SampleCountFlagBits, sampleMask []SampleMask) {
	...
	if vkCmdSetSampleMaskEXT.fnHandle == nil {
		vkCmdSetSampleMaskEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetSampleMaskEXT")))
	}
	C.Trampoline3(vkCmdSetSampleMaskEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(samples)), C.uintptr_t(uintptr(unsafe.Pointer(pSampleMask))))
...
func CmdSetScissor(commandBuffer CommandBuffer, firstScissor uint32, scissors []Rect2D) {
	...
	if vkCmdSetScissor.fnHandle == nil {
		vkCmdSetScissor.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetScissor")))
	}
	C.Trampoline6(vkCmdSetScissor.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstScissor)), C.uintptr_t(uintptr(scissorCount)), C.uintptr_t(uintptr(unsafe.Pointer(pScissors))), 0, 0)
...
func CmdSetScissorWithCount(commandBuffer CommandBuffer, scissors []Rect2D) {
	...
	if vkCmdSetScissorWithCount.fnHandle == nil {
		vkCmdSetScissorWithCount.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetScissorWithCount")))
	}
	C.Trampoline3(vkCmdSetScissorWithCount.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(scissorCount)), C.uintptr_t(uintptr(unsafe.Pointer(pScissors))))
...
func CmdSetShadingRateImageEnableNV(commandBuffer CommandBuffer, shadingRateImageEnable bool) {
	...
	if vkCmdSetShadingRateImageEnableNV.fnHandle == nil {
		vkCmdSetShadingRateImageEnableNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetShadingRateImageEnableNV")))
	}
	C.Trampoline3(vkCmdSetShadingRateImageEnableNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(shadingRateImageEnable_Bool32)), 0)
...
func CmdSetStencilCompareMask(commandBuffer CommandBuffer, faceMask StencilFaceFlags, compareMask uint32) {
	...
	if vkCmdSetStencilCompareMask.fnHandle == nil {
		vkCmdSetStencilCompareMask.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetStencilCompareMask")))
	}
	C.Trampoline3(vkCmdSetStencilCompareMask.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(faceMask)), C.uintptr_t(uintptr(compareMask)))
...
func CmdSetStencilOp(commandBuffer CommandBuffer, faceMask StencilFaceFlags, failOp StencilOp, passOp StencilOp, depthFailOp StencilOp, compareOp CompareOp) {
	...
	if vkCmdSetStencilOp.fnHandle == nil {
		vkCmdSetStencilOp.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetStencilOp")))
	}
	C.Trampoline6(vkCmdSetStencilOp.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(faceMask)), C.uintptr_t(uintptr(failOp)), C.uintptr_t(uintptr(passOp)), C.uintptr_t(uintptr(depthFailOp)), C.uintptr_t(uintptr(compareOp)))
...
func CmdSetStencilReference(commandBuffer CommandBuffer, faceMask StencilFaceFlags, reference uint32) {
	...
	if vkCmdSetStencilReference.fnHandle == nil {
		vkCmdSetStencilReference.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetStencilReference")))
	}
	C.Trampoline3(vkCmdSetStencilReference.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(faceMask)), C.uintptr_t(uintptr(reference)))
...
func CmdSetStencilTestEnable(commandBuffer CommandBuffer, stencilTestEnable bool) {
	...
	if vkCmdSetStencilTestEnable.fnHandle == nil {
		vkCmdSetStencilTestEnable.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetStencilTestEnable")))
	}
	C.Trampoline3(vkCmdSetStencilTestEnable.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(stencilTestEnable_Bool32)), 0)
...
func CmdSetStencilWriteMask(commandBuffer CommandBuffer, faceMask StencilFaceFlags, writeMask uint32) {
	...
	if vkCmdSetStencilWriteMask.fnHandle == nil {
		vkCmdSetStencilWriteMask.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetStencilWriteMask")))
	}
	C.Trampoline3(vkCmdSetStencilWriteMask.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(faceMask)), C.uintptr_t(uintptr(writeMask)))
...
func CmdSetTessellationDomainOriginEXT(commandBuffer CommandBuffer, domainOrigin TessellationDomainOrigin) {
	...
	if vkCmdSetTessellationDomainOriginEXT.fnHandle == nil {
		vkCmdSetTessellationDomainOriginEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetTessellationDomainOriginEXT")))
	}
	C.Trampoline3(vkCmdSetTessellationDomainOriginEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(domainOrigin)), 0)
...
func CmdSetVertexInputEXT(commandBuffer CommandBuffer, vertexBindingDescriptions []VertexInputBindingDescription2EXT, vertexAttributeDescriptions []VertexInputAttributeDescription2EXT) {
	...
	if vkCmdSetVertexInputEXT.fnHandle == nil {
		vkCmdSetVertexInputEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetVertexInputEXT")))
	}
	C.Trampoline6(vkCmdSetVertexInputEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(vertexBindingDescriptionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pVertexBindingDescriptions))), C.uintptr_t(uintptr(vertexAttributeDescriptionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pVertexAttributeDescriptions))), 0)
...
func CmdSetViewport(commandBuffer CommandBuffer, firstViewport uint32, viewports []Viewport) {
	...
	if vkCmdSetViewport.fnHandle == nil {
		vkCmdSetViewport.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetViewport")))
	}
	C.Trampoline6(vkCmdSetViewport.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstViewport)), C.uintptr_t(uintptr(viewportCount)), C.uintptr_t(uintptr(unsafe.Pointer(pViewports))), 0, 0)
...
func CmdSetViewportShadingRatePaletteNV(commandBuffer CommandBuffer, firstViewport uint32, shadingRatePalettes []ShadingRatePaletteNV) {
	...
	if vkCmdSetViewportShadingRatePaletteNV.fnHandle == nil {
		vkCmdSetViewportShadingRatePaletteNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetViewportShadingRatePaletteNV")))
	}
	C.Trampoline6(vkCmdSetViewportShadingRatePaletteNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstViewport)), C.uintptr_t(uintptr(viewportCount)), C.uintptr_t(uintptr(unsafe.Pointer(pShadingRatePalettes))), 0, 0)
...
func CmdSetViewportSwizzleNV(commandBuffer CommandBuffer, firstViewport uint32, viewportSwizzles []ViewportSwizzleNV) {
	...
	if vkCmdSetViewportSwizzleNV.fnHandle == nil {
		vkCmdSetViewportSwizzleNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetViewportSwizzleNV")))
	}
	C.Trampoline6(vkCmdSetViewportSwizzleNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstViewport)), C.uintptr_t(uintptr(viewportCount)), C.uintptr_t(uintptr(unsafe.Pointer(pViewportSwizzles))), 0, 0)
...
func CmdSetViewportWScalingEnableNV(commandBuffer CommandBuffer, viewportWScalingEnable bool) {
	...
	if vkCmdSetViewportWScalingEnableNV.fnHandle == nil {
		vkCmdSetViewportWScalingEnableNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetViewportWScalingEnableNV")))
	}
	C.Trampoline3(vkCmdSetViewportWScalingEnableNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(viewportWScalingEnable_Bool32)), 0)
...
func CmdSetViewportWScalingNV(commandBuffer CommandBuffer, firstViewport uint32, viewportWScalings []ViewportWScalingNV) {
	...
	if vkCmdSetViewportWScalingNV.fnHandle == nil {
		vkCmdSetViewportWScalingNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetViewportWScalingNV")))
	}
	C.Trampoline6(vkCmdSetViewportWScalingNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(firstViewport)), C.uintptr_t(uintptr(viewportCount)), C.uintptr_t(uintptr(unsafe.Pointer(pViewportWScalings))), 0, 0)
...
func CmdSetViewportWithCount(commandBuffer CommandBuffer, viewports []Viewport) {
	...
	if vkCmdSetViewportWithCount.fnHandle == nil {
		vkCmdSetViewportWithCount.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSetViewportWithCount")))
	}
	C.Trampoline3(vkCmdSetViewportWithCount.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(viewportCount)), C.uintptr_t(uintptr(unsafe.Pointer(pViewports))))
...
func CmdSubpassShadingHUAWEI(commandBuffer CommandBuffer) {
	...
	if vkCmdSubpassShadingHUAWEI.fnHandle == nil {
		vkCmdSubpassShadingHUAWEI.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdSubpassShadingHUAWEI")))
	}
	C.Trampoline3(vkCmdSubpassShadingHUAWEI.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
...
func CmdTraceRaysIndirect2KHR(commandBuffer CommandBuffer, indirectDeviceAddress DeviceAddress) {
	...
	if vkCmdTraceRaysIndirect2KHR.fnHandle == nil {
		vkCmdTraceRaysIndirect2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdTraceRaysIndirect2KHR")))
	}
	C.Trampoline3(vkCmdTraceRaysIndirect2KHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(indirectDeviceAddress)), 0)
...
func CmdTraceRaysIndirectKHR(commandBuffer CommandBuffer, raygenShaderBindingTable *StridedDeviceAddressRegionKHR, missShaderBindingTable *StridedDeviceAddressRegionKHR, hitShaderBindingTable *StridedDeviceAddressRegionKHR, callableShaderBindingTable *StridedDeviceAddressRegionKHR, indirectDeviceAddress DeviceAddress) {
	...
	if vkCmdTraceRaysIndirectKHR.fnHandle == nil {
		vkCmdTraceRaysIndirectKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdTraceRaysIndirectKHR")))
	}
	C.Trampoline6(vkCmdTraceRaysIndirectKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pRaygenShaderBindingTable))), C.uintptr_t(uintptr(unsafe.Pointer(pMissShaderBindingTable))), C.uintptr_t(uintptr(unsafe.Pointer(pHitShaderBindingTable))), C.uintptr_t(uintptr(unsafe.Pointer(pCallableShaderBindingTable))), C.uintptr_t(uintptr(indirectDeviceAddress)))
...
func CmdTraceRaysKHR(commandBuffer CommandBuffer, raygenShaderBindingTable *StridedDeviceAddressRegionKHR, missShaderBindingTable *StridedDeviceAddressRegionKHR, hitShaderBindingTable *StridedDeviceAddressRegionKHR, callableShaderBindingTable *StridedDeviceAddressRegionKHR, width uint32, height uint32, depth uint32) {
	...
	if vkCmdTraceRaysKHR.fnHandle == nil {
		vkCmdTraceRaysKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdTraceRaysKHR")))
	}
	C.Trampoline9(vkCmdTraceRaysKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pRaygenShaderBindingTable))), C.uintptr_t(uintptr(unsafe.Pointer(pMissShaderBindingTable))), C.uintptr_t(uintptr(unsafe.Pointer(pHitShaderBindingTable))), C.uintptr_t(uintptr(unsafe.Pointer(pCallableShaderBindingTable))), C.uintptr_t(uintptr(width)), C.uintptr_t(uintptr(height)), C.uintptr_t(uintptr(depth)), 0)
...
func CmdTraceRaysNV(commandBuffer CommandBuffer, raygenShaderBindingTableBuffer Buffer, raygenShaderBindingOffset DeviceSize, missShaderBindingTableBuffer Buffer, missShaderBindingOffset DeviceSize, missShaderBindingStride DeviceSize, hitShaderBindingTableBuffer Buffer, hitShaderBindingOffset DeviceSize, hitShaderBindingStride DeviceSize, callableShaderBindingTableBuffer Buffer, callableShaderBindingOffset DeviceSize, callableShaderBindingStride DeviceSize, width uint32, height uint32, depth uint32) {
	...
	if vkCmdTraceRaysNV.fnHandle == nil {
		vkCmdTraceRaysNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdTraceRaysNV")))
	}
	C.Trampoline15(vkCmdTraceRaysNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(raygenShaderBindingTableBuffer)), C.uintptr_t(uintptr(raygenShaderBindingOffset)), C.uintptr_t(uintptr(missShaderBindingTableBuffer)), C.uintptr_t(uintptr(missShaderBindingOffset)), C.uintptr_t(uintptr(missShaderBindingStride)), C.uintptr_t(uintptr(hitShaderBindingTableBuffer)), C.uintptr_t(uintptr(hitShaderBindingOffset)), C.uintptr_t(uintptr(hitShaderBindingStride)), C.uintptr_t(uintptr(callableShaderBindingTableBuffer)), C.uintptr_t(uintptr(callableShaderBindingOffset)), C.uintptr_t(uintptr(callableShaderBindingStride)), C.uintptr_t(uintptr(width)), C.uintptr_t(uintptr(height)), C.uintptr_t(uintptr(depth)))
...
func CmdUpdateBuffer(commandBuffer CommandBuffer, dstBuffer Buffer, dstOffset DeviceSize, data []byte) {
	...
	if vkCmdUpdateBuffer.fnHandle == nil {
		vkCmdUpdateBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdUpdateBuffer")))
	}
	C.Trampoline6(vkCmdUpdateBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(dstBuffer)), C.uintptr_t(uintptr(dstOffset)), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0)
...
func CmdUpdatePipelineIndirectBufferNV(commandBuffer CommandBuffer, pipelineBindPoint PipelineBindPoint, pipeline Pipeline) {
	...
	if vkCmdUpdatePipelineIndirectBufferNV.fnHandle == nil {
		vkCmdUpdatePipelineIndirectBufferNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdUpdatePipelineIndirectBufferNV")))
	}
	C.Trampoline3(vkCmdUpdatePipelineIndirectBufferNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineBindPoint)), C.uintptr_t(uintptr(pipeline)))
...
func CmdWaitEvents(commandBuffer CommandBuffer, events []Event, srcStageMask PipelineStageFlags, dstStageMask PipelineStageFlags, memoryBarriers []MemoryBarrier, bufferMemoryBarriers []BufferMemoryBarrier, imageMemoryBarriers []ImageMemoryBarrier) {
	...
	if vkCmdWaitEvents.fnHandle == nil {
		vkCmdWaitEvents.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWaitEvents")))
	}
	C.Trampoline12(vkCmdWaitEvents.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(eventCount)), C.uintptr_t(uintptr(unsafe.Pointer(pEvents))), C.uintptr_t(uintptr(srcStageMask)), C.uintptr_t(uintptr(dstStageMask)), C.uintptr_t(uintptr(memoryBarrierCount)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryBarriers))), C.uintptr_t(uintptr(bufferMemoryBarrierCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBufferMemoryBarriers))), C.uintptr_t(uintptr(imageMemoryBarrierCount)), C.uintptr_t(uintptr(unsafe.Pointer(pImageMemoryBarriers))), 0)
...
func CmdWaitEvents2(commandBuffer CommandBuffer, events []Event, dependencyInfos []DependencyInfo) {
	...
	if vkCmdWaitEvents2.fnHandle == nil {
		vkCmdWaitEvents2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWaitEvents2")))
	}
	C.Trampoline6(vkCmdWaitEvents2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(eventCount)), C.uintptr_t(uintptr(unsafe.Pointer(pEvents))), C.uintptr_t(uintptr(unsafe.Pointer(pDependencyInfos))), 0, 0)
...
func CmdWriteAccelerationStructuresPropertiesKHR(commandBuffer CommandBuffer, accelerationStructures []AccelerationStructureKHR, queryType QueryType, queryPool QueryPool, firstQuery uint32) {
	...
	if vkCmdWriteAccelerationStructuresPropertiesKHR.fnHandle == nil {
		vkCmdWriteAccelerationStructuresPropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteAccelerationStructuresPropertiesKHR")))
	}
	C.Trampoline6(vkCmdWriteAccelerationStructuresPropertiesKHR.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(accelerationStructureCount)), C.uintptr_t(uintptr(unsafe.Pointer(pAccelerationStructures))), C.uintptr_t(uintptr(queryType)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(firstQuery)))
...
func CmdWriteAccelerationStructuresPropertiesNV(commandBuffer CommandBuffer, accelerationStructures []AccelerationStructureNV, queryType QueryType, queryPool QueryPool, firstQuery uint32) {
	...
	if vkCmdWriteAccelerationStructuresPropertiesNV.fnHandle == nil {
		vkCmdWriteAccelerationStructuresPropertiesNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteAccelerationStructuresPropertiesNV")))
	}
	C.Trampoline6(vkCmdWriteAccelerationStructuresPropertiesNV.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(accelerationStructureCount)), C.uintptr_t(uintptr(unsafe.Pointer(pAccelerationStructures))), C.uintptr_t(uintptr(queryType)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(firstQuery)))
...
func CmdWriteBufferMarker2AMD(commandBuffer CommandBuffer, stage PipelineStageFlags2, dstBuffer Buffer, dstOffset DeviceSize, marker uint32) {
	...
	if vkCmdWriteBufferMarker2AMD.fnHandle == nil {
		vkCmdWriteBufferMarker2AMD.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteBufferMarker2AMD")))
	}
	C.Trampoline6(vkCmdWriteBufferMarker2AMD.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(stage)), C.uintptr_t(uintptr(dstBuffer)), C.uintptr_t(uintptr(dstOffset)), C.uintptr_t(uintptr(marker)), 0)
...
func CmdWriteBufferMarkerAMD(commandBuffer CommandBuffer, pipelineStage PipelineStageFlagBits, dstBuffer Buffer, dstOffset DeviceSize, marker uint32) {
	...
	if vkCmdWriteBufferMarkerAMD.fnHandle == nil {
		vkCmdWriteBufferMarkerAMD.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteBufferMarkerAMD")))
	}
	C.Trampoline6(vkCmdWriteBufferMarkerAMD.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineStage)), C.uintptr_t(uintptr(dstBuffer)), C.uintptr_t(uintptr(dstOffset)), C.uintptr_t(uintptr(marker)), 0)
...
func CmdWriteMicromapsPropertiesEXT(commandBuffer CommandBuffer, micromaps []MicromapEXT, queryType QueryType, queryPool QueryPool, firstQuery uint32) {
	...
	if vkCmdWriteMicromapsPropertiesEXT.fnHandle == nil {
		vkCmdWriteMicromapsPropertiesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteMicromapsPropertiesEXT")))
	}
	C.Trampoline6(vkCmdWriteMicromapsPropertiesEXT.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(micromapCount)), C.uintptr_t(uintptr(unsafe.Pointer(pMicromaps))), C.uintptr_t(uintptr(queryType)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(firstQuery)))
...
func CmdWriteTimestamp(commandBuffer CommandBuffer, pipelineStage PipelineStageFlagBits, queryPool QueryPool, query uint32) {
	...
	if vkCmdWriteTimestamp.fnHandle == nil {
		vkCmdWriteTimestamp.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteTimestamp")))
	}
	C.Trampoline6(vkCmdWriteTimestamp.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(pipelineStage)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(query)), 0, 0)
...
func CmdWriteTimestamp2(commandBuffer CommandBuffer, stage PipelineStageFlags2, queryPool QueryPool, query uint32) {
	...
	if vkCmdWriteTimestamp2.fnHandle == nil {
		vkCmdWriteTimestamp2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCmdWriteTimestamp2")))
	}
	C.Trampoline6(vkCmdWriteTimestamp2.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(stage)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(query)), 0, 0)
...
func CompileDeferredNV(device Device, pipeline Pipeline, shader uint32) (r error) {
	...
	if vkCompileDeferredNV.fnHandle == nil {
		vkCompileDeferredNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCompileDeferredNV")))
	}
	rsys = C.Trampoline3(vkCompileDeferredNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipeline)), C.uintptr_t(uintptr(shader)))
	r = Result(uintptr(rsys))
...
func CopyAccelerationStructureKHR(device Device, deferredOperation DeferredOperationKHR, info *CopyAccelerationStructureInfoKHR) (r error) {
	...
	if vkCopyAccelerationStructureKHR.fnHandle == nil {
		vkCopyAccelerationStructureKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyAccelerationStructureKHR")))
	}
	rsys = C.Trampoline3(vkCopyAccelerationStructureKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))))
	r = Result(uintptr(rsys))
...
func CopyAccelerationStructureToMemoryKHR(device Device, deferredOperation DeferredOperationKHR, info *CopyAccelerationStructureToMemoryInfoKHR) (r error) {
	...
	if vkCopyAccelerationStructureToMemoryKHR.fnHandle == nil {
		vkCopyAccelerationStructureToMemoryKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyAccelerationStructureToMemoryKHR")))
	}
	rsys = C.Trampoline3(vkCopyAccelerationStructureToMemoryKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))))
	r = Result(uintptr(rsys))
...
func CopyImageToImageEXT(device Device, copyImageToImageInfo *CopyImageToImageInfoEXT) (r error) {
	...
	if vkCopyImageToImageEXT.fnHandle == nil {
		vkCopyImageToImageEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyImageToImageEXT")))
	}
	rsys = C.Trampoline3(vkCopyImageToImageEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyImageToImageInfo))), 0)
	r = Result(uintptr(rsys))
...
func CopyImageToMemoryEXT(device Device, copyImageToMemoryInfo *CopyImageToMemoryInfoEXT) (r error) {
	...
	if vkCopyImageToMemoryEXT.fnHandle == nil {
		vkCopyImageToMemoryEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyImageToMemoryEXT")))
	}
	rsys = C.Trampoline3(vkCopyImageToMemoryEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyImageToMemoryInfo))), 0)
	r = Result(uintptr(rsys))
...
func CopyMemoryToAccelerationStructureKHR(device Device, deferredOperation DeferredOperationKHR, info *CopyMemoryToAccelerationStructureInfoKHR) (r error) {
	...
	if vkCopyMemoryToAccelerationStructureKHR.fnHandle == nil {
		vkCopyMemoryToAccelerationStructureKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyMemoryToAccelerationStructureKHR")))
	}
	rsys = C.Trampoline3(vkCopyMemoryToAccelerationStructureKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))))
	r = Result(uintptr(rsys))
...
func CopyMemoryToImageEXT(device Device, copyMemoryToImageInfo *CopyMemoryToImageInfoEXT) (r error) {
	...
	if vkCopyMemoryToImageEXT.fnHandle == nil {
		vkCopyMemoryToImageEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyMemoryToImageEXT")))
	}
	rsys = C.Trampoline3(vkCopyMemoryToImageEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCopyMemoryToImageInfo))), 0)
	r = Result(uintptr(rsys))
...
func CopyMemoryToMicromapEXT(device Device, deferredOperation DeferredOperationKHR, info *CopyMemoryToMicromapInfoEXT) (r error) {
	...
	if vkCopyMemoryToMicromapEXT.fnHandle == nil {
		vkCopyMemoryToMicromapEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyMemoryToMicromapEXT")))
	}
	rsys = C.Trampoline3(vkCopyMemoryToMicromapEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))))
	r = Result(uintptr(rsys))
...
func CopyMicromapEXT(device Device, deferredOperation DeferredOperationKHR, info *CopyMicromapInfoEXT) (r error) {
	...
	if vkCopyMicromapEXT.fnHandle == nil {
		vkCopyMicromapEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyMicromapEXT")))
	}
	rsys = C.Trampoline3(vkCopyMicromapEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))))
	r = Result(uintptr(rsys))
...
func CopyMicromapToMemoryEXT(device Device, deferredOperation DeferredOperationKHR, info *CopyMicromapToMemoryInfoEXT) (r error) {
	...
	if vkCopyMicromapToMemoryEXT.fnHandle == nil {
		vkCopyMicromapToMemoryEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCopyMicromapToMemoryEXT")))
	}
	rsys = C.Trampoline3(vkCopyMicromapToMemoryEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))))
	r = Result(uintptr(rsys))
...
func CreateAccelerationStructureKHR(device Device, createInfo *AccelerationStructureCreateInfoKHR, allocator *AllocationCallbacks) (accelerationStructure AccelerationStructureKHR, r error) {
	...
	if vkCreateAccelerationStructureKHR.fnHandle == nil {
		vkCreateAccelerationStructureKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateAccelerationStructureKHR")))
	}
	rsys = C.Trampoline6(vkCreateAccelerationStructureKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pAccelerationStructure))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateAccelerationStructureNV(device Device, createInfo *AccelerationStructureCreateInfoNV, allocator *AllocationCallbacks) (accelerationStructure AccelerationStructureNV, r error) {
	...
	if vkCreateAccelerationStructureNV.fnHandle == nil {
		vkCreateAccelerationStructureNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateAccelerationStructureNV")))
	}
	rsys = C.Trampoline6(vkCreateAccelerationStructureNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pAccelerationStructure))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateBuffer(device Device, createInfo *BufferCreateInfo, allocator *AllocationCallbacks) (buffer Buffer, r error) {
	...
	if vkCreateBuffer.fnHandle == nil {
		vkCreateBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateBuffer")))
	}
	rsys = C.Trampoline6(vkCreateBuffer.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pBuffer))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateBufferView(device Device, createInfo *BufferViewCreateInfo, allocator *AllocationCallbacks) (view BufferView, r error) {
	...
	if vkCreateBufferView.fnHandle == nil {
		vkCreateBufferView.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateBufferView")))
	}
	rsys = C.Trampoline6(vkCreateBufferView.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pView))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateCommandPool(device Device, createInfo *CommandPoolCreateInfo, allocator *AllocationCallbacks) (commandPool CommandPool, r error) {
	...
	if vkCreateCommandPool.fnHandle == nil {
		vkCreateCommandPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateCommandPool")))
	}
	rsys = C.Trampoline6(vkCreateCommandPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pCommandPool))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateComputePipelines(device Device, pipelineCache PipelineCache, createInfos []ComputePipelineCreateInfo, allocator *AllocationCallbacks) (pipelines []Pipeline, r error) {
	...
	if vkCreateComputePipelines.fnHandle == nil {
		vkCreateComputePipelines.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateComputePipelines")))
	}
	rsys = C.Trampoline6(vkCreateComputePipelines.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipelineCache)), C.uintptr_t(uintptr(createInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(pPipelines))))
	r = Result(uintptr(rsys))
...
func CreateCuFunctionNVX(device Device, createInfo *CuFunctionCreateInfoNVX, allocator *AllocationCallbacks) (function CuFunctionNVX, r error) {
	...
	if vkCreateCuFunctionNVX.fnHandle == nil {
		vkCreateCuFunctionNVX.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateCuFunctionNVX")))
	}
	rsys = C.Trampoline6(vkCreateCuFunctionNVX.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFunction))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateCuModuleNVX(device Device, createInfo *CuModuleCreateInfoNVX, allocator *AllocationCallbacks) (module CuModuleNVX, r error) {
	...
	if vkCreateCuModuleNVX.fnHandle == nil {
		vkCreateCuModuleNVX.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateCuModuleNVX")))
	}
	rsys = C.Trampoline6(vkCreateCuModuleNVX.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pModule))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateCudaFunctionNV(device Device, createInfo *CudaFunctionCreateInfoNV, allocator *AllocationCallbacks) (function CudaFunctionNV, r error) {
	...
	if vkCreateCudaFunctionNV.fnHandle == nil {
		vkCreateCudaFunctionNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateCudaFunctionNV")))
	}
	rsys = C.Trampoline6(vkCreateCudaFunctionNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFunction))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateCudaModuleNV(device Device, createInfo *CudaModuleCreateInfoNV, allocator *AllocationCallbacks) (module CudaModuleNV, r error) {
	...
	if vkCreateCudaModuleNV.fnHandle == nil {
		vkCreateCudaModuleNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateCudaModuleNV")))
	}
	rsys = C.Trampoline6(vkCreateCudaModuleNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pModule))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateDebugReportCallbackEXT(instance Instance, createInfo *DebugReportCallbackCreateInfoEXT, allocator *AllocationCallbacks) (callback DebugReportCallbackEXT, r error) {
	...
	if vkCreateDebugReportCallbackEXT.fnHandle == nil {
		vkCreateDebugReportCallbackEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDebugReportCallbackEXT")))
	}
	rsys = C.Trampoline6(vkCreateDebugReportCallbackEXT.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pCallback))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateDebugUtilsMessengerEXT(instance Instance, createInfo *DebugUtilsMessengerCreateInfoEXT, allocator *AllocationCallbacks) (messenger DebugUtilsMessengerEXT, r error) {
	...
	if vkCreateDebugUtilsMessengerEXT.fnHandle == nil {
		vkCreateDebugUtilsMessengerEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDebugUtilsMessengerEXT")))
	}
	rsys = C.Trampoline6(vkCreateDebugUtilsMessengerEXT.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMessenger))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateDeferredOperationKHR(device Device, allocator *AllocationCallbacks) (deferredOperation DeferredOperationKHR, r error) {
	...
	if vkCreateDeferredOperationKHR.fnHandle == nil {
		vkCreateDeferredOperationKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDeferredOperationKHR")))
	}
	rsys = C.Trampoline3(vkCreateDeferredOperationKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pDeferredOperation))))
	r = Result(uintptr(rsys))
...
func CreateDescriptorPool(device Device, createInfo *DescriptorPoolCreateInfo, allocator *AllocationCallbacks) (descriptorPool DescriptorPool, r error) {
	...
	if vkCreateDescriptorPool.fnHandle == nil {
		vkCreateDescriptorPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDescriptorPool")))
	}
	rsys = C.Trampoline6(vkCreateDescriptorPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pDescriptorPool))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateDescriptorSetLayout(device Device, createInfo *DescriptorSetLayoutCreateInfo, allocator *AllocationCallbacks) (setLayout DescriptorSetLayout, r error) {
	...
	if vkCreateDescriptorSetLayout.fnHandle == nil {
		vkCreateDescriptorSetLayout.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDescriptorSetLayout")))
	}
	rsys = C.Trampoline6(vkCreateDescriptorSetLayout.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pSetLayout))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateDescriptorUpdateTemplate(device Device, createInfo *DescriptorUpdateTemplateCreateInfo, allocator *AllocationCallbacks) (descriptorUpdateTemplate DescriptorUpdateTemplate, r error) {
	...
	if vkCreateDescriptorUpdateTemplate.fnHandle == nil {
		vkCreateDescriptorUpdateTemplate.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDescriptorUpdateTemplate")))
	}
	rsys = C.Trampoline6(vkCreateDescriptorUpdateTemplate.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pDescriptorUpdateTemplate))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateDevice(physicalDevice PhysicalDevice, createInfo *DeviceCreateInfo, allocator *AllocationCallbacks) (device Device, r error) {
	...
	if vkCreateDevice.fnHandle == nil {
		vkCreateDevice.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDevice")))
	}
	rsys = C.Trampoline6(vkCreateDevice.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pDevice))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateDisplayModeKHR(physicalDevice PhysicalDevice, display DisplayKHR, createInfo *DisplayModeCreateInfoKHR, allocator *AllocationCallbacks) (mode DisplayModeKHR, r error) {
	...
	if vkCreateDisplayModeKHR.fnHandle == nil {
		vkCreateDisplayModeKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDisplayModeKHR")))
	}
	rsys = C.Trampoline6(vkCreateDisplayModeKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(display)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMode))), 0)
	r = Result(uintptr(rsys))
...
func CreateDisplayPlaneSurfaceKHR(instance Instance, createInfo *DisplaySurfaceCreateInfoKHR, allocator *AllocationCallbacks) (surface SurfaceKHR, r error) {
	...
	if vkCreateDisplayPlaneSurfaceKHR.fnHandle == nil {
		vkCreateDisplayPlaneSurfaceKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateDisplayPlaneSurfaceKHR")))
	}
	rsys = C.Trampoline6(vkCreateDisplayPlaneSurfaceKHR.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pSurface))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateEvent(device Device, createInfo *EventCreateInfo, allocator *AllocationCallbacks) (event Event, r error) {
	...
	if vkCreateEvent.fnHandle == nil {
		vkCreateEvent.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateEvent")))
	}
	rsys = C.Trampoline6(vkCreateEvent.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pEvent))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateFence(device Device, createInfo *FenceCreateInfo, allocator *AllocationCallbacks) (fence Fence, r error) {
	...
	if vkCreateFence.fnHandle == nil {
		vkCreateFence.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateFence")))
	}
	rsys = C.Trampoline6(vkCreateFence.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFence))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateFramebuffer(device Device, createInfo *FramebufferCreateInfo, allocator *AllocationCallbacks) (framebuffer Framebuffer, r error) {
	...
	if vkCreateFramebuffer.fnHandle == nil {
		vkCreateFramebuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateFramebuffer")))
	}
	rsys = C.Trampoline6(vkCreateFramebuffer.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFramebuffer))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateGraphicsPipelines(device Device, pipelineCache PipelineCache, createInfos []GraphicsPipelineCreateInfo, allocator *AllocationCallbacks) (pipelines []Pipeline, r error) {
	...
	if vkCreateGraphicsPipelines.fnHandle == nil {
		vkCreateGraphicsPipelines.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateGraphicsPipelines")))
	}
	rsys = C.Trampoline6(vkCreateGraphicsPipelines.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipelineCache)), C.uintptr_t(uintptr(createInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(pPipelines))))
	r = Result(uintptr(rsys))
...
func CreateHeadlessSurfaceEXT(instance Instance, createInfo *HeadlessSurfaceCreateInfoEXT, allocator *AllocationCallbacks) (surface SurfaceKHR, r error) {
	...
	if vkCreateHeadlessSurfaceEXT.fnHandle == nil {
		vkCreateHeadlessSurfaceEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateHeadlessSurfaceEXT")))
	}
	rsys = C.Trampoline6(vkCreateHeadlessSurfaceEXT.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pSurface))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateImage(device Device, createInfo *ImageCreateInfo, allocator *AllocationCallbacks) (image Image, r error) {
	...
	if vkCreateImage.fnHandle == nil {
		vkCreateImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateImage")))
	}
	rsys = C.Trampoline6(vkCreateImage.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pImage))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateImageView(device Device, createInfo *ImageViewCreateInfo, allocator *AllocationCallbacks) (view ImageView, r error) {
	...
	if vkCreateImageView.fnHandle == nil {
		vkCreateImageView.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateImageView")))
	}
	rsys = C.Trampoline6(vkCreateImageView.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pView))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateIndirectCommandsLayoutNV(device Device, createInfo *IndirectCommandsLayoutCreateInfoNV, allocator *AllocationCallbacks) (indirectCommandsLayout IndirectCommandsLayoutNV, r error) {
	...
	if vkCreateIndirectCommandsLayoutNV.fnHandle == nil {
		vkCreateIndirectCommandsLayoutNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateIndirectCommandsLayoutNV")))
	}
	rsys = C.Trampoline6(vkCreateIndirectCommandsLayoutNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pIndirectCommandsLayout))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateInstance(createInfo *InstanceCreateInfo, allocator *AllocationCallbacks) (instance Instance, r error) {
	...
	if vkCreateInstance.fnHandle == nil {
		vkCreateInstance.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateInstance")))
	}
	rsys = C.Trampoline3(vkCreateInstance.fnHandle, C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pInstance))))
	r = Result(uintptr(rsys))
...
func CreateMicromapEXT(device Device, createInfo *MicromapCreateInfoEXT, allocator *AllocationCallbacks) (micromap MicromapEXT, r error) {
	...
	if vkCreateMicromapEXT.fnHandle == nil {
		vkCreateMicromapEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateMicromapEXT")))
	}
	rsys = C.Trampoline6(vkCreateMicromapEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMicromap))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateOpticalFlowSessionNV(device Device, createInfo *OpticalFlowSessionCreateInfoNV, allocator *AllocationCallbacks) (session OpticalFlowSessionNV, r error) {
	...
	if vkCreateOpticalFlowSessionNV.fnHandle == nil {
		vkCreateOpticalFlowSessionNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateOpticalFlowSessionNV")))
	}
	rsys = C.Trampoline6(vkCreateOpticalFlowSessionNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pSession))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreatePipelineCache(device Device, createInfo *PipelineCacheCreateInfo, allocator *AllocationCallbacks) (pipelineCache PipelineCache, r error) {
	...
	if vkCreatePipelineCache.fnHandle == nil {
		vkCreatePipelineCache.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreatePipelineCache")))
	}
	rsys = C.Trampoline6(vkCreatePipelineCache.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pPipelineCache))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreatePipelineLayout(device Device, createInfo *PipelineLayoutCreateInfo, allocator *AllocationCallbacks) (pipelineLayout PipelineLayout, r error) {
	...
	if vkCreatePipelineLayout.fnHandle == nil {
		vkCreatePipelineLayout.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreatePipelineLayout")))
	}
	rsys = C.Trampoline6(vkCreatePipelineLayout.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pPipelineLayout))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreatePrivateDataSlot(device Device, createInfo *PrivateDataSlotCreateInfo, allocator *AllocationCallbacks) (privateDataSlot PrivateDataSlot, r error) {
	...
	if vkCreatePrivateDataSlot.fnHandle == nil {
		vkCreatePrivateDataSlot.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreatePrivateDataSlot")))
	}
	rsys = C.Trampoline6(vkCreatePrivateDataSlot.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pPrivateDataSlot))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateQueryPool(device Device, createInfo *QueryPoolCreateInfo, allocator *AllocationCallbacks) (queryPool QueryPool, r error) {
	...
	if vkCreateQueryPool.fnHandle == nil {
		vkCreateQueryPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateQueryPool")))
	}
	rsys = C.Trampoline6(vkCreateQueryPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pQueryPool))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateRayTracingPipelinesKHR(device Device, deferredOperation DeferredOperationKHR, pipelineCache PipelineCache, createInfos []RayTracingPipelineCreateInfoKHR, allocator *AllocationCallbacks) (pipelines []Pipeline, r error) {
	...
	if vkCreateRayTracingPipelinesKHR.fnHandle == nil {
		vkCreateRayTracingPipelinesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateRayTracingPipelinesKHR")))
	}
	rsys = C.Trampoline9(vkCreateRayTracingPipelinesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(deferredOperation)), C.uintptr_t(uintptr(pipelineCache)), C.uintptr_t(uintptr(createInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(pPipelines))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateRayTracingPipelinesNV(device Device, pipelineCache PipelineCache, createInfos []RayTracingPipelineCreateInfoNV, allocator *AllocationCallbacks) (pipelines []Pipeline, r error) {
	...
	if vkCreateRayTracingPipelinesNV.fnHandle == nil {
		vkCreateRayTracingPipelinesNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateRayTracingPipelinesNV")))
	}
	rsys = C.Trampoline6(vkCreateRayTracingPipelinesNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipelineCache)), C.uintptr_t(uintptr(createInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(pPipelines))))
	r = Result(uintptr(rsys))
...
func CreateRenderPass(device Device, createInfo *RenderPassCreateInfo, allocator *AllocationCallbacks) (renderPass RenderPass, r error) {
	...
	if vkCreateRenderPass.fnHandle == nil {
		vkCreateRenderPass.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateRenderPass")))
	}
	rsys = C.Trampoline6(vkCreateRenderPass.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pRenderPass))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateRenderPass2(device Device, createInfo *RenderPassCreateInfo2, allocator *AllocationCallbacks) (renderPass RenderPass, r error) {
	...
	if vkCreateRenderPass2.fnHandle == nil {
		vkCreateRenderPass2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateRenderPass2")))
	}
	rsys = C.Trampoline6(vkCreateRenderPass2.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pRenderPass))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateSampler(device Device, createInfo *SamplerCreateInfo, allocator *AllocationCallbacks) (sampler Sampler, r error) {
	...
	if vkCreateSampler.fnHandle == nil {
		vkCreateSampler.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateSampler")))
	}
	rsys = C.Trampoline6(vkCreateSampler.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pSampler))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateSamplerYcbcrConversion(device Device, createInfo *SamplerYcbcrConversionCreateInfo, allocator *AllocationCallbacks) (ycbcrConversion SamplerYcbcrConversion, r error) {
	...
	if vkCreateSamplerYcbcrConversion.fnHandle == nil {
		vkCreateSamplerYcbcrConversion.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateSamplerYcbcrConversion")))
	}
	rsys = C.Trampoline6(vkCreateSamplerYcbcrConversion.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pYcbcrConversion))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateSemaphore(device Device, createInfo *SemaphoreCreateInfo, allocator *AllocationCallbacks) (semaphore Semaphore, r error) {
	...
	if vkCreateSemaphore.fnHandle == nil {
		vkCreateSemaphore.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateSemaphore")))
	}
	rsys = C.Trampoline6(vkCreateSemaphore.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pSemaphore))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateShaderModule(device Device, createInfo *ShaderModuleCreateInfo, allocator *AllocationCallbacks) (shaderModule ShaderModule, r error) {
	...
	if vkCreateShaderModule.fnHandle == nil {
		vkCreateShaderModule.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateShaderModule")))
	}
	rsys = C.Trampoline6(vkCreateShaderModule.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pShaderModule))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateShadersEXT(device Device, createInfos []ShaderCreateInfoEXT, allocator *AllocationCallbacks) (shaders []ShaderEXT, r error) {
	...
	if vkCreateShadersEXT.fnHandle == nil {
		vkCreateShadersEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateShadersEXT")))
	}
	rsys = C.Trampoline6(vkCreateShadersEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(createInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(pShaders))), 0)
	r = Result(uintptr(rsys))
...
func CreateSharedSwapchainsKHR(device Device, createInfos []SwapchainCreateInfoKHR, allocator *AllocationCallbacks) (swapchains []SwapchainKHR, r error) {
	...
	if vkCreateSharedSwapchainsKHR.fnHandle == nil {
		vkCreateSharedSwapchainsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateSharedSwapchainsKHR")))
	}
	rsys = C.Trampoline6(vkCreateSharedSwapchainsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchainCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(pSwapchains))), 0)
	r = Result(uintptr(rsys))
...
func CreateSwapchainKHR(device Device, createInfo *SwapchainCreateInfoKHR, allocator *AllocationCallbacks) (swapchain SwapchainKHR, r error) {
	...
	if vkCreateSwapchainKHR.fnHandle == nil {
		vkCreateSwapchainKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateSwapchainKHR")))
	}
	rsys = C.Trampoline6(vkCreateSwapchainKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pSwapchain))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateValidationCacheEXT(device Device, createInfo *ValidationCacheCreateInfoEXT, allocator *AllocationCallbacks) (validationCache ValidationCacheEXT, r error) {
	...
	if vkCreateValidationCacheEXT.fnHandle == nil {
		vkCreateValidationCacheEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateValidationCacheEXT")))
	}
	rsys = C.Trampoline6(vkCreateValidationCacheEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pValidationCache))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateVideoSessionKHR(device Device, createInfo *VideoSessionCreateInfoKHR, allocator *AllocationCallbacks) (videoSession VideoSessionKHR, r error) {
	...
	if vkCreateVideoSessionKHR.fnHandle == nil {
		vkCreateVideoSessionKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateVideoSessionKHR")))
	}
	rsys = C.Trampoline6(vkCreateVideoSessionKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pVideoSession))), 0, 0)
	r = Result(uintptr(rsys))
...
func CreateVideoSessionParametersKHR(device Device, createInfo *VideoSessionParametersCreateInfoKHR, allocator *AllocationCallbacks) (videoSessionParameters VideoSessionParametersKHR, r error) {
	...
	if vkCreateVideoSessionParametersKHR.fnHandle == nil {
		vkCreateVideoSessionParametersKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkCreateVideoSessionParametersKHR")))
	}
	rsys = C.Trampoline6(vkCreateVideoSessionParametersKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pVideoSessionParameters))), 0, 0)
	r = Result(uintptr(rsys))
...
func DebugMarkerSetObjectNameEXT(device Device, nameInfo *DebugMarkerObjectNameInfoEXT) (r error) {
	...
	if vkDebugMarkerSetObjectNameEXT.fnHandle == nil {
		vkDebugMarkerSetObjectNameEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDebugMarkerSetObjectNameEXT")))
	}
	rsys = C.Trampoline3(vkDebugMarkerSetObjectNameEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pNameInfo))), 0)
	r = Result(uintptr(rsys))
...
func DebugMarkerSetObjectTagEXT(device Device, tagInfo *DebugMarkerObjectTagInfoEXT) (r error) {
	...
	if vkDebugMarkerSetObjectTagEXT.fnHandle == nil {
		vkDebugMarkerSetObjectTagEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDebugMarkerSetObjectTagEXT")))
	}
	rsys = C.Trampoline3(vkDebugMarkerSetObjectTagEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pTagInfo))), 0)
	r = Result(uintptr(rsys))
...
func DebugReportMessageEXT(instance Instance, flags DebugReportFlagsEXT, objectType DebugReportObjectTypeEXT, object uint64, location uintptr, messageCode int32, layerPrefix string, message string) {
	...
	if vkDebugReportMessageEXT.fnHandle == nil {
		vkDebugReportMessageEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDebugReportMessageEXT")))
	}
	C.Trampoline9(vkDebugReportMessageEXT.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(flags)), C.uintptr_t(uintptr(objectType)), C.uintptr_t(uintptr(object)), C.uintptr_t(uintptr(location)), C.uintptr_t(uintptr(messageCode)), C.uintptr_t(uintptr(unsafe.Pointer(pLayerPrefix))), C.uintptr_t(uintptr(unsafe.Pointer(pMessage))), 0)
...
func DeferredOperationJoinKHR(device Device, operation DeferredOperationKHR) (r error) {
	...
	if vkDeferredOperationJoinKHR.fnHandle == nil {
		vkDeferredOperationJoinKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDeferredOperationJoinKHR")))
	}
	rsys = C.Trampoline3(vkDeferredOperationJoinKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(operation)), 0)
	r = Result(uintptr(rsys))
...
func DestroyAccelerationStructureKHR(device Device, accelerationStructure AccelerationStructureKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroyAccelerationStructureKHR.fnHandle == nil {
		vkDestroyAccelerationStructureKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyAccelerationStructureKHR")))
	}
	C.Trampoline3(vkDestroyAccelerationStructureKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(accelerationStructure)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyAccelerationStructureNV(device Device, accelerationStructure AccelerationStructureNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyAccelerationStructureNV.fnHandle == nil {
		vkDestroyAccelerationStructureNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyAccelerationStructureNV")))
	}
	C.Trampoline3(vkDestroyAccelerationStructureNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(accelerationStructure)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyBuffer(device Device, buffer Buffer, allocator *AllocationCallbacks) {
	...
	if vkDestroyBuffer.fnHandle == nil {
		vkDestroyBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyBuffer")))
	}
	C.Trampoline3(vkDestroyBuffer.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyBufferView(device Device, bufferView BufferView, allocator *AllocationCallbacks) {
	...
	if vkDestroyBufferView.fnHandle == nil {
		vkDestroyBufferView.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyBufferView")))
	}
	C.Trampoline3(vkDestroyBufferView.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(bufferView)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyCommandPool(device Device, commandPool CommandPool, allocator *AllocationCallbacks) {
	...
	if vkDestroyCommandPool.fnHandle == nil {
		vkDestroyCommandPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyCommandPool")))
	}
	C.Trampoline3(vkDestroyCommandPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(commandPool)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyCuFunctionNVX(device Device, function CuFunctionNVX, allocator *AllocationCallbacks) {
	...
	if vkDestroyCuFunctionNVX.fnHandle == nil {
		vkDestroyCuFunctionNVX.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyCuFunctionNVX")))
	}
	C.Trampoline3(vkDestroyCuFunctionNVX.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(function)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyCuModuleNVX(device Device, module CuModuleNVX, allocator *AllocationCallbacks) {
	...
	if vkDestroyCuModuleNVX.fnHandle == nil {
		vkDestroyCuModuleNVX.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyCuModuleNVX")))
	}
	C.Trampoline3(vkDestroyCuModuleNVX.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(module)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyCudaFunctionNV(device Device, function CudaFunctionNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyCudaFunctionNV.fnHandle == nil {
		vkDestroyCudaFunctionNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyCudaFunctionNV")))
	}
	C.Trampoline3(vkDestroyCudaFunctionNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(function)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyCudaModuleNV(device Device, module CudaModuleNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyCudaModuleNV.fnHandle == nil {
		vkDestroyCudaModuleNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyCudaModuleNV")))
	}
	C.Trampoline3(vkDestroyCudaModuleNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(module)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyDebugReportCallbackEXT(instance Instance, callback DebugReportCallbackEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyDebugReportCallbackEXT.fnHandle == nil {
		vkDestroyDebugReportCallbackEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyDebugReportCallbackEXT")))
	}
	C.Trampoline3(vkDestroyDebugReportCallbackEXT.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(callback)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyDebugUtilsMessengerEXT(instance Instance, messenger DebugUtilsMessengerEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyDebugUtilsMessengerEXT.fnHandle == nil {
		vkDestroyDebugUtilsMessengerEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyDebugUtilsMessengerEXT")))
	}
	C.Trampoline3(vkDestroyDebugUtilsMessengerEXT.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(messenger)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyDeferredOperationKHR(device Device, operation DeferredOperationKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroyDeferredOperationKHR.fnHandle == nil {
		vkDestroyDeferredOperationKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyDeferredOperationKHR")))
	}
	C.Trampoline3(vkDestroyDeferredOperationKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(operation)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyDescriptorPool(device Device, descriptorPool DescriptorPool, allocator *AllocationCallbacks) {
	...
	if vkDestroyDescriptorPool.fnHandle == nil {
		vkDestroyDescriptorPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyDescriptorPool")))
	}
	C.Trampoline3(vkDestroyDescriptorPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorPool)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyDescriptorSetLayout(device Device, descriptorSetLayout DescriptorSetLayout, allocator *AllocationCallbacks) {
	...
	if vkDestroyDescriptorSetLayout.fnHandle == nil {
		vkDestroyDescriptorSetLayout.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyDescriptorSetLayout")))
	}
	C.Trampoline3(vkDestroyDescriptorSetLayout.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorSetLayout)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyDescriptorUpdateTemplate(device Device, descriptorUpdateTemplate DescriptorUpdateTemplate, allocator *AllocationCallbacks) {
	...
	if vkDestroyDescriptorUpdateTemplate.fnHandle == nil {
		vkDestroyDescriptorUpdateTemplate.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyDescriptorUpdateTemplate")))
	}
	C.Trampoline3(vkDestroyDescriptorUpdateTemplate.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorUpdateTemplate)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyDevice(device Device, allocator *AllocationCallbacks) {
	...
	if vkDestroyDevice.fnHandle == nil {
		vkDestroyDevice.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyDevice")))
	}
	C.Trampoline3(vkDestroyDevice.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), 0)
...
func DestroyEvent(device Device, event Event, allocator *AllocationCallbacks) {
	...
	if vkDestroyEvent.fnHandle == nil {
		vkDestroyEvent.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyEvent")))
	}
	C.Trampoline3(vkDestroyEvent.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(event)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyFence(device Device, fence Fence, allocator *AllocationCallbacks) {
	...
	if vkDestroyFence.fnHandle == nil {
		vkDestroyFence.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyFence")))
	}
	C.Trampoline3(vkDestroyFence.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(fence)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyFramebuffer(device Device, framebuffer Framebuffer, allocator *AllocationCallbacks) {
	...
	if vkDestroyFramebuffer.fnHandle == nil {
		vkDestroyFramebuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyFramebuffer")))
	}
	C.Trampoline3(vkDestroyFramebuffer.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(framebuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyImage(device Device, image Image, allocator *AllocationCallbacks) {
	...
	if vkDestroyImage.fnHandle == nil {
		vkDestroyImage.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyImage")))
	}
	C.Trampoline3(vkDestroyImage.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyImageView(device Device, imageView ImageView, allocator *AllocationCallbacks) {
	...
	if vkDestroyImageView.fnHandle == nil {
		vkDestroyImageView.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyImageView")))
	}
	C.Trampoline3(vkDestroyImageView.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(imageView)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyIndirectCommandsLayoutNV(device Device, indirectCommandsLayout IndirectCommandsLayoutNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyIndirectCommandsLayoutNV.fnHandle == nil {
		vkDestroyIndirectCommandsLayoutNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyIndirectCommandsLayoutNV")))
	}
	C.Trampoline3(vkDestroyIndirectCommandsLayoutNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(indirectCommandsLayout)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyInstance(instance Instance, allocator *AllocationCallbacks) {
	...
	if vkDestroyInstance.fnHandle == nil {
		vkDestroyInstance.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyInstance")))
	}
	C.Trampoline3(vkDestroyInstance.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), 0)
...
func DestroyMicromapEXT(device Device, micromap MicromapEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyMicromapEXT.fnHandle == nil {
		vkDestroyMicromapEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyMicromapEXT")))
	}
	C.Trampoline3(vkDestroyMicromapEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(micromap)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyOpticalFlowSessionNV(device Device, session OpticalFlowSessionNV, allocator *AllocationCallbacks) {
	...
	if vkDestroyOpticalFlowSessionNV.fnHandle == nil {
		vkDestroyOpticalFlowSessionNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyOpticalFlowSessionNV")))
	}
	C.Trampoline3(vkDestroyOpticalFlowSessionNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(session)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyPipeline(device Device, pipeline Pipeline, allocator *AllocationCallbacks) {
	...
	if vkDestroyPipeline.fnHandle == nil {
		vkDestroyPipeline.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyPipeline")))
	}
	C.Trampoline3(vkDestroyPipeline.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipeline)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyPipelineCache(device Device, pipelineCache PipelineCache, allocator *AllocationCallbacks) {
	...
	if vkDestroyPipelineCache.fnHandle == nil {
		vkDestroyPipelineCache.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyPipelineCache")))
	}
	C.Trampoline3(vkDestroyPipelineCache.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipelineCache)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyPipelineLayout(device Device, pipelineLayout PipelineLayout, allocator *AllocationCallbacks) {
	...
	if vkDestroyPipelineLayout.fnHandle == nil {
		vkDestroyPipelineLayout.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyPipelineLayout")))
	}
	C.Trampoline3(vkDestroyPipelineLayout.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipelineLayout)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyPrivateDataSlot(device Device, privateDataSlot PrivateDataSlot, allocator *AllocationCallbacks) {
	...
	if vkDestroyPrivateDataSlot.fnHandle == nil {
		vkDestroyPrivateDataSlot.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyPrivateDataSlot")))
	}
	C.Trampoline3(vkDestroyPrivateDataSlot.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(privateDataSlot)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyQueryPool(device Device, queryPool QueryPool, allocator *AllocationCallbacks) {
	...
	if vkDestroyQueryPool.fnHandle == nil {
		vkDestroyQueryPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyQueryPool")))
	}
	C.Trampoline3(vkDestroyQueryPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyRenderPass(device Device, renderPass RenderPass, allocator *AllocationCallbacks) {
	...
	if vkDestroyRenderPass.fnHandle == nil {
		vkDestroyRenderPass.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyRenderPass")))
	}
	C.Trampoline3(vkDestroyRenderPass.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(renderPass)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroySampler(device Device, sampler Sampler, allocator *AllocationCallbacks) {
	...
	if vkDestroySampler.fnHandle == nil {
		vkDestroySampler.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroySampler")))
	}
	C.Trampoline3(vkDestroySampler.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(sampler)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroySamplerYcbcrConversion(device Device, ycbcrConversion SamplerYcbcrConversion, allocator *AllocationCallbacks) {
	...
	if vkDestroySamplerYcbcrConversion.fnHandle == nil {
		vkDestroySamplerYcbcrConversion.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroySamplerYcbcrConversion")))
	}
	C.Trampoline3(vkDestroySamplerYcbcrConversion.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(ycbcrConversion)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroySemaphore(device Device, semaphore Semaphore, allocator *AllocationCallbacks) {
	...
	if vkDestroySemaphore.fnHandle == nil {
		vkDestroySemaphore.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroySemaphore")))
	}
	C.Trampoline3(vkDestroySemaphore.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(semaphore)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyShaderEXT(device Device, shader ShaderEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyShaderEXT.fnHandle == nil {
		vkDestroyShaderEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyShaderEXT")))
	}
	C.Trampoline3(vkDestroyShaderEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(shader)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyShaderModule(device Device, shaderModule ShaderModule, allocator *AllocationCallbacks) {
	...
	if vkDestroyShaderModule.fnHandle == nil {
		vkDestroyShaderModule.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyShaderModule")))
	}
	C.Trampoline3(vkDestroyShaderModule.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(shaderModule)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroySurfaceKHR(instance Instance, surface SurfaceKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroySurfaceKHR.fnHandle == nil {
		vkDestroySurfaceKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroySurfaceKHR")))
	}
	C.Trampoline3(vkDestroySurfaceKHR.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroySwapchainKHR(device Device, swapchain SwapchainKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroySwapchainKHR.fnHandle == nil {
		vkDestroySwapchainKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroySwapchainKHR")))
	}
	C.Trampoline3(vkDestroySwapchainKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyValidationCacheEXT(device Device, validationCache ValidationCacheEXT, allocator *AllocationCallbacks) {
	...
	if vkDestroyValidationCacheEXT.fnHandle == nil {
		vkDestroyValidationCacheEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyValidationCacheEXT")))
	}
	C.Trampoline3(vkDestroyValidationCacheEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(validationCache)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyVideoSessionKHR(device Device, videoSession VideoSessionKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroyVideoSessionKHR.fnHandle == nil {
		vkDestroyVideoSessionKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyVideoSessionKHR")))
	}
	C.Trampoline3(vkDestroyVideoSessionKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(videoSession)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DestroyVideoSessionParametersKHR(device Device, videoSessionParameters VideoSessionParametersKHR, allocator *AllocationCallbacks) {
	...
	if vkDestroyVideoSessionParametersKHR.fnHandle == nil {
		vkDestroyVideoSessionParametersKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDestroyVideoSessionParametersKHR")))
	}
	C.Trampoline3(vkDestroyVideoSessionParametersKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(videoSessionParameters)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func DeviceWaitIdle(device Device) (r error) {
	...
	if vkDeviceWaitIdle.fnHandle == nil {
		vkDeviceWaitIdle.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDeviceWaitIdle")))
	}
	rsys = C.Trampoline3(vkDeviceWaitIdle.fnHandle, C.uintptr_t(uintptr(device)), 0, 0)
	r = Result(uintptr(rsys))
...
func DisplayPowerControlEXT(device Device, display DisplayKHR, displayPowerInfo *DisplayPowerInfoEXT) (r error) {
	...
	if vkDisplayPowerControlEXT.fnHandle == nil {
		vkDisplayPowerControlEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkDisplayPowerControlEXT")))
	}
	rsys = C.Trampoline3(vkDisplayPowerControlEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(display)), C.uintptr_t(uintptr(unsafe.Pointer(pDisplayPowerInfo))))
	r = Result(uintptr(rsys))
...
func EndCommandBuffer(commandBuffer CommandBuffer) (r error) {
	...
	if vkEndCommandBuffer.fnHandle == nil {
		vkEndCommandBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEndCommandBuffer")))
	}
	rsys = C.Trampoline3(vkEndCommandBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), 0, 0)
	r = Result(uintptr(rsys))
...
func EnumerateDeviceExtensionProperties(physicalDevice PhysicalDevice, layerName string) (properties []ExtensionProperties, r error) {
	...
	if vkEnumerateDeviceExtensionProperties.fnHandle == nil {
		vkEnumerateDeviceExtensionProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumerateDeviceExtensionProperties")))
	}
	rsys = C.Trampoline6(vkEnumerateDeviceExtensionProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pLayerName))), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func EnumerateDeviceLayerProperties(physicalDevice PhysicalDevice) (properties []LayerProperties, r error) {
	...
	if vkEnumerateDeviceLayerProperties.fnHandle == nil {
		vkEnumerateDeviceLayerProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumerateDeviceLayerProperties")))
	}
	rsys = C.Trampoline3(vkEnumerateDeviceLayerProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func EnumerateInstanceExtensionProperties(layerName string) (properties []ExtensionProperties, r error) {
	...
	if vkEnumerateInstanceExtensionProperties.fnHandle == nil {
		vkEnumerateInstanceExtensionProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumerateInstanceExtensionProperties")))
	}
	rsys = C.Trampoline3(vkEnumerateInstanceExtensionProperties.fnHandle, C.uintptr_t(uintptr(unsafe.Pointer(pLayerName))), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func EnumerateInstanceLayerProperties() (properties []LayerProperties, r error) {
	...
	if vkEnumerateInstanceLayerProperties.fnHandle == nil {
		vkEnumerateInstanceLayerProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumerateInstanceLayerProperties")))
	}
	rsys = C.Trampoline3(vkEnumerateInstanceLayerProperties.fnHandle, C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0)
	r = Result(uintptr(rsys))
...
func EnumerateInstanceVersion() (apiVersion uint32, r error) {
	...
	if vkEnumerateInstanceVersion.fnHandle == nil {
		vkEnumerateInstanceVersion.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumerateInstanceVersion")))
	}
	rsys = C.Trampoline3(vkEnumerateInstanceVersion.fnHandle, C.uintptr_t(uintptr(unsafe.Pointer(ptr_pApiVersion))), 0, 0)
	r = Result(uintptr(rsys))
...
func EnumeratePhysicalDeviceGroups(instance Instance) (physicalDeviceGroupProperties []PhysicalDeviceGroupProperties, r error) {
	...
	if vkEnumeratePhysicalDeviceGroups.fnHandle == nil {
		vkEnumeratePhysicalDeviceGroups.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumeratePhysicalDeviceGroups")))
	}
	rsys = C.Trampoline3(vkEnumeratePhysicalDeviceGroups.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pPhysicalDeviceGroupCount))), C.uintptr_t(uintptr(unsafe.Pointer(pPhysicalDeviceGroupProperties))))
	r = Result(uintptr(rsys))
...
func EnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(physicalDevice PhysicalDevice, queueFamilyIndex uint32) (counters []PerformanceCounterKHR, counterDescriptions []PerformanceCounterDescriptionKHR, r error) {
	...
	if vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR.fnHandle == nil {
		vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR")))
	}
	rsys = C.Trampoline6(vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(queueFamilyIndex)), C.uintptr_t(uintptr(unsafe.Pointer(pCounterCount))), C.uintptr_t(uintptr(unsafe.Pointer(pCounters))), C.uintptr_t(uintptr(unsafe.Pointer(pCounterDescriptions))), 0)
	r = Result(uintptr(rsys))
...
func EnumeratePhysicalDevices(instance Instance) (physicalDevices []PhysicalDevice, r error) {
	...
	if vkEnumeratePhysicalDevices.fnHandle == nil {
		vkEnumeratePhysicalDevices.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkEnumeratePhysicalDevices")))
	}
	rsys = C.Trampoline3(vkEnumeratePhysicalDevices.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pPhysicalDeviceCount))), C.uintptr_t(uintptr(unsafe.Pointer(pPhysicalDevices))))
	r = Result(uintptr(rsys))
...
func FlushMappedMemoryRanges(device Device, memoryRanges []MappedMemoryRange) (r error) {
	...
	if vkFlushMappedMemoryRanges.fnHandle == nil {
		vkFlushMappedMemoryRanges.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkFlushMappedMemoryRanges")))
	}
	rsys = C.Trampoline3(vkFlushMappedMemoryRanges.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(memoryRangeCount)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRanges))))
	r = Result(uintptr(rsys))
...
func FreeCommandBuffers(device Device, commandPool CommandPool, commandBuffers []CommandBuffer) {
	...
	if vkFreeCommandBuffers.fnHandle == nil {
		vkFreeCommandBuffers.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkFreeCommandBuffers")))
	}
	C.Trampoline6(vkFreeCommandBuffers.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(commandPool)), C.uintptr_t(uintptr(commandBufferCount)), C.uintptr_t(uintptr(unsafe.Pointer(pCommandBuffers))), 0, 0)
...
func FreeDescriptorSets(device Device, descriptorPool DescriptorPool, descriptorSets []DescriptorSet) (r error) {
	...
	if vkFreeDescriptorSets.fnHandle == nil {
		vkFreeDescriptorSets.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkFreeDescriptorSets")))
	}
	rsys = C.Trampoline6(vkFreeDescriptorSets.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorPool)), C.uintptr_t(uintptr(descriptorSetCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptorSets))), 0, 0)
	r = Result(uintptr(rsys))
...
func FreeMemory(device Device, memory DeviceMemory, allocator *AllocationCallbacks) {
	...
	if vkFreeMemory.fnHandle == nil {
		vkFreeMemory.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkFreeMemory")))
	}
	C.Trampoline3(vkFreeMemory.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(memory)), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))))
...
func GetAccelerationStructureBuildSizesKHR(device Device, buildType AccelerationStructureBuildTypeKHR, buildInfo *AccelerationStructureBuildGeometryInfoKHR, maxPrimitiveCounts []uint32) (sizeInfo AccelerationStructureBuildSizesInfoKHR) {
	...
	if vkGetAccelerationStructureBuildSizesKHR.fnHandle == nil {
		vkGetAccelerationStructureBuildSizesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetAccelerationStructureBuildSizesKHR")))
	}
	C.Trampoline6(vkGetAccelerationStructureBuildSizesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(buildType)), C.uintptr_t(uintptr(unsafe.Pointer(pBuildInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMaxPrimitiveCounts))), C.uintptr_t(uintptr(unsafe.Pointer(pSizeInfo))), 0)
...
func GetAccelerationStructureDeviceAddressKHR(device Device, info *AccelerationStructureDeviceAddressInfoKHR) (deviceAddress DeviceAddress) {
	...
	if vkGetAccelerationStructureDeviceAddressKHR.fnHandle == nil {
		vkGetAccelerationStructureDeviceAddressKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetAccelerationStructureDeviceAddressKHR")))
	}
	rsys = C.Trampoline3(vkGetAccelerationStructureDeviceAddressKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
	deviceAddress = DeviceAddress(uintptr(rsys))
...
func GetAccelerationStructureHandleNV(device Device, accelerationStructure AccelerationStructureNV, data []byte) (r error) {
	...
	if vkGetAccelerationStructureHandleNV.fnHandle == nil {
		vkGetAccelerationStructureHandleNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetAccelerationStructureHandleNV")))
	}
	rsys = C.Trampoline6(vkGetAccelerationStructureHandleNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(accelerationStructure)), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetAccelerationStructureMemoryRequirementsNV(device Device, info *AccelerationStructureMemoryRequirementsInfoNV) (memoryRequirements MemoryRequirements2KHR) {
	...
	if vkGetAccelerationStructureMemoryRequirementsNV.fnHandle == nil {
		vkGetAccelerationStructureMemoryRequirementsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetAccelerationStructureMemoryRequirementsNV")))
	}
	C.Trampoline3(vkGetAccelerationStructureMemoryRequirementsNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMemoryRequirements))))
...
func GetAccelerationStructureOpaqueCaptureDescriptorDataEXT(device Device, info *AccelerationStructureCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT")))
	}
	rsys = C.Trampoline3(vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pData))))
	r = Result(uintptr(rsys))
...
func GetBufferDeviceAddress(device Device, info *BufferDeviceAddressInfo) (deviceAddress DeviceAddress) {
	...
	if vkGetBufferDeviceAddress.fnHandle == nil {
		vkGetBufferDeviceAddress.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetBufferDeviceAddress")))
	}
	rsys = C.Trampoline3(vkGetBufferDeviceAddress.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
	deviceAddress = DeviceAddress(uintptr(rsys))
...
func GetBufferMemoryRequirements(device Device, buffer Buffer) (memoryRequirements MemoryRequirements) {
	...
	if vkGetBufferMemoryRequirements.fnHandle == nil {
		vkGetBufferMemoryRequirements.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetBufferMemoryRequirements")))
	}
	C.Trampoline3(vkGetBufferMemoryRequirements.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(buffer)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMemoryRequirements))))
...
func GetBufferMemoryRequirements2(device Device, info *BufferMemoryRequirementsInfo2) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetBufferMemoryRequirements2.fnHandle == nil {
		vkGetBufferMemoryRequirements2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetBufferMemoryRequirements2")))
	}
	C.Trampoline3(vkGetBufferMemoryRequirements2.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetBufferOpaqueCaptureAddress(device Device, info *BufferDeviceAddressInfo) (r uint64) {
	...
	if vkGetBufferOpaqueCaptureAddress.fnHandle == nil {
		vkGetBufferOpaqueCaptureAddress.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetBufferOpaqueCaptureAddress")))
	}
	rsys = C.Trampoline3(vkGetBufferOpaqueCaptureAddress.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
	r = uint64(uintptr(rsys))
...
func GetBufferOpaqueCaptureDescriptorDataEXT(device Device, info *BufferCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetBufferOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetBufferOpaqueCaptureDescriptorDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetBufferOpaqueCaptureDescriptorDataEXT")))
	}
	rsys = C.Trampoline3(vkGetBufferOpaqueCaptureDescriptorDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pData))))
	r = Result(uintptr(rsys))
...
func GetCalibratedTimestampsKHR(device Device, timestampInfos []CalibratedTimestampInfoKHR) (timestamps []uint64, maxDeviation uint64, r error) {
	...
	if vkGetCalibratedTimestampsKHR.fnHandle == nil {
		vkGetCalibratedTimestampsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetCalibratedTimestampsKHR")))
	}
	rsys = C.Trampoline6(vkGetCalibratedTimestampsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(timestampCount)), C.uintptr_t(uintptr(unsafe.Pointer(pTimestampInfos))), C.uintptr_t(uintptr(unsafe.Pointer(pTimestamps))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMaxDeviation))), 0)
	r = Result(uintptr(rsys))
...
func GetCudaModuleCacheNV(device Device, module CudaModuleNV) (cacheData []byte, r error) {
	...
	if vkGetCudaModuleCacheNV.fnHandle == nil {
		vkGetCudaModuleCacheNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetCudaModuleCacheNV")))
	}
	rsys = C.Trampoline6(vkGetCudaModuleCacheNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(module)), C.uintptr_t(uintptr(unsafe.Pointer(pCacheSize))), C.uintptr_t(uintptr(unsafe.Pointer(pCacheData))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetDeferredOperationMaxConcurrencyKHR(device Device, operation DeferredOperationKHR) (r uint32) {
	...
	if vkGetDeferredOperationMaxConcurrencyKHR.fnHandle == nil {
		vkGetDeferredOperationMaxConcurrencyKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeferredOperationMaxConcurrencyKHR")))
	}
	rsys = C.Trampoline3(vkGetDeferredOperationMaxConcurrencyKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(operation)), 0)
	r = uint32(uintptr(rsys))
...
func GetDeferredOperationResultKHR(device Device, operation DeferredOperationKHR) (r error) {
	...
	if vkGetDeferredOperationResultKHR.fnHandle == nil {
		vkGetDeferredOperationResultKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeferredOperationResultKHR")))
	}
	rsys = C.Trampoline3(vkGetDeferredOperationResultKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(operation)), 0)
	r = Result(uintptr(rsys))
...
func GetDescriptorEXT(device Device, descriptorInfo *DescriptorGetInfoEXT, descriptor []byte) {
	...
	if vkGetDescriptorEXT.fnHandle == nil {
		vkGetDescriptorEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDescriptorEXT")))
	}
	C.Trampoline6(vkGetDescriptorEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptorInfo))), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptor))), 0, 0)
...
func GetDescriptorSetHostMappingVALVE(device Device, descriptorSet DescriptorSet) (pData *byte) {
	...
	if vkGetDescriptorSetHostMappingVALVE.fnHandle == nil {
		vkGetDescriptorSetHostMappingVALVE.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDescriptorSetHostMappingVALVE")))
	}
	C.Trampoline3(vkGetDescriptorSetHostMappingVALVE.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorSet)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_ppData))))
...
func GetDescriptorSetLayoutBindingOffsetEXT(device Device, layout DescriptorSetLayout, binding uint32) (offset DeviceSize) {
	...
	if vkGetDescriptorSetLayoutBindingOffsetEXT.fnHandle == nil {
		vkGetDescriptorSetLayoutBindingOffsetEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDescriptorSetLayoutBindingOffsetEXT")))
	}
	C.Trampoline6(vkGetDescriptorSetLayoutBindingOffsetEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(binding)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pOffset))), 0, 0)
...
func GetDescriptorSetLayoutHostMappingInfoVALVE(device Device, bindingReference *DescriptorSetBindingReferenceVALVE) (hostMapping DescriptorSetLayoutHostMappingInfoVALVE) {
	...
	if vkGetDescriptorSetLayoutHostMappingInfoVALVE.fnHandle == nil {
		vkGetDescriptorSetLayoutHostMappingInfoVALVE.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDescriptorSetLayoutHostMappingInfoVALVE")))
	}
	C.Trampoline3(vkGetDescriptorSetLayoutHostMappingInfoVALVE.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pBindingReference))), C.uintptr_t(uintptr(unsafe.Pointer(pHostMapping))))
...
func GetDescriptorSetLayoutSizeEXT(device Device, layout DescriptorSetLayout) (layoutSizeInBytes DeviceSize) {
	...
	if vkGetDescriptorSetLayoutSizeEXT.fnHandle == nil {
		vkGetDescriptorSetLayoutSizeEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDescriptorSetLayoutSizeEXT")))
	}
	C.Trampoline3(vkGetDescriptorSetLayoutSizeEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(layout)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pLayoutSizeInBytes))))
...
func GetDescriptorSetLayoutSupport(device Device, createInfo *DescriptorSetLayoutCreateInfo) (support DescriptorSetLayoutSupport) {
	...
	if vkGetDescriptorSetLayoutSupport.fnHandle == nil {
		vkGetDescriptorSetLayoutSupport.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDescriptorSetLayoutSupport")))
	}
	C.Trampoline3(vkGetDescriptorSetLayoutSupport.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSupport))))
...
func GetDeviceAccelerationStructureCompatibilityKHR(device Device, versionInfo *AccelerationStructureVersionInfoKHR) (compatibility AccelerationStructureCompatibilityKHR) {
	...
	if vkGetDeviceAccelerationStructureCompatibilityKHR.fnHandle == nil {
		vkGetDeviceAccelerationStructureCompatibilityKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceAccelerationStructureCompatibilityKHR")))
	}
	C.Trampoline3(vkGetDeviceAccelerationStructureCompatibilityKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pVersionInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pCompatibility))))
...
func GetDeviceBufferMemoryRequirements(device Device, info *DeviceBufferMemoryRequirements) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetDeviceBufferMemoryRequirements.fnHandle == nil {
		vkGetDeviceBufferMemoryRequirements.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceBufferMemoryRequirements")))
	}
	C.Trampoline3(vkGetDeviceBufferMemoryRequirements.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetDeviceFaultInfoEXT(device Device) (faultCounts DeviceFaultCountsEXT, faultInfo DeviceFaultInfoEXT, r error) {
	...
	if vkGetDeviceFaultInfoEXT.fnHandle == nil {
		vkGetDeviceFaultInfoEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceFaultInfoEXT")))
	}
	rsys = C.Trampoline3(vkGetDeviceFaultInfoEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pFaultCounts))), C.uintptr_t(uintptr(unsafe.Pointer(pFaultInfo))))
	r = Result(uintptr(rsys))
...
func GetDeviceGroupPeerMemoryFeatures(device Device, heapIndex uint32, localDeviceIndex uint32, remoteDeviceIndex uint32) (peerMemoryFeatures PeerMemoryFeatureFlags) {
	...
	if vkGetDeviceGroupPeerMemoryFeatures.fnHandle == nil {
		vkGetDeviceGroupPeerMemoryFeatures.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceGroupPeerMemoryFeatures")))
	}
	C.Trampoline6(vkGetDeviceGroupPeerMemoryFeatures.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(heapIndex)), C.uintptr_t(uintptr(localDeviceIndex)), C.uintptr_t(uintptr(remoteDeviceIndex)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pPeerMemoryFeatures))), 0)
...
func GetDeviceGroupPresentCapabilitiesKHR(device Device) (deviceGroupPresentCapabilities DeviceGroupPresentCapabilitiesKHR, r error) {
	...
	if vkGetDeviceGroupPresentCapabilitiesKHR.fnHandle == nil {
		vkGetDeviceGroupPresentCapabilitiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceGroupPresentCapabilitiesKHR")))
	}
	rsys = C.Trampoline3(vkGetDeviceGroupPresentCapabilitiesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pDeviceGroupPresentCapabilities))), 0)
	r = Result(uintptr(rsys))
...
func GetDeviceGroupSurfacePresentModesKHR(device Device, surface SurfaceKHR) (modes DeviceGroupPresentModeFlagsKHR, r error) {
	...
	if vkGetDeviceGroupSurfacePresentModesKHR.fnHandle == nil {
		vkGetDeviceGroupSurfacePresentModesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceGroupSurfacePresentModesKHR")))
	}
	rsys = C.Trampoline3(vkGetDeviceGroupSurfacePresentModesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pModes))))
	r = Result(uintptr(rsys))
...
func GetDeviceImageMemoryRequirements(device Device, info *DeviceImageMemoryRequirements) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetDeviceImageMemoryRequirements.fnHandle == nil {
		vkGetDeviceImageMemoryRequirements.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceImageMemoryRequirements")))
	}
	C.Trampoline3(vkGetDeviceImageMemoryRequirements.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetDeviceImageSparseMemoryRequirements(device Device, info *DeviceImageMemoryRequirements) (sparseMemoryRequirements []SparseImageMemoryRequirements2) {
	...
	if vkGetDeviceImageSparseMemoryRequirements.fnHandle == nil {
		vkGetDeviceImageSparseMemoryRequirements.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceImageSparseMemoryRequirements")))
	}
	C.Trampoline6(vkGetDeviceImageSparseMemoryRequirements.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirementCount))), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirements))), 0, 0)
...
func GetDeviceImageSubresourceLayoutKHR(device Device, info *DeviceImageSubresourceInfoKHR) (layout SubresourceLayout2KHR) {
	...
	if vkGetDeviceImageSubresourceLayoutKHR.fnHandle == nil {
		vkGetDeviceImageSubresourceLayoutKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceImageSubresourceLayoutKHR")))
	}
	C.Trampoline3(vkGetDeviceImageSubresourceLayoutKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pLayout))))
...
func GetDeviceMemoryCommitment(device Device, memory DeviceMemory) (committedMemoryInBytes DeviceSize) {
	...
	if vkGetDeviceMemoryCommitment.fnHandle == nil {
		vkGetDeviceMemoryCommitment.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceMemoryCommitment")))
	}
	C.Trampoline3(vkGetDeviceMemoryCommitment.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(memory)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pCommittedMemoryInBytes))))
...
func GetDeviceMemoryOpaqueCaptureAddress(device Device, info *DeviceMemoryOpaqueCaptureAddressInfo) (r uint64) {
	...
	if vkGetDeviceMemoryOpaqueCaptureAddress.fnHandle == nil {
		vkGetDeviceMemoryOpaqueCaptureAddress.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceMemoryOpaqueCaptureAddress")))
	}
	rsys = C.Trampoline3(vkGetDeviceMemoryOpaqueCaptureAddress.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
	r = uint64(uintptr(rsys))
...
func GetDeviceMicromapCompatibilityEXT(device Device, versionInfo *MicromapVersionInfoEXT) (compatibility AccelerationStructureCompatibilityKHR) {
	...
	if vkGetDeviceMicromapCompatibilityEXT.fnHandle == nil {
		vkGetDeviceMicromapCompatibilityEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceMicromapCompatibilityEXT")))
	}
	C.Trampoline3(vkGetDeviceMicromapCompatibilityEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pVersionInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pCompatibility))))
...
func GetDeviceProcAddr(device Device, name string) (fn PFN_vkVoidFunction) {
	...
	if vkGetDeviceProcAddr.fnHandle == nil {
		vkGetDeviceProcAddr.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceProcAddr")))
	}
	rsys = C.Trampoline3(vkGetDeviceProcAddr.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pName))), 0)
...
func GetDeviceQueue(device Device, queueFamilyIndex uint32, queueIndex uint32) (queue Queue) {
	...
	if vkGetDeviceQueue.fnHandle == nil {
		vkGetDeviceQueue.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceQueue")))
	}
	C.Trampoline6(vkGetDeviceQueue.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(queueFamilyIndex)), C.uintptr_t(uintptr(queueIndex)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pQueue))), 0, 0)
...
func GetDeviceQueue2(device Device, queueInfo *DeviceQueueInfo2) (queue Queue) {
	...
	if vkGetDeviceQueue2.fnHandle == nil {
		vkGetDeviceQueue2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceQueue2")))
	}
	C.Trampoline3(vkGetDeviceQueue2.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pQueueInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pQueue))))
...
func GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(device Device, renderpass RenderPass) (maxWorkgroupSize Extent2D, r error) {
	...
	if vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI.fnHandle == nil {
		vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI")))
	}
	rsys = C.Trampoline3(vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(renderpass)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMaxWorkgroupSize))))
	r = Result(uintptr(rsys))
...
func GetDisplayModeProperties2KHR(physicalDevice PhysicalDevice, display DisplayKHR) (properties []DisplayModeProperties2KHR, r error) {
	...
	if vkGetDisplayModeProperties2KHR.fnHandle == nil {
		vkGetDisplayModeProperties2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDisplayModeProperties2KHR")))
	}
	rsys = C.Trampoline6(vkGetDisplayModeProperties2KHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(display)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetDisplayModePropertiesKHR(physicalDevice PhysicalDevice, display DisplayKHR) (properties []DisplayModePropertiesKHR, r error) {
	...
	if vkGetDisplayModePropertiesKHR.fnHandle == nil {
		vkGetDisplayModePropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDisplayModePropertiesKHR")))
	}
	rsys = C.Trampoline6(vkGetDisplayModePropertiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(display)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetDisplayPlaneCapabilities2KHR(physicalDevice PhysicalDevice, displayPlaneInfo *DisplayPlaneInfo2KHR) (capabilities DisplayPlaneCapabilities2KHR, r error) {
	...
	if vkGetDisplayPlaneCapabilities2KHR.fnHandle == nil {
		vkGetDisplayPlaneCapabilities2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDisplayPlaneCapabilities2KHR")))
	}
	rsys = C.Trampoline3(vkGetDisplayPlaneCapabilities2KHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pDisplayPlaneInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pCapabilities))))
	r = Result(uintptr(rsys))
...
func GetDisplayPlaneCapabilitiesKHR(physicalDevice PhysicalDevice, mode DisplayModeKHR, planeIndex uint32) (capabilities DisplayPlaneCapabilitiesKHR, r error) {
	...
	if vkGetDisplayPlaneCapabilitiesKHR.fnHandle == nil {
		vkGetDisplayPlaneCapabilitiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDisplayPlaneCapabilitiesKHR")))
	}
	rsys = C.Trampoline6(vkGetDisplayPlaneCapabilitiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(mode)), C.uintptr_t(uintptr(planeIndex)), C.uintptr_t(uintptr(unsafe.Pointer(pCapabilities))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetDisplayPlaneSupportedDisplaysKHR(physicalDevice PhysicalDevice, planeIndex uint32) (displays []DisplayKHR, r error) {
	...
	if vkGetDisplayPlaneSupportedDisplaysKHR.fnHandle == nil {
		vkGetDisplayPlaneSupportedDisplaysKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDisplayPlaneSupportedDisplaysKHR")))
	}
	rsys = C.Trampoline6(vkGetDisplayPlaneSupportedDisplaysKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(planeIndex)), C.uintptr_t(uintptr(unsafe.Pointer(pDisplayCount))), C.uintptr_t(uintptr(unsafe.Pointer(pDisplays))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetDrmDisplayEXT(physicalDevice PhysicalDevice, drmFd int32, connectorId uint32) (display DisplayKHR, r error) {
	...
	if vkGetDrmDisplayEXT.fnHandle == nil {
		vkGetDrmDisplayEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDrmDisplayEXT")))
	}
	rsys = C.Trampoline6(vkGetDrmDisplayEXT.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(drmFd)), C.uintptr_t(uintptr(connectorId)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_display))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetDynamicRenderingTilePropertiesQCOM(device Device, renderingInfo *RenderingInfo) (properties TilePropertiesQCOM, r error) {
	...
	if vkGetDynamicRenderingTilePropertiesQCOM.fnHandle == nil {
		vkGetDynamicRenderingTilePropertiesQCOM.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetDynamicRenderingTilePropertiesQCOM")))
	}
	rsys = C.Trampoline3(vkGetDynamicRenderingTilePropertiesQCOM.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pRenderingInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetEncodedVideoSessionParametersKHR(device Device, videoSessionParametersInfo *VideoEncodeSessionParametersGetInfoKHR) (feedbackInfo VideoEncodeSessionParametersFeedbackInfoKHR, data []byte, r error) {
	...
	if vkGetEncodedVideoSessionParametersKHR.fnHandle == nil {
		vkGetEncodedVideoSessionParametersKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetEncodedVideoSessionParametersKHR")))
	}
	rsys = C.Trampoline6(vkGetEncodedVideoSessionParametersKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pVideoSessionParametersInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pFeedbackInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pDataSize))), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0)
	r = Result(uintptr(rsys))
...
func GetEventStatus(device Device, event Event) (r error) {
	...
	if vkGetEventStatus.fnHandle == nil {
		vkGetEventStatus.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetEventStatus")))
	}
	rsys = C.Trampoline3(vkGetEventStatus.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(event)), 0)
	r = Result(uintptr(rsys))
...
func GetFenceFdKHR(device Device, getFdInfo *FenceGetFdInfoKHR) (fd int32, r error) {
	...
	if vkGetFenceFdKHR.fnHandle == nil {
		vkGetFenceFdKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetFenceFdKHR")))
	}
	rsys = C.Trampoline3(vkGetFenceFdKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pGetFdInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFd))))
	r = Result(uintptr(rsys))
...
func GetFenceStatus(device Device, fence Fence) (r error) {
	...
	if vkGetFenceStatus.fnHandle == nil {
		vkGetFenceStatus.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetFenceStatus")))
	}
	rsys = C.Trampoline3(vkGetFenceStatus.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(fence)), 0)
	r = Result(uintptr(rsys))
...
func GetFramebufferTilePropertiesQCOM(device Device, framebuffer Framebuffer) (properties []TilePropertiesQCOM, r error) {
	...
	if vkGetFramebufferTilePropertiesQCOM.fnHandle == nil {
		vkGetFramebufferTilePropertiesQCOM.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetFramebufferTilePropertiesQCOM")))
	}
	rsys = C.Trampoline6(vkGetFramebufferTilePropertiesQCOM.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(framebuffer)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertiesCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetGeneratedCommandsMemoryRequirementsNV(device Device, info *GeneratedCommandsMemoryRequirementsInfoNV) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetGeneratedCommandsMemoryRequirementsNV.fnHandle == nil {
		vkGetGeneratedCommandsMemoryRequirementsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetGeneratedCommandsMemoryRequirementsNV")))
	}
	C.Trampoline3(vkGetGeneratedCommandsMemoryRequirementsNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetImageDrmFormatModifierPropertiesEXT(device Device, image Image) (properties ImageDrmFormatModifierPropertiesEXT, r error) {
	...
	if vkGetImageDrmFormatModifierPropertiesEXT.fnHandle == nil {
		vkGetImageDrmFormatModifierPropertiesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageDrmFormatModifierPropertiesEXT")))
	}
	rsys = C.Trampoline3(vkGetImageDrmFormatModifierPropertiesEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetImageMemoryRequirements(device Device, image Image) (memoryRequirements MemoryRequirements) {
	...
	if vkGetImageMemoryRequirements.fnHandle == nil {
		vkGetImageMemoryRequirements.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageMemoryRequirements")))
	}
	C.Trampoline3(vkGetImageMemoryRequirements.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMemoryRequirements))))
...
func GetImageMemoryRequirements2(device Device, info *ImageMemoryRequirementsInfo2) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetImageMemoryRequirements2.fnHandle == nil {
		vkGetImageMemoryRequirements2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageMemoryRequirements2")))
	}
	C.Trampoline3(vkGetImageMemoryRequirements2.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetImageOpaqueCaptureDescriptorDataEXT(device Device, info *ImageCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetImageOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetImageOpaqueCaptureDescriptorDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageOpaqueCaptureDescriptorDataEXT")))
	}
	rsys = C.Trampoline3(vkGetImageOpaqueCaptureDescriptorDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pData))))
	r = Result(uintptr(rsys))
...
func GetImageSparseMemoryRequirements(device Device, image Image) (sparseMemoryRequirements []SparseImageMemoryRequirements) {
	...
	if vkGetImageSparseMemoryRequirements.fnHandle == nil {
		vkGetImageSparseMemoryRequirements.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageSparseMemoryRequirements")))
	}
	C.Trampoline6(vkGetImageSparseMemoryRequirements.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirementCount))), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirements))), 0, 0)
...
func GetImageSparseMemoryRequirements2(device Device, info *ImageSparseMemoryRequirementsInfo2) (sparseMemoryRequirements []SparseImageMemoryRequirements2) {
	...
	if vkGetImageSparseMemoryRequirements2.fnHandle == nil {
		vkGetImageSparseMemoryRequirements2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageSparseMemoryRequirements2")))
	}
	C.Trampoline6(vkGetImageSparseMemoryRequirements2.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirementCount))), C.uintptr_t(uintptr(unsafe.Pointer(pSparseMemoryRequirements))), 0, 0)
...
func GetImageSubresourceLayout(device Device, image Image, subresource *ImageSubresource) (layout SubresourceLayout) {
	...
	if vkGetImageSubresourceLayout.fnHandle == nil {
		vkGetImageSubresourceLayout.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageSubresourceLayout")))
	}
	C.Trampoline6(vkGetImageSubresourceLayout.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(unsafe.Pointer(pSubresource))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pLayout))), 0, 0)
...
func GetImageSubresourceLayout2KHR(device Device, image Image, subresource *ImageSubresource2KHR) (layout SubresourceLayout2KHR) {
	...
	if vkGetImageSubresourceLayout2KHR.fnHandle == nil {
		vkGetImageSubresourceLayout2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageSubresourceLayout2KHR")))
	}
	C.Trampoline6(vkGetImageSubresourceLayout2KHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(image)), C.uintptr_t(uintptr(unsafe.Pointer(pSubresource))), C.uintptr_t(uintptr(unsafe.Pointer(pLayout))), 0, 0)
...
func GetImageViewAddressNVX(device Device, imageView ImageView) (properties ImageViewAddressPropertiesNVX, r error) {
	...
	if vkGetImageViewAddressNVX.fnHandle == nil {
		vkGetImageViewAddressNVX.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageViewAddressNVX")))
	}
	rsys = C.Trampoline3(vkGetImageViewAddressNVX.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(imageView)), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetImageViewHandleNVX(device Device, info *ImageViewHandleInfoNVX) (r uint32) {
	...
	if vkGetImageViewHandleNVX.fnHandle == nil {
		vkGetImageViewHandleNVX.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageViewHandleNVX")))
	}
	rsys = C.Trampoline3(vkGetImageViewHandleNVX.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
	r = uint32(uintptr(rsys))
...
func GetImageViewOpaqueCaptureDescriptorDataEXT(device Device, info *ImageViewCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetImageViewOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetImageViewOpaqueCaptureDescriptorDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetImageViewOpaqueCaptureDescriptorDataEXT")))
	}
	rsys = C.Trampoline3(vkGetImageViewOpaqueCaptureDescriptorDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pData))))
	r = Result(uintptr(rsys))
...
func GetInstanceProcAddr(instance Instance, name string) (fn PFN_vkVoidFunction) {
	...
	if vkGetInstanceProcAddr.fnHandle == nil {
		vkGetInstanceProcAddr.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetInstanceProcAddr")))
	}
	rsys = C.Trampoline3(vkGetInstanceProcAddr.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(unsafe.Pointer(pName))), 0)
	fn = PFN_vkVoidFunction(uintptr(rsys))
...
func GetLatencyTimingsNV(device Device, swapchain SwapchainKHR) (latencyMarkerInfo GetLatencyMarkerInfoNV) {
	...
	if vkGetLatencyTimingsNV.fnHandle == nil {
		vkGetLatencyTimingsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetLatencyTimingsNV")))
	}
	C.Trampoline3(vkGetLatencyTimingsNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(pLatencyMarkerInfo))))
...
func GetMemoryFdKHR(device Device, getFdInfo *MemoryGetFdInfoKHR) (fd int32, r error) {
	...
	if vkGetMemoryFdKHR.fnHandle == nil {
		vkGetMemoryFdKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetMemoryFdKHR")))
	}
	rsys = C.Trampoline3(vkGetMemoryFdKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pGetFdInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFd))))
	r = Result(uintptr(rsys))
...
func GetMemoryFdPropertiesKHR(device Device, handleType ExternalMemoryHandleTypeFlagBits, fd int32) (memoryFdProperties MemoryFdPropertiesKHR, r error) {
	...
	if vkGetMemoryFdPropertiesKHR.fnHandle == nil {
		vkGetMemoryFdPropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetMemoryFdPropertiesKHR")))
	}
	rsys = C.Trampoline6(vkGetMemoryFdPropertiesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(handleType)), C.uintptr_t(uintptr(fd)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryFdProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetMemoryHostPointerPropertiesEXT(device Device, handleType ExternalMemoryHandleTypeFlagBits, hostPointer *byte) (memoryHostPointerProperties MemoryHostPointerPropertiesEXT, r error) {
	...
	if vkGetMemoryHostPointerPropertiesEXT.fnHandle == nil {
		vkGetMemoryHostPointerPropertiesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetMemoryHostPointerPropertiesEXT")))
	}
	rsys = C.Trampoline6(vkGetMemoryHostPointerPropertiesEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(handleType)), C.uintptr_t(uintptr(unsafe.Pointer(pHostPointer))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryHostPointerProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetMemoryRemoteAddressNV(device Device, memoryGetRemoteAddressInfo *MemoryGetRemoteAddressInfoNV) (address RemoteAddressNV, r error) {
	...
	if vkGetMemoryRemoteAddressNV.fnHandle == nil {
		vkGetMemoryRemoteAddressNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetMemoryRemoteAddressNV")))
	}
	rsys = C.Trampoline3(vkGetMemoryRemoteAddressNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryGetRemoteAddressInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pAddress))))
	r = Result(uintptr(rsys))
...
func GetMicromapBuildSizesEXT(device Device, buildType AccelerationStructureBuildTypeKHR, buildInfo *MicromapBuildInfoEXT) (sizeInfo MicromapBuildSizesInfoEXT) {
	...
	if vkGetMicromapBuildSizesEXT.fnHandle == nil {
		vkGetMicromapBuildSizesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetMicromapBuildSizesEXT")))
	}
	C.Trampoline6(vkGetMicromapBuildSizesEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(buildType)), C.uintptr_t(uintptr(unsafe.Pointer(pBuildInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSizeInfo))), 0, 0)
...
func GetPastPresentationTimingGOOGLE(device Device, swapchain SwapchainKHR) (presentationTimings []PastPresentationTimingGOOGLE, r error) {
	...
	if vkGetPastPresentationTimingGOOGLE.fnHandle == nil {
		vkGetPastPresentationTimingGOOGLE.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPastPresentationTimingGOOGLE")))
	}
	rsys = C.Trampoline6(vkGetPastPresentationTimingGOOGLE.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(pPresentationTimingCount))), C.uintptr_t(uintptr(unsafe.Pointer(pPresentationTimings))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPerformanceParameterINTEL(device Device, parameter PerformanceParameterTypeINTEL) (value PerformanceValueINTEL, r error) {
	...
	if vkGetPerformanceParameterINTEL.fnHandle == nil {
		vkGetPerformanceParameterINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPerformanceParameterINTEL")))
	}
	rsys = C.Trampoline3(vkGetPerformanceParameterINTEL.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(parameter)), C.uintptr_t(uintptr(unsafe.Pointer(pValue))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceCalibrateableTimeDomainsKHR(physicalDevice PhysicalDevice) (timeDomains []TimeDomainKHR, r error) {
	...
	if vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.fnHandle == nil {
		vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceCalibrateableTimeDomainsKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceCalibrateableTimeDomainsKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pTimeDomainCount))), C.uintptr_t(uintptr(unsafe.Pointer(pTimeDomains))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceCooperativeMatrixPropertiesKHR(physicalDevice PhysicalDevice) (properties []CooperativeMatrixPropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceCooperativeMatrixPropertiesNV(physicalDevice PhysicalDevice) (properties []CooperativeMatrixPropertiesNV, r error) {
	...
	if vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.fnHandle == nil {
		vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceCooperativeMatrixPropertiesNV")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceDisplayPlaneProperties2KHR(physicalDevice PhysicalDevice) (properties []DisplayPlaneProperties2KHR, r error) {
	...
	if vkGetPhysicalDeviceDisplayPlaneProperties2KHR.fnHandle == nil {
		vkGetPhysicalDeviceDisplayPlaneProperties2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceDisplayPlaneProperties2KHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceDisplayPlaneProperties2KHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceDisplayPlanePropertiesKHR(physicalDevice PhysicalDevice) (properties []DisplayPlanePropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceDisplayPlanePropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceDisplayPlanePropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceDisplayPlanePropertiesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceDisplayPlanePropertiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceDisplayProperties2KHR(physicalDevice PhysicalDevice) (properties []DisplayProperties2KHR, r error) {
	...
	if vkGetPhysicalDeviceDisplayProperties2KHR.fnHandle == nil {
		vkGetPhysicalDeviceDisplayProperties2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceDisplayProperties2KHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceDisplayProperties2KHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceDisplayPropertiesKHR(physicalDevice PhysicalDevice) (properties []DisplayPropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceDisplayPropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceDisplayPropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceDisplayPropertiesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceDisplayPropertiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceExternalBufferProperties(physicalDevice PhysicalDevice, externalBufferInfo *PhysicalDeviceExternalBufferInfo) (externalBufferProperties ExternalBufferProperties) {
	...
	if vkGetPhysicalDeviceExternalBufferProperties.fnHandle == nil {
		vkGetPhysicalDeviceExternalBufferProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceExternalBufferProperties")))
	}
	C.Trampoline3(vkGetPhysicalDeviceExternalBufferProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pExternalBufferInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pExternalBufferProperties))))
...
func GetPhysicalDeviceExternalFenceProperties(physicalDevice PhysicalDevice, externalFenceInfo *PhysicalDeviceExternalFenceInfo) (externalFenceProperties ExternalFenceProperties) {
	...
	if vkGetPhysicalDeviceExternalFenceProperties.fnHandle == nil {
		vkGetPhysicalDeviceExternalFenceProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceExternalFenceProperties")))
	}
	C.Trampoline3(vkGetPhysicalDeviceExternalFenceProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pExternalFenceInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pExternalFenceProperties))))
...
func GetPhysicalDeviceExternalImageFormatPropertiesNV(physicalDevice PhysicalDevice, format Format, typ ImageType, tiling ImageTiling, usage ImageUsageFlags, flags ImageCreateFlags, externalHandleType ExternalMemoryHandleTypeFlagsNV) (externalImageFormatProperties ExternalImageFormatPropertiesNV, r error) {
	...
	if vkGetPhysicalDeviceExternalImageFormatPropertiesNV.fnHandle == nil {
		vkGetPhysicalDeviceExternalImageFormatPropertiesNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceExternalImageFormatPropertiesNV")))
	}
	rsys = C.Trampoline9(vkGetPhysicalDeviceExternalImageFormatPropertiesNV.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(format)), C.uintptr_t(uintptr(typ)), C.uintptr_t(uintptr(tiling)), C.uintptr_t(uintptr(usage)), C.uintptr_t(uintptr(flags)), C.uintptr_t(uintptr(externalHandleType)), C.uintptr_t(uintptr(unsafe.Pointer(pExternalImageFormatProperties))), 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceExternalSemaphoreProperties(physicalDevice PhysicalDevice, externalSemaphoreInfo *PhysicalDeviceExternalSemaphoreInfo) (externalSemaphoreProperties ExternalSemaphoreProperties) {
	...
	if vkGetPhysicalDeviceExternalSemaphoreProperties.fnHandle == nil {
		vkGetPhysicalDeviceExternalSemaphoreProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceExternalSemaphoreProperties")))
	}
	C.Trampoline3(vkGetPhysicalDeviceExternalSemaphoreProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pExternalSemaphoreInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pExternalSemaphoreProperties))))
...
func GetPhysicalDeviceFeatures(physicalDevice PhysicalDevice) (features PhysicalDeviceFeatures) {
	...
	if vkGetPhysicalDeviceFeatures.fnHandle == nil {
		vkGetPhysicalDeviceFeatures.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceFeatures")))
	}
	C.Trampoline3(vkGetPhysicalDeviceFeatures.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pFeatures))), 0)
...
func GetPhysicalDeviceFeatures2(physicalDevice PhysicalDevice) (features PhysicalDeviceFeatures2) {
	...
	if vkGetPhysicalDeviceFeatures2.fnHandle == nil {
		vkGetPhysicalDeviceFeatures2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceFeatures2")))
	}
	C.Trampoline3(vkGetPhysicalDeviceFeatures2.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pFeatures))), 0)
...
func GetPhysicalDeviceFormatProperties(physicalDevice PhysicalDevice, format Format) (formatProperties FormatProperties) {
	...
	if vkGetPhysicalDeviceFormatProperties.fnHandle == nil {
		vkGetPhysicalDeviceFormatProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceFormatProperties")))
	}
	C.Trampoline3(vkGetPhysicalDeviceFormatProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(format)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFormatProperties))))
...
func GetPhysicalDeviceFormatProperties2(physicalDevice PhysicalDevice, format Format) (formatProperties FormatProperties2) {
	...
	if vkGetPhysicalDeviceFormatProperties2.fnHandle == nil {
		vkGetPhysicalDeviceFormatProperties2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceFormatProperties2")))
	}
	C.Trampoline3(vkGetPhysicalDeviceFormatProperties2.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(format)), C.uintptr_t(uintptr(unsafe.Pointer(pFormatProperties))))
...
func GetPhysicalDeviceFragmentShadingRatesKHR(physicalDevice PhysicalDevice) (fragmentShadingRates []PhysicalDeviceFragmentShadingRateKHR, r error) {
	...
	if vkGetPhysicalDeviceFragmentShadingRatesKHR.fnHandle == nil {
		vkGetPhysicalDeviceFragmentShadingRatesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceFragmentShadingRatesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceFragmentShadingRatesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pFragmentShadingRateCount))), C.uintptr_t(uintptr(unsafe.Pointer(pFragmentShadingRates))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceImageFormatProperties(physicalDevice PhysicalDevice, format Format, typ ImageType, tiling ImageTiling, usage ImageUsageFlags, flags ImageCreateFlags) (imageFormatProperties ImageFormatProperties, r error) {
	...
	if vkGetPhysicalDeviceImageFormatProperties.fnHandle == nil {
		vkGetPhysicalDeviceImageFormatProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceImageFormatProperties")))
	}
	rsys = C.Trampoline9(vkGetPhysicalDeviceImageFormatProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(format)), C.uintptr_t(uintptr(typ)), C.uintptr_t(uintptr(tiling)), C.uintptr_t(uintptr(usage)), C.uintptr_t(uintptr(flags)), C.uintptr_t(uintptr(unsafe.Pointer(pImageFormatProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceImageFormatProperties2(physicalDevice PhysicalDevice, imageFormatInfo *PhysicalDeviceImageFormatInfo2) (imageFormatProperties ImageFormatProperties2, r error) {
	...
	if vkGetPhysicalDeviceImageFormatProperties2.fnHandle == nil {
		vkGetPhysicalDeviceImageFormatProperties2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceImageFormatProperties2")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceImageFormatProperties2.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pImageFormatInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pImageFormatProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceMemoryProperties(physicalDevice PhysicalDevice) (memoryProperties PhysicalDeviceMemoryProperties) {
	...
	if vkGetPhysicalDeviceMemoryProperties.fnHandle == nil {
		vkGetPhysicalDeviceMemoryProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceMemoryProperties")))
	}
	C.Trampoline3(vkGetPhysicalDeviceMemoryProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pMemoryProperties))), 0)
...
func GetPhysicalDeviceMemoryProperties2(physicalDevice PhysicalDevice) (memoryProperties PhysicalDeviceMemoryProperties2) {
	...
	if vkGetPhysicalDeviceMemoryProperties2.fnHandle == nil {
		vkGetPhysicalDeviceMemoryProperties2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceMemoryProperties2")))
	}
	C.Trampoline3(vkGetPhysicalDeviceMemoryProperties2.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryProperties))), 0)
...
func GetPhysicalDeviceMultisamplePropertiesEXT(physicalDevice PhysicalDevice, samples SampleCountFlagBits) (multisampleProperties MultisamplePropertiesEXT) {
	...
	if vkGetPhysicalDeviceMultisamplePropertiesEXT.fnHandle == nil {
		vkGetPhysicalDeviceMultisamplePropertiesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceMultisamplePropertiesEXT")))
	}
	C.Trampoline3(vkGetPhysicalDeviceMultisamplePropertiesEXT.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(samples)), C.uintptr_t(uintptr(unsafe.Pointer(pMultisampleProperties))))
...
func GetPhysicalDeviceOpticalFlowImageFormatsNV(physicalDevice PhysicalDevice, opticalFlowImageFormatInfo *OpticalFlowImageFormatInfoNV) (imageFormatProperties []OpticalFlowImageFormatPropertiesNV, r error) {
	...
	if vkGetPhysicalDeviceOpticalFlowImageFormatsNV.fnHandle == nil {
		vkGetPhysicalDeviceOpticalFlowImageFormatsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceOpticalFlowImageFormatsNV")))
	}
	rsys = C.Trampoline6(vkGetPhysicalDeviceOpticalFlowImageFormatsNV.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pOpticalFlowImageFormatInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pFormatCount))), C.uintptr_t(uintptr(unsafe.Pointer(pImageFormatProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDevicePresentRectanglesKHR(physicalDevice PhysicalDevice, surface SurfaceKHR) (rects []Rect2D, r error) {
	...
	if vkGetPhysicalDevicePresentRectanglesKHR.fnHandle == nil {
		vkGetPhysicalDevicePresentRectanglesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDevicePresentRectanglesKHR")))
	}
	rsys = C.Trampoline6(vkGetPhysicalDevicePresentRectanglesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(pRectCount))), C.uintptr_t(uintptr(unsafe.Pointer(pRects))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceProperties(physicalDevice PhysicalDevice) (properties PhysicalDeviceProperties) {
	...
	if vkGetPhysicalDeviceProperties.fnHandle == nil {
		vkGetPhysicalDeviceProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceProperties")))
	}
	C.Trampoline3(vkGetPhysicalDeviceProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0)
...
func GetPhysicalDeviceProperties2(physicalDevice PhysicalDevice) (properties PhysicalDeviceProperties2) {
	...
	if vkGetPhysicalDeviceProperties2.fnHandle == nil {
		vkGetPhysicalDeviceProperties2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceProperties2")))
	}
	C.Trampoline3(vkGetPhysicalDeviceProperties2.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0)
...
func GetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(physicalDevice PhysicalDevice, performanceQueryCreateInfo *QueryPoolPerformanceCreateInfoKHR) (numPasses uint32) {
	...
	if vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.fnHandle == nil {
		vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR")))
	}
	C.Trampoline3(vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pPerformanceQueryCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pNumPasses))))
...
func GetPhysicalDeviceQueueFamilyProperties(physicalDevice PhysicalDevice) (queueFamilyProperties []QueueFamilyProperties) {
	...
	if vkGetPhysicalDeviceQueueFamilyProperties.fnHandle == nil {
		vkGetPhysicalDeviceQueueFamilyProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceQueueFamilyProperties")))
	}
	C.Trampoline3(vkGetPhysicalDeviceQueueFamilyProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pQueueFamilyPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pQueueFamilyProperties))))
...
func GetPhysicalDeviceQueueFamilyProperties2(physicalDevice PhysicalDevice) (queueFamilyProperties []QueueFamilyProperties2) {
	...
	if vkGetPhysicalDeviceQueueFamilyProperties2.fnHandle == nil {
		vkGetPhysicalDeviceQueueFamilyProperties2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceQueueFamilyProperties2")))
	}
	C.Trampoline3(vkGetPhysicalDeviceQueueFamilyProperties2.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pQueueFamilyPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pQueueFamilyProperties))))
...
func GetPhysicalDeviceRefreshableObjectTypesKHR(physicalDevice PhysicalDevice) (refreshableObjectTypes []ObjectType, r error) {
	...
	if vkGetPhysicalDeviceRefreshableObjectTypesKHR.fnHandle == nil {
		vkGetPhysicalDeviceRefreshableObjectTypesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceRefreshableObjectTypesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceRefreshableObjectTypesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pRefreshableObjectTypeCount))), C.uintptr_t(uintptr(unsafe.Pointer(pRefreshableObjectTypes))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSparseImageFormatProperties(physicalDevice PhysicalDevice, format Format, typ ImageType, samples SampleCountFlagBits, usage ImageUsageFlags, tiling ImageTiling) (properties []SparseImageFormatProperties) {
	...
	if vkGetPhysicalDeviceSparseImageFormatProperties.fnHandle == nil {
		vkGetPhysicalDeviceSparseImageFormatProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSparseImageFormatProperties")))
	}
	C.Trampoline9(vkGetPhysicalDeviceSparseImageFormatProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(format)), C.uintptr_t(uintptr(typ)), C.uintptr_t(uintptr(samples)), C.uintptr_t(uintptr(usage)), C.uintptr_t(uintptr(tiling)), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0)
...
func GetPhysicalDeviceSparseImageFormatProperties2(physicalDevice PhysicalDevice, formatInfo *PhysicalDeviceSparseImageFormatInfo2) (properties []SparseImageFormatProperties2) {
	...
	if vkGetPhysicalDeviceSparseImageFormatProperties2.fnHandle == nil {
		vkGetPhysicalDeviceSparseImageFormatProperties2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSparseImageFormatProperties2")))
	}
	C.Trampoline6(vkGetPhysicalDeviceSparseImageFormatProperties2.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pFormatInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0, 0)
...
func GetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(physicalDevice PhysicalDevice) (combinations []FramebufferMixedSamplesCombinationNV, r error) {
	...
	if vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV.fnHandle == nil {
		vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pCombinationCount))), C.uintptr_t(uintptr(unsafe.Pointer(pCombinations))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSurfaceCapabilities2EXT(physicalDevice PhysicalDevice, surface SurfaceKHR) (surfaceCapabilities SurfaceCapabilities2EXT, r error) {
	...
	if vkGetPhysicalDeviceSurfaceCapabilities2EXT.fnHandle == nil {
		vkGetPhysicalDeviceSurfaceCapabilities2EXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSurfaceCapabilities2EXT")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceSurfaceCapabilities2EXT.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceCapabilities))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSurfaceCapabilities2KHR(physicalDevice PhysicalDevice, surfaceInfo *PhysicalDeviceSurfaceInfo2KHR) (surfaceCapabilities SurfaceCapabilities2KHR, r error) {
	...
	if vkGetPhysicalDeviceSurfaceCapabilities2KHR.fnHandle == nil {
		vkGetPhysicalDeviceSurfaceCapabilities2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSurfaceCapabilities2KHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceSurfaceCapabilities2KHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceCapabilities))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSurfaceCapabilitiesKHR(physicalDevice PhysicalDevice, surface SurfaceKHR) (surfaceCapabilities SurfaceCapabilitiesKHR, r error) {
	...
	if vkGetPhysicalDeviceSurfaceCapabilitiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceSurfaceCapabilitiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSurfaceCapabilitiesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceSurfaceCapabilitiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceCapabilities))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSurfaceFormats2KHR(physicalDevice PhysicalDevice, surfaceInfo *PhysicalDeviceSurfaceInfo2KHR) (surfaceFormats []SurfaceFormat2KHR, r error) {
	...
	if vkGetPhysicalDeviceSurfaceFormats2KHR.fnHandle == nil {
		vkGetPhysicalDeviceSurfaceFormats2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSurfaceFormats2KHR")))
	}
	rsys = C.Trampoline6(vkGetPhysicalDeviceSurfaceFormats2KHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceFormatCount))), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceFormats))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSurfaceFormatsKHR(physicalDevice PhysicalDevice, surface SurfaceKHR) (surfaceFormats []SurfaceFormatKHR, r error) {
	...
	if vkGetPhysicalDeviceSurfaceFormatsKHR.fnHandle == nil {
		vkGetPhysicalDeviceSurfaceFormatsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSurfaceFormatsKHR")))
	}
	rsys = C.Trampoline6(vkGetPhysicalDeviceSurfaceFormatsKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceFormatCount))), C.uintptr_t(uintptr(unsafe.Pointer(pSurfaceFormats))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSurfacePresentModesKHR(physicalDevice PhysicalDevice, surface SurfaceKHR) (presentModes []PresentModeKHR, r error) {
	...
	if vkGetPhysicalDeviceSurfacePresentModesKHR.fnHandle == nil {
		vkGetPhysicalDeviceSurfacePresentModesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSurfacePresentModesKHR")))
	}
	rsys = C.Trampoline6(vkGetPhysicalDeviceSurfacePresentModesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(pPresentModeCount))), C.uintptr_t(uintptr(unsafe.Pointer(pPresentModes))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceSurfaceSupportKHR(physicalDevice PhysicalDevice, queueFamilyIndex uint32, surface SurfaceKHR) (supported bool, r error) {
	...
	if vkGetPhysicalDeviceSurfaceSupportKHR.fnHandle == nil {
		vkGetPhysicalDeviceSurfaceSupportKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceSurfaceSupportKHR")))
	}
	rsys = C.Trampoline6(vkGetPhysicalDeviceSurfaceSupportKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(queueFamilyIndex)), C.uintptr_t(uintptr(surface)), C.uintptr_t(uintptr(unsafe.Pointer(pSupported))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceToolProperties(physicalDevice PhysicalDevice) (toolProperties []PhysicalDeviceToolProperties, r error) {
	...
	if vkGetPhysicalDeviceToolProperties.fnHandle == nil {
		vkGetPhysicalDeviceToolProperties.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceToolProperties")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceToolProperties.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pToolCount))), C.uintptr_t(uintptr(unsafe.Pointer(pToolProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceVideoCapabilitiesKHR(physicalDevice PhysicalDevice, videoProfile *VideoProfileInfoKHR) (capabilities VideoCapabilitiesKHR, r error) {
	...
	if vkGetPhysicalDeviceVideoCapabilitiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceVideoCapabilitiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceVideoCapabilitiesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceVideoCapabilitiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pVideoProfile))), C.uintptr_t(uintptr(unsafe.Pointer(pCapabilities))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR(physicalDevice PhysicalDevice, qualityLevelInfo *PhysicalDeviceVideoEncodeQualityLevelInfoKHR) (qualityLevelProperties VideoEncodeQualityLevelPropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR")))
	}
	rsys = C.Trampoline3(vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pQualityLevelInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pQualityLevelProperties))))
	r = Result(uintptr(rsys))
...
func GetPhysicalDeviceVideoFormatPropertiesKHR(physicalDevice PhysicalDevice, videoFormatInfo *PhysicalDeviceVideoFormatInfoKHR) (videoFormatProperties []VideoFormatPropertiesKHR, r error) {
	...
	if vkGetPhysicalDeviceVideoFormatPropertiesKHR.fnHandle == nil {
		vkGetPhysicalDeviceVideoFormatPropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPhysicalDeviceVideoFormatPropertiesKHR")))
	}
	rsys = C.Trampoline6(vkGetPhysicalDeviceVideoFormatPropertiesKHR.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(unsafe.Pointer(pVideoFormatInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pVideoFormatPropertyCount))), C.uintptr_t(uintptr(unsafe.Pointer(pVideoFormatProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPipelineCacheData(device Device, pipelineCache PipelineCache) (data []byte, r error) {
	...
	if vkGetPipelineCacheData.fnHandle == nil {
		vkGetPipelineCacheData.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPipelineCacheData")))
	}
	rsys = C.Trampoline6(vkGetPipelineCacheData.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipelineCache)), C.uintptr_t(uintptr(unsafe.Pointer(pDataSize))), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPipelineExecutableInternalRepresentationsKHR(device Device, executableInfo *PipelineExecutableInfoKHR) (internalRepresentations []PipelineExecutableInternalRepresentationKHR, r error) {
	...
	if vkGetPipelineExecutableInternalRepresentationsKHR.fnHandle == nil {
		vkGetPipelineExecutableInternalRepresentationsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPipelineExecutableInternalRepresentationsKHR")))
	}
	rsys = C.Trampoline6(vkGetPipelineExecutableInternalRepresentationsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pExecutableInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pInternalRepresentationCount))), C.uintptr_t(uintptr(unsafe.Pointer(pInternalRepresentations))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPipelineExecutablePropertiesKHR(device Device, pipelineInfo *PipelineInfoKHR) (properties []PipelineExecutablePropertiesKHR, r error) {
	...
	if vkGetPipelineExecutablePropertiesKHR.fnHandle == nil {
		vkGetPipelineExecutablePropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPipelineExecutablePropertiesKHR")))
	}
	rsys = C.Trampoline6(vkGetPipelineExecutablePropertiesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pPipelineInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pExecutableCount))), C.uintptr_t(uintptr(unsafe.Pointer(pProperties))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPipelineExecutableStatisticsKHR(device Device, executableInfo *PipelineExecutableInfoKHR) (statistics []PipelineExecutableStatisticKHR, r error) {
	...
	if vkGetPipelineExecutableStatisticsKHR.fnHandle == nil {
		vkGetPipelineExecutableStatisticsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPipelineExecutableStatisticsKHR")))
	}
	rsys = C.Trampoline6(vkGetPipelineExecutableStatisticsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pExecutableInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pStatisticCount))), C.uintptr_t(uintptr(unsafe.Pointer(pStatistics))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetPipelineIndirectDeviceAddressNV(device Device, info *PipelineIndirectDeviceAddressInfoNV) (deviceAddress DeviceAddress) {
	...
	if vkGetPipelineIndirectDeviceAddressNV.fnHandle == nil {
		vkGetPipelineIndirectDeviceAddressNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPipelineIndirectDeviceAddressNV")))
	}
	rsys = C.Trampoline3(vkGetPipelineIndirectDeviceAddressNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), 0)
	deviceAddress = DeviceAddress(uintptr(rsys))
...
func GetPipelineIndirectMemoryRequirementsNV(device Device, createInfo *ComputePipelineCreateInfo) (memoryRequirements MemoryRequirements2) {
	...
	if vkGetPipelineIndirectMemoryRequirementsNV.fnHandle == nil {
		vkGetPipelineIndirectMemoryRequirementsNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPipelineIndirectMemoryRequirementsNV")))
	}
	C.Trampoline3(vkGetPipelineIndirectMemoryRequirementsNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))))
...
func GetPipelinePropertiesEXT(device Device, pipelineInfo *PipelineInfoEXT) (pipelineProperties BaseOutStructure, r error) {
	...
	if vkGetPipelinePropertiesEXT.fnHandle == nil {
		vkGetPipelinePropertiesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPipelinePropertiesEXT")))
	}
	rsys = C.Trampoline3(vkGetPipelinePropertiesEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pPipelineInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pPipelineProperties))))
	r = Result(uintptr(rsys))
...
func GetPrivateData(device Device, objectType ObjectType, objectHandle uint64, privateDataSlot PrivateDataSlot) (data uint64) {
	...
	if vkGetPrivateData.fnHandle == nil {
		vkGetPrivateData.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetPrivateData")))
	}
	C.Trampoline6(vkGetPrivateData.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(objectType)), C.uintptr_t(uintptr(objectHandle)), C.uintptr_t(uintptr(privateDataSlot)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pData))), 0)
...
func GetQueryPoolResults(device Device, queryPool QueryPool, firstQuery uint32, queryCount uint32, data []byte, stride DeviceSize, flags QueryResultFlags) (r error) {
	...
	if vkGetQueryPoolResults.fnHandle == nil {
		vkGetQueryPoolResults.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetQueryPoolResults")))
	}
	rsys = C.Trampoline9(vkGetQueryPoolResults.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(firstQuery)), C.uintptr_t(uintptr(queryCount)), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pData))), C.uintptr_t(uintptr(stride)), C.uintptr_t(uintptr(flags)), 0)
	r = Result(uintptr(rsys))
...
func GetQueueCheckpointData2NV(queue Queue) (checkpointData []CheckpointData2NV) {
	...
	if vkGetQueueCheckpointData2NV.fnHandle == nil {
		vkGetQueueCheckpointData2NV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetQueueCheckpointData2NV")))
	}
	C.Trampoline3(vkGetQueueCheckpointData2NV.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(unsafe.Pointer(pCheckpointDataCount))), C.uintptr_t(uintptr(unsafe.Pointer(pCheckpointData))))
...
func GetQueueCheckpointDataNV(queue Queue) (checkpointData []CheckpointDataNV) {
	...
	if vkGetQueueCheckpointDataNV.fnHandle == nil {
		vkGetQueueCheckpointDataNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetQueueCheckpointDataNV")))
	}
	C.Trampoline3(vkGetQueueCheckpointDataNV.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(unsafe.Pointer(pCheckpointDataCount))), C.uintptr_t(uintptr(unsafe.Pointer(pCheckpointData))))
...
func GetRayTracingCaptureReplayShaderGroupHandlesKHR(device Device, pipeline Pipeline, firstGroup uint32, groupCount uint32, data []byte) (r error) {
	...
	if vkGetRayTracingCaptureReplayShaderGroupHandlesKHR.fnHandle == nil {
		vkGetRayTracingCaptureReplayShaderGroupHandlesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetRayTracingCaptureReplayShaderGroupHandlesKHR")))
	}
	rsys = C.Trampoline6(vkGetRayTracingCaptureReplayShaderGroupHandlesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipeline)), C.uintptr_t(uintptr(firstGroup)), C.uintptr_t(uintptr(groupCount)), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pData))))
	r = Result(uintptr(rsys))
...
func GetRayTracingShaderGroupHandlesKHR(device Device, pipeline Pipeline, firstGroup uint32, groupCount uint32, data []byte) (r error) {
	...
	if vkGetRayTracingShaderGroupHandlesKHR.fnHandle == nil {
		vkGetRayTracingShaderGroupHandlesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetRayTracingShaderGroupHandlesKHR")))
	}
	rsys = C.Trampoline6(vkGetRayTracingShaderGroupHandlesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipeline)), C.uintptr_t(uintptr(firstGroup)), C.uintptr_t(uintptr(groupCount)), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pData))))
	r = Result(uintptr(rsys))
...
func GetRayTracingShaderGroupStackSizeKHR(device Device, pipeline Pipeline, group uint32, groupShader ShaderGroupShaderKHR) (deviceSize DeviceSize) {
	...
	if vkGetRayTracingShaderGroupStackSizeKHR.fnHandle == nil {
		vkGetRayTracingShaderGroupStackSizeKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetRayTracingShaderGroupStackSizeKHR")))
	}
	rsys = C.Trampoline6(vkGetRayTracingShaderGroupStackSizeKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipeline)), C.uintptr_t(uintptr(group)), C.uintptr_t(uintptr(groupShader)), 0, 0)
	deviceSize = DeviceSize(uintptr(rsys))
...
func GetRefreshCycleDurationGOOGLE(device Device, swapchain SwapchainKHR) (displayTimingProperties RefreshCycleDurationGOOGLE, r error) {
	...
	if vkGetRefreshCycleDurationGOOGLE.fnHandle == nil {
		vkGetRefreshCycleDurationGOOGLE.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetRefreshCycleDurationGOOGLE")))
	}
	rsys = C.Trampoline3(vkGetRefreshCycleDurationGOOGLE.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pDisplayTimingProperties))))
	r = Result(uintptr(rsys))
...
func GetRenderAreaGranularity(device Device, renderPass RenderPass) (granularity Extent2D) {
	...
	if vkGetRenderAreaGranularity.fnHandle == nil {
		vkGetRenderAreaGranularity.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetRenderAreaGranularity")))
	}
	C.Trampoline3(vkGetRenderAreaGranularity.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(renderPass)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pGranularity))))
...
func GetRenderingAreaGranularityKHR(device Device, renderingAreaInfo *RenderingAreaInfoKHR) (granularity Extent2D) {
	...
	if vkGetRenderingAreaGranularityKHR.fnHandle == nil {
		vkGetRenderingAreaGranularityKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetRenderingAreaGranularityKHR")))
	}
	C.Trampoline3(vkGetRenderingAreaGranularityKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pRenderingAreaInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pGranularity))))
...
func GetSamplerOpaqueCaptureDescriptorDataEXT(device Device, info *SamplerCaptureDescriptorDataInfoEXT) (data byte, r error) {
	...
	if vkGetSamplerOpaqueCaptureDescriptorDataEXT.fnHandle == nil {
		vkGetSamplerOpaqueCaptureDescriptorDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetSamplerOpaqueCaptureDescriptorDataEXT")))
	}
	rsys = C.Trampoline3(vkGetSamplerOpaqueCaptureDescriptorDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pData))))
	r = Result(uintptr(rsys))
...
func GetSemaphoreCounterValue(device Device, semaphore Semaphore) (value uint64, r error) {
	...
	if vkGetSemaphoreCounterValue.fnHandle == nil {
		vkGetSemaphoreCounterValue.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetSemaphoreCounterValue")))
	}
	rsys = C.Trampoline3(vkGetSemaphoreCounterValue.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(semaphore)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pValue))))
	r = Result(uintptr(rsys))
...
func GetSemaphoreFdKHR(device Device, getFdInfo *SemaphoreGetFdInfoKHR) (fd int32, r error) {
	...
	if vkGetSemaphoreFdKHR.fnHandle == nil {
		vkGetSemaphoreFdKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetSemaphoreFdKHR")))
	}
	rsys = C.Trampoline3(vkGetSemaphoreFdKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pGetFdInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFd))))
	r = Result(uintptr(rsys))
...
func GetShaderBinaryDataEXT(device Device, shader ShaderEXT) (data []byte, r error) {
	...
	if vkGetShaderBinaryDataEXT.fnHandle == nil {
		vkGetShaderBinaryDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetShaderBinaryDataEXT")))
	}
	rsys = C.Trampoline6(vkGetShaderBinaryDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(shader)), C.uintptr_t(uintptr(unsafe.Pointer(pDataSize))), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetShaderInfoAMD(device Device, pipeline Pipeline, shaderStage ShaderStageFlagBits, infoType ShaderInfoTypeAMD) (info []byte, r error) {
	...
	if vkGetShaderInfoAMD.fnHandle == nil {
		vkGetShaderInfoAMD.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetShaderInfoAMD")))
	}
	rsys = C.Trampoline6(vkGetShaderInfoAMD.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(pipeline)), C.uintptr_t(uintptr(shaderStage)), C.uintptr_t(uintptr(infoType)), C.uintptr_t(uintptr(unsafe.Pointer(pInfoSize))), C.uintptr_t(uintptr(unsafe.Pointer(pInfo))))
	r = Result(uintptr(rsys))
...
func GetShaderModuleCreateInfoIdentifierEXT(device Device, createInfo *ShaderModuleCreateInfo) (identifier ShaderModuleIdentifierEXT) {
	...
	if vkGetShaderModuleCreateInfoIdentifierEXT.fnHandle == nil {
		vkGetShaderModuleCreateInfoIdentifierEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetShaderModuleCreateInfoIdentifierEXT")))
	}
	C.Trampoline3(vkGetShaderModuleCreateInfoIdentifierEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pCreateInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pIdentifier))))
...
func GetShaderModuleIdentifierEXT(device Device, shaderModule ShaderModule) (identifier ShaderModuleIdentifierEXT) {
	...
	if vkGetShaderModuleIdentifierEXT.fnHandle == nil {
		vkGetShaderModuleIdentifierEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetShaderModuleIdentifierEXT")))
	}
	C.Trampoline3(vkGetShaderModuleIdentifierEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(shaderModule)), C.uintptr_t(uintptr(unsafe.Pointer(pIdentifier))))
...
func GetSwapchainCounterEXT(device Device, swapchain SwapchainKHR, counter SurfaceCounterFlagBitsEXT) (counterValue uint64, r error) {
	...
	if vkGetSwapchainCounterEXT.fnHandle == nil {
		vkGetSwapchainCounterEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetSwapchainCounterEXT")))
	}
	rsys = C.Trampoline6(vkGetSwapchainCounterEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(counter)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pCounterValue))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetSwapchainImagesKHR(device Device, swapchain SwapchainKHR) (swapchainImages []Image, r error) {
	...
	if vkGetSwapchainImagesKHR.fnHandle == nil {
		vkGetSwapchainImagesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetSwapchainImagesKHR")))
	}
	rsys = C.Trampoline6(vkGetSwapchainImagesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(pSwapchainImageCount))), C.uintptr_t(uintptr(unsafe.Pointer(pSwapchainImages))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetSwapchainStatusKHR(device Device, swapchain SwapchainKHR) (r error) {
	...
	if vkGetSwapchainStatusKHR.fnHandle == nil {
		vkGetSwapchainStatusKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetSwapchainStatusKHR")))
	}
	rsys = C.Trampoline3(vkGetSwapchainStatusKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), 0)
	r = Result(uintptr(rsys))
...
func GetValidationCacheDataEXT(device Device, validationCache ValidationCacheEXT) (data []byte, r error) {
	...
	if vkGetValidationCacheDataEXT.fnHandle == nil {
		vkGetValidationCacheDataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetValidationCacheDataEXT")))
	}
	rsys = C.Trampoline6(vkGetValidationCacheDataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(validationCache)), C.uintptr_t(uintptr(unsafe.Pointer(pDataSize))), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0, 0)
	r = Result(uintptr(rsys))
...
func GetVideoSessionMemoryRequirementsKHR(device Device, videoSession VideoSessionKHR) (memoryRequirements []VideoSessionMemoryRequirementsKHR, r error) {
	...
	if vkGetVideoSessionMemoryRequirementsKHR.fnHandle == nil {
		vkGetVideoSessionMemoryRequirementsKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkGetVideoSessionMemoryRequirementsKHR")))
	}
	rsys = C.Trampoline6(vkGetVideoSessionMemoryRequirementsKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(videoSession)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirementsCount))), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRequirements))), 0, 0)
	r = Result(uintptr(rsys))
...
func ImportFenceFdKHR(device Device, importFenceFdInfo *ImportFenceFdInfoKHR) (r error) {
	...
	if vkImportFenceFdKHR.fnHandle == nil {
		vkImportFenceFdKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkImportFenceFdKHR")))
	}
	rsys = C.Trampoline3(vkImportFenceFdKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pImportFenceFdInfo))), 0)
	r = Result(uintptr(rsys))
...
func ImportSemaphoreFdKHR(device Device, importSemaphoreFdInfo *ImportSemaphoreFdInfoKHR) (r error) {
	...
	if vkImportSemaphoreFdKHR.fnHandle == nil {
		vkImportSemaphoreFdKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkImportSemaphoreFdKHR")))
	}
	rsys = C.Trampoline3(vkImportSemaphoreFdKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pImportSemaphoreFdInfo))), 0)
	r = Result(uintptr(rsys))
...
func InitializePerformanceApiINTEL(device Device, initializeInfo *InitializePerformanceApiInfoINTEL) (r error) {
	...
	if vkInitializePerformanceApiINTEL.fnHandle == nil {
		vkInitializePerformanceApiINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkInitializePerformanceApiINTEL")))
	}
	rsys = C.Trampoline3(vkInitializePerformanceApiINTEL.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pInitializeInfo))), 0)
	r = Result(uintptr(rsys))
...
func InvalidateMappedMemoryRanges(device Device, memoryRanges []MappedMemoryRange) (r error) {
	...
	if vkInvalidateMappedMemoryRanges.fnHandle == nil {
		vkInvalidateMappedMemoryRanges.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkInvalidateMappedMemoryRanges")))
	}
	rsys = C.Trampoline3(vkInvalidateMappedMemoryRanges.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(memoryRangeCount)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryRanges))))
	r = Result(uintptr(rsys))
...
func LatencySleepNV(device Device, swapchain SwapchainKHR, sleepInfo *LatencySleepInfoNV) (r error) {
	...
	if vkLatencySleepNV.fnHandle == nil {
		vkLatencySleepNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkLatencySleepNV")))
	}
	rsys = C.Trampoline3(vkLatencySleepNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(pSleepInfo))))
	r = Result(uintptr(rsys))
...
func MapMemory(device Device, memory DeviceMemory, offset DeviceSize, size DeviceSize, flags MemoryMapFlags) (pData *byte, r error) {
	...
	if vkMapMemory.fnHandle == nil {
		vkMapMemory.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkMapMemory")))
	}
	rsys = C.Trampoline6(vkMapMemory.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(memory)), C.uintptr_t(uintptr(offset)), C.uintptr_t(uintptr(size)), C.uintptr_t(uintptr(flags)), C.uintptr_t(uintptr(unsafe.Pointer(ptr_ppData))))
	r = Result(uintptr(rsys))
...
func MapMemory2KHR(device Device, memoryMapInfo *MemoryMapInfoKHR) (pData *byte, r error) {
	...
	if vkMapMemory2KHR.fnHandle == nil {
		vkMapMemory2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkMapMemory2KHR")))
	}
	rsys = C.Trampoline3(vkMapMemory2KHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryMapInfo))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_ppData))))
	r = Result(uintptr(rsys))
...
func MergePipelineCaches(device Device, dstCache PipelineCache, srcCaches []PipelineCache) (r error) {
	...
	if vkMergePipelineCaches.fnHandle == nil {
		vkMergePipelineCaches.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkMergePipelineCaches")))
	}
	rsys = C.Trampoline6(vkMergePipelineCaches.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(dstCache)), C.uintptr_t(uintptr(srcCacheCount)), C.uintptr_t(uintptr(unsafe.Pointer(pSrcCaches))), 0, 0)
	r = Result(uintptr(rsys))
...
func MergeValidationCachesEXT(device Device, dstCache ValidationCacheEXT, srcCaches []ValidationCacheEXT) (r error) {
	...
	if vkMergeValidationCachesEXT.fnHandle == nil {
		vkMergeValidationCachesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkMergeValidationCachesEXT")))
	}
	rsys = C.Trampoline6(vkMergeValidationCachesEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(dstCache)), C.uintptr_t(uintptr(srcCacheCount)), C.uintptr_t(uintptr(unsafe.Pointer(pSrcCaches))), 0, 0)
	r = Result(uintptr(rsys))
...
func QueueBeginDebugUtilsLabelEXT(queue Queue, labelInfo *DebugUtilsLabelEXT) {
	...
	if vkQueueBeginDebugUtilsLabelEXT.fnHandle == nil {
		vkQueueBeginDebugUtilsLabelEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueBeginDebugUtilsLabelEXT")))
	}
	C.Trampoline3(vkQueueBeginDebugUtilsLabelEXT.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(unsafe.Pointer(pLabelInfo))), 0)
...
func QueueBindSparse(queue Queue, bindInfo []BindSparseInfo, fence Fence) (r error) {
	...
	if vkQueueBindSparse.fnHandle == nil {
		vkQueueBindSparse.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueBindSparse")))
	}
	rsys = C.Trampoline6(vkQueueBindSparse.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(bindInfoCount)), C.uintptr_t(uintptr(unsafe.Pointer(pBindInfo))), C.uintptr_t(uintptr(fence)), 0, 0)
	r = Result(uintptr(rsys))
...
func QueueEndDebugUtilsLabelEXT(queue Queue) {
	...
	if vkQueueEndDebugUtilsLabelEXT.fnHandle == nil {
		vkQueueEndDebugUtilsLabelEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueEndDebugUtilsLabelEXT")))
	}
	C.Trampoline3(vkQueueEndDebugUtilsLabelEXT.fnHandle, C.uintptr_t(uintptr(queue)), 0, 0)
...
func QueueInsertDebugUtilsLabelEXT(queue Queue, labelInfo *DebugUtilsLabelEXT) {
	...
	if vkQueueInsertDebugUtilsLabelEXT.fnHandle == nil {
		vkQueueInsertDebugUtilsLabelEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueInsertDebugUtilsLabelEXT")))
	}
	C.Trampoline3(vkQueueInsertDebugUtilsLabelEXT.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(unsafe.Pointer(pLabelInfo))), 0)
...
func QueueNotifyOutOfBandNV(queue Queue, queueTypeInfo *OutOfBandQueueTypeInfoNV) {
	...
	if vkQueueNotifyOutOfBandNV.fnHandle == nil {
		vkQueueNotifyOutOfBandNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueNotifyOutOfBandNV")))
	}
	C.Trampoline3(vkQueueNotifyOutOfBandNV.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(unsafe.Pointer(pQueueTypeInfo))), 0)
...
func QueuePresentKHR(queue Queue, presentInfo *PresentInfoKHR) (r error) {
	...
	if vkQueuePresentKHR.fnHandle == nil {
		vkQueuePresentKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueuePresentKHR")))
	}
	rsys = C.Trampoline3(vkQueuePresentKHR.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(unsafe.Pointer(pPresentInfo))), 0)
	r = Result(uintptr(rsys))
...
func QueueSetPerformanceConfigurationINTEL(queue Queue, configuration PerformanceConfigurationINTEL) (r error) {
	...
	if vkQueueSetPerformanceConfigurationINTEL.fnHandle == nil {
		vkQueueSetPerformanceConfigurationINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueSetPerformanceConfigurationINTEL")))
	}
	rsys = C.Trampoline3(vkQueueSetPerformanceConfigurationINTEL.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(configuration)), 0)
	r = Result(uintptr(rsys))
...
func QueueSubmit(queue Queue, submits []SubmitInfo, fence Fence) (r error) {
	...
	if vkQueueSubmit.fnHandle == nil {
		vkQueueSubmit.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueSubmit")))
	}
	rsys = C.Trampoline6(vkQueueSubmit.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(submitCount)), C.uintptr_t(uintptr(unsafe.Pointer(pSubmits))), C.uintptr_t(uintptr(fence)), 0, 0)
	r = Result(uintptr(rsys))
...
func QueueSubmit2(queue Queue, submits []SubmitInfo2, fence Fence) (r error) {
	...
	if vkQueueSubmit2.fnHandle == nil {
		vkQueueSubmit2.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueSubmit2")))
	}
	rsys = C.Trampoline6(vkQueueSubmit2.fnHandle, C.uintptr_t(uintptr(queue)), C.uintptr_t(uintptr(submitCount)), C.uintptr_t(uintptr(unsafe.Pointer(pSubmits))), C.uintptr_t(uintptr(fence)), 0, 0)
	r = Result(uintptr(rsys))
...
func QueueWaitIdle(queue Queue) (r error) {
	...
	if vkQueueWaitIdle.fnHandle == nil {
		vkQueueWaitIdle.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkQueueWaitIdle")))
	}
	rsys = C.Trampoline3(vkQueueWaitIdle.fnHandle, C.uintptr_t(uintptr(queue)), 0, 0)
	r = Result(uintptr(rsys))
...
func RegisterDeviceEventEXT(device Device, deviceEventInfo *DeviceEventInfoEXT, allocator *AllocationCallbacks) (fence Fence, r error) {
	...
	if vkRegisterDeviceEventEXT.fnHandle == nil {
		vkRegisterDeviceEventEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkRegisterDeviceEventEXT")))
	}
	rsys = C.Trampoline6(vkRegisterDeviceEventEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pDeviceEventInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFence))), 0, 0)
	r = Result(uintptr(rsys))
...
func RegisterDisplayEventEXT(device Device, display DisplayKHR, displayEventInfo *DisplayEventInfoEXT, allocator *AllocationCallbacks) (fence Fence, r error) {
	...
	if vkRegisterDisplayEventEXT.fnHandle == nil {
		vkRegisterDisplayEventEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkRegisterDisplayEventEXT")))
	}
	rsys = C.Trampoline6(vkRegisterDisplayEventEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(display)), C.uintptr_t(uintptr(unsafe.Pointer(pDisplayEventInfo))), C.uintptr_t(uintptr(unsafe.Pointer(pAllocator))), C.uintptr_t(uintptr(unsafe.Pointer(ptr_pFence))), 0)
	r = Result(uintptr(rsys))
...
func ReleaseDisplayEXT(physicalDevice PhysicalDevice, display DisplayKHR) (r error) {
	...
	if vkReleaseDisplayEXT.fnHandle == nil {
		vkReleaseDisplayEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkReleaseDisplayEXT")))
	}
	rsys = C.Trampoline3(vkReleaseDisplayEXT.fnHandle, C.uintptr_t(uintptr(physicalDevice)), C.uintptr_t(uintptr(display)), 0)
	r = Result(uintptr(rsys))
...
func ReleasePerformanceConfigurationINTEL(device Device, configuration PerformanceConfigurationINTEL) (r error) {
	...
	if vkReleasePerformanceConfigurationINTEL.fnHandle == nil {
		vkReleasePerformanceConfigurationINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkReleasePerformanceConfigurationINTEL")))
	}
	rsys = C.Trampoline3(vkReleasePerformanceConfigurationINTEL.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(configuration)), 0)
	r = Result(uintptr(rsys))
...
func ReleaseProfilingLockKHR(device Device) {
	...
	if vkReleaseProfilingLockKHR.fnHandle == nil {
		vkReleaseProfilingLockKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkReleaseProfilingLockKHR")))
	}
	C.Trampoline3(vkReleaseProfilingLockKHR.fnHandle, C.uintptr_t(uintptr(device)), 0, 0)
...
func ReleaseSwapchainImagesEXT(device Device, releaseInfo *ReleaseSwapchainImagesInfoEXT) (r error) {
	...
	if vkReleaseSwapchainImagesEXT.fnHandle == nil {
		vkReleaseSwapchainImagesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkReleaseSwapchainImagesEXT")))
	}
	rsys = C.Trampoline3(vkReleaseSwapchainImagesEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pReleaseInfo))), 0)
	r = Result(uintptr(rsys))
...
func ResetCommandBuffer(commandBuffer CommandBuffer, flags CommandBufferResetFlags) (r error) {
	...
	if vkResetCommandBuffer.fnHandle == nil {
		vkResetCommandBuffer.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkResetCommandBuffer")))
	}
	rsys = C.Trampoline3(vkResetCommandBuffer.fnHandle, C.uintptr_t(uintptr(commandBuffer)), C.uintptr_t(uintptr(flags)), 0)
	r = Result(uintptr(rsys))
...
func ResetCommandPool(device Device, commandPool CommandPool, flags CommandPoolResetFlags) (r error) {
	...
	if vkResetCommandPool.fnHandle == nil {
		vkResetCommandPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkResetCommandPool")))
	}
	rsys = C.Trampoline3(vkResetCommandPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(commandPool)), C.uintptr_t(uintptr(flags)))
	r = Result(uintptr(rsys))
...
func ResetDescriptorPool(device Device, descriptorPool DescriptorPool, flags DescriptorPoolResetFlags) (r error) {
	...
	if vkResetDescriptorPool.fnHandle == nil {
		vkResetDescriptorPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkResetDescriptorPool")))
	}
	rsys = C.Trampoline3(vkResetDescriptorPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorPool)), C.uintptr_t(uintptr(flags)))
	r = Result(uintptr(rsys))
...
func ResetEvent(device Device, event Event) (r error) {
	...
	if vkResetEvent.fnHandle == nil {
		vkResetEvent.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkResetEvent")))
	}
	rsys = C.Trampoline3(vkResetEvent.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(event)), 0)
	r = Result(uintptr(rsys))
...
func ResetFences(device Device, fences []Fence) (r error) {
	...
	if vkResetFences.fnHandle == nil {
		vkResetFences.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkResetFences")))
	}
	rsys = C.Trampoline3(vkResetFences.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(fenceCount)), C.uintptr_t(uintptr(unsafe.Pointer(pFences))))
	r = Result(uintptr(rsys))
...
func ResetQueryPool(device Device, queryPool QueryPool, firstQuery uint32, queryCount uint32) {
	...
	if vkResetQueryPool.fnHandle == nil {
		vkResetQueryPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkResetQueryPool")))
	}
	C.Trampoline6(vkResetQueryPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(queryPool)), C.uintptr_t(uintptr(firstQuery)), C.uintptr_t(uintptr(queryCount)), 0, 0)
...
func SetDebugUtilsObjectNameEXT(device Device, nameInfo *DebugUtilsObjectNameInfoEXT) (r error) {
	...
	if vkSetDebugUtilsObjectNameEXT.fnHandle == nil {
		vkSetDebugUtilsObjectNameEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetDebugUtilsObjectNameEXT")))
	}
	rsys = C.Trampoline3(vkSetDebugUtilsObjectNameEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pNameInfo))), 0)
	r = Result(uintptr(rsys))
...
func SetDebugUtilsObjectTagEXT(device Device, tagInfo *DebugUtilsObjectTagInfoEXT) (r error) {
	...
	if vkSetDebugUtilsObjectTagEXT.fnHandle == nil {
		vkSetDebugUtilsObjectTagEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetDebugUtilsObjectTagEXT")))
	}
	rsys = C.Trampoline3(vkSetDebugUtilsObjectTagEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pTagInfo))), 0)
	r = Result(uintptr(rsys))
...
func SetDeviceMemoryPriorityEXT(device Device, memory DeviceMemory, priority float32) {
	...
	if vkSetDeviceMemoryPriorityEXT.fnHandle == nil {
		vkSetDeviceMemoryPriorityEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetDeviceMemoryPriorityEXT")))
	}
	C.Trampoline3(vkSetDeviceMemoryPriorityEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(memory)), C.uintptr_t(uintptr(priority)))
...
func SetEvent(device Device, event Event) (r error) {
	...
	if vkSetEvent.fnHandle == nil {
		vkSetEvent.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetEvent")))
	}
	rsys = C.Trampoline3(vkSetEvent.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(event)), 0)
	r = Result(uintptr(rsys))
...
func SetHdrMetadataEXT(device Device, swapchains []SwapchainKHR, metadata []HdrMetadataEXT) {
	...
	if vkSetHdrMetadataEXT.fnHandle == nil {
		vkSetHdrMetadataEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetHdrMetadataEXT")))
	}
	C.Trampoline6(vkSetHdrMetadataEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchainCount)), C.uintptr_t(uintptr(unsafe.Pointer(pSwapchains))), C.uintptr_t(uintptr(unsafe.Pointer(pMetadata))), 0, 0)
...
func SetLatencyMarkerNV(device Device, swapchain SwapchainKHR, latencyMarkerInfo *SetLatencyMarkerInfoNV) {
	...
	if vkSetLatencyMarkerNV.fnHandle == nil {
		vkSetLatencyMarkerNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetLatencyMarkerNV")))
	}
	C.Trampoline3(vkSetLatencyMarkerNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(pLatencyMarkerInfo))))
...
func SetLatencySleepModeNV(device Device, swapchain SwapchainKHR, sleepModeInfo *LatencySleepModeInfoNV) (r error) {
	...
	if vkSetLatencySleepModeNV.fnHandle == nil {
		vkSetLatencySleepModeNV.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetLatencySleepModeNV")))
	}
	rsys = C.Trampoline3(vkSetLatencySleepModeNV.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(unsafe.Pointer(pSleepModeInfo))))
	r = Result(uintptr(rsys))
...
func SetLocalDimmingAMD(device Device, swapChain SwapchainKHR, localDimmingEnable bool) {
	...
	if vkSetLocalDimmingAMD.fnHandle == nil {
		vkSetLocalDimmingAMD.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetLocalDimmingAMD")))
	}
	C.Trampoline3(vkSetLocalDimmingAMD.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapChain)), C.uintptr_t(uintptr(localDimmingEnable_Bool32)))
...
func SetPrivateData(device Device, objectType ObjectType, objectHandle uint64, privateDataSlot PrivateDataSlot, data uint64) (r error) {
	...
	if vkSetPrivateData.fnHandle == nil {
		vkSetPrivateData.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSetPrivateData")))
	}
	rsys = C.Trampoline6(vkSetPrivateData.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(objectType)), C.uintptr_t(uintptr(objectHandle)), C.uintptr_t(uintptr(privateDataSlot)), C.uintptr_t(uintptr(data)), 0)
	r = Result(uintptr(rsys))
...
func SignalSemaphore(device Device, signalInfo *SemaphoreSignalInfo) (r error) {
	...
	if vkSignalSemaphore.fnHandle == nil {
		vkSignalSemaphore.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSignalSemaphore")))
	}
	rsys = C.Trampoline3(vkSignalSemaphore.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pSignalInfo))), 0)
	r = Result(uintptr(rsys))
...
func SubmitDebugUtilsMessageEXT(instance Instance, messageSeverity DebugUtilsMessageSeverityFlagBitsEXT, messageTypes DebugUtilsMessageTypeFlagsEXT, callbackData *DebugUtilsMessengerCallbackDataEXT) {
	...
	if vkSubmitDebugUtilsMessageEXT.fnHandle == nil {
		vkSubmitDebugUtilsMessageEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkSubmitDebugUtilsMessageEXT")))
	}
	C.Trampoline6(vkSubmitDebugUtilsMessageEXT.fnHandle, C.uintptr_t(uintptr(instance)), C.uintptr_t(uintptr(messageSeverity)), C.uintptr_t(uintptr(messageTypes)), C.uintptr_t(uintptr(unsafe.Pointer(pCallbackData))), 0, 0)
...
func TransitionImageLayoutEXT(device Device, transitions []HostImageLayoutTransitionInfoEXT) (r error) {
	...
	if vkTransitionImageLayoutEXT.fnHandle == nil {
		vkTransitionImageLayoutEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkTransitionImageLayoutEXT")))
	}
	rsys = C.Trampoline3(vkTransitionImageLayoutEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(transitionCount)), C.uintptr_t(uintptr(unsafe.Pointer(pTransitions))))
	r = Result(uintptr(rsys))
...
func TrimCommandPool(device Device, commandPool CommandPool, flags CommandPoolTrimFlags) {
	...
	if vkTrimCommandPool.fnHandle == nil {
		vkTrimCommandPool.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkTrimCommandPool")))
	}
	C.Trampoline3(vkTrimCommandPool.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(commandPool)), C.uintptr_t(uintptr(flags)))
...
func UninitializePerformanceApiINTEL(device Device) {
	...
	if vkUninitializePerformanceApiINTEL.fnHandle == nil {
		vkUninitializePerformanceApiINTEL.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkUninitializePerformanceApiINTEL")))
	}
	C.Trampoline3(vkUninitializePerformanceApiINTEL.fnHandle, C.uintptr_t(uintptr(device)), 0, 0)
...
func UnmapMemory(device Device, memory DeviceMemory) {
	...
	if vkUnmapMemory.fnHandle == nil {
		vkUnmapMemory.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkUnmapMemory")))
	}
	C.Trampoline3(vkUnmapMemory.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(memory)), 0)
...
func UnmapMemory2KHR(device Device, memoryUnmapInfo *MemoryUnmapInfoKHR) (r error) {
	...
	if vkUnmapMemory2KHR.fnHandle == nil {
		vkUnmapMemory2KHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkUnmapMemory2KHR")))
	}
	rsys = C.Trampoline3(vkUnmapMemory2KHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pMemoryUnmapInfo))), 0)
	r = Result(uintptr(rsys))
...
func UpdateDescriptorSetWithTemplate(device Device, descriptorSet DescriptorSet, descriptorUpdateTemplate DescriptorUpdateTemplate, data *byte) {
	...
	if vkUpdateDescriptorSetWithTemplate.fnHandle == nil {
		vkUpdateDescriptorSetWithTemplate.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkUpdateDescriptorSetWithTemplate")))
	}
	C.Trampoline6(vkUpdateDescriptorSetWithTemplate.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorSet)), C.uintptr_t(uintptr(descriptorUpdateTemplate)), C.uintptr_t(uintptr(unsafe.Pointer(pData))), 0, 0)
...
func UpdateDescriptorSets(device Device, descriptorWrites []WriteDescriptorSet, descriptorCopies []CopyDescriptorSet) {
	...
	if vkUpdateDescriptorSets.fnHandle == nil {
		vkUpdateDescriptorSets.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkUpdateDescriptorSets")))
	}
	C.Trampoline6(vkUpdateDescriptorSets.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(descriptorWriteCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptorWrites))), C.uintptr_t(uintptr(descriptorCopyCount)), C.uintptr_t(uintptr(unsafe.Pointer(pDescriptorCopies))), 0)
...
func UpdateVideoSessionParametersKHR(device Device, videoSessionParameters VideoSessionParametersKHR, updateInfo *VideoSessionParametersUpdateInfoKHR) (r error) {
	...
	if vkUpdateVideoSessionParametersKHR.fnHandle == nil {
		vkUpdateVideoSessionParametersKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkUpdateVideoSessionParametersKHR")))
	}
	rsys = C.Trampoline3(vkUpdateVideoSessionParametersKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(videoSessionParameters)), C.uintptr_t(uintptr(unsafe.Pointer(pUpdateInfo))))
	r = Result(uintptr(rsys))
...
func WaitForFences(device Device, fences []Fence, waitAll bool, timeout uint64) (r error) {
	...
	if vkWaitForFences.fnHandle == nil {
		vkWaitForFences.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkWaitForFences")))
	}
	rsys = C.Trampoline6(vkWaitForFences.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(fenceCount)), C.uintptr_t(uintptr(unsafe.Pointer(pFences))), C.uintptr_t(uintptr(waitAll_Bool32)), C.uintptr_t(uintptr(timeout)), 0)
	r = Result(uintptr(rsys))
...
func WaitForPresentKHR(device Device, swapchain SwapchainKHR, presentId uint64, timeout uint64) (r error) {
	...
	if vkWaitForPresentKHR.fnHandle == nil {
		vkWaitForPresentKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkWaitForPresentKHR")))
	}
	rsys = C.Trampoline6(vkWaitForPresentKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(swapchain)), C.uintptr_t(uintptr(presentId)), C.uintptr_t(uintptr(timeout)), 0, 0)
	r = Result(uintptr(rsys))
...
func WaitSemaphores(device Device, waitInfo *SemaphoreWaitInfo, timeout uint64) (r error) {
	...
	if vkWaitSemaphores.fnHandle == nil {
		vkWaitSemaphores.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkWaitSemaphores")))
	}
	rsys = C.Trampoline3(vkWaitSemaphores.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(unsafe.Pointer(pWaitInfo))), C.uintptr_t(uintptr(timeout)))
	r = Result(uintptr(rsys))
...
func WriteAccelerationStructuresPropertiesKHR(device Device, accelerationStructures []AccelerationStructureKHR, queryType QueryType, data []byte, stride uintptr) (r error) {
	...
	if vkWriteAccelerationStructuresPropertiesKHR.fnHandle == nil {
		vkWriteAccelerationStructuresPropertiesKHR.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkWriteAccelerationStructuresPropertiesKHR")))
	}
	rsys = C.Trampoline9(vkWriteAccelerationStructuresPropertiesKHR.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(accelerationStructureCount)), C.uintptr_t(uintptr(unsafe.Pointer(pAccelerationStructures))), C.uintptr_t(uintptr(queryType)), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pData))), C.uintptr_t(uintptr(stride)), 0, 0)
	r = Result(uintptr(rsys))
...
func WriteMicromapsPropertiesEXT(device Device, micromaps []MicromapEXT, queryType QueryType, data []byte, stride uintptr) (r error) {
	...
	if vkWriteMicromapsPropertiesEXT.fnHandle == nil {
		vkWriteMicromapsPropertiesEXT.fnHandle = C.SymbolFromName(dlHandle, unsafe.Pointer(sys_stringToBytePointer("vkWriteMicromapsPropertiesEXT")))
	}
	rsys = C.Trampoline9(vkWriteMicromapsPropertiesEXT.fnHandle, C.uintptr_t(uintptr(device)), C.uintptr_t(uintptr(micromapCount)), C.uintptr_t(uintptr(unsafe.Pointer(pMicromaps))), C.uintptr_t(uintptr(queryType)), C.uintptr_t(uintptr(dataSize)), C.uintptr_t(uintptr(unsafe.Pointer(pData))), C.uintptr_t(uintptr(stride)), 0, 0)
	r = Result(uintptr(rsys))
