// Code generated by go-vk from vk.xml at 2025-02-06 09:21:29.3085881 -0500 EST m=+1.160227001. DO NOT EDIT.
...
func CmdSetBlendConstants(commandBuffer CommandBuffer, blendConstants float32) {
	...
	syscall.SyscallN(vkCmdSetBlendConstants.fnHandle.Addr(), uintptr(commandBuffer), uintptr(math.Float32bits(blendConstants)))
...
func CmdSetDepthBias(commandBuffer CommandBuffer, depthBiasConstantFactor float32, depthBiasClamp float32, depthBiasSlopeFactor float32) {
	...
	syscall.SyscallN(vkCmdSetDepthBias.fnHandle.Addr(), uintptr(commandBuffer), uintptr(math.Float32bits(depthBiasConstantFactor)), uintptr(math.Float32bits(depthBiasClamp)), uintptr(math.Float32bits(depthBiasSlopeFactor)))
...
func CmdSetDepthBounds(commandBuffer CommandBuffer, minDepthBounds float32, maxDepthBounds float32) {
	...
	syscall.SyscallN(vkCmdSetDepthBounds.fnHandle.Addr(), uintptr(commandBuffer), uintptr(math.Float32bits(minDepthBounds)), uintptr(math.Float32bits(maxDepthBounds)))
...
func CmdSetLineWidth(commandBuffer CommandBuffer, lineWidth float32) {
	...
	syscall.SyscallN(vkCmdSetLineWidth.fnHandle.Addr(), uintptr(commandBuffer), uintptr(math.Float32bits(lineWidth)))
...
func SetDeviceMemoryPriorityEXT(device Device, memory DeviceMemory, priority float32) {
	...
	syscall.SyscallN(vkSetDeviceMemoryPriorityEXT.fnHandle.Addr(), uintptr(device), uintptr(memory), uintptr(math.Float32bits(priority)))
