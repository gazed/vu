...
func (sg *sgtag) back(i *vu.Input, down int)    { sg.tr.top.Move(0, 0, sg.dt*sg.run, sg.cam.Lookxz()) }
func (sg *sgtag) forward(i *vu.Input, down int) { sg.tr.top.Move(0, 0, sg.dt*-sg.run, sg.cam.Lookxz()) }
