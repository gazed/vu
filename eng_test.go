...
func TestChildWorldTransform(t *testing.T) {
	...
	// call updateTransforms to initialize the model transform matrix needed by World.
...
// However it had a noticable affect on performance, it was roughly 100 times more
// expensive to make state changes. Currently attributes are used for Engine
// but not for Pov, Camera, or Model.
