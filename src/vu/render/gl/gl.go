// Package gl provides a wrapper 3D graphics library
// that was auto-generated from glcorearb.h-v4.3.
...
// GLAPI void APIENTRY wrap_glClearDepthf(float d) { (*pfn_glClearDepthf)(d); }
//
// void (APIENTRYP pfn_glDepthRangef)(GLfloat n, GLfloat f);
// GLAPI void APIENTRY wrap_glDepthRangef(float n, float f) { (*pfn_glDepthRangef)(n, f); }
//
// void (APIENTRYP pfn_glGetShaderPrecisionFormat)(GLenum shadertype, GLenum precisiontype, GLint *range, GLint *precision);
// GLAPI void APIENTRY wrap_glGetShaderPrecisionFormat(unsigned int shadertype, unsigned int precisiontype, int* r_ange, int* precision) { (*pfn_glGetShaderPrecisionFormat)(shadertype, precisiontype, r_ange, precision); }
//
// void (APIENTRYP pfn_glReleaseShaderCompiler)();
...
// GLAPI void APIENTRY wrap_glShaderBinary(int count, unsigned int* shaders, unsigned int binaryformat, void* binary, int length) { (*pfn_glShaderBinary)(count, shaders, binaryformat, binary, length); }
//
...
// GLAPI void APIENTRY wrap_glDrawArraysInstancedBaseInstance(unsigned int mode, int first, int count, int instancecount, unsigned int baseinstance) { (*pfn_glDrawArraysInstancedBaseInstance)(mode, first, count, instancecount, baseinstance); }
//
...
// GLAPI void APIENTRY wrap_glDrawElementsInstancedBaseInstance(unsigned int mode, int count, unsigned int t_ype, void* indices, int instancecount, unsigned int baseinstance) { (*pfn_glDrawElementsInstancedBaseInstance)(mode, count, t_ype, indices, instancecount, baseinstance); }
//
...
// GLAPI void APIENTRY wrap_glDrawElementsInstancedBaseVertexBaseInstance(unsigned int mode, int count, unsigned int t_ype, void* indices, int instancecount, int basevertex, unsigned int baseinstance) { (*pfn_glDrawElementsInstancedBaseVertexBaseInstance)(mode, count, t_ype, indices, instancecount, basevertex, baseinstance); }
//
// // GL_ARB_blend_func_extended
//
// void (APIENTRYP pfn_glBindFragDataLocationIndexed)(GLuint program, GLuint colorNumber, GLuint index, const GLchar *name);
// GLAPI void APIENTRY wrap_glBindFragDataLocationIndexed(unsigned int program, unsigned int colorNumber, unsigned int index, char* name) { (*pfn_glBindFragDataLocationIndexed)(program, colorNumber, index, name); }
//
// GLint (APIENTRYP pfn_glGetFragDataIndex)(GLuint program, const GLchar *name);
// GLAPI GLint APIENTRY wrap_glGetFragDataIndex(unsigned int program, char* name) { return (*pfn_glGetFragDataIndex)(program, name); }
//
// // GL_ARB_cl_event
//
// GLsync (APIENTRYP pfn_glCreateSyncFromCLeventARB)(struct _cl_context * context, struct _cl_event * event, GLbitfield flags);
// GLAPI GLsync APIENTRY wrap_glCreateSyncFromCLeventARB(struct _cl_context* context, struct _cl_event* event, unsigned int flags) { return (*pfn_glCreateSyncFromCLeventARB)(context, event, flags); }
//
// // GL_ARB_clear_buffer_object
//
// void (APIENTRYP pfn_glClearBufferData)(GLenum target, GLenum internalformat, GLenum format, GLenum type, const void *data);
// GLAPI void APIENTRY wrap_glClearBufferData(unsigned int target, unsigned int internalformat, unsigned int format, unsigned int t_ype, void* data) { (*pfn_glClearBufferData)(target, internalformat, format, t_ype, data); }
//
...
// GLAPI void APIENTRY wrap_glClearBufferSubData(unsigned int target, unsigned int internalformat, long long offset, long long size, unsigned int format, unsigned int t_ype, void* data) { (*pfn_glClearBufferSubData)(target, internalformat, offset, size, format, t_ype, data); }
//
...
// GLAPI void APIENTRY wrap_glClearNamedBufferDataEXT(unsigned int buffer, unsigned int internalformat, unsigned int format, unsigned int t_ype, void* data) { (*pfn_glClearNamedBufferDataEXT)(buffer, internalformat, format, t_ype, data); }
//
...
// GLAPI void APIENTRY wrap_glClearNamedBufferSubDataEXT(unsigned int buffer, unsigned int internalformat, unsigned int format, unsigned int t_ype, long long offset, long long size, void* data) { (*pfn_glClearNamedBufferSubDataEXT)(buffer, internalformat, format, t_ype, offset, size, data); }
//
// // GL_ARB_compute_shader
//
// void (APIENTRYP pfn_glDispatchCompute)(GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z);
// GLAPI void APIENTRY wrap_glDispatchCompute(unsigned int num_groups_x, unsigned int num_groups_y, unsigned int num_groups_z) { (*pfn_glDispatchCompute)(num_groups_x, num_groups_y, num_groups_z); }
//
// void (APIENTRYP pfn_glDispatchComputeIndirect)(GLintptr indirect);
// GLAPI void APIENTRY wrap_glDispatchComputeIndirect(long long indirect) { (*pfn_glDispatchComputeIndirect)(indirect); }
//
// // GL_ARB_copy_buffer
//
...
// GLAPI void APIENTRY wrap_glCopyBufferSubData(unsigned int readTarget, unsigned int writeTarget, long long readOffset, long long writeOffset, long long size) { (*pfn_glCopyBufferSubData)(readTarget, writeTarget, readOffset, writeOffset, size); }
//
// // GL_ARB_copy_image
//
...
// GLAPI void APIENTRY wrap_glDebugMessageCallbackARB(GLDEBUGPROCARB callback, void* userParam) { (*pfn_glDebugMessageCallbackARB)(callback, userParam); }
//
...
// GLAPI void APIENTRY wrap_glDebugMessageControlARB(unsigned int source, unsigned int t_ype, unsigned int severity, int count, unsigned int* ids, unsigned char enabled) { (*pfn_glDebugMessageControlARB)(source, t_ype, severity, count, ids, enabled); }
//
...
// GLAPI void APIENTRY wrap_glDebugMessageInsertARB(unsigned int source, unsigned int t_ype, unsigned int id, unsigned int severity, int length, char* buf) { (*pfn_glDebugMessageInsertARB)(source, t_ype, id, severity, length, buf); }
//
...
// GLAPI GLuint APIENTRY wrap_glGetDebugMessageLogARB(unsigned int count, int bufsize, unsigned int* sources, unsigned int* types, unsigned int* ids, unsigned int* severities, int* lengths, unsigned char* messageLog) { return (*pfn_glGetDebugMessageLogARB)(count, bufsize, sources, types, ids, severities, lengths, (GLchar *)messageLog); }
//
// // GL_ARB_draw_buffers_blend
//
// void (APIENTRYP pfn_glBlendEquationSeparateiARB)(GLuint buf, GLenum modeRGB, GLenum modeAlpha);
// GLAPI void APIENTRY wrap_glBlendEquationSeparateiARB(unsigned int buf, unsigned int modeRGB, unsigned int modeAlpha) { (*pfn_glBlendEquationSeparateiARB)(buf, modeRGB, modeAlpha); }
//
// void (APIENTRYP pfn_glBlendEquationiARB)(GLuint buf, GLenum mode);
// GLAPI void APIENTRY wrap_glBlendEquationiARB(unsigned int buf, unsigned int mode) { (*pfn_glBlendEquationiARB)(buf, mode); }
//
// void (APIENTRYP pfn_glBlendFuncSeparateiARB)(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
// GLAPI void APIENTRY wrap_glBlendFuncSeparateiARB(unsigned int buf, unsigned int srcRGB, unsigned int dstRGB, unsigned int srcAlpha, unsigned int dstAlpha) { (*pfn_glBlendFuncSeparateiARB)(buf, srcRGB, dstRGB, srcAlpha, dstAlpha); }
//
// void (APIENTRYP pfn_glBlendFunciARB)(GLuint buf, GLenum src, GLenum dst);
// GLAPI void APIENTRY wrap_glBlendFunciARB(unsigned int buf, unsigned int src, unsigned int dst) { (*pfn_glBlendFunciARB)(buf, src, dst); }
//
...
// GLAPI void APIENTRY wrap_glDrawElementsBaseVertex(unsigned int mode, int count, unsigned int t_ype, void* indices, int basevertex) { (*pfn_glDrawElementsBaseVertex)(mode, count, t_ype, indices, basevertex); }
//
...
// GLAPI void APIENTRY wrap_glDrawElementsInstancedBaseVertex(unsigned int mode, int count, unsigned int t_ype, void* indices, int instancecount, int basevertex) { (*pfn_glDrawElementsInstancedBaseVertex)(mode, count, t_ype, indices, instancecount, basevertex); }
//
...
// GLAPI void APIENTRY wrap_glDrawRangeElementsBaseVertex(unsigned int mode, unsigned int start, unsigned int end, int count, unsigned int t_ype, void* indices, int basevertex) { (*pfn_glDrawRangeElementsBaseVertex)(mode, start, end, count, t_ype, indices, basevertex); }
//
...
// GLAPI void APIENTRY wrap_glMultiDrawElementsBaseVertex(unsigned int mode, int* count, unsigned int t_ype, const void* const* indices, int drawcount, int* basevertex) { (*pfn_glMultiDrawElementsBaseVertex)(mode, count, t_ype, indices, drawcount, basevertex); }
//
// // GL_ARB_draw_indirect
//
// void (APIENTRYP pfn_glDrawArraysIndirect)(GLenum mode, const GLvoid *indirect);
// GLAPI void APIENTRY wrap_glDrawArraysIndirect(unsigned int mode, void* indirect) { (*pfn_glDrawArraysIndirect)(mode, indirect); }
//
// void (APIENTRYP pfn_glDrawElementsIndirect)(GLenum mode, GLenum type, const GLvoid *indirect);
// GLAPI void APIENTRY wrap_glDrawElementsIndirect(unsigned int mode, unsigned int t_ype, void* indirect) { (*pfn_glDrawElementsIndirect)(mode, t_ype, indirect); }
//
// // GL_ARB_framebuffer_no_attachments
//
// void (APIENTRYP pfn_glFramebufferParameteri)(GLenum target, GLenum pname, GLint param);
// GLAPI void APIENTRY wrap_glFramebufferParameteri(unsigned int target, unsigned int pname, int param) { (*pfn_glFramebufferParameteri)(target, pname, param); }
//
// void (APIENTRYP pfn_glGetFramebufferParameteriv)(GLenum target, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetFramebufferParameteriv(unsigned int target, unsigned int pname, int* params) { (*pfn_glGetFramebufferParameteriv)(target, pname, params); }
//
// void (APIENTRYP pfn_glGetNamedFramebufferParameterivEXT)(GLuint framebuffer, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetNamedFramebufferParameterivEXT(unsigned int framebuffer, unsigned int pname, int* params) { (*pfn_glGetNamedFramebufferParameterivEXT)(framebuffer, pname, params); }
//
// void (APIENTRYP pfn_glNamedFramebufferParameteriEXT)(GLuint framebuffer, GLenum pname, GLint param);
// GLAPI void APIENTRY wrap_glNamedFramebufferParameteriEXT(unsigned int framebuffer, unsigned int pname, int param) { (*pfn_glNamedFramebufferParameteriEXT)(framebuffer, pname, param); }
//
// // GL_ARB_framebuffer_object
//
// void (APIENTRYP pfn_glBindFramebuffer)(GLenum target, GLuint framebuffer);
// GLAPI void APIENTRY wrap_glBindFramebuffer(unsigned int target, unsigned int framebuffer) { (*pfn_glBindFramebuffer)(target, framebuffer); }
//
// void (APIENTRYP pfn_glBindRenderbuffer)(GLenum target, GLuint renderbuffer);
// GLAPI void APIENTRY wrap_glBindRenderbuffer(unsigned int target, unsigned int renderbuffer) { (*pfn_glBindRenderbuffer)(target, renderbuffer); }
//
...
// GLAPI void APIENTRY wrap_glBlitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, unsigned int mask, unsigned int filter) { (*pfn_glBlitFramebuffer)(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter); }
//
// GLenum (APIENTRYP pfn_glCheckFramebufferStatus)(GLenum target);
// GLAPI GLenum APIENTRY wrap_glCheckFramebufferStatus(unsigned int target) { return (*pfn_glCheckFramebufferStatus)(target); }
//
// void (APIENTRYP pfn_glDeleteFramebuffers)(GLsizei n, const GLuint *framebuffers);
// GLAPI void APIENTRY wrap_glDeleteFramebuffers(int n, unsigned int* framebuffers) { (*pfn_glDeleteFramebuffers)(n, framebuffers); }
//
// void (APIENTRYP pfn_glDeleteRenderbuffers)(GLsizei n, const GLuint *renderbuffers);
// GLAPI void APIENTRY wrap_glDeleteRenderbuffers(int n, unsigned int* renderbuffers) { (*pfn_glDeleteRenderbuffers)(n, renderbuffers); }
//
...
// GLAPI void APIENTRY wrap_glFramebufferRenderbuffer(unsigned int target, unsigned int attachment, unsigned int renderbuffertarget, unsigned int renderbuffer) { (*pfn_glFramebufferRenderbuffer)(target, attachment, renderbuffertarget, renderbuffer); }
//
// void (APIENTRYP pfn_glFramebufferTexture1D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
// GLAPI void APIENTRY wrap_glFramebufferTexture1D(unsigned int target, unsigned int attachment, unsigned int textarget, unsigned int texture, int level) { (*pfn_glFramebufferTexture1D)(target, attachment, textarget, texture, level); }
//
// void (APIENTRYP pfn_glFramebufferTexture2D)(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
// GLAPI void APIENTRY wrap_glFramebufferTexture2D(unsigned int target, unsigned int attachment, unsigned int textarget, unsigned int texture, int level) { (*pfn_glFramebufferTexture2D)(target, attachment, textarget, texture, level); }
//
...
// GLAPI void APIENTRY wrap_glFramebufferTexture3D(unsigned int target, unsigned int attachment, unsigned int textarget, unsigned int texture, int level, int zoffset) { (*pfn_glFramebufferTexture3D)(target, attachment, textarget, texture, level, zoffset); }
//
// void (APIENTRYP pfn_glFramebufferTextureLayer)(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
// GLAPI void APIENTRY wrap_glFramebufferTextureLayer(unsigned int target, unsigned int attachment, unsigned int texture, int level, int layer) { (*pfn_glFramebufferTextureLayer)(target, attachment, texture, level, layer); }
//
// void (APIENTRYP pfn_glGenFramebuffers)(GLsizei n, GLuint *framebuffers);
// GLAPI void APIENTRY wrap_glGenFramebuffers(int n, unsigned int* framebuffers) { (*pfn_glGenFramebuffers)(n, framebuffers); }
//
// void (APIENTRYP pfn_glGenRenderbuffers)(GLsizei n, GLuint *renderbuffers);
// GLAPI void APIENTRY wrap_glGenRenderbuffers(int n, unsigned int* renderbuffers) { (*pfn_glGenRenderbuffers)(n, renderbuffers); }
//
// void (APIENTRYP pfn_glGenerateMipmap)(GLenum target);
// GLAPI void APIENTRY wrap_glGenerateMipmap(unsigned int target) { (*pfn_glGenerateMipmap)(target); }
//
// void (APIENTRYP pfn_glGetFramebufferAttachmentParameteriv)(GLenum target, GLenum attachment, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetFramebufferAttachmentParameteriv(unsigned int target, unsigned int attachment, unsigned int pname, int* params) { (*pfn_glGetFramebufferAttachmentParameteriv)(target, attachment, pname, params); }
//
// void (APIENTRYP pfn_glGetRenderbufferParameteriv)(GLenum target, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetRenderbufferParameteriv(unsigned int target, unsigned int pname, int* params) { (*pfn_glGetRenderbufferParameteriv)(target, pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsFramebuffer)(GLuint framebuffer);
// GLAPI GLboolean APIENTRY wrap_glIsFramebuffer(unsigned int framebuffer) { return (*pfn_glIsFramebuffer)(framebuffer); }
//
// GLboolean (APIENTRYP pfn_glIsRenderbuffer)(GLuint renderbuffer);
// GLAPI GLboolean APIENTRY wrap_glIsRenderbuffer(unsigned int renderbuffer) { return (*pfn_glIsRenderbuffer)(renderbuffer); }
//
// void (APIENTRYP pfn_glRenderbufferStorage)(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
// GLAPI void APIENTRY wrap_glRenderbufferStorage(unsigned int target, unsigned int internalformat, int width, int height) { (*pfn_glRenderbufferStorage)(target, internalformat, width, height); }
//
...
// GLAPI void APIENTRY wrap_glRenderbufferStorageMultisample(unsigned int target, int samples, unsigned int internalformat, int width, int height) { (*pfn_glRenderbufferStorageMultisample)(target, samples, internalformat, width, height); }
//
...
// GLAPI void APIENTRY wrap_glGetProgramBinary(unsigned int program, int bufSize, int* length, unsigned int* binaryFormat, void* binary) { (*pfn_glGetProgramBinary)(program, bufSize, length, binaryFormat, binary); }
//
// void (APIENTRYP pfn_glProgramBinary)(GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length);
// GLAPI void APIENTRY wrap_glProgramBinary(unsigned int program, unsigned int binaryFormat, void* binary, int length) { (*pfn_glProgramBinary)(program, binaryFormat, binary, length); }
//
// void (APIENTRYP pfn_glProgramParameteri)(GLuint program, GLenum pname, GLint value);
// GLAPI void APIENTRY wrap_glProgramParameteri(unsigned int program, unsigned int pname, int value) { (*pfn_glProgramParameteri)(program, pname, value); }
//
// // GL_ARB_gpu_shader_fp64
//
// void (APIENTRYP pfn_glGetUniformdv)(GLuint program, GLint location, GLdouble *params);
// GLAPI void APIENTRY wrap_glGetUniformdv(unsigned int program, int location, double* params) { (*pfn_glGetUniformdv)(program, location, params); }
//
// void (APIENTRYP pfn_glUniform1d)(GLint location, GLdouble x);
// GLAPI void APIENTRY wrap_glUniform1d(int location, double x) { (*pfn_glUniform1d)(location, x); }
//
// void (APIENTRYP pfn_glUniform1dv)(GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniform1dv(int location, int count, double* value) { (*pfn_glUniform1dv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform2d)(GLint location, GLdouble x, GLdouble y);
// GLAPI void APIENTRY wrap_glUniform2d(int location, double x, double y) { (*pfn_glUniform2d)(location, x, y); }
//
// void (APIENTRYP pfn_glUniform2dv)(GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniform2dv(int location, int count, double* value) { (*pfn_glUniform2dv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform3d)(GLint location, GLdouble x, GLdouble y, GLdouble z);
// GLAPI void APIENTRY wrap_glUniform3d(int location, double x, double y, double z) { (*pfn_glUniform3d)(location, x, y, z); }
//
// void (APIENTRYP pfn_glUniform3dv)(GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniform3dv(int location, int count, double* value) { (*pfn_glUniform3dv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform4d)(GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
// GLAPI void APIENTRY wrap_glUniform4d(int location, double x, double y, double z, double w) { (*pfn_glUniform4d)(location, x, y, z, w); }
//
// void (APIENTRYP pfn_glUniform4dv)(GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniform4dv(int location, int count, double* value) { (*pfn_glUniform4dv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniformMatrix2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix2dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix2dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix2x3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix2x3dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix2x3dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix2x4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix2x4dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix2x4dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix3dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix3dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix3x2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix3x2dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix3x2dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix3x4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix3x4dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix3x4dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix4dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix4dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix4dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix4x2dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix4x2dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix4x2dv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix4x3dv)(GLint location, GLsizei count, GLboolean transpose, const GLdouble *value);
// GLAPI void APIENTRY wrap_glUniformMatrix4x3dv(int location, int count, unsigned char transpose, double* value) { (*pfn_glUniformMatrix4x3dv)(location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glGetInternalformativ(unsigned int target, unsigned int internalformat, unsigned int pname, int bufSize, int* params) { (*pfn_glGetInternalformativ)(target, internalformat, pname, bufSize, params); }
//
...
// GLAPI void APIENTRY wrap_glGetInternalformati64v(unsigned int target, unsigned int internalformat, unsigned int pname, int bufSize, long long* params) { (*pfn_glGetInternalformati64v)(target, internalformat, pname, bufSize, params); }
//
// // GL_ARB_invalidate_subdata
//
// void (APIENTRYP pfn_glInvalidateBufferData)(GLuint buffer);
// GLAPI void APIENTRY wrap_glInvalidateBufferData(unsigned int buffer) { (*pfn_glInvalidateBufferData)(buffer); }
//
// void (APIENTRYP pfn_glInvalidateBufferSubData)(GLuint buffer, GLintptr offset, GLsizeiptr length);
// GLAPI void APIENTRY wrap_glInvalidateBufferSubData(unsigned int buffer, long long offset, long long length) { (*pfn_glInvalidateBufferSubData)(buffer, offset, length); }
//
// void (APIENTRYP pfn_glInvalidateFramebuffer)(GLenum target, GLsizei numAttachments, const GLenum *attachments);
// GLAPI void APIENTRY wrap_glInvalidateFramebuffer(unsigned int target, int numAttachments, unsigned int* attachments) { (*pfn_glInvalidateFramebuffer)(target, numAttachments, attachments); }
//
...
// GLAPI void APIENTRY wrap_glInvalidateSubFramebuffer(unsigned int target, int numAttachments, unsigned int* attachments, int x, int y, int width, int height) { (*pfn_glInvalidateSubFramebuffer)(target, numAttachments, attachments, x, y, width, height); }
//
// void (APIENTRYP pfn_glInvalidateTexImage)(GLuint texture, GLint level);
// GLAPI void APIENTRY wrap_glInvalidateTexImage(unsigned int texture, int level) { (*pfn_glInvalidateTexImage)(texture, level); }
//
...
// GLAPI void APIENTRY wrap_glInvalidateTexSubImage(unsigned int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth) { (*pfn_glInvalidateTexSubImage)(texture, level, xoffset, yoffset, zoffset, width, height, depth); }
//
// // GL_ARB_map_buffer_range
//
// void (APIENTRYP pfn_glFlushMappedBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length);
// GLAPI void APIENTRY wrap_glFlushMappedBufferRange(unsigned int target, long long offset, long long length) { (*pfn_glFlushMappedBufferRange)(target, offset, length); }
//
// GLvoid* (APIENTRYP pfn_glMapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
// GLAPI GLvoid* APIENTRY wrap_glMapBufferRange(unsigned int target, long long offset, long long length, unsigned int access) { return (*pfn_glMapBufferRange)(target, offset, length, access); }
//
// // GL_ARB_multi_draw_indirect
//
// void (APIENTRYP pfn_glMultiDrawArraysIndirect)(GLenum mode, const void *indirect, GLsizei drawcount, GLsizei stride);
// GLAPI void APIENTRY wrap_glMultiDrawArraysIndirect(unsigned int mode, void* indirect, int drawcount, int stride) { (*pfn_glMultiDrawArraysIndirect)(mode, indirect, drawcount, stride); }
//
...
// GLAPI void APIENTRY wrap_glMultiDrawElementsIndirect(unsigned int mode, unsigned int t_ype, void* indirect, int drawcount, int stride) { (*pfn_glMultiDrawElementsIndirect)(mode, t_ype, indirect, drawcount, stride); }
//
// // GL_ARB_program_interface_query
//
// void (APIENTRYP pfn_glGetProgramInterfaceiv)(GLuint program, GLenum programInterface, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetProgramInterfaceiv(unsigned int program, unsigned int programInterface, unsigned int pname, int* params) { (*pfn_glGetProgramInterfaceiv)(program, programInterface, pname, params); }
//
// GLuint (APIENTRYP pfn_glGetProgramResourceIndex)(GLuint program, GLenum programInterface, const GLchar *name);
// GLAPI GLuint APIENTRY wrap_glGetProgramResourceIndex(unsigned int program, unsigned int programInterface, char* name) { return (*pfn_glGetProgramResourceIndex)(program, programInterface, name); }
//
// GLint (APIENTRYP pfn_glGetProgramResourceLocation)(GLuint program, GLenum programInterface, const GLchar *name);
// GLAPI GLint APIENTRY wrap_glGetProgramResourceLocation(unsigned int program, unsigned int programInterface, char* name) { return (*pfn_glGetProgramResourceLocation)(program, programInterface, name); }
//
// GLint (APIENTRYP pfn_glGetProgramResourceLocationIndex)(GLuint program, GLenum programInterface, const GLchar *name);
// GLAPI GLint APIENTRY wrap_glGetProgramResourceLocationIndex(unsigned int program, unsigned int programInterface, char* name) { return (*pfn_glGetProgramResourceLocationIndex)(program, programInterface, name); }
//
...
// GLAPI void APIENTRY wrap_glGetProgramResourceName(unsigned int program, unsigned int programInterface, unsigned int index, int bufSize, int* length, char* name) { (*pfn_glGetProgramResourceName)(program, programInterface, index, bufSize, length, name); }
//
...
// GLAPI void APIENTRY wrap_glGetProgramResourceiv(unsigned int program, unsigned int programInterface, unsigned int index, int propCount, unsigned int* props, int bufSize, int* length, int* params) { (*pfn_glGetProgramResourceiv)(program, programInterface, index, propCount, props, bufSize, length, params); }
//
// // GL_ARB_provoking_vertex
//
// void (APIENTRYP pfn_glProvokingVertex)(GLenum mode);
// GLAPI void APIENTRY wrap_glProvokingVertex(unsigned int mode) { (*pfn_glProvokingVertex)(mode); }
//
// // GL_ARB_robustness
//
// GLenum (APIENTRYP pfn_glGetGraphicsResetStatusARB)();
// GLAPI GLenum APIENTRY wrap_glGetGraphicsResetStatusARB() { return (*pfn_glGetGraphicsResetStatusARB)(); }
//
// void (APIENTRYP pfn_glGetnColorTableARB)(GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *table);
// GLAPI void APIENTRY wrap_glGetnColorTableARB(unsigned int target, unsigned int format, unsigned int t_ype, int bufSize, void* table) { (*pfn_glGetnColorTableARB)(target, format, t_ype, bufSize, table); }
//
// void (APIENTRYP pfn_glGetnCompressedTexImageARB)(GLenum target, GLint lod, GLsizei bufSize, GLvoid *img);
// GLAPI void APIENTRY wrap_glGetnCompressedTexImageARB(unsigned int target, int lod, int bufSize, void* img) { (*pfn_glGetnCompressedTexImageARB)(target, lod, bufSize, img); }
//
// void (APIENTRYP pfn_glGetnConvolutionFilterARB)(GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *image);
// GLAPI void APIENTRY wrap_glGetnConvolutionFilterARB(unsigned int target, unsigned int format, unsigned int t_ype, int bufSize, void* image) { (*pfn_glGetnConvolutionFilterARB)(target, format, t_ype, bufSize, image); }
//
...
// GLAPI void APIENTRY wrap_glGetnHistogramARB(unsigned int target, unsigned char reset, unsigned int format, unsigned int t_ype, int bufSize, void* values) { (*pfn_glGetnHistogramARB)(target, reset, format, t_ype, bufSize, values); }
//
// void (APIENTRYP pfn_glGetnMapdvARB)(GLenum target, GLenum query, GLsizei bufSize, GLdouble *v);
// GLAPI void APIENTRY wrap_glGetnMapdvARB(unsigned int target, unsigned int query, int bufSize, double* v) { (*pfn_glGetnMapdvARB)(target, query, bufSize, v); }
//
// void (APIENTRYP pfn_glGetnMapfvARB)(GLenum target, GLenum query, GLsizei bufSize, GLfloat *v);
// GLAPI void APIENTRY wrap_glGetnMapfvARB(unsigned int target, unsigned int query, int bufSize, float* v) { (*pfn_glGetnMapfvARB)(target, query, bufSize, v); }
//
// void (APIENTRYP pfn_glGetnMapivARB)(GLenum target, GLenum query, GLsizei bufSize, GLint *v);
// GLAPI void APIENTRY wrap_glGetnMapivARB(unsigned int target, unsigned int query, int bufSize, int* v) { (*pfn_glGetnMapivARB)(target, query, bufSize, v); }
//
// void (APIENTRYP pfn_glGetnMinmaxARB)(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values);
// GLAPI void APIENTRY wrap_glGetnMinmaxARB(unsigned int target, unsigned char reset, unsigned int format, unsigned int t_ype, int bufSize, void* values) { (*pfn_glGetnMinmaxARB)(target, reset, format, t_ype, bufSize, values); }
//
// void (APIENTRYP pfn_glGetnPixelMapfvARB)(GLenum map, GLsizei bufSize, GLfloat *values);
// GLAPI void APIENTRY wrap_glGetnPixelMapfvARB(unsigned int m_ap, int bufSize, float* values) { (*pfn_glGetnPixelMapfvARB)(m_ap, bufSize, values); }
//
// void (APIENTRYP pfn_glGetnPixelMapuivARB)(GLenum map, GLsizei bufSize, GLuint *values);
// GLAPI void APIENTRY wrap_glGetnPixelMapuivARB(unsigned int m_ap, int bufSize, unsigned int* values) { (*pfn_glGetnPixelMapuivARB)(m_ap, bufSize, values); }
//
// void (APIENTRYP pfn_glGetnPixelMapusvARB)(GLenum map, GLsizei bufSize, GLushort *values);
// GLAPI void APIENTRY wrap_glGetnPixelMapusvARB(unsigned int m_ap, int bufSize, unsigned short* values) { (*pfn_glGetnPixelMapusvARB)(m_ap, bufSize, values); }
//
// void (APIENTRYP pfn_glGetnPolygonStippleARB)(GLsizei bufSize, GLubyte *pattern);
// GLAPI void APIENTRY wrap_glGetnPolygonStippleARB(int bufSize, unsigned char* pattern) { (*pfn_glGetnPolygonStippleARB)(bufSize, pattern); }
//
...
// GLAPI void APIENTRY wrap_glGetnSeparableFilterARB(unsigned int target, unsigned int format, unsigned int t_ype, int rowBufSize, void* row, int columnBufSize, void* column, void* span) { (*pfn_glGetnSeparableFilterARB)(target, format, t_ype, rowBufSize, row, columnBufSize, column, span); }
//
// void (APIENTRYP pfn_glGetnTexImageARB)(GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, GLvoid *img);
// GLAPI void APIENTRY wrap_glGetnTexImageARB(unsigned int target, int level, unsigned int format, unsigned int t_ype, int bufSize, void* img) { (*pfn_glGetnTexImageARB)(target, level, format, t_ype, bufSize, img); }
//
// void (APIENTRYP pfn_glGetnUniformdvARB)(GLuint program, GLint location, GLsizei bufSize, GLdouble *params);
// GLAPI void APIENTRY wrap_glGetnUniformdvARB(unsigned int program, int location, int bufSize, double* params) { (*pfn_glGetnUniformdvARB)(program, location, bufSize, params); }
//
// void (APIENTRYP pfn_glGetnUniformfvARB)(GLuint program, GLint location, GLsizei bufSize, GLfloat *params);
// GLAPI void APIENTRY wrap_glGetnUniformfvARB(unsigned int program, int location, int bufSize, float* params) { (*pfn_glGetnUniformfvARB)(program, location, bufSize, params); }
//
// void (APIENTRYP pfn_glGetnUniformivARB)(GLuint program, GLint location, GLsizei bufSize, GLint *params);
// GLAPI void APIENTRY wrap_glGetnUniformivARB(unsigned int program, int location, int bufSize, int* params) { (*pfn_glGetnUniformivARB)(program, location, bufSize, params); }
//
// void (APIENTRYP pfn_glGetnUniformuivARB)(GLuint program, GLint location, GLsizei bufSize, GLuint *params);
// GLAPI void APIENTRY wrap_glGetnUniformuivARB(unsigned int program, int location, int bufSize, unsigned int* params) { (*pfn_glGetnUniformuivARB)(program, location, bufSize, params); }
//
...
// GLAPI void APIENTRY wrap_glReadnPixelsARB(int x, int y, int width, int height, unsigned int format, unsigned int t_ype, int bufSize, void* data) { (*pfn_glReadnPixelsARB)(x, y, width, height, format, t_ype, bufSize, data); }
//
// // GL_ARB_sample_shading
//
// void (APIENTRYP pfn_glMinSampleShadingARB)(GLfloat value);
// GLAPI void APIENTRY wrap_glMinSampleShadingARB(float value) { (*pfn_glMinSampleShadingARB)(value); }
//
// // GL_ARB_sampler_objects
//
// void (APIENTRYP pfn_glBindSampler)(GLuint unit, GLuint sampler);
// GLAPI void APIENTRY wrap_glBindSampler(unsigned int unit, unsigned int sampler) { (*pfn_glBindSampler)(unit, sampler); }
//
// void (APIENTRYP pfn_glDeleteSamplers)(GLsizei count, const GLuint *samplers);
// GLAPI void APIENTRY wrap_glDeleteSamplers(int count, unsigned int* samplers) { (*pfn_glDeleteSamplers)(count, samplers); }
//
// void (APIENTRYP pfn_glGenSamplers)(GLsizei count, GLuint *samplers);
// GLAPI void APIENTRY wrap_glGenSamplers(int count, unsigned int* samplers) { (*pfn_glGenSamplers)(count, samplers); }
//
// void (APIENTRYP pfn_glGetSamplerParameterIiv)(GLuint sampler, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetSamplerParameterIiv(unsigned int sampler, unsigned int pname, int* params) { (*pfn_glGetSamplerParameterIiv)(sampler, pname, params); }
//
// void (APIENTRYP pfn_glGetSamplerParameterIuiv)(GLuint sampler, GLenum pname, GLuint *params);
// GLAPI void APIENTRY wrap_glGetSamplerParameterIuiv(unsigned int sampler, unsigned int pname, unsigned int* params) { (*pfn_glGetSamplerParameterIuiv)(sampler, pname, params); }
//
// void (APIENTRYP pfn_glGetSamplerParameterfv)(GLuint sampler, GLenum pname, GLfloat *params);
// GLAPI void APIENTRY wrap_glGetSamplerParameterfv(unsigned int sampler, unsigned int pname, float* params) { (*pfn_glGetSamplerParameterfv)(sampler, pname, params); }
//
// void (APIENTRYP pfn_glGetSamplerParameteriv)(GLuint sampler, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetSamplerParameteriv(unsigned int sampler, unsigned int pname, int* params) { (*pfn_glGetSamplerParameteriv)(sampler, pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsSampler)(GLuint sampler);
// GLAPI GLboolean APIENTRY wrap_glIsSampler(unsigned int sampler) { return (*pfn_glIsSampler)(sampler); }
//
// void (APIENTRYP pfn_glSamplerParameterIiv)(GLuint sampler, GLenum pname, const GLint *param);
// GLAPI void APIENTRY wrap_glSamplerParameterIiv(unsigned int sampler, unsigned int pname, int* param) { (*pfn_glSamplerParameterIiv)(sampler, pname, param); }
//
// void (APIENTRYP pfn_glSamplerParameterIuiv)(GLuint sampler, GLenum pname, const GLuint *param);
// GLAPI void APIENTRY wrap_glSamplerParameterIuiv(unsigned int sampler, unsigned int pname, unsigned int* param) { (*pfn_glSamplerParameterIuiv)(sampler, pname, param); }
//
// void (APIENTRYP pfn_glSamplerParameterf)(GLuint sampler, GLenum pname, GLfloat param);
// GLAPI void APIENTRY wrap_glSamplerParameterf(unsigned int sampler, unsigned int pname, float param) { (*pfn_glSamplerParameterf)(sampler, pname, param); }
//
// void (APIENTRYP pfn_glSamplerParameterfv)(GLuint sampler, GLenum pname, const GLfloat *param);
// GLAPI void APIENTRY wrap_glSamplerParameterfv(unsigned int sampler, unsigned int pname, float* param) { (*pfn_glSamplerParameterfv)(sampler, pname, param); }
//
// void (APIENTRYP pfn_glSamplerParameteri)(GLuint sampler, GLenum pname, GLint param);
// GLAPI void APIENTRY wrap_glSamplerParameteri(unsigned int sampler, unsigned int pname, int param) { (*pfn_glSamplerParameteri)(sampler, pname, param); }
//
// void (APIENTRYP pfn_glSamplerParameteriv)(GLuint sampler, GLenum pname, const GLint *param);
// GLAPI void APIENTRY wrap_glSamplerParameteriv(unsigned int sampler, unsigned int pname, int* param) { (*pfn_glSamplerParameteriv)(sampler, pname, param); }
//
// // GL_ARB_separate_shader_objects
//
// void (APIENTRYP pfn_glActiveShaderProgram)(GLuint pipeline, GLuint program);
// GLAPI void APIENTRY wrap_glActiveShaderProgram(unsigned int pipeline, unsigned int program) { (*pfn_glActiveShaderProgram)(pipeline, program); }
//
// void (APIENTRYP pfn_glBindProgramPipeline)(GLuint pipeline);
// GLAPI void APIENTRY wrap_glBindProgramPipeline(unsigned int pipeline) { (*pfn_glBindProgramPipeline)(pipeline); }
//
// GLuint (APIENTRYP pfn_glCreateShaderProgramv)(GLenum type, GLsizei count, const GLchar* const *strings);
// GLAPI GLuint APIENTRY wrap_glCreateShaderProgramv(unsigned int t_ype, int count, const char* const* strings) { return (*pfn_glCreateShaderProgramv)(t_ype, count, strings); }
//
// void (APIENTRYP pfn_glDeleteProgramPipelines)(GLsizei n, const GLuint *pipelines);
// GLAPI void APIENTRY wrap_glDeleteProgramPipelines(int n, unsigned int* pipelines) { (*pfn_glDeleteProgramPipelines)(n, pipelines); }
//
// void (APIENTRYP pfn_glGenProgramPipelines)(GLsizei n, GLuint *pipelines);
// GLAPI void APIENTRY wrap_glGenProgramPipelines(int n, unsigned int* pipelines) { (*pfn_glGenProgramPipelines)(n, pipelines); }
//
// void (APIENTRYP pfn_glGetProgramPipelineInfoLog)(GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
// GLAPI void APIENTRY wrap_glGetProgramPipelineInfoLog(unsigned int pipeline, int bufSize, int* length, unsigned char* infoLog) { (*pfn_glGetProgramPipelineInfoLog)(pipeline, bufSize, length, (GLchar *)infoLog); }
//
// void (APIENTRYP pfn_glGetProgramPipelineiv)(GLuint pipeline, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetProgramPipelineiv(unsigned int pipeline, unsigned int pname, int* params) { (*pfn_glGetProgramPipelineiv)(pipeline, pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsProgramPipeline)(GLuint pipeline);
// GLAPI GLboolean APIENTRY wrap_glIsProgramPipeline(unsigned int pipeline) { return (*pfn_glIsProgramPipeline)(pipeline); }
//
// void (APIENTRYP pfn_glProgramUniform1d)(GLuint program, GLint location, GLdouble v0);
// GLAPI void APIENTRY wrap_glProgramUniform1d(unsigned int program, int location, double v0) { (*pfn_glProgramUniform1d)(program, location, v0); }
//
// void (APIENTRYP pfn_glProgramUniform1dv)(GLuint program, GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glProgramUniform1dv(unsigned int program, int location, int count, double* value) { (*pfn_glProgramUniform1dv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform1f)(GLuint program, GLint location, GLfloat v0);
// GLAPI void APIENTRY wrap_glProgramUniform1f(unsigned int program, int location, float v0) { (*pfn_glProgramUniform1f)(program, location, v0); }
//
// void (APIENTRYP pfn_glProgramUniform1fv)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glProgramUniform1fv(unsigned int program, int location, int count, float* value) { (*pfn_glProgramUniform1fv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform1i)(GLuint program, GLint location, GLint v0);
// GLAPI void APIENTRY wrap_glProgramUniform1i(unsigned int program, int location, int v0) { (*pfn_glProgramUniform1i)(program, location, v0); }
//
// void (APIENTRYP pfn_glProgramUniform1iv)(GLuint program, GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glProgramUniform1iv(unsigned int program, int location, int count, int* value) { (*pfn_glProgramUniform1iv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform1ui)(GLuint program, GLint location, GLuint v0);
// GLAPI void APIENTRY wrap_glProgramUniform1ui(unsigned int program, int location, unsigned int v0) { (*pfn_glProgramUniform1ui)(program, location, v0); }
//
// void (APIENTRYP pfn_glProgramUniform1uiv)(GLuint program, GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glProgramUniform1uiv(unsigned int program, int location, int count, unsigned int* value) { (*pfn_glProgramUniform1uiv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform2d)(GLuint program, GLint location, GLdouble v0, GLdouble v1);
// GLAPI void APIENTRY wrap_glProgramUniform2d(unsigned int program, int location, double v0, double v1) { (*pfn_glProgramUniform2d)(program, location, v0, v1); }
//
// void (APIENTRYP pfn_glProgramUniform2dv)(GLuint program, GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glProgramUniform2dv(unsigned int program, int location, int count, double* value) { (*pfn_glProgramUniform2dv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform2f)(GLuint program, GLint location, GLfloat v0, GLfloat v1);
// GLAPI void APIENTRY wrap_glProgramUniform2f(unsigned int program, int location, float v0, float v1) { (*pfn_glProgramUniform2f)(program, location, v0, v1); }
//
// void (APIENTRYP pfn_glProgramUniform2fv)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glProgramUniform2fv(unsigned int program, int location, int count, float* value) { (*pfn_glProgramUniform2fv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform2i)(GLuint program, GLint location, GLint v0, GLint v1);
// GLAPI void APIENTRY wrap_glProgramUniform2i(unsigned int program, int location, int v0, int v1) { (*pfn_glProgramUniform2i)(program, location, v0, v1); }
//
// void (APIENTRYP pfn_glProgramUniform2iv)(GLuint program, GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glProgramUniform2iv(unsigned int program, int location, int count, int* value) { (*pfn_glProgramUniform2iv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform2ui)(GLuint program, GLint location, GLuint v0, GLuint v1);
// GLAPI void APIENTRY wrap_glProgramUniform2ui(unsigned int program, int location, unsigned int v0, unsigned int v1) { (*pfn_glProgramUniform2ui)(program, location, v0, v1); }
//
// void (APIENTRYP pfn_glProgramUniform2uiv)(GLuint program, GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glProgramUniform2uiv(unsigned int program, int location, int count, unsigned int* value) { (*pfn_glProgramUniform2uiv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform3d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2);
// GLAPI void APIENTRY wrap_glProgramUniform3d(unsigned int program, int location, double v0, double v1, double v2) { (*pfn_glProgramUniform3d)(program, location, v0, v1, v2); }
//
// void (APIENTRYP pfn_glProgramUniform3dv)(GLuint program, GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glProgramUniform3dv(unsigned int program, int location, int count, double* value) { (*pfn_glProgramUniform3dv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform3f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
// GLAPI void APIENTRY wrap_glProgramUniform3f(unsigned int program, int location, float v0, float v1, float v2) { (*pfn_glProgramUniform3f)(program, location, v0, v1, v2); }
//
// void (APIENTRYP pfn_glProgramUniform3fv)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glProgramUniform3fv(unsigned int program, int location, int count, float* value) { (*pfn_glProgramUniform3fv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform3i)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2);
// GLAPI void APIENTRY wrap_glProgramUniform3i(unsigned int program, int location, int v0, int v1, int v2) { (*pfn_glProgramUniform3i)(program, location, v0, v1, v2); }
//
// void (APIENTRYP pfn_glProgramUniform3iv)(GLuint program, GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glProgramUniform3iv(unsigned int program, int location, int count, int* value) { (*pfn_glProgramUniform3iv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform3ui)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2);
// GLAPI void APIENTRY wrap_glProgramUniform3ui(unsigned int program, int location, unsigned int v0, unsigned int v1, unsigned int v2) { (*pfn_glProgramUniform3ui)(program, location, v0, v1, v2); }
//
// void (APIENTRYP pfn_glProgramUniform3uiv)(GLuint program, GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glProgramUniform3uiv(unsigned int program, int location, int count, unsigned int* value) { (*pfn_glProgramUniform3uiv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform4d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2, GLdouble v3);
// GLAPI void APIENTRY wrap_glProgramUniform4d(unsigned int program, int location, double v0, double v1, double v2, double v3) { (*pfn_glProgramUniform4d)(program, location, v0, v1, v2, v3); }
//
// void (APIENTRYP pfn_glProgramUniform4dv)(GLuint program, GLint location, GLsizei count, const GLdouble *value);
// GLAPI void APIENTRY wrap_glProgramUniform4dv(unsigned int program, int location, int count, double* value) { (*pfn_glProgramUniform4dv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform4f)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
// GLAPI void APIENTRY wrap_glProgramUniform4f(unsigned int program, int location, float v0, float v1, float v2, float v3) { (*pfn_glProgramUniform4f)(program, location, v0, v1, v2, v3); }
//
// void (APIENTRYP pfn_glProgramUniform4fv)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glProgramUniform4fv(unsigned int program, int location, int count, float* value) { (*pfn_glProgramUniform4fv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform4i)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
// GLAPI void APIENTRY wrap_glProgramUniform4i(unsigned int program, int location, int v0, int v1, int v2, int v3) { (*pfn_glProgramUniform4i)(program, location, v0, v1, v2, v3); }
//
// void (APIENTRYP pfn_glProgramUniform4iv)(GLuint program, GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glProgramUniform4iv(unsigned int program, int location, int count, int* value) { (*pfn_glProgramUniform4iv)(program, location, count, value); }
//
// void (APIENTRYP pfn_glProgramUniform4ui)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
// GLAPI void APIENTRY wrap_glProgramUniform4ui(unsigned int program, int location, unsigned int v0, unsigned int v1, unsigned int v2, unsigned int v3) { (*pfn_glProgramUniform4ui)(program, location, v0, v1, v2, v3); }
//
// void (APIENTRYP pfn_glProgramUniform4uiv)(GLuint program, GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glProgramUniform4uiv(unsigned int program, int location, int count, unsigned int* value) { (*pfn_glProgramUniform4uiv)(program, location, count, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix2dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix2dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix2fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix2fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix2x3dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix2x3dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix2x3fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix2x3fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix2x4dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix2x4dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix2x4fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix2x4fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix3dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix3dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix3fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix3fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix3x2dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix3x2dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix3x2fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix3x2fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix3x4dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix3x4dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix3x4fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix3x4fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix4dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix4dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix4fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix4fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix4x2dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix4x2dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix4x2fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix4x2fv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix4x3dv(unsigned int program, int location, int count, unsigned char transpose, double* value) { (*pfn_glProgramUniformMatrix4x3dv)(program, location, count, transpose, value); }
//
...
// GLAPI void APIENTRY wrap_glProgramUniformMatrix4x3fv(unsigned int program, int location, int count, unsigned char transpose, float* value) { (*pfn_glProgramUniformMatrix4x3fv)(program, location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUseProgramStages)(GLuint pipeline, GLbitfield stages, GLuint program);
// GLAPI void APIENTRY wrap_glUseProgramStages(unsigned int pipeline, unsigned int stages, unsigned int program) { (*pfn_glUseProgramStages)(pipeline, stages, program); }
//
// void (APIENTRYP pfn_glValidateProgramPipeline)(GLuint pipeline);
// GLAPI void APIENTRY wrap_glValidateProgramPipeline(unsigned int pipeline) { (*pfn_glValidateProgramPipeline)(pipeline); }
//
// // GL_ARB_shader_atomic_counters
//
// void (APIENTRYP pfn_glGetActiveAtomicCounterBufferiv)(GLuint program, GLuint bufferIndex, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetActiveAtomicCounterBufferiv(unsigned int program, unsigned int bufferIndex, unsigned int pname, int* params) { (*pfn_glGetActiveAtomicCounterBufferiv)(program, bufferIndex, pname, params); }
//
...
// GLAPI void APIENTRY wrap_glBindImageTexture(unsigned int unit, unsigned int texture, int level, unsigned char layered, int layer, unsigned int access, unsigned int format) { (*pfn_glBindImageTexture)(unit, texture, level, layered, layer, access, format); }
//
// void (APIENTRYP pfn_glMemoryBarrier)(GLbitfield barriers);
// GLAPI void APIENTRY wrap_glMemoryBarrier(unsigned int barriers) { (*pfn_glMemoryBarrier)(barriers); }
//
// // GL_ARB_shader_storage_buffer_object
//
// void (APIENTRYP pfn_glShaderStorageBlockBinding)(GLuint program, GLuint storageBlockIndex, GLuint storageBlockBinding);
// GLAPI void APIENTRY wrap_glShaderStorageBlockBinding(unsigned int program, unsigned int storageBlockIndex, unsigned int storageBlockBinding) { (*pfn_glShaderStorageBlockBinding)(program, storageBlockIndex, storageBlockBinding); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveSubroutineName(unsigned int program, unsigned int shadertype, unsigned int index, int bufsize, int* length, unsigned char* name) { (*pfn_glGetActiveSubroutineName)(program, shadertype, index, bufsize, length, (GLchar *)name); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveSubroutineUniformName(unsigned int program, unsigned int shadertype, unsigned int index, int bufsize, int* length, char* name) { (*pfn_glGetActiveSubroutineUniformName)(program, shadertype, index, bufsize, length, name); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveSubroutineUniformiv(unsigned int program, unsigned int shadertype, unsigned int index, unsigned int pname, int* values) { (*pfn_glGetActiveSubroutineUniformiv)(program, shadertype, index, pname, values); }
//
// void (APIENTRYP pfn_glGetProgramStageiv)(GLuint program, GLenum shadertype, GLenum pname, GLint *values);
// GLAPI void APIENTRY wrap_glGetProgramStageiv(unsigned int program, unsigned int shadertype, unsigned int pname, int* values) { (*pfn_glGetProgramStageiv)(program, shadertype, pname, values); }
//
// GLuint (APIENTRYP pfn_glGetSubroutineIndex)(GLuint program, GLenum shadertype, const GLchar *name);
// GLAPI GLuint APIENTRY wrap_glGetSubroutineIndex(unsigned int program, unsigned int shadertype, char* name) { return (*pfn_glGetSubroutineIndex)(program, shadertype, name); }
//
// GLint (APIENTRYP pfn_glGetSubroutineUniformLocation)(GLuint program, GLenum shadertype, const GLchar *name);
// GLAPI GLint APIENTRY wrap_glGetSubroutineUniformLocation(unsigned int program, unsigned int shadertype, char* name) { return (*pfn_glGetSubroutineUniformLocation)(program, shadertype, name); }
//
// void (APIENTRYP pfn_glGetUniformSubroutineuiv)(GLenum shadertype, GLint location, GLuint *params);
// GLAPI void APIENTRY wrap_glGetUniformSubroutineuiv(unsigned int shadertype, int location, unsigned int* params) { (*pfn_glGetUniformSubroutineuiv)(shadertype, location, params); }
//
// void (APIENTRYP pfn_glUniformSubroutinesuiv)(GLenum shadertype, GLsizei count, const GLuint *indices);
// GLAPI void APIENTRY wrap_glUniformSubroutinesuiv(unsigned int shadertype, int count, unsigned int* indices) { (*pfn_glUniformSubroutinesuiv)(shadertype, count, indices); }
//
// // GL_ARB_shading_language_include
//
// void (APIENTRYP pfn_glCompileShaderIncludeARB)(GLuint shader, GLsizei count, const GLchar* *path, const GLint *length);
// GLAPI void APIENTRY wrap_glCompileShaderIncludeARB(unsigned int shader, int count, const char** path, int* length) { (*pfn_glCompileShaderIncludeARB)(shader, count, path, length); }
//
// void (APIENTRYP pfn_glDeleteNamedStringARB)(GLint namelen, const GLchar *name);
// GLAPI void APIENTRY wrap_glDeleteNamedStringARB(int namelen, char* name) { (*pfn_glDeleteNamedStringARB)(namelen, name); }
//
// void (APIENTRYP pfn_glGetNamedStringARB)(GLint namelen, const GLchar *name, GLsizei bufSize, GLint *stringlen, GLchar *string);
// GLAPI void APIENTRY wrap_glGetNamedStringARB(int namelen, char* name, int bufSize, int* stringlen, char* s_tring) { (*pfn_glGetNamedStringARB)(namelen, name, bufSize, stringlen, s_tring); }
//
// void (APIENTRYP pfn_glGetNamedStringivARB)(GLint namelen, const GLchar *name, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetNamedStringivARB(int namelen, char* name, unsigned int pname, int* params) { (*pfn_glGetNamedStringivARB)(namelen, name, pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsNamedStringARB)(GLint namelen, const GLchar *name);
// GLAPI GLboolean APIENTRY wrap_glIsNamedStringARB(int namelen, char* name) { return (*pfn_glIsNamedStringARB)(namelen, name); }
//
// void (APIENTRYP pfn_glNamedStringARB)(GLenum type, GLint namelen, const GLchar *name, GLint stringlen, const GLchar *string);
// GLAPI void APIENTRY wrap_glNamedStringARB(unsigned int t_ype, int namelen, char* name, int stringlen, char* s_tring) { (*pfn_glNamedStringARB)(t_ype, namelen, name, stringlen, s_tring); }
//
// // GL_ARB_sync
//
// GLenum (APIENTRYP pfn_glClientWaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);
// GLAPI GLenum APIENTRY wrap_glClientWaitSync(GLsync sync, unsigned int flags, unsigned long long timeout) { return (*pfn_glClientWaitSync)(sync, flags, timeout); }
//
// void (APIENTRYP pfn_glDeleteSync)(GLsync sync);
// GLAPI void APIENTRY wrap_glDeleteSync(GLsync sync) { (*pfn_glDeleteSync)(sync); }
//
// GLsync (APIENTRYP pfn_glFenceSync)(GLenum condition, GLbitfield flags);
// GLAPI GLsync APIENTRY wrap_glFenceSync(unsigned int condition, unsigned int flags) { return (*pfn_glFenceSync)(condition, flags); }
//
// void (APIENTRYP pfn_glGetInteger64v)(GLenum pname, GLint64 *params);
// GLAPI void APIENTRY wrap_glGetInteger64v(unsigned int pname, long long* params) { (*pfn_glGetInteger64v)(pname, params); }
//
// void (APIENTRYP pfn_glGetSynciv)(GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values);
// GLAPI void APIENTRY wrap_glGetSynciv(GLsync sync, unsigned int pname, int bufSize, int* length, int* values) { (*pfn_glGetSynciv)(sync, pname, bufSize, length, values); }
//
// GLboolean (APIENTRYP pfn_glIsSync)(GLsync sync);
// GLAPI GLboolean APIENTRY wrap_glIsSync(GLsync sync) { return (*pfn_glIsSync)(sync); }
//
// void (APIENTRYP pfn_glWaitSync)(GLsync sync, GLbitfield flags, GLuint64 timeout);
// GLAPI void APIENTRY wrap_glWaitSync(GLsync sync, unsigned int flags, unsigned long long timeout) { (*pfn_glWaitSync)(sync, flags, timeout); }
//
// // GL_ARB_tessellation_shader
//
// void (APIENTRYP pfn_glPatchParameterfv)(GLenum pname, const GLfloat *values);
// GLAPI void APIENTRY wrap_glPatchParameterfv(unsigned int pname, float* values) { (*pfn_glPatchParameterfv)(pname, values); }
//
// void (APIENTRYP pfn_glPatchParameteri)(GLenum pname, GLint value);
// GLAPI void APIENTRY wrap_glPatchParameteri(unsigned int pname, int value) { (*pfn_glPatchParameteri)(pname, value); }
//
...
// GLAPI void APIENTRY wrap_glTexBufferRange(unsigned int target, unsigned int internalformat, unsigned int buffer, long long offset, long long size) { (*pfn_glTexBufferRange)(target, internalformat, buffer, offset, size); }
//
...
// GLAPI void APIENTRY wrap_glTextureBufferRangeEXT(unsigned int texture, unsigned int target, unsigned int internalformat, unsigned int buffer, long long offset, long long size) { (*pfn_glTextureBufferRangeEXT)(texture, target, internalformat, buffer, offset, size); }
//
// // GL_ARB_texture_multisample
//
// void (APIENTRYP pfn_glGetMultisamplefv)(GLenum pname, GLuint index, GLfloat *val);
// GLAPI void APIENTRY wrap_glGetMultisamplefv(unsigned int pname, unsigned int index, float* val) { (*pfn_glGetMultisamplefv)(pname, index, val); }
//
// void (APIENTRYP pfn_glSampleMaski)(GLuint index, GLbitfield mask);
// GLAPI void APIENTRY wrap_glSampleMaski(unsigned int index, unsigned int mask) { (*pfn_glSampleMaski)(index, mask); }
//
...
// GLAPI void APIENTRY wrap_glTexImage2DMultisample(unsigned int target, int samples, int internalformat, int width, int height, unsigned char fixedsamplelocations) { (*pfn_glTexImage2DMultisample)(target, samples, internalformat, width, height, fixedsamplelocations); }
//
...
// GLAPI void APIENTRY wrap_glTexImage3DMultisample(unsigned int target, int samples, int internalformat, int width, int height, int depth, unsigned char fixedsamplelocations) { (*pfn_glTexImage3DMultisample)(target, samples, internalformat, width, height, depth, fixedsamplelocations); }
//
// // GL_ARB_texture_storage
//
// void (APIENTRYP pfn_glDebugMessageCallback)(GLDEBUGPROC callback, const void *userParam);
// GLAPI void APIENTRY wrap_glDebugMessageCallback(GLDEBUGPROC callback, void* userParam) { (*pfn_glDebugMessageCallback)(callback, userParam); }
//
...
// GLAPI void APIENTRY wrap_glDebugMessageControl(unsigned int source, unsigned int t_ype, unsigned int severity, int count, unsigned int* ids, unsigned char enabled) { (*pfn_glDebugMessageControl)(source, t_ype, severity, count, ids, enabled); }
//
...
// GLAPI void APIENTRY wrap_glDebugMessageInsert(unsigned int source, unsigned int t_ype, unsigned int id, unsigned int severity, int length, char* buf) { (*pfn_glDebugMessageInsert)(source, t_ype, id, severity, length, buf); }
//
...
// GLAPI GLuint APIENTRY wrap_glGetDebugMessageLog(unsigned int count, int bufsize, unsigned int* sources, unsigned int* types, unsigned int* ids, unsigned int* severities, int* lengths, unsigned char* messageLog) { return (*pfn_glGetDebugMessageLog)(count, bufsize, sources, types, ids, severities, lengths, (GLchar *)messageLog); }
//
// void (APIENTRYP pfn_glGetObjectLabel)(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei *length, GLchar *label);
// GLAPI void APIENTRY wrap_glGetObjectLabel(unsigned int identifier, unsigned int name, int bufSize, int* length, unsigned char* label) { (*pfn_glGetObjectLabel)(identifier, name, bufSize, length, (GLchar *)label); }
//
// void (APIENTRYP pfn_glGetObjectPtrLabel)(const void *ptr, GLsizei bufSize, GLsizei *length, GLchar *label);
// GLAPI void APIENTRY wrap_glGetObjectPtrLabel(void* ptr, int bufSize, int* length, unsigned char* label) { (*pfn_glGetObjectPtrLabel)(ptr, bufSize, length, (GLchar *)label); }
//
// void (APIENTRYP pfn_glObjectLabel)(GLenum identifier, GLuint name, GLsizei length, const GLchar *label);
// GLAPI void APIENTRY wrap_glObjectLabel(unsigned int identifier, unsigned int name, int length, char* label) { (*pfn_glObjectLabel)(identifier, name, length, label); }
//
// void (APIENTRYP pfn_glObjectPtrLabel)(const void *ptr, GLsizei length, const GLchar *label);
// GLAPI void APIENTRY wrap_glObjectPtrLabel(void* ptr, int length, char* label) { (*pfn_glObjectPtrLabel)(ptr, length, label); }
//
// void (APIENTRYP pfn_glPopDebugGroup)();
...
// GLAPI void APIENTRY wrap_glPushDebugGroup(unsigned int source, unsigned int id, int length, char* message) { (*pfn_glPushDebugGroup)(source, id, length, message); }
//
// void (APIENTRYP pfn_glTexStorage1D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);
// GLAPI void APIENTRY wrap_glTexStorage1D(unsigned int target, int levels, unsigned int internalformat, int width) { (*pfn_glTexStorage1D)(target, levels, internalformat, width); }
//
// void (APIENTRYP pfn_glTexStorage2D)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
// GLAPI void APIENTRY wrap_glTexStorage2D(unsigned int target, int levels, unsigned int internalformat, int width, int height) { (*pfn_glTexStorage2D)(target, levels, internalformat, width, height); }
//
...
// GLAPI void APIENTRY wrap_glTexStorage3D(unsigned int target, int levels, unsigned int internalformat, int width, int height, int depth) { (*pfn_glTexStorage3D)(target, levels, internalformat, width, height, depth); }
//
// void (APIENTRYP pfn_glTextureStorage1DEXT)(GLuint texture, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);
// GLAPI void APIENTRY wrap_glTextureStorage1DEXT(unsigned int texture, unsigned int target, int levels, unsigned int internalformat, int width) { (*pfn_glTextureStorage1DEXT)(texture, target, levels, internalformat, width); }
//
...
// GLAPI void APIENTRY wrap_glTextureStorage2DEXT(unsigned int texture, unsigned int target, int levels, unsigned int internalformat, int width, int height) { (*pfn_glTextureStorage2DEXT)(texture, target, levels, internalformat, width, height); }
//
...
// GLAPI void APIENTRY wrap_glTextureStorage3DEXT(unsigned int texture, unsigned int target, int levels, unsigned int internalformat, int width, int height, int depth) { (*pfn_glTextureStorage3DEXT)(texture, target, levels, internalformat, width, height, depth); }
//
...
// GLAPI void APIENTRY wrap_glTexStorage2DMultisample(unsigned int target, int samples, unsigned int internalformat, int width, int height, unsigned char fixedsamplelocations) { (*pfn_glTexStorage2DMultisample)(target, samples, internalformat, width, height, fixedsamplelocations); }
//
...
// GLAPI void APIENTRY wrap_glTexStorage3DMultisample(unsigned int target, int samples, unsigned int internalformat, int width, int height, int depth, unsigned char fixedsamplelocations) { (*pfn_glTexStorage3DMultisample)(target, samples, internalformat, width, height, depth, fixedsamplelocations); }
//
...
// GLAPI void APIENTRY wrap_glTextureView(unsigned int texture, unsigned int target, unsigned int origtexture, unsigned int internalformat, unsigned int minlevel, unsigned int numlevels, unsigned int minlayer, unsigned int numlayers) { (*pfn_glTextureView)(texture, target, origtexture, internalformat, minlevel, numlevels, minlayer, numlayers); }
//
// // GL_ARB_timer_query
//
// void (APIENTRYP pfn_glGetQueryObjecti64v)(GLuint id, GLenum pname, GLint64 *params);
// GLAPI void APIENTRY wrap_glGetQueryObjecti64v(unsigned int id, unsigned int pname, long long* params) { (*pfn_glGetQueryObjecti64v)(id, pname, params); }
//
// void (APIENTRYP pfn_glGetQueryObjectui64v)(GLuint id, GLenum pname, GLuint64 *params);
// GLAPI void APIENTRY wrap_glGetQueryObjectui64v(unsigned int id, unsigned int pname, unsigned long long* params) { (*pfn_glGetQueryObjectui64v)(id, pname, params); }
//
// void (APIENTRYP pfn_glQueryCounter)(GLuint id, GLenum target);
// GLAPI void APIENTRY wrap_glQueryCounter(unsigned int id, unsigned int target) { (*pfn_glQueryCounter)(id, target); }
//
// // GL_ARB_transform_feedback2
//
// void (APIENTRYP pfn_glBindTransformFeedback)(GLenum target, GLuint id);
// GLAPI void APIENTRY wrap_glBindTransformFeedback(unsigned int target, unsigned int id) { (*pfn_glBindTransformFeedback)(target, id); }
//
// void (APIENTRYP pfn_glDeleteTransformFeedbacks)(GLsizei n, const GLuint *ids);
// GLAPI void APIENTRY wrap_glDeleteTransformFeedbacks(int n, unsigned int* ids) { (*pfn_glDeleteTransformFeedbacks)(n, ids); }
//
// void (APIENTRYP pfn_glDrawTransformFeedback)(GLenum mode, GLuint id);
// GLAPI void APIENTRY wrap_glDrawTransformFeedback(unsigned int mode, unsigned int id) { (*pfn_glDrawTransformFeedback)(mode, id); }
//
// void (APIENTRYP pfn_glGenTransformFeedbacks)(GLsizei n, GLuint *ids);
// GLAPI void APIENTRY wrap_glGenTransformFeedbacks(int n, unsigned int* ids) { (*pfn_glGenTransformFeedbacks)(n, ids); }
//
// GLboolean (APIENTRYP pfn_glIsTransformFeedback)(GLuint id);
// GLAPI GLboolean APIENTRY wrap_glIsTransformFeedback(unsigned int id) { return (*pfn_glIsTransformFeedback)(id); }
//
...
//
// void (APIENTRYP pfn_glResumeTransformFeedback)();
...
// GLAPI void APIENTRY wrap_glBeginQueryIndexed(unsigned int target, unsigned int index, unsigned int id) { (*pfn_glBeginQueryIndexed)(target, index, id); }
//
// void (APIENTRYP pfn_glDrawTransformFeedbackStream)(GLenum mode, GLuint id, GLuint stream);
// GLAPI void APIENTRY wrap_glDrawTransformFeedbackStream(unsigned int mode, unsigned int id, unsigned int stream) { (*pfn_glDrawTransformFeedbackStream)(mode, id, stream); }
//
// void (APIENTRYP pfn_glEndQueryIndexed)(GLenum target, GLuint index);
// GLAPI void APIENTRY wrap_glEndQueryIndexed(unsigned int target, unsigned int index) { (*pfn_glEndQueryIndexed)(target, index); }
//
// void (APIENTRYP pfn_glGetQueryIndexediv)(GLenum target, GLuint index, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetQueryIndexediv(unsigned int target, unsigned int index, unsigned int pname, int* params) { (*pfn_glGetQueryIndexediv)(target, index, pname, params); }
//
// // GL_ARB_transform_feedback_instanced
//
// void (APIENTRYP pfn_glDrawTransformFeedbackInstanced)(GLenum mode, GLuint id, GLsizei instancecount);
// GLAPI void APIENTRY wrap_glDrawTransformFeedbackInstanced(unsigned int mode, unsigned int id, int instancecount) { (*pfn_glDrawTransformFeedbackInstanced)(mode, id, instancecount); }
//
// void (APIENTRYP pfn_glDrawTransformFeedbackStreamInstanced)(GLenum mode, GLuint id, GLuint stream, GLsizei instancecount);
// GLAPI void APIENTRY wrap_glDrawTransformFeedbackStreamInstanced(unsigned int mode, unsigned int id, unsigned int stream, int instancecount) { (*pfn_glDrawTransformFeedbackStreamInstanced)(mode, id, stream, instancecount); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveUniformBlockName(unsigned int program, unsigned int uniformBlockIndex, int bufSize, int* length, unsigned char* uniformBlockName) { (*pfn_glGetActiveUniformBlockName)(program, uniformBlockIndex, bufSize, length, (GLchar *)uniformBlockName); }
//
// void (APIENTRYP pfn_glGetActiveUniformBlockiv)(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetActiveUniformBlockiv(unsigned int program, unsigned int uniformBlockIndex, unsigned int pname, int* params) { (*pfn_glGetActiveUniformBlockiv)(program, uniformBlockIndex, pname, params); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveUniformName(unsigned int program, unsigned int uniformIndex, int bufSize, int* length, unsigned char* uniformName) { (*pfn_glGetActiveUniformName)(program, uniformIndex, bufSize, length, (GLchar *)uniformName); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveUniformsiv(unsigned int program, int uniformCount, unsigned int* uniformIndices, unsigned int pname, int* params) { (*pfn_glGetActiveUniformsiv)(program, uniformCount, uniformIndices, pname, params); }
//
// GLuint (APIENTRYP pfn_glGetUniformBlockIndex)(GLuint program, const GLchar *uniformBlockName);
// GLAPI GLuint APIENTRY wrap_glGetUniformBlockIndex(unsigned int program, char* uniformBlockName) { return (*pfn_glGetUniformBlockIndex)(program, uniformBlockName); }
//
...
// GLAPI void APIENTRY wrap_glGetUniformIndices(unsigned int program, int uniformCount, const char* const* uniformNames, unsigned int* uniformIndices) { (*pfn_glGetUniformIndices)(program, uniformCount, uniformNames, uniformIndices); }
//
// void (APIENTRYP pfn_glUniformBlockBinding)(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding);
// GLAPI void APIENTRY wrap_glUniformBlockBinding(unsigned int program, unsigned int uniformBlockIndex, unsigned int uniformBlockBinding) { (*pfn_glUniformBlockBinding)(program, uniformBlockIndex, uniformBlockBinding); }
//
// // GL_ARB_vertex_array_object
//
// void (APIENTRYP pfn_glBindVertexArray)(GLuint array);
// GLAPI void APIENTRY wrap_glBindVertexArray(unsigned int array) { (*pfn_glBindVertexArray)(array); }
//
// void (APIENTRYP pfn_glDeleteVertexArrays)(GLsizei n, const GLuint *arrays);
// GLAPI void APIENTRY wrap_glDeleteVertexArrays(int n, unsigned int* arrays) { (*pfn_glDeleteVertexArrays)(n, arrays); }
//
// void (APIENTRYP pfn_glGenVertexArrays)(GLsizei n, GLuint *arrays);
// GLAPI void APIENTRY wrap_glGenVertexArrays(int n, unsigned int* arrays) { (*pfn_glGenVertexArrays)(n, arrays); }
//
// GLboolean (APIENTRYP pfn_glIsVertexArray)(GLuint array);
// GLAPI GLboolean APIENTRY wrap_glIsVertexArray(unsigned int array) { return (*pfn_glIsVertexArray)(array); }
//
// // GL_ARB_vertex_attrib_64bit
//
// void (APIENTRYP pfn_glGetVertexAttribLdv)(GLuint index, GLenum pname, GLdouble *params);
// GLAPI void APIENTRY wrap_glGetVertexAttribLdv(unsigned int index, unsigned int pname, double* params) { (*pfn_glGetVertexAttribLdv)(index, pname, params); }
//
// void (APIENTRYP pfn_glVertexAttribL1d)(GLuint index, GLdouble x);
// GLAPI void APIENTRY wrap_glVertexAttribL1d(unsigned int index, double x) { (*pfn_glVertexAttribL1d)(index, x); }
//
// void (APIENTRYP pfn_glVertexAttribL1dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttribL1dv(unsigned int index, double* v) { (*pfn_glVertexAttribL1dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribL2d)(GLuint index, GLdouble x, GLdouble y);
// GLAPI void APIENTRY wrap_glVertexAttribL2d(unsigned int index, double x, double y) { (*pfn_glVertexAttribL2d)(index, x, y); }
//
// void (APIENTRYP pfn_glVertexAttribL2dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttribL2dv(unsigned int index, double* v) { (*pfn_glVertexAttribL2dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribL3d)(GLuint index, GLdouble x, GLdouble y, GLdouble z);
// GLAPI void APIENTRY wrap_glVertexAttribL3d(unsigned int index, double x, double y, double z) { (*pfn_glVertexAttribL3d)(index, x, y, z); }
//
// void (APIENTRYP pfn_glVertexAttribL3dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttribL3dv(unsigned int index, double* v) { (*pfn_glVertexAttribL3dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribL4d)(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
// GLAPI void APIENTRY wrap_glVertexAttribL4d(unsigned int index, double x, double y, double z, double w) { (*pfn_glVertexAttribL4d)(index, x, y, z, w); }
//
// void (APIENTRYP pfn_glVertexAttribL4dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttribL4dv(unsigned int index, double* v) { (*pfn_glVertexAttribL4dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribLPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
// GLAPI void APIENTRY wrap_glVertexAttribLPointer(unsigned int index, int size, unsigned int t_ype, int stride, void* pointer) { (*pfn_glVertexAttribLPointer)(index, size, t_ype, stride, pointer); }
//
// // GL_ARB_vertex_attrib_binding
//
// void (APIENTRYP pfn_glBindVertexBuffer)(GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
// GLAPI void APIENTRY wrap_glBindVertexBuffer(unsigned int bindingindex, unsigned int buffer, long long offset, int stride) { (*pfn_glBindVertexBuffer)(bindingindex, buffer, offset, stride); }
//
...
// GLAPI void APIENTRY wrap_glVertexArrayBindVertexBufferEXT(unsigned int vaobj, unsigned int bindingindex, unsigned int buffer, long long offset, int stride) { (*pfn_glVertexArrayBindVertexBufferEXT)(vaobj, bindingindex, buffer, offset, stride); }
//
// void (APIENTRYP pfn_glVertexArrayVertexAttribBindingEXT)(GLuint vaobj, GLuint attribindex, GLuint bindingindex);
// GLAPI void APIENTRY wrap_glVertexArrayVertexAttribBindingEXT(unsigned int vaobj, unsigned int attribindex, unsigned int bindingindex) { (*pfn_glVertexArrayVertexAttribBindingEXT)(vaobj, attribindex, bindingindex); }
//
...
// GLAPI void APIENTRY wrap_glVertexArrayVertexAttribFormatEXT(unsigned int vaobj, unsigned int attribindex, int size, unsigned int t_ype, unsigned char normalized, unsigned int relativeoffset) { (*pfn_glVertexArrayVertexAttribFormatEXT)(vaobj, attribindex, size, t_ype, normalized, relativeoffset); }
//
...
// GLAPI void APIENTRY wrap_glVertexArrayVertexAttribIFormatEXT(unsigned int vaobj, unsigned int attribindex, int size, unsigned int t_ype, unsigned int relativeoffset) { (*pfn_glVertexArrayVertexAttribIFormatEXT)(vaobj, attribindex, size, t_ype, relativeoffset); }
//
...
// GLAPI void APIENTRY wrap_glVertexArrayVertexAttribLFormatEXT(unsigned int vaobj, unsigned int attribindex, int size, unsigned int t_ype, unsigned int relativeoffset) { (*pfn_glVertexArrayVertexAttribLFormatEXT)(vaobj, attribindex, size, t_ype, relativeoffset); }
//
// void (APIENTRYP pfn_glVertexArrayVertexBindingDivisorEXT)(GLuint vaobj, GLuint bindingindex, GLuint divisor);
// GLAPI void APIENTRY wrap_glVertexArrayVertexBindingDivisorEXT(unsigned int vaobj, unsigned int bindingindex, unsigned int divisor) { (*pfn_glVertexArrayVertexBindingDivisorEXT)(vaobj, bindingindex, divisor); }
//
// void (APIENTRYP pfn_glVertexAttribBinding)(GLuint attribindex, GLuint bindingindex);
// GLAPI void APIENTRY wrap_glVertexAttribBinding(unsigned int attribindex, unsigned int bindingindex) { (*pfn_glVertexAttribBinding)(attribindex, bindingindex); }
//
...
// GLAPI void APIENTRY wrap_glVertexAttribFormat(unsigned int attribindex, int size, unsigned int t_ype, unsigned char normalized, unsigned int relativeoffset) { (*pfn_glVertexAttribFormat)(attribindex, size, t_ype, normalized, relativeoffset); }
//
// void (APIENTRYP pfn_glVertexAttribIFormat)(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
// GLAPI void APIENTRY wrap_glVertexAttribIFormat(unsigned int attribindex, int size, unsigned int t_ype, unsigned int relativeoffset) { (*pfn_glVertexAttribIFormat)(attribindex, size, t_ype, relativeoffset); }
//
// void (APIENTRYP pfn_glVertexAttribLFormat)(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
// GLAPI void APIENTRY wrap_glVertexAttribLFormat(unsigned int attribindex, int size, unsigned int t_ype, unsigned int relativeoffset) { (*pfn_glVertexAttribLFormat)(attribindex, size, t_ype, relativeoffset); }
//
// void (APIENTRYP pfn_glVertexBindingDivisor)(GLuint bindingindex, GLuint divisor);
// GLAPI void APIENTRY wrap_glVertexBindingDivisor(unsigned int bindingindex, unsigned int divisor) { (*pfn_glVertexBindingDivisor)(bindingindex, divisor); }
//
// // GL_ARB_vertex_type_2_10_10_10_rev
//
// void (APIENTRYP pfn_glColorP3ui)(GLenum type, GLuint color);
// GLAPI void APIENTRY wrap_glColorP3ui(unsigned int t_ype, unsigned int color) { (*pfn_glColorP3ui)(t_ype, color); }
//
// void (APIENTRYP pfn_glColorP3uiv)(GLenum type, const GLuint *color);
// GLAPI void APIENTRY wrap_glColorP3uiv(unsigned int t_ype, unsigned int* color) { (*pfn_glColorP3uiv)(t_ype, color); }
//
// void (APIENTRYP pfn_glColorP4ui)(GLenum type, GLuint color);
// GLAPI void APIENTRY wrap_glColorP4ui(unsigned int t_ype, unsigned int color) { (*pfn_glColorP4ui)(t_ype, color); }
//
// void (APIENTRYP pfn_glColorP4uiv)(GLenum type, const GLuint *color);
// GLAPI void APIENTRY wrap_glColorP4uiv(unsigned int t_ype, unsigned int* color) { (*pfn_glColorP4uiv)(t_ype, color); }
//
// void (APIENTRYP pfn_glMultiTexCoordP1ui)(GLenum texture, GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP1ui(unsigned int texture, unsigned int t_ype, unsigned int coords) { (*pfn_glMultiTexCoordP1ui)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glMultiTexCoordP1uiv)(GLenum texture, GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP1uiv(unsigned int texture, unsigned int t_ype, unsigned int* coords) { (*pfn_glMultiTexCoordP1uiv)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glMultiTexCoordP2ui)(GLenum texture, GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP2ui(unsigned int texture, unsigned int t_ype, unsigned int coords) { (*pfn_glMultiTexCoordP2ui)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glMultiTexCoordP2uiv)(GLenum texture, GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP2uiv(unsigned int texture, unsigned int t_ype, unsigned int* coords) { (*pfn_glMultiTexCoordP2uiv)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glMultiTexCoordP3ui)(GLenum texture, GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP3ui(unsigned int texture, unsigned int t_ype, unsigned int coords) { (*pfn_glMultiTexCoordP3ui)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glMultiTexCoordP3uiv)(GLenum texture, GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP3uiv(unsigned int texture, unsigned int t_ype, unsigned int* coords) { (*pfn_glMultiTexCoordP3uiv)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glMultiTexCoordP4ui)(GLenum texture, GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP4ui(unsigned int texture, unsigned int t_ype, unsigned int coords) { (*pfn_glMultiTexCoordP4ui)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glMultiTexCoordP4uiv)(GLenum texture, GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glMultiTexCoordP4uiv(unsigned int texture, unsigned int t_ype, unsigned int* coords) { (*pfn_glMultiTexCoordP4uiv)(texture, t_ype, coords); }
//
// void (APIENTRYP pfn_glNormalP3ui)(GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glNormalP3ui(unsigned int t_ype, unsigned int coords) { (*pfn_glNormalP3ui)(t_ype, coords); }
//
// void (APIENTRYP pfn_glNormalP3uiv)(GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glNormalP3uiv(unsigned int t_ype, unsigned int* coords) { (*pfn_glNormalP3uiv)(t_ype, coords); }
//
// void (APIENTRYP pfn_glSecondaryColorP3ui)(GLenum type, GLuint color);
// GLAPI void APIENTRY wrap_glSecondaryColorP3ui(unsigned int t_ype, unsigned int color) { (*pfn_glSecondaryColorP3ui)(t_ype, color); }
//
// void (APIENTRYP pfn_glSecondaryColorP3uiv)(GLenum type, const GLuint *color);
// GLAPI void APIENTRY wrap_glSecondaryColorP3uiv(unsigned int t_ype, unsigned int* color) { (*pfn_glSecondaryColorP3uiv)(t_ype, color); }
//
// void (APIENTRYP pfn_glTexCoordP1ui)(GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glTexCoordP1ui(unsigned int t_ype, unsigned int coords) { (*pfn_glTexCoordP1ui)(t_ype, coords); }
//
// void (APIENTRYP pfn_glTexCoordP1uiv)(GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glTexCoordP1uiv(unsigned int t_ype, unsigned int* coords) { (*pfn_glTexCoordP1uiv)(t_ype, coords); }
//
// void (APIENTRYP pfn_glTexCoordP2ui)(GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glTexCoordP2ui(unsigned int t_ype, unsigned int coords) { (*pfn_glTexCoordP2ui)(t_ype, coords); }
//
// void (APIENTRYP pfn_glTexCoordP2uiv)(GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glTexCoordP2uiv(unsigned int t_ype, unsigned int* coords) { (*pfn_glTexCoordP2uiv)(t_ype, coords); }
//
// void (APIENTRYP pfn_glTexCoordP3ui)(GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glTexCoordP3ui(unsigned int t_ype, unsigned int coords) { (*pfn_glTexCoordP3ui)(t_ype, coords); }
//
// void (APIENTRYP pfn_glTexCoordP3uiv)(GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glTexCoordP3uiv(unsigned int t_ype, unsigned int* coords) { (*pfn_glTexCoordP3uiv)(t_ype, coords); }
//
// void (APIENTRYP pfn_glTexCoordP4ui)(GLenum type, GLuint coords);
// GLAPI void APIENTRY wrap_glTexCoordP4ui(unsigned int t_ype, unsigned int coords) { (*pfn_glTexCoordP4ui)(t_ype, coords); }
//
// void (APIENTRYP pfn_glTexCoordP4uiv)(GLenum type, const GLuint *coords);
// GLAPI void APIENTRY wrap_glTexCoordP4uiv(unsigned int t_ype, unsigned int* coords) { (*pfn_glTexCoordP4uiv)(t_ype, coords); }
//
// void (APIENTRYP pfn_glVertexAttribP1ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
// GLAPI void APIENTRY wrap_glVertexAttribP1ui(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int value) { (*pfn_glVertexAttribP1ui)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexAttribP1uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint *value);
// GLAPI void APIENTRY wrap_glVertexAttribP1uiv(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int* value) { (*pfn_glVertexAttribP1uiv)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexAttribP2ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
// GLAPI void APIENTRY wrap_glVertexAttribP2ui(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int value) { (*pfn_glVertexAttribP2ui)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexAttribP2uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint *value);
// GLAPI void APIENTRY wrap_glVertexAttribP2uiv(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int* value) { (*pfn_glVertexAttribP2uiv)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexAttribP3ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
// GLAPI void APIENTRY wrap_glVertexAttribP3ui(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int value) { (*pfn_glVertexAttribP3ui)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexAttribP3uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint *value);
// GLAPI void APIENTRY wrap_glVertexAttribP3uiv(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int* value) { (*pfn_glVertexAttribP3uiv)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexAttribP4ui)(GLuint index, GLenum type, GLboolean normalized, GLuint value);
// GLAPI void APIENTRY wrap_glVertexAttribP4ui(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int value) { (*pfn_glVertexAttribP4ui)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexAttribP4uiv)(GLuint index, GLenum type, GLboolean normalized, const GLuint *value);
// GLAPI void APIENTRY wrap_glVertexAttribP4uiv(unsigned int index, unsigned int t_ype, unsigned char normalized, unsigned int* value) { (*pfn_glVertexAttribP4uiv)(index, t_ype, normalized, value); }
//
// void (APIENTRYP pfn_glVertexP2ui)(GLenum type, GLuint value);
// GLAPI void APIENTRY wrap_glVertexP2ui(unsigned int t_ype, unsigned int value) { (*pfn_glVertexP2ui)(t_ype, value); }
//
// void (APIENTRYP pfn_glVertexP2uiv)(GLenum type, const GLuint *value);
// GLAPI void APIENTRY wrap_glVertexP2uiv(unsigned int t_ype, unsigned int* value) { (*pfn_glVertexP2uiv)(t_ype, value); }
//
// void (APIENTRYP pfn_glVertexP3ui)(GLenum type, GLuint value);
// GLAPI void APIENTRY wrap_glVertexP3ui(unsigned int t_ype, unsigned int value) { (*pfn_glVertexP3ui)(t_ype, value); }
//
// void (APIENTRYP pfn_glVertexP3uiv)(GLenum type, const GLuint *value);
// GLAPI void APIENTRY wrap_glVertexP3uiv(unsigned int t_ype, unsigned int* value) { (*pfn_glVertexP3uiv)(t_ype, value); }
//
// void (APIENTRYP pfn_glVertexP4ui)(GLenum type, GLuint value);
// GLAPI void APIENTRY wrap_glVertexP4ui(unsigned int t_ype, unsigned int value) { (*pfn_glVertexP4ui)(t_ype, value); }
//
// void (APIENTRYP pfn_glVertexP4uiv)(GLenum type, const GLuint *value);
// GLAPI void APIENTRY wrap_glVertexP4uiv(unsigned int t_ype, unsigned int* value) { (*pfn_glVertexP4uiv)(t_ype, value); }
//
// // GL_ARB_viewport_array
//
// void (APIENTRYP pfn_glDepthRangeArrayv)(GLuint first, GLsizei count, const GLdouble *v);
// GLAPI void APIENTRY wrap_glDepthRangeArrayv(unsigned int first, int count, double* v) { (*pfn_glDepthRangeArrayv)(first, count, v); }
//
// void (APIENTRYP pfn_glDepthRangeIndexed)(GLuint index, GLdouble n, GLdouble f);
// GLAPI void APIENTRY wrap_glDepthRangeIndexed(unsigned int index, double n, double f) { (*pfn_glDepthRangeIndexed)(index, n, f); }
//
// void (APIENTRYP pfn_glGetDoublei_v)(GLenum target, GLuint index, GLdouble *data);
// GLAPI void APIENTRY wrap_glGetDoublei_v(unsigned int target, unsigned int index, double* data) { (*pfn_glGetDoublei_v)(target, index, data); }
//
// void (APIENTRYP pfn_glGetFloati_v)(GLenum target, GLuint index, GLfloat *data);
// GLAPI void APIENTRY wrap_glGetFloati_v(unsigned int target, unsigned int index, float* data) { (*pfn_glGetFloati_v)(target, index, data); }
//
// void (APIENTRYP pfn_glScissorArrayv)(GLuint first, GLsizei count, const GLint *v);
// GLAPI void APIENTRY wrap_glScissorArrayv(unsigned int first, int count, int* v) { (*pfn_glScissorArrayv)(first, count, v); }
//
// void (APIENTRYP pfn_glScissorIndexed)(GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height);
// GLAPI void APIENTRY wrap_glScissorIndexed(unsigned int index, int left, int bottom, int width, int height) { (*pfn_glScissorIndexed)(index, left, bottom, width, height); }
//
// void (APIENTRYP pfn_glScissorIndexedv)(GLuint index, const GLint *v);
// GLAPI void APIENTRY wrap_glScissorIndexedv(unsigned int index, int* v) { (*pfn_glScissorIndexedv)(index, v); }
//
// void (APIENTRYP pfn_glViewportArrayv)(GLuint first, GLsizei count, const GLfloat *v);
// GLAPI void APIENTRY wrap_glViewportArrayv(unsigned int first, int count, float* v) { (*pfn_glViewportArrayv)(first, count, v); }
//
// void (APIENTRYP pfn_glViewportIndexedf)(GLuint index, GLfloat x, GLfloat y, GLfloat w, GLfloat h);
// GLAPI void APIENTRY wrap_glViewportIndexedf(unsigned int index, float x, float y, float w, float h) { (*pfn_glViewportIndexedf)(index, x, y, w, h); }
//
// void (APIENTRYP pfn_glViewportIndexedfv)(GLuint index, const GLfloat *v);
// GLAPI void APIENTRY wrap_glViewportIndexedfv(unsigned int index, float* v) { (*pfn_glViewportIndexedfv)(index, v); }
//
// // GL_VERSION_1_0
//
// void (APIENTRYP pfn_glBlendFunc)(GLenum sfactor, GLenum dfactor);
// GLAPI void APIENTRY wrap_glBlendFunc(unsigned int sfactor, unsigned int dfactor) { (*pfn_glBlendFunc)(sfactor, dfactor); }
//
// void (APIENTRYP pfn_glClear)(GLbitfield mask);
// GLAPI void APIENTRY wrap_glClear(unsigned int mask) { (*pfn_glClear)(mask); }
//
// void (APIENTRYP pfn_glClearColor)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
// GLAPI void APIENTRY wrap_glClearColor(float red, float green, float blue, float alpha) { (*pfn_glClearColor)(red, green, blue, alpha); }
//
// void (APIENTRYP pfn_glClearDepth)(GLdouble depth);
// GLAPI void APIENTRY wrap_glClearDepth(double depth) { (*pfn_glClearDepth)(depth); }
//
// void (APIENTRYP pfn_glClearStencil)(GLint s);
// GLAPI void APIENTRY wrap_glClearStencil(int s) { (*pfn_glClearStencil)(s); }
//
// void (APIENTRYP pfn_glColorMask)(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
// GLAPI void APIENTRY wrap_glColorMask(unsigned char red, unsigned char green, unsigned char blue, unsigned char alpha) { (*pfn_glColorMask)(red, green, blue, alpha); }
//
// void (APIENTRYP pfn_glCullFace)(GLenum mode);
// GLAPI void APIENTRY wrap_glCullFace(unsigned int mode) { (*pfn_glCullFace)(mode); }
//
// void (APIENTRYP pfn_glDepthFunc)(GLenum func);
// GLAPI void APIENTRY wrap_glDepthFunc(unsigned int f_unc) { (*pfn_glDepthFunc)(f_unc); }
//
// void (APIENTRYP pfn_glDepthMask)(GLboolean flag);
// GLAPI void APIENTRY wrap_glDepthMask(unsigned char flag) { (*pfn_glDepthMask)(flag); }
//
// void (APIENTRYP pfn_glDepthRange)(GLdouble near, GLdouble far);
// GLAPI void APIENTRY wrap_glDepthRange(double n_ear, double f_ar) { (*pfn_glDepthRange)(n_ear, f_ar); }
//
// void (APIENTRYP pfn_glDisable)(GLenum cap);
// GLAPI void APIENTRY wrap_glDisable(unsigned int cap) { (*pfn_glDisable)(cap); }
//
// void (APIENTRYP pfn_glDrawBuffer)(GLenum mode);
// GLAPI void APIENTRY wrap_glDrawBuffer(unsigned int mode) { (*pfn_glDrawBuffer)(mode); }
//
// void (APIENTRYP pfn_glEnable)(GLenum cap);
// GLAPI void APIENTRY wrap_glEnable(unsigned int cap) { (*pfn_glEnable)(cap); }
//
// void (APIENTRYP pfn_glFinish)();
// GLAPI void APIENTRY wrap_glFinish() { (*pfn_glFinish)(); }
//
// void (APIENTRYP pfn_glFlush)();
// GLAPI void APIENTRY wrap_glFlush() { (*pfn_glFlush)(); }
//
// void (APIENTRYP pfn_glFrontFace)(GLenum mode);
// GLAPI void APIENTRY wrap_glFrontFace(unsigned int mode) { (*pfn_glFrontFace)(mode); }
//
// void (APIENTRYP pfn_glGetBooleanv)(GLenum pname, GLboolean *params);
// GLAPI void APIENTRY wrap_glGetBooleanv(unsigned int pname, unsigned char* params) { (*pfn_glGetBooleanv)(pname, params); }
//
// void (APIENTRYP pfn_glGetDoublev)(GLenum pname, GLdouble *params);
// GLAPI void APIENTRY wrap_glGetDoublev(unsigned int pname, double* params) { (*pfn_glGetDoublev)(pname, params); }
//
// GLenum (APIENTRYP pfn_glGetError)();
// GLAPI GLenum APIENTRY wrap_glGetError() { return (*pfn_glGetError)(); }
//
// void (APIENTRYP pfn_glGetFloatv)(GLenum pname, GLfloat *params);
// GLAPI void APIENTRY wrap_glGetFloatv(unsigned int pname, float* params) { (*pfn_glGetFloatv)(pname, params); }
//
// void (APIENTRYP pfn_glGetIntegerv)(GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetIntegerv(unsigned int pname, int* params) { (*pfn_glGetIntegerv)(pname, params); }
//
...
// GLAPI void APIENTRY wrap_glGetTexImage(unsigned int target, int level, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glGetTexImage)(target, level, format, t_ype, pixels); }
//
// void (APIENTRYP pfn_glGetTexLevelParameterfv)(GLenum target, GLint level, GLenum pname, GLfloat *params);
// GLAPI void APIENTRY wrap_glGetTexLevelParameterfv(unsigned int target, int level, unsigned int pname, float* params) { (*pfn_glGetTexLevelParameterfv)(target, level, pname, params); }
//
// void (APIENTRYP pfn_glGetTexLevelParameteriv)(GLenum target, GLint level, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetTexLevelParameteriv(unsigned int target, int level, unsigned int pname, int* params) { (*pfn_glGetTexLevelParameteriv)(target, level, pname, params); }
//
// void (APIENTRYP pfn_glGetTexParameterfv)(GLenum target, GLenum pname, GLfloat *params);
// GLAPI void APIENTRY wrap_glGetTexParameterfv(unsigned int target, unsigned int pname, float* params) { (*pfn_glGetTexParameterfv)(target, pname, params); }
//
// void (APIENTRYP pfn_glGetTexParameteriv)(GLenum target, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetTexParameteriv(unsigned int target, unsigned int pname, int* params) { (*pfn_glGetTexParameteriv)(target, pname, params); }
//
// void (APIENTRYP pfn_glHint)(GLenum target, GLenum mode);
// GLAPI void APIENTRY wrap_glHint(unsigned int target, unsigned int mode) { (*pfn_glHint)(target, mode); }
//
// GLboolean (APIENTRYP pfn_glIsEnabled)(GLenum cap);
// GLAPI GLboolean APIENTRY wrap_glIsEnabled(unsigned int cap) { return (*pfn_glIsEnabled)(cap); }
//
// void (APIENTRYP pfn_glLineWidth)(GLfloat width);
// GLAPI void APIENTRY wrap_glLineWidth(float width) { (*pfn_glLineWidth)(width); }
//
// void (APIENTRYP pfn_glLogicOp)(GLenum opcode);
// GLAPI void APIENTRY wrap_glLogicOp(unsigned int opcode) { (*pfn_glLogicOp)(opcode); }
//
// void (APIENTRYP pfn_glPixelStoref)(GLenum pname, GLfloat param);
// GLAPI void APIENTRY wrap_glPixelStoref(unsigned int pname, float param) { (*pfn_glPixelStoref)(pname, param); }
//
// void (APIENTRYP pfn_glPixelStorei)(GLenum pname, GLint param);
// GLAPI void APIENTRY wrap_glPixelStorei(unsigned int pname, int param) { (*pfn_glPixelStorei)(pname, param); }
//
// void (APIENTRYP pfn_glPointSize)(GLfloat size);
// GLAPI void APIENTRY wrap_glPointSize(float size) { (*pfn_glPointSize)(size); }
//
// void (APIENTRYP pfn_glPolygonMode)(GLenum face, GLenum mode);
// GLAPI void APIENTRY wrap_glPolygonMode(unsigned int face, unsigned int mode) { (*pfn_glPolygonMode)(face, mode); }
//
// void (APIENTRYP pfn_glReadBuffer)(GLenum mode);
// GLAPI void APIENTRY wrap_glReadBuffer(unsigned int mode) { (*pfn_glReadBuffer)(mode); }
//
// void (APIENTRYP pfn_glReadPixels)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels);
// GLAPI void APIENTRY wrap_glReadPixels(int x, int y, int width, int height, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glReadPixels)(x, y, width, height, format, t_ype, pixels); }
//
// void (APIENTRYP pfn_glScissor)(GLint x, GLint y, GLsizei width, GLsizei height);
// GLAPI void APIENTRY wrap_glScissor(int x, int y, int width, int height) { (*pfn_glScissor)(x, y, width, height); }
//
// void (APIENTRYP pfn_glStencilFunc)(GLenum func, GLint ref, GLuint mask);
// GLAPI void APIENTRY wrap_glStencilFunc(unsigned int f_unc, int ref, unsigned int mask) { (*pfn_glStencilFunc)(f_unc, ref, mask); }
//
// void (APIENTRYP pfn_glStencilMask)(GLuint mask);
// GLAPI void APIENTRY wrap_glStencilMask(unsigned int mask) { (*pfn_glStencilMask)(mask); }
//
// void (APIENTRYP pfn_glStencilOp)(GLenum fail, GLenum zfail, GLenum zpass);
// GLAPI void APIENTRY wrap_glStencilOp(unsigned int fail, unsigned int zfail, unsigned int zpass) { (*pfn_glStencilOp)(fail, zfail, zpass); }
//
...
// GLAPI void APIENTRY wrap_glTexImage1D(unsigned int target, int level, int internalformat, int width, int border, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glTexImage1D)(target, level, internalformat, width, border, format, t_ype, pixels); }
//
...
// GLAPI void APIENTRY wrap_glTexImage2D(unsigned int target, int level, int internalformat, int width, int height, int border, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glTexImage2D)(target, level, internalformat, width, height, border, format, t_ype, pixels); }
//
// void (APIENTRYP pfn_glTexParameterf)(GLenum target, GLenum pname, GLfloat param);
// GLAPI void APIENTRY wrap_glTexParameterf(unsigned int target, unsigned int pname, float param) { (*pfn_glTexParameterf)(target, pname, param); }
//
// void (APIENTRYP pfn_glTexParameterfv)(GLenum target, GLenum pname, const GLfloat *params);
// GLAPI void APIENTRY wrap_glTexParameterfv(unsigned int target, unsigned int pname, float* params) { (*pfn_glTexParameterfv)(target, pname, params); }
//
// void (APIENTRYP pfn_glTexParameteri)(GLenum target, GLenum pname, GLint param);
// GLAPI void APIENTRY wrap_glTexParameteri(unsigned int target, unsigned int pname, int param) { (*pfn_glTexParameteri)(target, pname, param); }
//
// void (APIENTRYP pfn_glTexParameteriv)(GLenum target, GLenum pname, const GLint *params);
// GLAPI void APIENTRY wrap_glTexParameteriv(unsigned int target, unsigned int pname, int* params) { (*pfn_glTexParameteriv)(target, pname, params); }
//
// void (APIENTRYP pfn_glViewport)(GLint x, GLint y, GLsizei width, GLsizei height);
// GLAPI void APIENTRY wrap_glViewport(int x, int y, int width, int height) { (*pfn_glViewport)(x, y, width, height); }
//
// // GL_VERSION_1_1
//
// void (APIENTRYP pfn_glBindTexture)(GLenum target, GLuint texture);
// GLAPI void APIENTRY wrap_glBindTexture(unsigned int target, unsigned int texture) { (*pfn_glBindTexture)(target, texture); }
//
...
// GLAPI void APIENTRY wrap_glCopyTexImage1D(unsigned int target, int level, unsigned int internalformat, int x, int y, int width, int border) { (*pfn_glCopyTexImage1D)(target, level, internalformat, x, y, width, border); }
//
...
// GLAPI void APIENTRY wrap_glCopyTexImage2D(unsigned int target, int level, unsigned int internalformat, int x, int y, int width, int height, int border) { (*pfn_glCopyTexImage2D)(target, level, internalformat, x, y, width, height, border); }
//
// void (APIENTRYP pfn_glCopyTexSubImage1D)(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
// GLAPI void APIENTRY wrap_glCopyTexSubImage1D(unsigned int target, int level, int xoffset, int x, int y, int width) { (*pfn_glCopyTexSubImage1D)(target, level, xoffset, x, y, width); }
//
...
// GLAPI void APIENTRY wrap_glCopyTexSubImage2D(unsigned int target, int level, int xoffset, int yoffset, int x, int y, int width, int height) { (*pfn_glCopyTexSubImage2D)(target, level, xoffset, yoffset, x, y, width, height); }
//
// void (APIENTRYP pfn_glDeleteTextures)(GLsizei n, const GLuint *textures);
// GLAPI void APIENTRY wrap_glDeleteTextures(int n, unsigned int* textures) { (*pfn_glDeleteTextures)(n, textures); }
//
// void (APIENTRYP pfn_glDrawArrays)(GLenum mode, GLint first, GLsizei count);
// GLAPI void APIENTRY wrap_glDrawArrays(unsigned int mode, int first, int count) { (*pfn_glDrawArrays)(mode, first, count); }
//
// void (APIENTRYP pfn_glDrawElements)(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
// GLAPI void APIENTRY wrap_glDrawElements(unsigned int mode, int count, unsigned int t_ype, void* indices) { (*pfn_glDrawElements)(mode, count, t_ype, indices); }
//
// void (APIENTRYP pfn_glGenTextures)(GLsizei n, GLuint *textures);
// GLAPI void APIENTRY wrap_glGenTextures(int n, unsigned int* textures) { (*pfn_glGenTextures)(n, textures); }
//
// void (APIENTRYP pfn_glGetPointerv)(GLenum pname, GLvoid* *params);
// GLAPI void APIENTRY wrap_glGetPointerv(unsigned int pname, void** params) { (*pfn_glGetPointerv)(pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsTexture)(GLuint texture);
// GLAPI GLboolean APIENTRY wrap_glIsTexture(unsigned int texture) { return (*pfn_glIsTexture)(texture); }
//
// void (APIENTRYP pfn_glPolygonOffset)(GLfloat factor, GLfloat units);
// GLAPI void APIENTRY wrap_glPolygonOffset(float factor, float units) { (*pfn_glPolygonOffset)(factor, units); }
//
...
// GLAPI void APIENTRY wrap_glTexSubImage1D(unsigned int target, int level, int xoffset, int width, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glTexSubImage1D)(target, level, xoffset, width, format, t_ype, pixels); }
//
...
// GLAPI void APIENTRY wrap_glTexSubImage2D(unsigned int target, int level, int xoffset, int yoffset, int width, int height, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glTexSubImage2D)(target, level, xoffset, yoffset, width, height, format, t_ype, pixels); }
//
// // GL_VERSION_1_2
//
// void (APIENTRYP pfn_glBlendColor)(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
// GLAPI void APIENTRY wrap_glBlendColor(float red, float green, float blue, float alpha) { (*pfn_glBlendColor)(red, green, blue, alpha); }
//
// void (APIENTRYP pfn_glBlendEquation)(GLenum mode);
// GLAPI void APIENTRY wrap_glBlendEquation(unsigned int mode) { (*pfn_glBlendEquation)(mode); }
//
...
// GLAPI void APIENTRY wrap_glCopyTexSubImage3D(unsigned int target, int level, int xoffset, int yoffset, int zoffset, int x, int y, int width, int height) { (*pfn_glCopyTexSubImage3D)(target, level, xoffset, yoffset, zoffset, x, y, width, height); }
//
...
// GLAPI void APIENTRY wrap_glDrawRangeElements(unsigned int mode, unsigned int start, unsigned int end, int count, unsigned int t_ype, void* indices) { (*pfn_glDrawRangeElements)(mode, start, end, count, t_ype, indices); }
//
...
// GLAPI void APIENTRY wrap_glTexImage3D(unsigned int target, int level, int internalformat, int width, int height, int depth, int border, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glTexImage3D)(target, level, internalformat, width, height, depth, border, format, t_ype, pixels); }
//
...
// GLAPI void APIENTRY wrap_glTexSubImage3D(unsigned int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, unsigned int format, unsigned int t_ype, void* pixels) { (*pfn_glTexSubImage3D)(target, level, xoffset, yoffset, zoffset, width, height, depth, format, t_ype, pixels); }
//
// // GL_VERSION_1_3
//
// void (APIENTRYP pfn_glActiveTexture)(GLenum texture);
// GLAPI void APIENTRY wrap_glActiveTexture(unsigned int texture) { (*pfn_glActiveTexture)(texture); }
//
...
// GLAPI void APIENTRY wrap_glCompressedTexImage1D(unsigned int target, int level, unsigned int internalformat, int width, int border, int imageSize, void* data) { (*pfn_glCompressedTexImage1D)(target, level, internalformat, width, border, imageSize, data); }
//
...
// GLAPI void APIENTRY wrap_glCompressedTexImage2D(unsigned int target, int level, unsigned int internalformat, int width, int height, int border, int imageSize, void* data) { (*pfn_glCompressedTexImage2D)(target, level, internalformat, width, height, border, imageSize, data); }
//
...
// GLAPI void APIENTRY wrap_glCompressedTexImage3D(unsigned int target, int level, unsigned int internalformat, int width, int height, int depth, int border, int imageSize, void* data) { (*pfn_glCompressedTexImage3D)(target, level, internalformat, width, height, depth, border, imageSize, data); }
//
...
// GLAPI void APIENTRY wrap_glCompressedTexSubImage1D(unsigned int target, int level, int xoffset, int width, unsigned int format, int imageSize, void* data) { (*pfn_glCompressedTexSubImage1D)(target, level, xoffset, width, format, imageSize, data); }
//
...
// GLAPI void APIENTRY wrap_glCompressedTexSubImage2D(unsigned int target, int level, int xoffset, int yoffset, int width, int height, unsigned int format, int imageSize, void* data) { (*pfn_glCompressedTexSubImage2D)(target, level, xoffset, yoffset, width, height, format, imageSize, data); }
//
...
// GLAPI void APIENTRY wrap_glCompressedTexSubImage3D(unsigned int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, unsigned int format, int imageSize, void* data) { (*pfn_glCompressedTexSubImage3D)(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data); }
//
// void (APIENTRYP pfn_glGetCompressedTexImage)(GLenum target, GLint level, GLvoid *img);
// GLAPI void APIENTRY wrap_glGetCompressedTexImage(unsigned int target, int level, void* img) { (*pfn_glGetCompressedTexImage)(target, level, img); }
//
// void (APIENTRYP pfn_glSampleCoverage)(GLfloat value, GLboolean invert);
// GLAPI void APIENTRY wrap_glSampleCoverage(float value, unsigned char invert) { (*pfn_glSampleCoverage)(value, invert); }
//
// // GL_VERSION_1_4
//
// void (APIENTRYP pfn_glBlendFuncSeparate)(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
// GLAPI void APIENTRY wrap_glBlendFuncSeparate(unsigned int sfactorRGB, unsigned int dfactorRGB, unsigned int sfactorAlpha, unsigned int dfactorAlpha) { (*pfn_glBlendFuncSeparate)(sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha); }
//
// void (APIENTRYP pfn_glMultiDrawArrays)(GLenum mode, const GLint *first, const GLsizei *count, GLsizei drawcount);
// GLAPI void APIENTRY wrap_glMultiDrawArrays(unsigned int mode, int* first, int* count, int drawcount) { (*pfn_glMultiDrawArrays)(mode, first, count, drawcount); }
//
...
// GLAPI void APIENTRY wrap_glMultiDrawElements(unsigned int mode, int* count, unsigned int t_ype, const void* const* indices, int drawcount) { (*pfn_glMultiDrawElements)(mode, count, t_ype, indices, drawcount); }
//
// void (APIENTRYP pfn_glPointParameterf)(GLenum pname, GLfloat param);
// GLAPI void APIENTRY wrap_glPointParameterf(unsigned int pname, float param) { (*pfn_glPointParameterf)(pname, param); }
//
// void (APIENTRYP pfn_glPointParameterfv)(GLenum pname, const GLfloat *params);
// GLAPI void APIENTRY wrap_glPointParameterfv(unsigned int pname, float* params) { (*pfn_glPointParameterfv)(pname, params); }
//
// void (APIENTRYP pfn_glPointParameteri)(GLenum pname, GLint param);
// GLAPI void APIENTRY wrap_glPointParameteri(unsigned int pname, int param) { (*pfn_glPointParameteri)(pname, param); }
//
// void (APIENTRYP pfn_glPointParameteriv)(GLenum pname, const GLint *params);
// GLAPI void APIENTRY wrap_glPointParameteriv(unsigned int pname, int* params) { (*pfn_glPointParameteriv)(pname, params); }
//
// // GL_VERSION_1_5
//
// void (APIENTRYP pfn_glBeginQuery)(GLenum target, GLuint id);
// GLAPI void APIENTRY wrap_glBeginQuery(unsigned int target, unsigned int id) { (*pfn_glBeginQuery)(target, id); }
//
// void (APIENTRYP pfn_glBindBuffer)(GLenum target, GLuint buffer);
// GLAPI void APIENTRY wrap_glBindBuffer(unsigned int target, unsigned int buffer) { (*pfn_glBindBuffer)(target, buffer); }
//
// void (APIENTRYP pfn_glBufferData)(GLenum target, GLsizeiptr size, const GLvoid *data, GLenum usage);
// GLAPI void APIENTRY wrap_glBufferData(unsigned int target, long long size, void* data, unsigned int usage) { (*pfn_glBufferData)(target, size, data, usage); }
//
// void (APIENTRYP pfn_glBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data);
// GLAPI void APIENTRY wrap_glBufferSubData(unsigned int target, long long offset, long long size, void* data) { (*pfn_glBufferSubData)(target, offset, size, data); }
//
// void (APIENTRYP pfn_glDeleteBuffers)(GLsizei n, const GLuint *buffers);
// GLAPI void APIENTRY wrap_glDeleteBuffers(int n, unsigned int* buffers) { (*pfn_glDeleteBuffers)(n, buffers); }
//
// void (APIENTRYP pfn_glDeleteQueries)(GLsizei n, const GLuint *ids);
// GLAPI void APIENTRY wrap_glDeleteQueries(int n, unsigned int* ids) { (*pfn_glDeleteQueries)(n, ids); }
//
// void (APIENTRYP pfn_glEndQuery)(GLenum target);
// GLAPI void APIENTRY wrap_glEndQuery(unsigned int target) { (*pfn_glEndQuery)(target); }
//
// void (APIENTRYP pfn_glGenBuffers)(GLsizei n, GLuint *buffers);
// GLAPI void APIENTRY wrap_glGenBuffers(int n, unsigned int* buffers) { (*pfn_glGenBuffers)(n, buffers); }
//
// void (APIENTRYP pfn_glGenQueries)(GLsizei n, GLuint *ids);
// GLAPI void APIENTRY wrap_glGenQueries(int n, unsigned int* ids) { (*pfn_glGenQueries)(n, ids); }
//
// void (APIENTRYP pfn_glGetBufferParameteriv)(GLenum target, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetBufferParameteriv(unsigned int target, unsigned int pname, int* params) { (*pfn_glGetBufferParameteriv)(target, pname, params); }
//
// void (APIENTRYP pfn_glGetBufferPointerv)(GLenum target, GLenum pname, GLvoid* *params);
// GLAPI void APIENTRY wrap_glGetBufferPointerv(unsigned int target, unsigned int pname, void** params) { (*pfn_glGetBufferPointerv)(target, pname, params); }
//
// void (APIENTRYP pfn_glGetBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, GLvoid *data);
// GLAPI void APIENTRY wrap_glGetBufferSubData(unsigned int target, long long offset, long long size, void* data) { (*pfn_glGetBufferSubData)(target, offset, size, data); }
//
// void (APIENTRYP pfn_glGetQueryObjectiv)(GLuint id, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetQueryObjectiv(unsigned int id, unsigned int pname, int* params) { (*pfn_glGetQueryObjectiv)(id, pname, params); }
//
// void (APIENTRYP pfn_glGetQueryObjectuiv)(GLuint id, GLenum pname, GLuint *params);
// GLAPI void APIENTRY wrap_glGetQueryObjectuiv(unsigned int id, unsigned int pname, unsigned int* params) { (*pfn_glGetQueryObjectuiv)(id, pname, params); }
//
// void (APIENTRYP pfn_glGetQueryiv)(GLenum target, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetQueryiv(unsigned int target, unsigned int pname, int* params) { (*pfn_glGetQueryiv)(target, pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsBuffer)(GLuint buffer);
// GLAPI GLboolean APIENTRY wrap_glIsBuffer(unsigned int buffer) { return (*pfn_glIsBuffer)(buffer); }
//
// GLboolean (APIENTRYP pfn_glIsQuery)(GLuint id);
// GLAPI GLboolean APIENTRY wrap_glIsQuery(unsigned int id) { return (*pfn_glIsQuery)(id); }
//
// GLvoid* (APIENTRYP pfn_glMapBuffer)(GLenum target, GLenum access);
// GLAPI GLvoid* APIENTRY wrap_glMapBuffer(unsigned int target, unsigned int access) { return (*pfn_glMapBuffer)(target, access); }
//
// GLboolean (APIENTRYP pfn_glUnmapBuffer)(GLenum target);
// GLAPI GLboolean APIENTRY wrap_glUnmapBuffer(unsigned int target) { return (*pfn_glUnmapBuffer)(target); }
//
// // GL_VERSION_2_0
//
// void (APIENTRYP pfn_glAttachShader)(GLuint program, GLuint shader);
// GLAPI void APIENTRY wrap_glAttachShader(unsigned int program, unsigned int shader) { (*pfn_glAttachShader)(program, shader); }
//
// void (APIENTRYP pfn_glBindAttribLocation)(GLuint program, GLuint index, const GLchar *name);
// GLAPI void APIENTRY wrap_glBindAttribLocation(unsigned int program, unsigned int index, char* name) { (*pfn_glBindAttribLocation)(program, index, name); }
//
// void (APIENTRYP pfn_glBlendEquationSeparate)(GLenum modeRGB, GLenum modeAlpha);
// GLAPI void APIENTRY wrap_glBlendEquationSeparate(unsigned int modeRGB, unsigned int modeAlpha) { (*pfn_glBlendEquationSeparate)(modeRGB, modeAlpha); }
//
// void (APIENTRYP pfn_glCompileShader)(GLuint shader);
// GLAPI void APIENTRY wrap_glCompileShader(unsigned int shader) { (*pfn_glCompileShader)(shader); }
//
// GLuint (APIENTRYP pfn_glCreateProgram)();
// GLAPI GLuint APIENTRY wrap_glCreateProgram() { return (*pfn_glCreateProgram)(); }
//
...
// GLAPI void APIENTRY wrap_glDeleteProgram(unsigned int program) { (*pfn_glDeleteProgram)(program); }
//
// void (APIENTRYP pfn_glDeleteShader)(GLuint shader);
// GLAPI void APIENTRY wrap_glDeleteShader(unsigned int shader) { (*pfn_glDeleteShader)(shader); }
//
// void (APIENTRYP pfn_glDetachShader)(GLuint program, GLuint shader);
// GLAPI void APIENTRY wrap_glDetachShader(unsigned int program, unsigned int shader) { (*pfn_glDetachShader)(program, shader); }
//
// void (APIENTRYP pfn_glDisableVertexAttribArray)(GLuint index);
// GLAPI void APIENTRY wrap_glDisableVertexAttribArray(unsigned int index) { (*pfn_glDisableVertexAttribArray)(index); }
//
// void (APIENTRYP pfn_glDrawBuffers)(GLsizei n, const GLenum *bufs);
// GLAPI void APIENTRY wrap_glDrawBuffers(int n, unsigned int* bufs) { (*pfn_glDrawBuffers)(n, bufs); }
//
// void (APIENTRYP pfn_glEnableVertexAttribArray)(GLuint index);
// GLAPI void APIENTRY wrap_glEnableVertexAttribArray(unsigned int index) { (*pfn_glEnableVertexAttribArray)(index); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveAttrib(unsigned int program, unsigned int index, int bufSize, int* length, int* size, unsigned int* t_ype, char* name) { (*pfn_glGetActiveAttrib)(program, index, bufSize, length, size, t_ype, name); }
//
...
// GLAPI void APIENTRY wrap_glGetActiveUniform(unsigned int program, unsigned int index, int bufSize, int* length, int* size, unsigned int* t_ype, unsigned char* name) { (*pfn_glGetActiveUniform)(program, index, bufSize, length, size, t_ype, (GLchar *)name); }
//
// void (APIENTRYP pfn_glGetAttachedShaders)(GLuint program, GLsizei maxCount, GLsizei *count, GLuint *obj);
// GLAPI void APIENTRY wrap_glGetAttachedShaders(unsigned int program, int maxCount, int* count, unsigned int* obj) { (*pfn_glGetAttachedShaders)(program, maxCount, count, obj); }
//
// GLint (APIENTRYP pfn_glGetAttribLocation)(GLuint program, const GLchar *name);
// GLAPI GLint APIENTRY wrap_glGetAttribLocation(unsigned int program, char* name) { return (*pfn_glGetAttribLocation)(program, name); }
//
// void (APIENTRYP pfn_glGetProgramInfoLog)(GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
// GLAPI void APIENTRY wrap_glGetProgramInfoLog(unsigned int program, int bufSize, int* length, unsigned char* infoLog) { (*pfn_glGetProgramInfoLog)(program, bufSize, length, (GLchar *)infoLog); }
//
// void (APIENTRYP pfn_glGetProgramiv)(GLuint program, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetProgramiv(unsigned int program, unsigned int pname, int* params) { (*pfn_glGetProgramiv)(program, pname, params); }
//
// void (APIENTRYP pfn_glGetShaderInfoLog)(GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
// GLAPI void APIENTRY wrap_glGetShaderInfoLog(unsigned int shader, int bufSize, int* length, unsigned char* infoLog) { (*pfn_glGetShaderInfoLog)(shader, bufSize, length, (GLchar *)infoLog); }
//
// void (APIENTRYP pfn_glGetShaderSource)(GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *source);
// GLAPI void APIENTRY wrap_glGetShaderSource(unsigned int shader, int bufSize, int* length, unsigned char* source) { (*pfn_glGetShaderSource)(shader, bufSize, length, (GLchar *)source); }
//
// void (APIENTRYP pfn_glGetShaderiv)(GLuint shader, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetShaderiv(unsigned int shader, unsigned int pname, int* params) { (*pfn_glGetShaderiv)(shader, pname, params); }
//
// GLint (APIENTRYP pfn_glGetUniformLocation)(GLuint program, const GLchar *name);
// GLAPI GLint APIENTRY wrap_glGetUniformLocation(unsigned int program, char* name) { return (*pfn_glGetUniformLocation)(program, name); }
//
// void (APIENTRYP pfn_glGetUniformfv)(GLuint program, GLint location, GLfloat *params);
// GLAPI void APIENTRY wrap_glGetUniformfv(unsigned int program, int location, float* params) { (*pfn_glGetUniformfv)(program, location, params); }
//
// void (APIENTRYP pfn_glGetUniformiv)(GLuint program, GLint location, GLint *params);
// GLAPI void APIENTRY wrap_glGetUniformiv(unsigned int program, int location, int* params) { (*pfn_glGetUniformiv)(program, location, params); }
//
// void (APIENTRYP pfn_glGetVertexAttribPointerv)(GLuint index, GLenum pname, GLvoid* *pointer);
// GLAPI void APIENTRY wrap_glGetVertexAttribPointerv(unsigned int index, unsigned int pname, long long* pointer) { (*pfn_glGetVertexAttribPointerv)(index, pname, (GLvoid **)pointer); }
//
// void (APIENTRYP pfn_glGetVertexAttribdv)(GLuint index, GLenum pname, GLdouble *params);
// GLAPI void APIENTRY wrap_glGetVertexAttribdv(unsigned int index, unsigned int pname, double* params) { (*pfn_glGetVertexAttribdv)(index, pname, params); }
//
// void (APIENTRYP pfn_glGetVertexAttribfv)(GLuint index, GLenum pname, GLfloat *params);
// GLAPI void APIENTRY wrap_glGetVertexAttribfv(unsigned int index, unsigned int pname, float* params) { (*pfn_glGetVertexAttribfv)(index, pname, params); }
//
// void (APIENTRYP pfn_glGetVertexAttribiv)(GLuint index, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetVertexAttribiv(unsigned int index, unsigned int pname, int* params) { (*pfn_glGetVertexAttribiv)(index, pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsProgram)(GLuint program);
// GLAPI GLboolean APIENTRY wrap_glIsProgram(unsigned int program) { return (*pfn_glIsProgram)(program); }
//
// GLboolean (APIENTRYP pfn_glIsShader)(GLuint shader);
// GLAPI GLboolean APIENTRY wrap_glIsShader(unsigned int shader) { return (*pfn_glIsShader)(shader); }
//
// void (APIENTRYP pfn_glLinkProgram)(GLuint program);
// GLAPI void APIENTRY wrap_glLinkProgram(unsigned int program) { (*pfn_glLinkProgram)(program); }
//
// void (APIENTRYP pfn_glShaderSource)(GLuint shader, GLsizei count, const GLchar* const *string, const GLint *length);
// GLAPI void APIENTRY wrap_glShaderSource(unsigned int shader, int count, const char* const* s_tring, int* length) { (*pfn_glShaderSource)(shader, count, s_tring, length); }
//
// void (APIENTRYP pfn_glStencilFuncSeparate)(GLenum face, GLenum func, GLint ref, GLuint mask);
// GLAPI void APIENTRY wrap_glStencilFuncSeparate(unsigned int face, unsigned int f_unc, int ref, unsigned int mask) { (*pfn_glStencilFuncSeparate)(face, f_unc, ref, mask); }
//
// void (APIENTRYP pfn_glStencilMaskSeparate)(GLenum face, GLuint mask);
// GLAPI void APIENTRY wrap_glStencilMaskSeparate(unsigned int face, unsigned int mask) { (*pfn_glStencilMaskSeparate)(face, mask); }
//
// void (APIENTRYP pfn_glStencilOpSeparate)(GLenum face, GLenum sfail, GLenum dpfail, GLenum dppass);
// GLAPI void APIENTRY wrap_glStencilOpSeparate(unsigned int face, unsigned int sfail, unsigned int dpfail, unsigned int dppass) { (*pfn_glStencilOpSeparate)(face, sfail, dpfail, dppass); }
//
// void (APIENTRYP pfn_glUniform1f)(GLint location, GLfloat v0);
// GLAPI void APIENTRY wrap_glUniform1f(int location, float v0) { (*pfn_glUniform1f)(location, v0); }
//
// void (APIENTRYP pfn_glUniform1fv)(GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniform1fv(int location, int count, float* value) { (*pfn_glUniform1fv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform1i)(GLint location, GLint v0);
// GLAPI void APIENTRY wrap_glUniform1i(int location, int v0) { (*pfn_glUniform1i)(location, v0); }
//
// void (APIENTRYP pfn_glUniform1iv)(GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glUniform1iv(int location, int count, int* value) { (*pfn_glUniform1iv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform2f)(GLint location, GLfloat v0, GLfloat v1);
// GLAPI void APIENTRY wrap_glUniform2f(int location, float v0, float v1) { (*pfn_glUniform2f)(location, v0, v1); }
//
// void (APIENTRYP pfn_glUniform2fv)(GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniform2fv(int location, int count, float* value) { (*pfn_glUniform2fv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform2i)(GLint location, GLint v0, GLint v1);
// GLAPI void APIENTRY wrap_glUniform2i(int location, int v0, int v1) { (*pfn_glUniform2i)(location, v0, v1); }
//
// void (APIENTRYP pfn_glUniform2iv)(GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glUniform2iv(int location, int count, int* value) { (*pfn_glUniform2iv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform3f)(GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
// GLAPI void APIENTRY wrap_glUniform3f(int location, float v0, float v1, float v2) { (*pfn_glUniform3f)(location, v0, v1, v2); }
//
// void (APIENTRYP pfn_glUniform3fv)(GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniform3fv(int location, int count, float* value) { (*pfn_glUniform3fv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform3i)(GLint location, GLint v0, GLint v1, GLint v2);
// GLAPI void APIENTRY wrap_glUniform3i(int location, int v0, int v1, int v2) { (*pfn_glUniform3i)(location, v0, v1, v2); }
//
// void (APIENTRYP pfn_glUniform3iv)(GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glUniform3iv(int location, int count, int* value) { (*pfn_glUniform3iv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform4f)(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
// GLAPI void APIENTRY wrap_glUniform4f(int location, float v0, float v1, float v2, float v3) { (*pfn_glUniform4f)(location, v0, v1, v2, v3); }
//
// void (APIENTRYP pfn_glUniform4fv)(GLint location, GLsizei count, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniform4fv(int location, int count, float* value) { (*pfn_glUniform4fv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform4i)(GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
// GLAPI void APIENTRY wrap_glUniform4i(int location, int v0, int v1, int v2, int v3) { (*pfn_glUniform4i)(location, v0, v1, v2, v3); }
//
// void (APIENTRYP pfn_glUniform4iv)(GLint location, GLsizei count, const GLint *value);
// GLAPI void APIENTRY wrap_glUniform4iv(int location, int count, int* value) { (*pfn_glUniform4iv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniformMatrix2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix2fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix2fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix3fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix3fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix4fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix4fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUseProgram)(GLuint program);
// GLAPI void APIENTRY wrap_glUseProgram(unsigned int program) { (*pfn_glUseProgram)(program); }
//
// void (APIENTRYP pfn_glValidateProgram)(GLuint program);
// GLAPI void APIENTRY wrap_glValidateProgram(unsigned int program) { (*pfn_glValidateProgram)(program); }
//
// void (APIENTRYP pfn_glVertexAttrib1d)(GLuint index, GLdouble x);
// GLAPI void APIENTRY wrap_glVertexAttrib1d(unsigned int index, double x) { (*pfn_glVertexAttrib1d)(index, x); }
//
// void (APIENTRYP pfn_glVertexAttrib1dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttrib1dv(unsigned int index, double* v) { (*pfn_glVertexAttrib1dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib1f)(GLuint index, GLfloat x);
// GLAPI void APIENTRY wrap_glVertexAttrib1f(unsigned int index, float x) { (*pfn_glVertexAttrib1f)(index, x); }
//
// void (APIENTRYP pfn_glVertexAttrib1fv)(GLuint index, const GLfloat *v);
// GLAPI void APIENTRY wrap_glVertexAttrib1fv(unsigned int index, float* v) { (*pfn_glVertexAttrib1fv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib1s)(GLuint index, GLshort x);
// GLAPI void APIENTRY wrap_glVertexAttrib1s(unsigned int index, short  x) { (*pfn_glVertexAttrib1s)(index, x); }
//
// void (APIENTRYP pfn_glVertexAttrib1sv)(GLuint index, const GLshort *v);
// GLAPI void APIENTRY wrap_glVertexAttrib1sv(unsigned int index, short * v) { (*pfn_glVertexAttrib1sv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib2d)(GLuint index, GLdouble x, GLdouble y);
// GLAPI void APIENTRY wrap_glVertexAttrib2d(unsigned int index, double x, double y) { (*pfn_glVertexAttrib2d)(index, x, y); }
//
// void (APIENTRYP pfn_glVertexAttrib2dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttrib2dv(unsigned int index, double* v) { (*pfn_glVertexAttrib2dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib2f)(GLuint index, GLfloat x, GLfloat y);
// GLAPI void APIENTRY wrap_glVertexAttrib2f(unsigned int index, float x, float y) { (*pfn_glVertexAttrib2f)(index, x, y); }
//
// void (APIENTRYP pfn_glVertexAttrib2fv)(GLuint index, const GLfloat *v);
// GLAPI void APIENTRY wrap_glVertexAttrib2fv(unsigned int index, float* v) { (*pfn_glVertexAttrib2fv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib2s)(GLuint index, GLshort x, GLshort y);
// GLAPI void APIENTRY wrap_glVertexAttrib2s(unsigned int index, short  x, short  y) { (*pfn_glVertexAttrib2s)(index, x, y); }
//
// void (APIENTRYP pfn_glVertexAttrib2sv)(GLuint index, const GLshort *v);
// GLAPI void APIENTRY wrap_glVertexAttrib2sv(unsigned int index, short * v) { (*pfn_glVertexAttrib2sv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib3d)(GLuint index, GLdouble x, GLdouble y, GLdouble z);
// GLAPI void APIENTRY wrap_glVertexAttrib3d(unsigned int index, double x, double y, double z) { (*pfn_glVertexAttrib3d)(index, x, y, z); }
//
// void (APIENTRYP pfn_glVertexAttrib3dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttrib3dv(unsigned int index, double* v) { (*pfn_glVertexAttrib3dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib3f)(GLuint index, GLfloat x, GLfloat y, GLfloat z);
// GLAPI void APIENTRY wrap_glVertexAttrib3f(unsigned int index, float x, float y, float z) { (*pfn_glVertexAttrib3f)(index, x, y, z); }
//
// void (APIENTRYP pfn_glVertexAttrib3fv)(GLuint index, const GLfloat *v);
// GLAPI void APIENTRY wrap_glVertexAttrib3fv(unsigned int index, float* v) { (*pfn_glVertexAttrib3fv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib3s)(GLuint index, GLshort x, GLshort y, GLshort z);
// GLAPI void APIENTRY wrap_glVertexAttrib3s(unsigned int index, short  x, short  y, short  z) { (*pfn_glVertexAttrib3s)(index, x, y, z); }
//
// void (APIENTRYP pfn_glVertexAttrib3sv)(GLuint index, const GLshort *v);
// GLAPI void APIENTRY wrap_glVertexAttrib3sv(unsigned int index, short * v) { (*pfn_glVertexAttrib3sv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4Nbv)(GLuint index, const GLbyte *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4Nbv(unsigned int index, signed char* v) { (*pfn_glVertexAttrib4Nbv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4Niv)(GLuint index, const GLint *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4Niv(unsigned int index, int* v) { (*pfn_glVertexAttrib4Niv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4Nsv)(GLuint index, const GLshort *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4Nsv(unsigned int index, short * v) { (*pfn_glVertexAttrib4Nsv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4Nub)(GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
// GLAPI void APIENTRY wrap_glVertexAttrib4Nub(unsigned int index, unsigned char x, unsigned char y, unsigned char z, unsigned char w) { (*pfn_glVertexAttrib4Nub)(index, x, y, z, w); }
//
// void (APIENTRYP pfn_glVertexAttrib4Nubv)(GLuint index, const GLubyte *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4Nubv(unsigned int index, unsigned char* v) { (*pfn_glVertexAttrib4Nubv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4Nuiv)(GLuint index, const GLuint *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4Nuiv(unsigned int index, unsigned int* v) { (*pfn_glVertexAttrib4Nuiv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4Nusv)(GLuint index, const GLushort *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4Nusv(unsigned int index, unsigned short* v) { (*pfn_glVertexAttrib4Nusv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4bv)(GLuint index, const GLbyte *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4bv(unsigned int index, signed char* v) { (*pfn_glVertexAttrib4bv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4d)(GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
// GLAPI void APIENTRY wrap_glVertexAttrib4d(unsigned int index, double x, double y, double z, double w) { (*pfn_glVertexAttrib4d)(index, x, y, z, w); }
//
// void (APIENTRYP pfn_glVertexAttrib4dv)(GLuint index, const GLdouble *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4dv(unsigned int index, double* v) { (*pfn_glVertexAttrib4dv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4f)(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
// GLAPI void APIENTRY wrap_glVertexAttrib4f(unsigned int index, float x, float y, float z, float w) { (*pfn_glVertexAttrib4f)(index, x, y, z, w); }
//
// void (APIENTRYP pfn_glVertexAttrib4fv)(GLuint index, const GLfloat *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4fv(unsigned int index, float* v) { (*pfn_glVertexAttrib4fv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4iv)(GLuint index, const GLint *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4iv(unsigned int index, int* v) { (*pfn_glVertexAttrib4iv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4s)(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
// GLAPI void APIENTRY wrap_glVertexAttrib4s(unsigned int index, short  x, short  y, short  z, short  w) { (*pfn_glVertexAttrib4s)(index, x, y, z, w); }
//
// void (APIENTRYP pfn_glVertexAttrib4sv)(GLuint index, const GLshort *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4sv(unsigned int index, short * v) { (*pfn_glVertexAttrib4sv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4ubv)(GLuint index, const GLubyte *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4ubv(unsigned int index, unsigned char* v) { (*pfn_glVertexAttrib4ubv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4uiv)(GLuint index, const GLuint *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4uiv(unsigned int index, unsigned int* v) { (*pfn_glVertexAttrib4uiv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttrib4usv)(GLuint index, const GLushort *v);
// GLAPI void APIENTRY wrap_glVertexAttrib4usv(unsigned int index, unsigned short* v) { (*pfn_glVertexAttrib4usv)(index, v); }
//
...
// GLAPI void APIENTRY wrap_glVertexAttribPointer(unsigned int index, int size, unsigned int t_ype, unsigned char normalized, int stride, long long pointer) { (*pfn_glVertexAttribPointer)(index, size, t_ype, normalized, stride, (const GLvoid *)pointer); }
//
// // GL_VERSION_2_1
//
// void (APIENTRYP pfn_glUniformMatrix2x3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix2x3fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix2x3fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix2x4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix2x4fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix2x4fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix3x2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix3x2fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix3x2fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix3x4fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix3x4fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix3x4fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix4x2fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix4x2fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix4x2fv)(location, count, transpose, value); }
//
// void (APIENTRYP pfn_glUniformMatrix4x3fv)(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
// GLAPI void APIENTRY wrap_glUniformMatrix4x3fv(int location, int count, unsigned char transpose, float* value) { (*pfn_glUniformMatrix4x3fv)(location, count, transpose, value); }
//
// // GL_VERSION_3_0
//
// void (APIENTRYP pfn_glBeginConditionalRender)(GLuint id, GLenum mode);
// GLAPI void APIENTRY wrap_glBeginConditionalRender(unsigned int id, unsigned int mode) { (*pfn_glBeginConditionalRender)(id, mode); }
//
// void (APIENTRYP pfn_glBeginTransformFeedback)(GLenum primitiveMode);
// GLAPI void APIENTRY wrap_glBeginTransformFeedback(unsigned int primitiveMode) { (*pfn_glBeginTransformFeedback)(primitiveMode); }
//
// void (APIENTRYP pfn_glBindBufferBase)(GLenum target, GLuint index, GLuint buffer);
// GLAPI void APIENTRY wrap_glBindBufferBase(unsigned int target, unsigned int index, unsigned int buffer) { (*pfn_glBindBufferBase)(target, index, buffer); }
//
// void (APIENTRYP pfn_glBindBufferRange)(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
// GLAPI void APIENTRY wrap_glBindBufferRange(unsigned int target, unsigned int index, unsigned int buffer, long long offset, long long size) { (*pfn_glBindBufferRange)(target, index, buffer, offset, size); }
//
// void (APIENTRYP pfn_glBindFragDataLocation)(GLuint program, GLuint color, const GLchar *name);
// GLAPI void APIENTRY wrap_glBindFragDataLocation(unsigned int program, unsigned int color, char* name) { (*pfn_glBindFragDataLocation)(program, color, name); }
//
// void (APIENTRYP pfn_glClampColor)(GLenum target, GLenum clamp);
// GLAPI void APIENTRY wrap_glClampColor(unsigned int target, unsigned int clamp) { (*pfn_glClampColor)(target, clamp); }
//
// void (APIENTRYP pfn_glClearBufferfi)(GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
// GLAPI void APIENTRY wrap_glClearBufferfi(unsigned int buffer, int drawbuffer, float depth, int stencil) { (*pfn_glClearBufferfi)(buffer, drawbuffer, depth, stencil); }
//
// void (APIENTRYP pfn_glClearBufferfv)(GLenum buffer, GLint drawbuffer, const GLfloat *value);
// GLAPI void APIENTRY wrap_glClearBufferfv(unsigned int buffer, int drawbuffer, float* value) { (*pfn_glClearBufferfv)(buffer, drawbuffer, value); }
//
// void (APIENTRYP pfn_glClearBufferiv)(GLenum buffer, GLint drawbuffer, const GLint *value);
// GLAPI void APIENTRY wrap_glClearBufferiv(unsigned int buffer, int drawbuffer, int* value) { (*pfn_glClearBufferiv)(buffer, drawbuffer, value); }
//
// void (APIENTRYP pfn_glClearBufferuiv)(GLenum buffer, GLint drawbuffer, const GLuint *value);
// GLAPI void APIENTRY wrap_glClearBufferuiv(unsigned int buffer, int drawbuffer, unsigned int* value) { (*pfn_glClearBufferuiv)(buffer, drawbuffer, value); }
//
// void (APIENTRYP pfn_glColorMaski)(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
// GLAPI void APIENTRY wrap_glColorMaski(unsigned int index, unsigned char r, unsigned char g, unsigned char b, unsigned char a) { (*pfn_glColorMaski)(index, r, g, b, a); }
//
// void (APIENTRYP pfn_glDisablei)(GLenum target, GLuint index);
// GLAPI void APIENTRY wrap_glDisablei(unsigned int target, unsigned int index) { (*pfn_glDisablei)(target, index); }
//
// void (APIENTRYP pfn_glEnablei)(GLenum target, GLuint index);
// GLAPI void APIENTRY wrap_glEnablei(unsigned int target, unsigned int index) { (*pfn_glEnablei)(target, index); }
//
// void (APIENTRYP pfn_glEndConditionalRender)();
// GLAPI void APIENTRY wrap_glEndConditionalRender() { (*pfn_glEndConditionalRender)(); }
//
// void (APIENTRYP pfn_glEndTransformFeedback)();
...
// GLAPI void APIENTRY wrap_glGetBooleani_v(unsigned int target, unsigned int index, unsigned char* data) { (*pfn_glGetBooleani_v)(target, index, data); }
//
// GLint (APIENTRYP pfn_glGetFragDataLocation)(GLuint program, const GLchar *name);
// GLAPI GLint APIENTRY wrap_glGetFragDataLocation(unsigned int program, char* name) { return (*pfn_glGetFragDataLocation)(program, name); }
//
// void (APIENTRYP pfn_glGetIntegeri_v)(GLenum target, GLuint index, GLint *data);
// GLAPI void APIENTRY wrap_glGetIntegeri_v(unsigned int target, unsigned int index, int* data) { (*pfn_glGetIntegeri_v)(target, index, data); }
//
// const GLubyte * (APIENTRYP pfn_glGetStringi)(GLenum name, GLuint index);
// GLAPI const char * APIENTRY wrap_glGetStringi(unsigned int name, unsigned int index) { return (char *)(*pfn_glGetStringi)(name, index); }
//
// void (APIENTRYP pfn_glGetTexParameterIiv)(GLenum target, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetTexParameterIiv(unsigned int target, unsigned int pname, int* params) { (*pfn_glGetTexParameterIiv)(target, pname, params); }
//
// void (APIENTRYP pfn_glGetTexParameterIuiv)(GLenum target, GLenum pname, GLuint *params);
// GLAPI void APIENTRY wrap_glGetTexParameterIuiv(unsigned int target, unsigned int pname, unsigned int* params) { (*pfn_glGetTexParameterIuiv)(target, pname, params); }
//
...
// GLAPI void APIENTRY wrap_glGetTransformFeedbackVarying(unsigned int program, unsigned int index, int bufSize, int* length, int* size, unsigned int* t_ype, char* name) { (*pfn_glGetTransformFeedbackVarying)(program, index, bufSize, length, size, t_ype, name); }
//
// void (APIENTRYP pfn_glGetUniformuiv)(GLuint program, GLint location, GLuint *params);
// GLAPI void APIENTRY wrap_glGetUniformuiv(unsigned int program, int location, unsigned int* params) { (*pfn_glGetUniformuiv)(program, location, params); }
//
// void (APIENTRYP pfn_glGetVertexAttribIiv)(GLuint index, GLenum pname, GLint *params);
// GLAPI void APIENTRY wrap_glGetVertexAttribIiv(unsigned int index, unsigned int pname, int* params) { (*pfn_glGetVertexAttribIiv)(index, pname, params); }
//
// void (APIENTRYP pfn_glGetVertexAttribIuiv)(GLuint index, GLenum pname, GLuint *params);
// GLAPI void APIENTRY wrap_glGetVertexAttribIuiv(unsigned int index, unsigned int pname, unsigned int* params) { (*pfn_glGetVertexAttribIuiv)(index, pname, params); }
//
// GLboolean (APIENTRYP pfn_glIsEnabledi)(GLenum target, GLuint index);
// GLAPI GLboolean APIENTRY wrap_glIsEnabledi(unsigned int target, unsigned int index) { return (*pfn_glIsEnabledi)(target, index); }
//
// void (APIENTRYP pfn_glTexParameterIiv)(GLenum target, GLenum pname, const GLint *params);
// GLAPI void APIENTRY wrap_glTexParameterIiv(unsigned int target, unsigned int pname, int* params) { (*pfn_glTexParameterIiv)(target, pname, params); }
//
// void (APIENTRYP pfn_glTexParameterIuiv)(GLenum target, GLenum pname, const GLuint *params);
// GLAPI void APIENTRY wrap_glTexParameterIuiv(unsigned int target, unsigned int pname, unsigned int* params) { (*pfn_glTexParameterIuiv)(target, pname, params); }
//
...
// GLAPI void APIENTRY wrap_glTransformFeedbackVaryings(unsigned int program, int count, const char* const* varyings, unsigned int bufferMode) { (*pfn_glTransformFeedbackVaryings)(program, count, varyings, bufferMode); }
//
// void (APIENTRYP pfn_glUniform1ui)(GLint location, GLuint v0);
// GLAPI void APIENTRY wrap_glUniform1ui(int location, unsigned int v0) { (*pfn_glUniform1ui)(location, v0); }
//
// void (APIENTRYP pfn_glUniform1uiv)(GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glUniform1uiv(int location, int count, unsigned int* value) { (*pfn_glUniform1uiv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform2ui)(GLint location, GLuint v0, GLuint v1);
// GLAPI void APIENTRY wrap_glUniform2ui(int location, unsigned int v0, unsigned int v1) { (*pfn_glUniform2ui)(location, v0, v1); }
//
// void (APIENTRYP pfn_glUniform2uiv)(GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glUniform2uiv(int location, int count, unsigned int* value) { (*pfn_glUniform2uiv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform3ui)(GLint location, GLuint v0, GLuint v1, GLuint v2);
// GLAPI void APIENTRY wrap_glUniform3ui(int location, unsigned int v0, unsigned int v1, unsigned int v2) { (*pfn_glUniform3ui)(location, v0, v1, v2); }
//
// void (APIENTRYP pfn_glUniform3uiv)(GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glUniform3uiv(int location, int count, unsigned int* value) { (*pfn_glUniform3uiv)(location, count, value); }
//
// void (APIENTRYP pfn_glUniform4ui)(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
// GLAPI void APIENTRY wrap_glUniform4ui(int location, unsigned int v0, unsigned int v1, unsigned int v2, unsigned int v3) { (*pfn_glUniform4ui)(location, v0, v1, v2, v3); }
//
// void (APIENTRYP pfn_glUniform4uiv)(GLint location, GLsizei count, const GLuint *value);
// GLAPI void APIENTRY wrap_glUniform4uiv(int location, int count, unsigned int* value) { (*pfn_glUniform4uiv)(location, count, value); }
//
// void (APIENTRYP pfn_glVertexAttribI1i)(GLuint index, GLint x);
// GLAPI void APIENTRY wrap_glVertexAttribI1i(unsigned int index, int x) { (*pfn_glVertexAttribI1i)(index, x); }
//
// void (APIENTRYP pfn_glVertexAttribI1iv)(GLuint index, const GLint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI1iv(unsigned int index, int* v) { (*pfn_glVertexAttribI1iv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI1ui)(GLuint index, GLuint x);
// GLAPI void APIENTRY wrap_glVertexAttribI1ui(unsigned int index, unsigned int x) { (*pfn_glVertexAttribI1ui)(index, x); }
//
// void (APIENTRYP pfn_glVertexAttribI1uiv)(GLuint index, const GLuint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI1uiv(unsigned int index, unsigned int* v) { (*pfn_glVertexAttribI1uiv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI2i)(GLuint index, GLint x, GLint y);
// GLAPI void APIENTRY wrap_glVertexAttribI2i(unsigned int index, int x, int y) { (*pfn_glVertexAttribI2i)(index, x, y); }
//
// void (APIENTRYP pfn_glVertexAttribI2iv)(GLuint index, const GLint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI2iv(unsigned int index, int* v) { (*pfn_glVertexAttribI2iv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI2ui)(GLuint index, GLuint x, GLuint y);
// GLAPI void APIENTRY wrap_glVertexAttribI2ui(unsigned int index, unsigned int x, unsigned int y) { (*pfn_glVertexAttribI2ui)(index, x, y); }
//
// void (APIENTRYP pfn_glVertexAttribI2uiv)(GLuint index, const GLuint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI2uiv(unsigned int index, unsigned int* v) { (*pfn_glVertexAttribI2uiv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI3i)(GLuint index, GLint x, GLint y, GLint z);
// GLAPI void APIENTRY wrap_glVertexAttribI3i(unsigned int index, int x, int y, int z) { (*pfn_glVertexAttribI3i)(index, x, y, z); }
//
// void (APIENTRYP pfn_glVertexAttribI3iv)(GLuint index, const GLint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI3iv(unsigned int index, int* v) { (*pfn_glVertexAttribI3iv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI3ui)(GLuint index, GLuint x, GLuint y, GLuint z);
// GLAPI void APIENTRY wrap_glVertexAttribI3ui(unsigned int index, unsigned int x, unsigned int y, unsigned int z) { (*pfn_glVertexAttribI3ui)(index, x, y, z); }
//
// void (APIENTRYP pfn_glVertexAttribI3uiv)(GLuint index, const GLuint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI3uiv(unsigned int index, unsigned int* v) { (*pfn_glVertexAttribI3uiv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI4bv)(GLuint index, const GLbyte *v);
// GLAPI void APIENTRY wrap_glVertexAttribI4bv(unsigned int index, signed char* v) { (*pfn_glVertexAttribI4bv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI4i)(GLuint index, GLint x, GLint y, GLint z, GLint w);
// GLAPI void APIENTRY wrap_glVertexAttribI4i(unsigned int index, int x, int y, int z, int w) { (*pfn_glVertexAttribI4i)(index, x, y, z, w); }
//
// void (APIENTRYP pfn_glVertexAttribI4iv)(GLuint index, const GLint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI4iv(unsigned int index, int* v) { (*pfn_glVertexAttribI4iv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI4sv)(GLuint index, const GLshort *v);
// GLAPI void APIENTRY wrap_glVertexAttribI4sv(unsigned int index, short * v) { (*pfn_glVertexAttribI4sv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI4ubv)(GLuint index, const GLubyte *v);
// GLAPI void APIENTRY wrap_glVertexAttribI4ubv(unsigned int index, unsigned char* v) { (*pfn_glVertexAttribI4ubv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI4ui)(GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
// GLAPI void APIENTRY wrap_glVertexAttribI4ui(unsigned int index, unsigned int x, unsigned int y, unsigned int z, unsigned int w) { (*pfn_glVertexAttribI4ui)(index, x, y, z, w); }
//
// void (APIENTRYP pfn_glVertexAttribI4uiv)(GLuint index, const GLuint *v);
// GLAPI void APIENTRY wrap_glVertexAttribI4uiv(unsigned int index, unsigned int* v) { (*pfn_glVertexAttribI4uiv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribI4usv)(GLuint index, const GLushort *v);
// GLAPI void APIENTRY wrap_glVertexAttribI4usv(unsigned int index, unsigned short* v) { (*pfn_glVertexAttribI4usv)(index, v); }
//
// void (APIENTRYP pfn_glVertexAttribIPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
// GLAPI void APIENTRY wrap_glVertexAttribIPointer(unsigned int index, int size, unsigned int t_ype, int stride, void* pointer) { (*pfn_glVertexAttribIPointer)(index, size, t_ype, stride, pointer); }
//
// // GL_VERSION_3_1
//
// void (APIENTRYP pfn_glDrawArraysInstanced)(GLenum mode, GLint first, GLsizei count, GLsizei instancecount);
// GLAPI void APIENTRY wrap_glDrawArraysInstanced(unsigned int mode, int first, int count, int instancecount) { (*pfn_glDrawArraysInstanced)(mode, first, count, instancecount); }
//
...
// GLAPI void APIENTRY wrap_glDrawElementsInstanced(unsigned int mode, int count, unsigned int t_ype, void* indices, int instancecount) { (*pfn_glDrawElementsInstanced)(mode, count, t_ype, indices, instancecount); }
//
// void (APIENTRYP pfn_glPrimitiveRestartIndex)(GLuint index);
// GLAPI void APIENTRY wrap_glPrimitiveRestartIndex(unsigned int index) { (*pfn_glPrimitiveRestartIndex)(index); }
//
// void (APIENTRYP pfn_glTexBuffer)(GLenum target, GLenum internalformat, GLuint buffer);
// GLAPI void APIENTRY wrap_glTexBuffer(unsigned int target, unsigned int internalformat, unsigned int buffer) { (*pfn_glTexBuffer)(target, internalformat, buffer); }
//
// // GL_VERSION_3_2
//
// void (APIENTRYP pfn_glFramebufferTexture)(GLenum target, GLenum attachment, GLuint texture, GLint level);
// GLAPI void APIENTRY wrap_glFramebufferTexture(unsigned int target, unsigned int attachment, unsigned int texture, int level) { (*pfn_glFramebufferTexture)(target, attachment, texture, level); }
//
// void (APIENTRYP pfn_glGetBufferParameteri64v)(GLenum target, GLenum pname, GLint64 *params);
// GLAPI void APIENTRY wrap_glGetBufferParameteri64v(unsigned int target, unsigned int pname, long long* params) { (*pfn_glGetBufferParameteri64v)(target, pname, params); }
//
// void (APIENTRYP pfn_glGetInteger64i_v)(GLenum target, GLuint index, GLint64 *data);
// GLAPI void APIENTRY wrap_glGetInteger64i_v(unsigned int target, unsigned int index, long long* data) { (*pfn_glGetInteger64i_v)(target, index, data); }
//
// // GL_VERSION_3_3
//
// void (APIENTRYP pfn_glVertexAttribDivisor)(GLuint index, GLuint divisor);
// GLAPI void APIENTRY wrap_glVertexAttribDivisor(unsigned int index, unsigned int divisor) { (*pfn_glVertexAttribDivisor)(index, divisor); }
//
// // GL_VERSION_4_0
//
// void (APIENTRYP pfn_glBlendEquationSeparatei)(GLuint buf, GLenum modeRGB, GLenum modeAlpha);
// GLAPI void APIENTRY wrap_glBlendEquationSeparatei(unsigned int buf, unsigned int modeRGB, unsigned int modeAlpha) { (*pfn_glBlendEquationSeparatei)(buf, modeRGB, modeAlpha); }
//
// void (APIENTRYP pfn_glBlendEquationi)(GLuint buf, GLenum mode);
// GLAPI void APIENTRY wrap_glBlendEquationi(unsigned int buf, unsigned int mode) { (*pfn_glBlendEquationi)(buf, mode); }
//
// void (APIENTRYP pfn_glBlendFuncSeparatei)(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
// GLAPI void APIENTRY wrap_glBlendFuncSeparatei(unsigned int buf, unsigned int srcRGB, unsigned int dstRGB, unsigned int srcAlpha, unsigned int dstAlpha) { (*pfn_glBlendFuncSeparatei)(buf, srcRGB, dstRGB, srcAlpha, dstAlpha); }
//
// void (APIENTRYP pfn_glBlendFunci)(GLuint buf, GLenum src, GLenum dst);
// GLAPI void APIENTRY wrap_glBlendFunci(unsigned int buf, unsigned int src, unsigned int dst) { (*pfn_glBlendFunci)(buf, src, dst); }
//
// void (APIENTRYP pfn_glMinSampleShading)(GLfloat value);
// GLAPI void APIENTRY wrap_glMinSampleShading(float value) { (*pfn_glMinSampleShading)(value); }
//
// void init() {
...
// GL_ARB_ES2_compatibility
func ClearDepthf(d float32)            { C.wrap_glClearDepthf(C.float(d)) }
func DepthRangef(n float32, f float32) { C.wrap_glDepthRangef(C.float(n), C.float(f)) }
...
func ReleaseShaderCompiler() { C.wrap_glReleaseShaderCompiler() }
...
func DispatchComputeIndirect(indirect int64) { C.wrap_glDispatchComputeIndirect(C.longlong(indirect)) }
...
func GenerateMipmap(target uint32) { C.wrap_glGenerateMipmap(C.uint(target)) }
...
func Uniform1d(location int32, x float64) { C.wrap_glUniform1d(C.int(location), C.double(x)) }
...
// GL_ARB_invalidate_subdata
func InvalidateBufferData(buffer uint32) { C.wrap_glInvalidateBufferData(C.uint(buffer)) }
...
// GL_ARB_provoking_vertex
func ProvokingVertex(mode uint32) { C.wrap_glProvokingVertex(C.uint(mode)) }
...
// GL_ARB_robustness
func GetGraphicsResetStatusARB() uint32 { return uint32(C.wrap_glGetGraphicsResetStatusARB()) }
...
// GL_ARB_sample_shading
func MinSampleShadingARB(value float32) { C.wrap_glMinSampleShadingARB(C.float(value)) }
...
// GL_ARB_sampler_objects
func BindSampler(unit uint32, sampler uint32) { C.wrap_glBindSampler(C.uint(unit), C.uint(sampler)) }
...
func IsSampler(sampler uint32) bool { return cbool(uint(C.wrap_glIsSampler(C.uint(sampler)))) }
...
func BindProgramPipeline(pipeline uint32) { C.wrap_glBindProgramPipeline(C.uint(pipeline)) }
...
func ValidateProgramPipeline(pipeline uint32) { C.wrap_glValidateProgramPipeline(C.uint(pipeline)) }
...
func MemoryBarrier(barriers uint32) { C.wrap_glMemoryBarrier(C.uint(barriers)) }
...
func DeleteSync(sync Sync) { C.wrap_glDeleteSync(C.GLsync(sync)) }
...
func IsSync(sync Sync) bool { return cbool(uint(C.wrap_glIsSync(C.GLsync(sync)))) }
...
func SampleMaski(index uint32, mask uint32) { C.wrap_glSampleMaski(C.uint(index), C.uint(mask)) }
...
func PopDebugGroup() { C.wrap_glPopDebugGroup() }
...
func QueryCounter(id uint32, target uint32) { C.wrap_glQueryCounter(C.uint(id), C.uint(target)) }
...
func PauseTransformFeedback()  { C.wrap_glPauseTransformFeedback() }
func ResumeTransformFeedback() { C.wrap_glResumeTransformFeedback() }
...
// GL_ARB_vertex_array_object
func BindVertexArray(array uint32) { C.wrap_glBindVertexArray(C.uint(array)) }
func DeleteVertexArrays(n int32, arrays *uint32) {
	C.wrap_glDeleteVertexArrays(C.int(n), (*C.uint)(arrays))
}
func GenVertexArrays(n int32, arrays *uint32) { C.wrap_glGenVertexArrays(C.int(n), (*C.uint)(arrays)) }
func IsVertexArray(array uint32) bool         { return cbool(uint(C.wrap_glIsVertexArray(C.uint(array)))) }
...
func VertexAttribL1d(index uint32, x float64) { C.wrap_glVertexAttribL1d(C.uint(index), C.double(x)) }
...
// GL_ARB_vertex_type_2_10_10_10_rev
func ColorP3ui(t_ype uint32, color uint32)   { C.wrap_glColorP3ui(C.uint(t_ype), C.uint(color)) }
func ColorP3uiv(t_ype uint32, color *uint32) { C.wrap_glColorP3uiv(C.uint(t_ype), (*C.uint)(color)) }
func ColorP4ui(t_ype uint32, color uint32)   { C.wrap_glColorP4ui(C.uint(t_ype), C.uint(color)) }
func ColorP4uiv(t_ype uint32, color *uint32) { C.wrap_glColorP4uiv(C.uint(t_ype), (*C.uint)(color)) }
...
func NormalP3ui(t_ype uint32, coords uint32) { C.wrap_glNormalP3ui(C.uint(t_ype), C.uint(coords)) }
...
func TexCoordP1ui(t_ype uint32, coords uint32) { C.wrap_glTexCoordP1ui(C.uint(t_ype), C.uint(coords)) }
func TexCoordP1uiv(t_ype uint32, coords *uint32) {
	C.wrap_glTexCoordP1uiv(C.uint(t_ype), (*C.uint)(coords))
}
func TexCoordP2ui(t_ype uint32, coords uint32) { C.wrap_glTexCoordP2ui(C.uint(t_ype), C.uint(coords)) }
func TexCoordP2uiv(t_ype uint32, coords *uint32) {
	C.wrap_glTexCoordP2uiv(C.uint(t_ype), (*C.uint)(coords))
}
func TexCoordP3ui(t_ype uint32, coords uint32) { C.wrap_glTexCoordP3ui(C.uint(t_ype), C.uint(coords)) }
func TexCoordP3uiv(t_ype uint32, coords *uint32) {
	C.wrap_glTexCoordP3uiv(C.uint(t_ype), (*C.uint)(coords))
}
func TexCoordP4ui(t_ype uint32, coords uint32) { C.wrap_glTexCoordP4ui(C.uint(t_ype), C.uint(coords)) }
...
func VertexP2ui(t_ype uint32, value uint32)   { C.wrap_glVertexP2ui(C.uint(t_ype), C.uint(value)) }
func VertexP2uiv(t_ype uint32, value *uint32) { C.wrap_glVertexP2uiv(C.uint(t_ype), (*C.uint)(value)) }
func VertexP3ui(t_ype uint32, value uint32)   { C.wrap_glVertexP3ui(C.uint(t_ype), C.uint(value)) }
func VertexP3uiv(t_ype uint32, value *uint32) { C.wrap_glVertexP3uiv(C.uint(t_ype), (*C.uint)(value)) }
func VertexP4ui(t_ype uint32, value uint32)   { C.wrap_glVertexP4ui(C.uint(t_ype), C.uint(value)) }
func VertexP4uiv(t_ype uint32, value *uint32) { C.wrap_glVertexP4uiv(C.uint(t_ype), (*C.uint)(value)) }
...
func ScissorIndexedv(index uint32, v *int32) { C.wrap_glScissorIndexedv(C.uint(index), (*C.int)(v)) }
...
// GL_VERSION_1_0
func BlendFunc(sfactor uint32, dfactor uint32) { C.wrap_glBlendFunc(C.uint(sfactor), C.uint(dfactor)) }
func Clear(mask uint32)                        { C.wrap_glClear(C.uint(mask)) }
func ClearColor(red float32, green float32, blue float32, alpha float32) {
	C.wrap_glClearColor(C.float(red), C.float(green), C.float(blue), C.float(alpha))
}
func ClearDepth(depth float64) { C.wrap_glClearDepth(C.double(depth)) }
func ClearStencil(s int32)     { C.wrap_glClearStencil(C.int(s)) }
...
func CullFace(mode uint32)   { C.wrap_glCullFace(C.uint(mode)) }
func DepthFunc(f_unc uint32) { C.wrap_glDepthFunc(C.uint(f_unc)) }
...
func DepthRange(n_ear float64, f_ar float64) { C.wrap_glDepthRange(C.double(n_ear), C.double(f_ar)) }
func Disable(cap uint32)                     { C.wrap_glDisable(C.uint(cap)) }
func DrawBuffer(mode uint32)                 { C.wrap_glDrawBuffer(C.uint(mode)) }
func Enable(cap uint32)                      { C.wrap_glEnable(C.uint(cap)) }
func Finish()                                { C.wrap_glFinish() }
func Flush()                                 { C.wrap_glFlush() }
func FrontFace(mode uint32)                  { C.wrap_glFrontFace(C.uint(mode)) }
...
func GetError() uint32                        { return uint32(C.wrap_glGetError()) }
func GetFloatv(pname uint32, params *float32) { C.wrap_glGetFloatv(C.uint(pname), (*C.float)(params)) }
func GetIntegerv(pname uint32, params *int32) { C.wrap_glGetIntegerv(C.uint(pname), (*C.int)(params)) }
func GetString(name uint32) string            { return C.GoString(C.wrap_glGetString(C.uint(name))) }
...
func Hint(target uint32, mode uint32)         { C.wrap_glHint(C.uint(target), C.uint(mode)) }
func IsEnabled(cap uint32) bool               { return cbool(uint(C.wrap_glIsEnabled(C.uint(cap)))) }
func LineWidth(width float32)                 { C.wrap_glLineWidth(C.float(width)) }
func LogicOp(opcode uint32)                   { C.wrap_glLogicOp(C.uint(opcode)) }
func PixelStoref(pname uint32, param float32) { C.wrap_glPixelStoref(C.uint(pname), C.float(param)) }
func PixelStorei(pname uint32, param int32)   { C.wrap_glPixelStorei(C.uint(pname), C.int(param)) }
func PointSize(size float32)                  { C.wrap_glPointSize(C.float(size)) }
func PolygonMode(face uint32, mode uint32)    { C.wrap_glPolygonMode(C.uint(face), C.uint(mode)) }
func ReadBuffer(mode uint32)                  { C.wrap_glReadBuffer(C.uint(mode)) }
...
func StencilMask(mask uint32) { C.wrap_glStencilMask(C.uint(mask)) }
...
func GenTextures(n int32, textures *uint32) { C.wrap_glGenTextures(C.int(n), (*C.uint)(textures)) }
func GetPointerv(pname uint32, params *Pointer) {
	C.wrap_glGetPointerv(C.uint(pname), (*unsafe.Pointer)(params))
}
func IsTexture(texture uint32) bool { return cbool(uint(C.wrap_glIsTexture(C.uint(texture)))) }
...
func BlendEquation(mode uint32) { C.wrap_glBlendEquation(C.uint(mode)) }
...
// GL_VERSION_1_3
func ActiveTexture(texture uint32) { C.wrap_glActiveTexture(C.uint(texture)) }
...
// GL_VERSION_1_5
func BeginQuery(target uint32, id uint32)     { C.wrap_glBeginQuery(C.uint(target), C.uint(id)) }
func BindBuffer(target uint32, buffer uint32) { C.wrap_glBindBuffer(C.uint(target), C.uint(buffer)) }
...
func DeleteBuffers(n int32, buffers *uint32) { C.wrap_glDeleteBuffers(C.int(n), (*C.uint)(buffers)) }
func DeleteQueries(n int32, ids *uint32)     { C.wrap_glDeleteQueries(C.int(n), (*C.uint)(ids)) }
func EndQuery(target uint32)                 { C.wrap_glEndQuery(C.uint(target)) }
func GenBuffers(n int32, buffers *uint32)    { C.wrap_glGenBuffers(C.int(n), (*C.uint)(buffers)) }
func GenQueries(n int32, ids *uint32)        { C.wrap_glGenQueries(C.int(n), (*C.uint)(ids)) }
...
func IsBuffer(buffer uint32) bool { return cbool(uint(C.wrap_glIsBuffer(C.uint(buffer)))) }
func IsQuery(id uint32) bool      { return cbool(uint(C.wrap_glIsQuery(C.uint(id)))) }
func MapBuffer(target uint32, access uint32) Pointer {
	return Pointer(C.wrap_glMapBuffer(C.uint(target), C.uint(access)))
}
func UnmapBuffer(target uint32) bool { return cbool(uint(C.wrap_glUnmapBuffer(C.uint(target)))) }
...
func CompileShader(shader uint32)      { C.wrap_glCompileShader(C.uint(shader)) }
func CreateProgram() uint32            { return uint32(C.wrap_glCreateProgram()) }
func CreateShader(t_ype uint32) uint32 { return uint32(C.wrap_glCreateShader(C.uint(t_ype))) }
func DeleteProgram(program uint32)     { C.wrap_glDeleteProgram(C.uint(program)) }
func DeleteShader(shader uint32)       { C.wrap_glDeleteShader(C.uint(shader)) }
func DetachShader(program uint32, shader uint32) {
	C.wrap_glDetachShader(C.uint(program), C.uint(shader))
}
func DisableVertexAttribArray(index uint32) { C.wrap_glDisableVertexAttribArray(C.uint(index)) }
func DrawBuffers(n int32, bufs *uint32)     { C.wrap_glDrawBuffers(C.int(n), (*C.uint)(bufs)) }
func EnableVertexAttribArray(index uint32)  { C.wrap_glEnableVertexAttribArray(C.uint(index)) }
...
func IsProgram(program uint32) bool { return cbool(uint(C.wrap_glIsProgram(C.uint(program)))) }
func IsShader(shader uint32) bool   { return cbool(uint(C.wrap_glIsShader(C.uint(shader)))) }
func LinkProgram(program uint32)    { C.wrap_glLinkProgram(C.uint(program)) }
...
func Uniform1f(location int32, v0 float32) { C.wrap_glUniform1f(C.int(location), C.float(v0)) }
func Uniform1fv(location int32, count int32, value *float32) {
	C.wrap_glUniform1fv(C.int(location), C.int(count), (*C.float)(value))
}
func Uniform1i(location int32, v0 int32) { C.wrap_glUniform1i(C.int(location), C.int(v0)) }
...
func UseProgram(program uint32)              { C.wrap_glUseProgram(C.uint(program)) }
func ValidateProgram(program uint32)         { C.wrap_glValidateProgram(C.uint(program)) }
func VertexAttrib1d(index uint32, x float64) { C.wrap_glVertexAttrib1d(C.uint(index), C.double(x)) }
func VertexAttrib1dv(index uint32, v *float64) {
	C.wrap_glVertexAttrib1dv(C.uint(index), (*C.double)(v))
}
func VertexAttrib1f(index uint32, x float32) { C.wrap_glVertexAttrib1f(C.uint(index), C.float(x)) }
func VertexAttrib1fv(index uint32, v *float32) {
	C.wrap_glVertexAttrib1fv(C.uint(index), (*C.float)(v))
}
func VertexAttrib1s(index uint32, x int16)   { C.wrap_glVertexAttrib1s(C.uint(index), C.short(x)) }
func VertexAttrib1sv(index uint32, v *int16) { C.wrap_glVertexAttrib1sv(C.uint(index), (*C.short)(v)) }
...
func VertexAttrib2sv(index uint32, v *int16) { C.wrap_glVertexAttrib2sv(C.uint(index), (*C.short)(v)) }
...
func VertexAttrib3sv(index uint32, v *int16)  { C.wrap_glVertexAttrib3sv(C.uint(index), (*C.short)(v)) }
func VertexAttrib4Nbv(index uint32, v *int8)  { C.wrap_glVertexAttrib4Nbv(C.uint(index), (*C.schar)(v)) }
func VertexAttrib4Niv(index uint32, v *int32) { C.wrap_glVertexAttrib4Niv(C.uint(index), (*C.int)(v)) }
...
func VertexAttrib4bv(index uint32, v *int8) { C.wrap_glVertexAttrib4bv(C.uint(index), (*C.schar)(v)) }
...
func VertexAttrib4iv(index uint32, v *int32) { C.wrap_glVertexAttrib4iv(C.uint(index), (*C.int)(v)) }
...
func VertexAttrib4sv(index uint32, v *int16) { C.wrap_glVertexAttrib4sv(C.uint(index), (*C.short)(v)) }
...
func ClampColor(target uint32, clamp uint32) { C.wrap_glClampColor(C.uint(target), C.uint(clamp)) }
...
func Disablei(target uint32, index uint32) { C.wrap_glDisablei(C.uint(target), C.uint(index)) }
func Enablei(target uint32, index uint32)  { C.wrap_glEnablei(C.uint(target), C.uint(index)) }
func EndConditionalRender()                { C.wrap_glEndConditionalRender() }
func EndTransformFeedback()                { C.wrap_glEndTransformFeedback() }
...
func Uniform1ui(location int32, v0 uint32) { C.wrap_glUniform1ui(C.int(location), C.uint(v0)) }
...
func VertexAttribI1i(index uint32, x int32)   { C.wrap_glVertexAttribI1i(C.uint(index), C.int(x)) }
func VertexAttribI1iv(index uint32, v *int32) { C.wrap_glVertexAttribI1iv(C.uint(index), (*C.int)(v)) }
func VertexAttribI1ui(index uint32, x uint32) { C.wrap_glVertexAttribI1ui(C.uint(index), C.uint(x)) }
...
func VertexAttribI2iv(index uint32, v *int32) { C.wrap_glVertexAttribI2iv(C.uint(index), (*C.int)(v)) }
...
func VertexAttribI3iv(index uint32, v *int32) { C.wrap_glVertexAttribI3iv(C.uint(index), (*C.int)(v)) }
...
func VertexAttribI4bv(index uint32, v *int8) { C.wrap_glVertexAttribI4bv(C.uint(index), (*C.schar)(v)) }
...
func VertexAttribI4iv(index uint32, v *int32) { C.wrap_glVertexAttribI4iv(C.uint(index), (*C.int)(v)) }
...
func PrimitiveRestartIndex(index uint32) { C.wrap_glPrimitiveRestartIndex(C.uint(index)) }
...
func BlendEquationi(buf uint32, mode uint32) { C.wrap_glBlendEquationi(C.uint(buf), C.uint(mode)) }
...
func MinSampleShading(value float32) { C.wrap_glMinSampleShading(C.float(value)) }
...
func BindingReport() (report []string) {
	report = []string{}
	report = append(report, "GL_ARB_ES2_compatibility")
	...
	report = append(report, "GL_ARB_base_instance")
	...
	report = append(report, "GL_ARB_blend_func_extended")
	...
	report = append(report, "GL_ARB_compute_shader")
	...
	report = append(report, "GL_ARB_draw_buffers_blend")
	...
	report = append(report, "GL_ARB_draw_elements_base_vertex")
	...
	report = append(report, "GL_ARB_draw_indirect")
	...
	report = append(report, "GL_ARB_framebuffer_no_attachments")
	...
	report = append(report, "GL_ARB_framebuffer_object")
	...
	report = append(report, "GL_ARB_get_program_binary")
	...
	report = append(report, "GL_ARB_gpu_shader_fp64")
	...
	report = append(report, "GL_ARB_map_buffer_range")
	...
	report = append(report, "GL_ARB_multi_draw_indirect")
	...
	report = append(report, "GL_ARB_program_interface_query")
	...
	report = append(report, "GL_ARB_separate_shader_objects")
	...
	report = append(report, "GL_ARB_shading_language_include")
	...
	report = append(report, "GL_ARB_sync")
	...
	report = append(report, "GL_ARB_tessellation_shader")
	...
	report = append(report, "GL_ARB_texture_buffer_range")
	...
	report = append(report, "GL_ARB_texture_multisample")
	...
	report = append(report, "GL_ARB_texture_storage")
	...
	report = append(report, "GL_ARB_texture_storage_multisample")
	...
	report = append(report, "GL_ARB_texture_view")
	report = append(report, isBound(unsafe.Pointer(C.pfn_glTextureView), "glTextureView"))
	report = append(report, "GL_ARB_timer_query")
	...
	report = append(report, "GL_ARB_transform_feedback2")
	...
	report = append(report, "GL_ARB_transform_feedback3")
	...
	report = append(report, "GL_ARB_transform_feedback_instanced")
	...
	report = append(report, "GL_ARB_uniform_buffer_object")
	...
	report = append(report, "GL_ARB_vertex_array_object")
	...
	report = append(report, "GL_ARB_vertex_attrib_64bit")
	...
	report = append(report, "GL_ARB_vertex_attrib_binding")
	...
	report = append(report, "GL_ARB_vertex_type_2_10_10_10_rev")
	...
	report = append(report, "GL_ARB_viewport_array")
	...
	report = append(report, "GL_VERSION_1_0")
	...
	report = append(report, "GL_VERSION_1_1")
	...
	report = append(report, "GL_VERSION_1_2")
	...
	report = append(report, "GL_VERSION_1_3")
	...
	report = append(report, "GL_VERSION_1_4")
	...
	report = append(report, "GL_VERSION_1_5")
	...
	report = append(report, "GL_VERSION_2_0")
	...
	report = append(report, "GL_VERSION_2_1")
	...
	report = append(report, "GL_VERSION_3_0")
	...
	report = append(report, "GL_VERSION_3_1")
	...
	report = append(report, "GL_VERSION_3_2")
