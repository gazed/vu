...
// T is a 3D transform for rotation and translation. It excludes scaling and shear information.
// T is used as a simplification and optimization instead of keeping all transform information
// in a 4x4 matrix.
//
...
// InvT updates transform t to be the inverse of transform a.
// The updated transform t is returned.
func (t *T) InvT(a *T) *T {
...
func (t *T) InvS(x, y, z float64) (vx, vy, vz float64) {
	...
	return MultSQ(vx, vy, vz, t.Ivr)             // apply inverse rotation.
}
